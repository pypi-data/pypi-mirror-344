---
title: Configuration
description: "Configure your mcp_router_use environment"
---

# Configuration Guide

This guide covers all the configuration options available in mcp_router_use.
...
mcp_router_use supports any MCP server through a flexible configuration system. (For a list of awesome servers you can visit https://github.com/punkpeye/awesome-mcp-servers or https://github.com/appcypher/awesome-mcp-servers which have an amazing collection of them)
...
```json
{
  "mcpServers": {
    ...
    "filesystem": {
      "command": "npx",
      "args": ["-y", "@modelcontextprotocol/server-filesystem", "/home/pietro/projects/mcp-router-use/"]
    }
  }
}
```

For a complete example of using multiple servers, see the [multi-server example](https://github.com/mcp-router/mcp-router-use/blob/main/examples/multi_server_example.py) in our repository.
...
mcp_router_use provides several ways to handle errors:
