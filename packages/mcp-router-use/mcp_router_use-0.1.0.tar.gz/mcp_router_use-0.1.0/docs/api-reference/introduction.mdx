---
title: API Reference
description: "Complete mcp_router_use API Documentation"
---

# API Reference

This section provides comprehensive documentation for the mcp_router_use API, including all components, methods, their arguments, and when to use different options.
...
- **llm**:
  ...
  - mcp_router_use supports ANY LLM that is compatible with LangChain
...
mcp_router_use provides several exception types to handle different error scenarios:
...
```python
from mcp_router_use.exceptions import MCPConnectionError, MCPTimeoutError
