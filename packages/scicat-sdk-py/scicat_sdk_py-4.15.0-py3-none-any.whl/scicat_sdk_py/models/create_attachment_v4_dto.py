...
class CreateAttachmentV4Dto(BaseModel):
    ...
    caption: StrictStr
    relationships: Optional[List[AttachmentRelationshipClass]] = None
    is_published: StrictBool = Field(alias="isPublished")
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "aid", "thumbnail", "caption", "relationships", "isPublished"]
