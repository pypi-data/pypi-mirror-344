...
class ChunkPos:
    ...
    Note that ChunkPos is a hashable object, and it hash is equal to (ChunkPos.x, ChunkPos.z).
    """
...
class SubChunkPos:
    ...
    Note that SubChunkPos is a hashable object, and it hash is equal to (SubChunkPos.x, SubChunkPos.y, SubChunkPos.z).
    """
...
class Range:
    ...
    Note that Range is a hashable object, and it hash is equal to (Range.start_range, Range.end_range).
    """
    ...
    def __hash__(self) -> int:
        return (self.start_range, self.end_range).__hash__()
...
class Dimension:
    ...
    Note that Dimension is a hashable object, and it hash is equal to int(Dimension).
    """
...
class HashWithPosY:
    """
    Note that HashWithPosY is a hashable object, and it
    hash is equal to (HashWithPosY.Hash, HashWithPosY.PosY).
    """
    ...
    def __hash__(self) -> int:
        return (self.Hash, self.PosY).__hash__()
