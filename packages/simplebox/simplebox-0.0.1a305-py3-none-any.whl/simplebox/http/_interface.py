...
class BaseRestWrapper(__BaseRestAdvice, ABC):
    ...
    @property
    def name(self) -> str:
        raise NotImplementedError("not support get name method.")

    @name.setter
    def name(self, value: str):
        raise NotImplementedError("not support set name method.")

    @property
    def host(self) -> str:
        raise NotImplementedError("not support get host method.")

    @host.setter
    def host(self, value: str):
        raise NotImplementedError("not support set host method.")

    @property
    def upstream(self) -> str:
        raise NotImplementedError("not support get upstream method.")

    @upstream.setter
    def upstream(self, value: str):
        raise NotImplementedError("not support set upstream method.")

    @property
    def headers(self) -> dict:
        raise NotImplementedError("not support get headers method.")

    @headers.setter
    def headers(self, headers: dict or Serializable):
        raise NotImplementedError("not support set headers method.")

    @property
    def cookies(self) -> dict:
        raise NotImplementedError("not support get cookies method.")

    @cookies.setter
    def cookies(self, cookies: dict or Serializable):
        raise NotImplementedError("not support set cookies method.")

    @property
    def auth(self) -> tuple or Callable:
        raise NotImplementedError("not support get auth method.")

    @auth.setter
    def auth(self, auth: tuple or list or Serializable or Callable):
        raise NotImplementedError("not support set auth method.")

    @property
    def hooks(self) -> Hooks:
        raise NotImplementedError("not support get hooks method.")

    @hooks.setter
    def hooks(self, hooks: Hooks):
        raise NotImplementedError("not support set hooks method.")

    @property
    def show_len(self) -> int:
        raise NotImplementedError("not support get show_len method.")

    @show_len.setter
    def show_len(self, value: int):
        raise NotImplementedError("not support set show_len method.")

    @property
    def http2(self) -> bool:
        raise NotImplementedError("not support get http2 method.")

    @http2.setter
    def http2(self, value: bool):
        raise NotImplementedError("not support set http2 method.")

    @property
    def check_status(self) -> bool:
        raise NotImplementedError("not support get check_status method.")

    @check_status.setter
    def check_status(self, value: bool):
        raise NotImplementedError("not support set check_status method.")

    @property
    def encoding(self) -> str:
        raise NotImplementedError("not support get encoding method.")
    ...
    @property
    def description(self) -> str:
        raise NotImplementedError("not support get description method.")

    @description.setter
    def description(self, value):
        raise NotImplementedError("not support set description method.")

    @property
    def restful(self) -> RestFul:
        raise NotImplementedError("not support get restful method.")

    @restful.setter
    def restful(self, restful: RestFul):
        raise NotImplementedError("not support set restful method.")

    @property
    def retry_times(self) -> int:
        raise NotImplementedError("not support get retry_times method.")

    @retry_times.setter
    def retry_times(self, retry_time: int):
        raise NotImplementedError("not support set retry_times method.")

    @property
    def retry_interval(self) -> int:
        raise NotImplementedError("not support get retry_interval method.")

    @retry_interval.setter
    def retry_interval(self, retry_interval: int):
        raise NotImplementedError("not support set retry_interval method.")

    @property
    def retry_exit_code_range(self) -> list:
        raise NotImplementedError("not support get retry_exit_code_range method.")

    @retry_exit_code_range.setter
    def retry_exit_code_range(self, retry_exit_code_range: list):
        raise NotImplementedError("not support set retry_exit_code_range method.")

    @property
    def retry_exception_retry(self) -> bool:
        raise NotImplementedError("not support get retry_exception_retry method.")

    @retry_exception_retry.setter
    def retry_exception_retry(self, retry_exception_retry: bool):
        raise NotImplementedError("not support set retry_exception_retry method.")

    @property
    def retry_check_handler(self) -> Callable[[Any], bool]:
        raise NotImplementedError("not support get retry_check_handler method.")

    @retry_check_handler.setter
    def retry_check_handler(self, retry_check_handler: Callable[[Any], bool]):
        raise NotImplementedError("not support set retry_check_handler method.")

    @property
    def verify(self) -> bool:
        raise NotImplementedError("not support get verify method.")

    @verify.setter
    def verify(self, verify: bool):
        raise NotImplementedError("not support set verify method.")

    @property
    def proxies(self) -> dict:
        raise NotImplementedError("not support get proxies method.")

    @proxies.setter
    def proxies(self, proxies: dict):
        raise NotImplementedError("not support set proxies method.")

    @property
    def cert(self) -> str or tuple:
        raise NotImplementedError("not support get cert method.")

    @cert.setter
    def cert(self, cert: str or tuple or Serializable):
        raise NotImplementedError("not support set cert method.")

    @property
    def stats(self) -> bool:
        raise NotImplementedError("not support get stats method.")

    @stats.setter
    def stats(self, stats: bool):
        raise NotImplementedError("not support set stats method.")
