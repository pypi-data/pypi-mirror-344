...
class ProfanityFilter:
    ...
    DEFAULT_MODEL = "gemini-1.5-pro-latest" # Или ваша модель gemini-2.5-pro-exp-03-25
...
{{  
  ...
  "filtered_text": "Text where *only* the characters of identified profane words/phrases are replaced by asterisks. CRITICAL: ALL non-profane words, spaces, punctuation, line breaks, and other characters MUST be preserved exactly in their original positions. Replacement should ideally match the length of the detected profane word (e.g., 'fuck' -> '****'). Example transformation: 'Go fuck yourself, asshole!' MUST become 'Go **** yourself, *******!'.",
  "detected_profanity": [
    {{  
...
11. Filtered Text Structure Integrity: When generating the "filtered_text", you MUST replace *only* the characters belonging to the detected profane word or phrase with asterisks. All surrounding characters – including spaces, punctuation (commas, periods, hyphens, etc.), numbers, capitalization, and non-profane words – MUST be preserved precisely as they appear in the "original_text". Maintain the exact structure, spacing, and line breaks of the original text, replacing only the profanity itself. Do NOT merge replacements for adjacent profane words separated by spaces or punctuation into a single block of asterisks.
