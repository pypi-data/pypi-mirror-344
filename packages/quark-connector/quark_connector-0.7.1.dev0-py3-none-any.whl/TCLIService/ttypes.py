...
class TTypeId(object):
    ...
    NULL_TYPE = 16
    DATE_TYPE = 17
    INTERVAL_YEAR_TO_MONTH_TYPE = 18
    INTERVAL_DAY_TO_SECOND_TYPE = 19
    VARCHAR_TYPE = 20
    CHAR_TYPE = 21
    CURSOR_TYPE = 22
    TIME_TYPE = 23
    ...
    _VALUES_TO_NAMES = {
        ...
        16: "NULL_TYPE",
        17: "DATE_TYPE",
        18: "INTERVAL_YEAR_TO_MONTH_TYPE",
        19: "INTERVAL_DAY_TO_SECOND_TYPE",
        20: "VARCHAR_TYPE",
        21: "CHAR_TYPE",
        22: "CURSOR_TYPE",
        23: "TIME_TYPE",
...
class TOperationType(object):
    ...
    GET_FUNCTIONS = 7
    GET_PROCEDURES = 8
    GET_PROCEDURECOLUMNS = 9
    GET_STATISTICS = 10
    GET_DATABASEORTABLES = 11
    PRECOMPILE_STATEMENT = 12
    EXECUTE_PRECOMPILED_STATEMENT = 13
    UNKNOWN = 14
    ...
    _VALUES_TO_NAMES = {
        ...
        7: "GET_FUNCTIONS",
        8: "GET_PROCEDURES",
        9: "GET_PROCEDURECOLUMNS",
        10: "GET_STATISTICS",
        11: "GET_DATABASEORTABLES",
        12: "PRECOMPILE_STATEMENT",
        13: "EXECUTE_PRECOMPILED_STATEMENT",
        14: "UNKNOWN",
    }
...
class TColumnDesc(object):
    ...
    def __init__(self, columnName=None, typeDesc=None, position=None, comment=None, tableName=None, dbName=None,):
...
class TColumnValue(object):
    ...
    def __init__(self, boolVal=None, byteVal=None, i16Val=None, i32Val=None, i64Val=None, doubleVal=None, stringVal=None, handleVal=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.handleVal = TOperationHandle()
                    self.handleVal.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.stringVal is not None:
            ...
            oprot.writeFieldEnd()
        if self.handleVal is not None:
            oprot.writeFieldBegin('handleVal', TType.STRUCT, 8)
            self.handleVal.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TOpenSessionReq(object):
    ...
    def __init__(self, client_protocol=    6, username=None, password=None, configuration=None,):
...
class TOpenSessionResp(object):
    ...
    def __init__(self, status=None, serverProtocolVersion=    6, sessionHandle=None, configuration=None,):
        self.status = status
...
class TParam(object):
    ...
    def __init__(self, type=None, name=None, value=None, attrInOut=    0, attrCopy=    0,):
        self.type = type
        self.name = name
        self.value = value
        self.attrInOut = attrInOut
        self.attrCopy = attrCopy
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.value = TColumnValue()
                    self.value.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I32:
                    self.attrInOut = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.I32:
                    self.attrCopy = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.value is not None:
            ...
            oprot.writeFieldEnd()
        if self.attrInOut is not None:
            oprot.writeFieldBegin('attrInOut', TType.I32, 4)
            oprot.writeI32(self.attrInOut)
            oprot.writeFieldEnd()
        if self.attrCopy is not None:
            oprot.writeFieldBegin('attrCopy', TType.I32, 5)
            oprot.writeI32(self.attrCopy)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TExecuteStatementReq(object):
    ...
    def __init__(self, sessionHandle=None, statement=None, confOverlay=None, runAsync=False, parameters=None, timeOut=0,):
        self.sessionHandle = sessionHandle
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i154 in range(_size150):
                        _elem155 = TParam()
                        _elem155.read(iprot)
                        self.parameters.append(_elem155)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.confOverlay is not None:
            ...
            for kiter156, viter157 in self.confOverlay.items():
                oprot.writeString(kiter156.encode('utf-8') if sys.version_info[0] == 2 else kiter156)
                oprot.writeString(viter157.encode('utf-8') if sys.version_info[0] == 2 else viter157)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        ...
        if self.parameters is not None:
            ...
            for iter158 in self.parameters:
                iter158.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TExecuteStatementResp(object):
    ...
    def __init__(self, status=None, operationHandle=None, parameters=None,):
        self.status = status
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i163 in range(_size159):
                        _elem164 = TParam()
                        _elem164.read(iprot)
                        self.parameters.append(_elem164)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.parameters is not None:
            ...
            oprot.writeListBegin(TType.STRUCT, len(self.parameters))
            for iter165 in self.parameters:
                iter165.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TGetTypeInfoReq(object):
    ...
    def __init__(self, sessionHandle=None, dataType=None,):
        self.sessionHandle = sessionHandle
    ...
    def write(self, oprot):
        ...
        if self.dataType is not None:
            oprot.writeFieldBegin('dataType', TType.I16, 2)
            oprot.writeI16(self.dataType)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TGetProceduresReq(object):
    """
    Attributes:
     - sessionHandle
     - catalogName
    ...
    def __init__(self, sessionHandle=None, catalogName=None, schemaName=None, procedureName=None,):
        self.sessionHandle = sessionHandle
        self.catalogName = catalogName
        self.schemaName = schemaName
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.procedureName = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TGetProceduresReq')
        if self.sessionHandle is not None:
            oprot.writeFieldBegin('sessionHandle', TType.STRUCT, 1)
            self.sessionHandle.write(oprot)
            oprot.writeFieldEnd()
        ...
        if self.procedureName is not None:
            oprot.writeFieldBegin('procedureName', TType.STRING, 4)
...
class TGetProceduresResp(object):
    """
    Attributes:
     - status
     - operationHandle
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TGetProceduresResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
...
class TGetProcedureColumnsReq(object):
    """
    Attributes:
     - sessionHandle
     - catalogName
    ...
    def __init__(self, sessionHandle=None, catalogName=None, schemaName=None, procedureName=None, columnName=None,):
        self.sessionHandle = sessionHandle
        self.catalogName = catalogName
        self.schemaName = schemaName
        self.procedureName = procedureName
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TGetProcedureColumnsReq')
        if self.sessionHandle is not None:
            oprot.writeFieldBegin('sessionHandle', TType.STRUCT, 1)
            self.sessionHandle.write(oprot)
            oprot.writeFieldEnd()
...
class TGetProcedureColumnsResp(object):
    """
    Attributes:
     - status
     - operationHandle
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TGetProcedureColumnsResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
...
class TGetStatisticsReq(object):
    """
    Attributes:
     - sessionHandle
     - catalogName
    ...
    def __init__(self, sessionHandle=None, catalogName=None, schemaName=None, tableName=None, unique=None,):
        self.sessionHandle = sessionHandle
        self.catalogName = catalogName
        self.schemaName = schemaName
        self.tableName = tableName
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TGetStatisticsReq')
        if self.sessionHandle is not None:
            oprot.writeFieldBegin('sessionHandle', TType.STRUCT, 1)
            self.sessionHandle.write(oprot)
            oprot.writeFieldEnd()
        ...
        if self.unique is not None:
            oprot.writeFieldBegin('unique', TType.I16, 5)
            oprot.writeI16(self.unique)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TGetStatisticsResp(object):
    """
    Attributes:
     - status
     - operationHandle
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TGetStatisticsResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
...
class TGetTablesReq(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i170 in range(_size166):
                        ...
                        self.tableTypes.append(_elem171)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.tableTypes is not None:
            ...
            for iter172 in self.tableTypes:
...
class TFetchResultsReq(object):
    ...
    def __init__(self, operationHandle=None, orientation=    0, maxRows=None, fetchType=0, offset=None,):
        self.operationHandle = operationHandle
...
class TFetchResultsResp(object):
    ...
    def __init__(self, status=None, hasMoreRows=None, results=None, resultBuffer=None,):
        self.status = status
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.resultBuffer = iprot.readBinary()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.results is not None:
            ...
            oprot.writeFieldEnd()
        if self.resultBuffer is not None:
            oprot.writeFieldBegin('resultBuffer', TType.STRING, 4)
            oprot.writeBinary(self.resultBuffer)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TCancelOperationBySessionReq(object):
    """
    Attributes:
     - sessionHandle
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TCancelOperationBySessionReq')
        if self.sessionHandle is not None:
            oprot.writeFieldBegin('sessionHandle', TType.STRUCT, 1)
            self.sessionHandle.write(oprot)
            oprot.writeFieldEnd()
...
class TCancelOperationBySessionResp(object):
    """
    Attributes:
     - status
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TCancelOperationBySessionResp')
        if self.status is not None:
            oprot.writeFieldBegin('status', TType.STRUCT, 1)
            self.status.write(oprot)
            oprot.writeFieldEnd()
...
class TPreCompileStatementReq(object):
    """
    Attributes:
     - execStmtReq
    ...
    def __init__(self, execStmtReq=None,):
        self.execStmtReq = execStmtReq
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.execStmtReq = TExecuteStatementReq()
                    self.execStmtReq.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TPreCompileStatementReq')
        if self.execStmtReq is not None:
            oprot.writeFieldBegin('execStmtReq', TType.STRUCT, 1)
            self.execStmtReq.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()

    def validate(self):
        if self.execStmtReq is None:
            raise TProtocolException(message='Required field execStmtReq is unset!')
        return
...
class TPreCompileStatementResp(object):
    """
    Attributes:
     - execStmtResp
    ...
    def __init__(self, execStmtResp=None,):
        self.execStmtResp = execStmtResp
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.execStmtResp = TExecuteStatementResp()
                    self.execStmtResp.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TPreCompileStatementResp')
        if self.execStmtResp is not None:
            oprot.writeFieldBegin('execStmtResp', TType.STRUCT, 1)
            self.execStmtResp.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()

    def validate(self):
        if self.execStmtResp is None:
            raise TProtocolException(message='Required field execStmtResp is unset!')
        return
...
class TExecutePreCompiledStatementReq(object):
    """
    Attributes:
     - operationHandle
     - execStmtReq
    ...
    def __init__(self, operationHandle=None, execStmtReq=None,):
        self.operationHandle = operationHandle
        self.execStmtReq = execStmtReq
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TExecutePreCompiledStatementReq')
        if self.operationHandle is not None:
            oprot.writeFieldBegin('operationHandle', TType.STRUCT, 1)
            self.operationHandle.write(oprot)
            oprot.writeFieldEnd()
        if self.execStmtReq is not None:
            oprot.writeFieldBegin('execStmtReq', TType.STRUCT, 2)
            self.execStmtReq.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TExecutePreCompiledStatementResp(object):
    """
    Attributes:
     - execStmtResp
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TExecutePreCompiledStatementResp')
        if self.execStmtResp is not None:
            oprot.writeFieldBegin('execStmtResp', TType.STRUCT, 1)
            self.execStmtResp.write(oprot)
            oprot.writeFieldEnd()
...
TColumnValue.thrift_spec = (
    ...
    (8, TType.STRUCT, 'handleVal', [TOperationHandle, None], None, ),  # 8
)
...
all_structs.append(TParam)
TParam.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'type', None, None, ),  # 1
    (2, TType.STRING, 'name', 'UTF8', None, ),  # 2
    (3, TType.STRUCT, 'value', [TColumnValue, None], None, ),  # 3
    (4, TType.I32, 'attrInOut', None,     0, ),  # 4
    (5, TType.I32, 'attrCopy', None,     0, ),  # 5
)
...
TExecuteStatementReq.thrift_spec = (
    ...
    (5, TType.LIST, 'parameters', (TType.STRUCT, [TParam, None], False), None, ),  # 5
    (6, TType.I64, 'timeOut', None, 0, ),  # 6
)
...
TExecuteStatementResp.thrift_spec = (
    ...
    (3, TType.LIST, 'parameters', (TType.STRUCT, [TParam, None], False), None, ),  # 3
)
all_structs.append(TGetTypeInfoReq)
TGetTypeInfoReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None, ),  # 1
    (2, TType.I16, 'dataType', None, None, ),  # 2
)
...
all_structs.append(TGetProceduresReq)
TGetProceduresReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None, ),  # 1
    (2, TType.STRING, 'catalogName', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'schemaName', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'procedureName', 'UTF8', None, ),  # 4
)
all_structs.append(TGetProceduresResp)
TGetProceduresResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [TStatus, None], None, ),  # 1
    (2, TType.STRUCT, 'operationHandle', [TOperationHandle, None], None, ),  # 2
)
all_structs.append(TGetProcedureColumnsReq)
TGetProcedureColumnsReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None, ),  # 1
    (2, TType.STRING, 'catalogName', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'schemaName', 'UTF8', None, ),  # 3
...
all_structs.append(TGetProcedureColumnsResp)
TGetProcedureColumnsResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [TStatus, None], None, ),  # 1
    (2, TType.STRUCT, 'operationHandle', [TOperationHandle, None], None, ),  # 2
)
all_structs.append(TGetStatisticsReq)
TGetStatisticsReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None, ),  # 1
    (2, TType.STRING, 'catalogName', 'UTF8', None, ),  # 2
    (3, TType.STRING, 'schemaName', 'UTF8', None, ),  # 3
    (4, TType.STRING, 'tableName', 'UTF8', None, ),  # 4
    (5, TType.I16, 'unique', None, None, ),  # 5
)
all_structs.append(TGetStatisticsResp)
TGetStatisticsResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [TStatus, None], None, ),  # 1
    (2, TType.STRUCT, 'operationHandle', [TOperationHandle, None], None, ),  # 2
)
...
TFetchResultsResp.thrift_spec = (
    ...
    (4, TType.STRING, 'resultBuffer', 'BINARY', None, ),  # 4
)
...
all_structs.append(TCancelOperationBySessionReq)
TCancelOperationBySessionReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'sessionHandle', [TSessionHandle, None], None, ),  # 1
)
all_structs.append(TCancelOperationBySessionResp)
TCancelOperationBySessionResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'status', [TStatus, None], None, ),  # 1
)
all_structs.append(TPreCompileStatementReq)
TPreCompileStatementReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'execStmtReq', [TExecuteStatementReq, None], None, ),  # 1
)
all_structs.append(TPreCompileStatementResp)
TPreCompileStatementResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'execStmtResp', [TExecuteStatementResp, None], None, ),  # 1
)
all_structs.append(TExecutePreCompiledStatementReq)
TExecutePreCompiledStatementReq.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'operationHandle', [TOperationHandle, None], None, ),  # 1
    (2, TType.STRUCT, 'execStmtReq', [TExecuteStatementReq, None], None, ),  # 2
)
all_structs.append(TExecutePreCompiledStatementResp)
TExecutePreCompiledStatementResp.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'execStmtResp', [TExecuteStatementResp, None], None, ),  # 1
)
