...
class Iface(object):
    ...
    def GetProcedureColumns(self, req):
        """
        Parameters:
         - req
    ...
    def GetDatabaseOrTables(self, req):
        """
        Parameters:
         - req
    ...
    def CancelOperationBySession(self, req):
        """
        Parameters:
         - req
    ...
    def PreCompileStatement(self, req):
        """
        Parameters:
         - req
    ...
    def ExecutePreCompiledStatement(self, req):
        """
        Parameters:
         - req
...
class Client(Iface):
    ...
    def GetProcedures(self, req):
        ...
        """
        self.send_GetProcedures(req)
        return self.recv_GetProcedures()

    def send_GetProcedures(self, req):
        self._oprot.writeMessageBegin('GetProcedures', TMessageType.CALL, self._seqid)
        args = GetProcedures_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_GetProcedures(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = GetProcedures_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "GetProcedures failed: unknown result")
    ...
    def GetProcedureColumns(self, req):
        ...
        """
        self.send_GetProcedureColumns(req)
        return self.recv_GetProcedureColumns()

    def send_GetProcedureColumns(self, req):
        self._oprot.writeMessageBegin('GetProcedureColumns', TMessageType.CALL, self._seqid)
        args = GetProcedureColumns_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_GetProcedureColumns(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = GetProcedureColumns_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "GetProcedureColumns failed: unknown result")
    ...
    def GetDatabaseOrTables(self, req):
        ...
        """
        self.send_GetDatabaseOrTables(req)
        return self.recv_GetDatabaseOrTables()

    def send_GetDatabaseOrTables(self, req):
        self._oprot.writeMessageBegin('GetDatabaseOrTables', TMessageType.CALL, self._seqid)
        args = GetDatabaseOrTables_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_GetDatabaseOrTables(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = GetDatabaseOrTables_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "GetDatabaseOrTables failed: unknown result")
    ...
    def GetStatistics(self, req):
        ...
        """
        self.send_GetStatistics(req)
        return self.recv_GetStatistics()

    def send_GetStatistics(self, req):
        self._oprot.writeMessageBegin('GetStatistics', TMessageType.CALL, self._seqid)
        args = GetStatistics_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_GetStatistics(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = GetStatistics_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "GetStatistics failed: unknown result")
    ...
    def CancelOperationBySession(self, req):
        ...
        """
        self.send_CancelOperationBySession(req)
        return self.recv_CancelOperationBySession()

    def send_CancelOperationBySession(self, req):
        self._oprot.writeMessageBegin('CancelOperationBySession', TMessageType.CALL, self._seqid)
        args = CancelOperationBySession_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_CancelOperationBySession(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = CancelOperationBySession_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "CancelOperationBySession failed: unknown result")
    ...
    def PreCompileStatement(self, req):
        ...
        """
        self.send_PreCompileStatement(req)
        return self.recv_PreCompileStatement()

    def send_PreCompileStatement(self, req):
        self._oprot.writeMessageBegin('PreCompileStatement', TMessageType.CALL, self._seqid)
        args = PreCompileStatement_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_PreCompileStatement(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = PreCompileStatement_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "PreCompileStatement failed: unknown result")
    ...
    def ExecutePreCompiledStatement(self, req):
        ...
        """
        self.send_ExecutePreCompiledStatement(req)
        return self.recv_ExecutePreCompiledStatement()

    def send_ExecutePreCompiledStatement(self, req):
        self._oprot.writeMessageBegin('ExecutePreCompiledStatement', TMessageType.CALL, self._seqid)
        args = ExecutePreCompiledStatement_args()
        args.req = req
        args.write(self._oprot)
        self._oprot.writeMessageEnd()
        self._oprot.trans.flush()

    def recv_ExecutePreCompiledStatement(self):
        iprot = self._iprot
        (fname, mtype, rseqid) = iprot.readMessageBegin()
        if mtype == TMessageType.EXCEPTION:
            x = TApplicationException()
            ...
            iprot.readMessageEnd()
            raise x
        result = ExecutePreCompiledStatement_result()
        result.read(iprot)
        iprot.readMessageEnd()
        if result.success is not None:
            return result.success
        raise TApplicationException(TApplicationException.MISSING_RESULT, "ExecutePreCompiledStatement failed: unknown result")
...
class Processor(Iface, TProcessor):
    def __init__(self, handler):
        ...
        self._processMap["GetProcedures"] = Processor.process_GetProcedures
        self._processMap["GetProcedureColumns"] = Processor.process_GetProcedureColumns
        self._processMap["GetTables"] = Processor.process_GetTables
        self._processMap["GetDatabaseOrTables"] = Processor.process_GetDatabaseOrTables
        self._processMap["GetStatistics"] = Processor.process_GetStatistics
        ...
        self._processMap["CancelOperationBySession"] = Processor.process_CancelOperationBySession
        self._processMap["PreCompileStatement"] = Processor.process_PreCompileStatement
        self._processMap["ExecutePreCompiledStatement"] = Processor.process_ExecutePreCompiledStatement
    ...
    def process_GetProcedures(self, seqid, iprot, oprot):
        args = GetProcedures_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = GetProcedures_result()
        try:
            result.success = self._handler.GetProcedures(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("GetProcedures", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_GetProcedureColumns(self, seqid, iprot, oprot):
        args = GetProcedureColumns_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = GetProcedureColumns_result()
        try:
            result.success = self._handler.GetProcedureColumns(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("GetProcedureColumns", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_GetDatabaseOrTables(self, seqid, iprot, oprot):
        args = GetDatabaseOrTables_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = GetDatabaseOrTables_result()
        try:
            result.success = self._handler.GetDatabaseOrTables(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("GetDatabaseOrTables", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_GetStatistics(self, seqid, iprot, oprot):
        args = GetStatistics_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = GetStatistics_result()
        try:
            result.success = self._handler.GetStatistics(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("GetStatistics", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
    ...
    def process_CancelOperationBySession(self, seqid, iprot, oprot):
        args = CancelOperationBySession_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = CancelOperationBySession_result()
        try:
            result.success = self._handler.CancelOperationBySession(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("CancelOperationBySession", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_PreCompileStatement(self, seqid, iprot, oprot):
        args = PreCompileStatement_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = PreCompileStatement_result()
        try:
            result.success = self._handler.PreCompileStatement(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("PreCompileStatement", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()

    def process_ExecutePreCompiledStatement(self, seqid, iprot, oprot):
        args = ExecutePreCompiledStatement_args()
        args.read(iprot)
        iprot.readMessageEnd()
        result = ExecutePreCompiledStatement_result()
        try:
            result.success = self._handler.ExecutePreCompiledStatement(args.req)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
            ...
            msg_type = TMessageType.EXCEPTION
            result = TApplicationException(TApplicationException.INTERNAL_ERROR, 'Internal error')
        oprot.writeMessageBegin("ExecutePreCompiledStatement", msg_type, seqid)
        result.write(oprot)
        oprot.writeMessageEnd()
        oprot.trans.flush()
...
class GetProcedures_args(object):
    """
    Attributes:
     - req
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetProcedures_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetProcedures_args)
GetProcedures_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TGetProceduresReq, None], None, ),  # 1
)


class GetProcedures_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TGetProceduresResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetProcedures_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetProcedures_result)
GetProcedures_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TGetProceduresResp, None], None, ),  # 0
)


class GetProcedureColumns_args(object):
    """
    Attributes:
     - req
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = TGetProcedureColumnsReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetProcedureColumns_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetProcedureColumns_args)
GetProcedureColumns_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TGetProcedureColumnsReq, None], None, ),  # 1
)


class GetProcedureColumns_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TGetProcedureColumnsResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetProcedureColumns_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetProcedureColumns_result)
GetProcedureColumns_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TGetProcedureColumnsResp, None], None, ),  # 0
)
...
class GetDatabaseOrTables_args(object):
    """
    Attributes:
     - req
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetDatabaseOrTables_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetDatabaseOrTables_args)
GetDatabaseOrTables_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TGetTablesReq, None], None, ),  # 1
)


class GetDatabaseOrTables_result(object):
    """
    Attributes:
     - success
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetDatabaseOrTables_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetDatabaseOrTables_result)
GetDatabaseOrTables_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TGetTablesResp, None], None, ),  # 0
)


class GetStatistics_args(object):
    """
    Attributes:
     - req
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetStatistics_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetStatistics_args)
GetStatistics_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TGetStatisticsReq, None], None, ),  # 1
)


class GetStatistics_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TGetStatisticsResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('GetStatistics_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(GetStatistics_result)
GetStatistics_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TGetStatisticsResp, None], None, ),  # 0
)
...
class CancelOperationBySession_args(object):
    """
    Attributes:
     - req
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = TCancelOperationBySessionReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('CancelOperationBySession_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(CancelOperationBySession_args)
CancelOperationBySession_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TCancelOperationBySessionReq, None], None, ),  # 1
)


class CancelOperationBySession_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TCancelOperationBySessionResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('CancelOperationBySession_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(CancelOperationBySession_result)
CancelOperationBySession_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TCancelOperationBySessionResp, None], None, ),  # 0
)


class PreCompileStatement_args(object):
    """
    Attributes:
     - req
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = TPreCompileStatementReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('PreCompileStatement_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(PreCompileStatement_args)
PreCompileStatement_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TPreCompileStatementReq, None], None, ),  # 1
)


class PreCompileStatement_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TPreCompileStatementResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('PreCompileStatement_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(PreCompileStatement_result)
PreCompileStatement_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TPreCompileStatementResp, None], None, ),  # 0
)


class ExecutePreCompiledStatement_args(object):
    """
    Attributes:
     - req
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    self.req = TExecutePreCompiledStatementReq()
                    self.req.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ExecutePreCompiledStatement_args')
        if self.req is not None:
            oprot.writeFieldBegin('req', TType.STRUCT, 1)
            self.req.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(ExecutePreCompiledStatement_args)
ExecutePreCompiledStatement_args.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'req', [TExecutePreCompiledStatementReq, None], None, ),  # 1
)


class ExecutePreCompiledStatement_result(object):
    """
    Attributes:
     - success
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = TExecutePreCompiledStatementResp()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('ExecutePreCompiledStatement_result')
        if self.success is not None:
            oprot.writeFieldBegin('success', TType.STRUCT, 0)
            self.success.write(oprot)
            oprot.writeFieldEnd()
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(ExecutePreCompiledStatement_result)
ExecutePreCompiledStatement_result.thrift_spec = (
    (0, TType.STRUCT, 'success', [TExecutePreCompiledStatementResp, None], None, ),  # 0
)
