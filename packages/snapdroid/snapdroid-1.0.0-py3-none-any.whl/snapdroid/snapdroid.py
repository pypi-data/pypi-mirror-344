...
{COLOR_GREEN}/____/_/ /_/\__,_/ .___/_____/_/   \____/_/\__,_/      {COLOR_GREEN}
...
def main():
    ...
    try:
        ...
        # Then check if any devices are connected
        ...
        # Finally check if device is responsive
        try:
