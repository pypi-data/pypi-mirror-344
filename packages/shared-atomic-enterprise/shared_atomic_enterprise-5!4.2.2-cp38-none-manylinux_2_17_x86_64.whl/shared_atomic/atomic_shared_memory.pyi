...
class atomic_shared_memory(shared_atomic.atomic_object_backend.atomic_object):
    ...
    def __init__(self, initial: bytes = ..., length: int = ..., paddingdirection: unicode = ..., paddingbytes: bytes = ..., trimming_direction: unicode = ..., source: unicode = ..., previous_shared_memory_path: bytes = ..., remove_previous_file: bool = ..., dealloc_async: bool = ...) -> Any:
    ...
    def file_sync(self, _async: bool = ..., start: int = ..., length: int = ...) -> int:
        ...
        """
    def memdump(self, file_path: bytes, start: int = ..., length: int = ...) -> int:
        """memdump(self, file_path: bytes, start: int = 0, length: int = 0) -> int
