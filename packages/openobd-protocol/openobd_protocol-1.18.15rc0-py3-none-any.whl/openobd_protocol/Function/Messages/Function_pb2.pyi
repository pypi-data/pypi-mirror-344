...
class FunctionDetails(_message.Message):
    __slots__ = ("id", "version", "name", "description")
    ID_FIELD_NUMBER: _ClassVar[int]
    ...
    name: str
    description: str
    def __init__(self, id: _Optional[str] = ..., version: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ...) -> None: ...

class VariableList(_message.Message):
    __slots__ = ("memory", "prefix", "variables")
    ...
    def __init__(self, memory: _Optional[_Union[ContextType, str]] = ..., prefix: _Optional[str] = ..., variables: _Optional[_Iterable[_Union[Variable, _Mapping]]] = ...) -> None: ...
...
class Variable(_message.Message):
    ...
    value: str
    object: _any_pb2.Any
    def __init__(self, memory: _Optional[_Union[ContextType, str]] = ..., key: _Optional[str] = ..., value: _Optional[str] = ..., object: _Optional[_Union[_any_pb2.Any, _Mapping]] = ...) -> None: ...
