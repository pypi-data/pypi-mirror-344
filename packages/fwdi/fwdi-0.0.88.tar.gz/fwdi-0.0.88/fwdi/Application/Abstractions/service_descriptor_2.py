    ...
    def __set_inject(cls):
        ...
        if not inspect.isabstract(cls):
            if hasattr(cls, '__name__'):
                if GlobalSettingService.log_lvl == logging.DEBUG or GlobalSettingService.log_lvl == logging.INFO:
                    print(f"Set attribute __log__ to :{cls}")
                    
                cls.__log__ = ManagerLogging.get_logging(cls.__name__, GlobalSettingService)
