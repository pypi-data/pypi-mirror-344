    ...
    def upload(self, chunk_number: int):
        ...
        try:
            ...
            if response.status_code == 202:
                ...
                self.chunks_statuses[chunk_number]["message"] = (
...
class Client:
    ...
    def add_metadata(self, title: str, metas_set_id: int) -> int:
        ...
        """
        return self.__call("add_metadata", [title, metas_set_id])
    ...
    def create_annotation(self, resource_id: int, data: dict) -> dict:
        ...
        ```
        """
        return self.__call("create_annotation", [resource_id, data])
    ...
    def delete_annotation(self, annotation_id: int) -> bool:
        ...
        """
        return self.__call("delete_annotation", [annotation_id])
    ...
    def list_annotations(self, resource_id: int) -> List[dict]:
        ...
        """
        return self.__call("list_annotations", [resource_id])
    ...
    def resource(self, resource_id: int, include_metas: bool = True) -> Dict:
        ...
        ```
        """
        return self.__call("resource", [resource_id, include_metas])
    ...
    def update_annotation(self, annotation_id: int, data: dict) -> dict:
        ...
        """
        return self.__call("update_annotation", [annotation_id, data])
    ...
    def update_resource_from_xlsx_row(self, resource_data: dict) -> bool:
        ...
        """
        return self.__call("update_resource_from_xlsx_row", [resource_data])
    ...
    def user_tasks_status(self, project_id: int = None) -> List[dict]:
        ...
        ```
        """
        return self.__call("user_tasks_status", [project_id])
