...
class UkPseudonymizer:
    ...
    # Mapping from spaCy model entities to Presidio entities
    ...
    def pseudonymize(self, text: str) -> str:
        ...
        anonymized_result = self.anonymizer.anonymize(text=text, analyzer_results=results, operators=self.custom_operators if len(self.custom_operators.items()) > 0 else None)
