...
class BaseSwissmetroModel(BaseDiscreteChoiceModel):
    ...
    def calculate_choice_accuracy(self):
        """Calculate individual choice prediction accuracy."""
        if not hasattr(self, 'results'):
...
class MultinomialLogitModel(BaseSwissmetroModel):
...
class NestedLogitModel(BaseSwissmetroModel):
...
class MixedLogitModel(BaseSwissmetroModel):
