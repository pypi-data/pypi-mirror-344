...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DELETERESOURCEREQUEST']._serialized_start=113
  _globals['_DELETERESOURCEREQUEST']._serialized_end=235
