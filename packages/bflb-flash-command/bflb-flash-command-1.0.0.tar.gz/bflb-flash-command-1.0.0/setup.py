...
longdesc = """
## Bouffalolab Flash Command Tool
====================================
...
entry_points = {"console_scripts": ["bflb-flash-command = bflb_flash_command.__main__:run_main"]}

setup(
    name="bflb-flash-command",
    version="1.0.0",
    author="bouffalolab",
    ...
    license="MIT",
    url="https://pypi.org/project/bflb-flash-command/",
