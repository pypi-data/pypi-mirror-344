...
from libs.bl616d.flash_select_do import create_flashcfg_table
from libs.bl616d.bootheader_cfg_keys import (
    flashcfg_table_start_pos as flashcfg_table_start,
)
from libs.bl616d.bootheader_cfg_keys import bootcpucfg_start_pos as bootcpucfg_start
from libs.bl616d.bootheader_cfg_keys import bootcpucfg_len as bootcpucfg_length
from libs.bl616d.bootheader_cfg_keys import (
...
from libs.bl616d.bootheader_cfg_keys import bootcfg_start_pos as bootcfg_start
from libs.bl616d.bootheader_cfg_keys import bootheader_len as header_len
...
def img_creat_process(group_type, flash_img, cfg, security=False, **kwargs):
    ...
    flash_cfg_addr = len(bootheader_data + pk_data + signature + aesiv_data)
    ...
    if flash_img == 1:
        ...
        with open(bootinfo_file_name, "wb+") as fp:
            bootinfo = bootheader_data + pk_data + signature + aesiv_data + flash_cfg_list + flash_cfg_table
            fp.write(bootinfo)
