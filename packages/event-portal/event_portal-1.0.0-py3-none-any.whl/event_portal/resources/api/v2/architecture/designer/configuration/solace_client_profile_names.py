...
class SolaceClientProfileNamesResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        """
        Create a client profile name configuration for an application version.
    ...
    def retrieve(
        ...
        *,
        ...
        """
        Get a specific client profile name configuration for an application version.
        ...
        extra_headers = {"Accept": "application/json;charset=utf-8", **(extra_headers or {})}
        return self._get(
            f"/api/v2/architecture/designer/configuration/solaceClientProfileNames/{id}",
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ConfigurationResponse,
    ...
    def list(
        ...
        *,
        ...
        """
        Get a list of client profile name configurations for an application version.
        ...
        Args:
          entity_ids: The unique identifiers of designer entities, separated by commas, to retrieve
              client profile name configurations from.

          event_broker_ids: The unique identifiers of the event brokers, separated by commas, to retrieve
              client profile name configurations from.

          ids: The unique identifiers of the client profile name configurations to retrieve,
              separated by commas.

          page_number: The page number to retrieve.

          page_size: The number of client profile name configurations to return per page.
    ...
    def delete(
        ...
        *,
        ...
        """Delete a client profile name configuration for an application version.
