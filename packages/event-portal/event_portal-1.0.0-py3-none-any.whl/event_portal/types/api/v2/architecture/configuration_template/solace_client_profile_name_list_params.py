...
__all__ = ["SolaceClientProfileNameListParams"]


class SolaceClientProfileNameListParams(TypedDict, total=False):
    ids: List[str]
    """
    The unique identifiers of the client profile name configuration templates to
    retrieve, separated by commas.
    """

    name: str
    """The name of the client profile name configuration template to match."""

    page_number: Annotated[int, PropertyInfo(alias="pageNumber")]
    """The page number to retrieve."""

    page_size: Annotated[int, PropertyInfo(alias="pageSize")]
    """The number of client profile name configuration templates to return per page."""
