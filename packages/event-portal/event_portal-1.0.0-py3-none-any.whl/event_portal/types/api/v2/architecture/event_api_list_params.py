...
__all__ = ["EventAPIListParams"]


class EventAPIListParams(TypedDict, total=False):
    ...
    available_within_application_domain_ids: Annotated[bool, PropertyInfo(alias="availableWithinApplicationDomainIds")]
