...
__all__ = ["SolaceClientUsernameListParams"]


class SolaceClientUsernameListParams(TypedDict, total=False):
    ...
    ids: List[str]
    """
    The unique identifiers of the client username configurations to retrieve,
    separated by commas.
    """
    ...
    """The number of client username configurations to return per page."""
