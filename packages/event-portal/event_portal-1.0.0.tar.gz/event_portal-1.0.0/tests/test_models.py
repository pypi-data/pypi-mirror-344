...
from event_portal._utils import PropertyInfo
from event_portal._compat import PYDANTIC_V2, parse_obj, model_dump, model_json
from event_portal._models import BaseModel, construct_type
