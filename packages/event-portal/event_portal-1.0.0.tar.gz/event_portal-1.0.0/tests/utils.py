...
from event_portal._types import Omit, NoneType
from event_portal._utils import (
    is_dict,
    is_list,
    is_list_type,
    is_union_type,
...
from event_portal._compat import PYDANTIC_V2, field_outer_type, get_model_fields
from event_portal._models import BaseModel
