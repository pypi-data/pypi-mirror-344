...
class TestEventAPIs:
    ...
    def test_method_create(self, client: EventPortal) -> None:
        event_api = client.api.v2.architecture.event_apis.create()
        assert_matches_type(EventAPIResponse, event_api, path=["response"])
    ...
    def test_raw_response_create(self, client: EventPortal) -> None:
        response = client.api.v2.architecture.event_apis.with_raw_response.create()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        event_api = response.parse()
        assert_matches_type(EventAPIResponse, event_api, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_create(self, client: EventPortal) -> None:
        with client.api.v2.architecture.event_apis.with_streaming_response.create() as response:
    ...
    def test_method_retrieve(self, client: EventPortal) -> None:
        event_api = client.api.v2.architecture.event_apis.retrieve(
            "id",
        )
        assert_matches_type(EventAPIResponse, event_api, path=["response"])
    ...
    def test_raw_response_retrieve(self, client: EventPortal) -> None:
        response = client.api.v2.architecture.event_apis.with_raw_response.retrieve(
            "id",
        )
    ...
    def test_streaming_response_retrieve(self, client: EventPortal) -> None:
        with client.api.v2.architecture.event_apis.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_retrieve(self, client: EventPortal) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v2.architecture.event_apis.with_raw_response.retrieve(
                "",
            )
    ...
    def test_method_update(self, client: EventPortal) -> None:
        event_api = client.api.v2.architecture.event_apis.update(
            id="id",
        )
        assert_matches_type(EventAPIResponse, event_api, path=["response"])
    ...
    def test_raw_response_update(self, client: EventPortal) -> None:
        response = client.api.v2.architecture.event_apis.with_raw_response.update(
            id="id",
        )
    ...
    def test_streaming_response_update(self, client: EventPortal) -> None:
        with client.api.v2.architecture.event_apis.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_update(self, client: EventPortal) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v2.architecture.event_apis.with_raw_response.update(
                id="",
            )
    ...
    def test_method_list(self, client: EventPortal) -> None:
        event_api = client.api.v2.architecture.event_apis.list()
        assert_matches_type(EventAPIListResponse, event_api, path=["response"])
    ...
    def test_method_list_with_all_params(self, client: EventPortal) -> None:
        event_api = client.api.v2.architecture.event_apis.list(
            ...
            available_within_application_domain_ids=True,
    ...
    def test_raw_response_list(self, client: EventPortal) -> None:
        response = client.api.v2.architecture.event_apis.with_raw_response.list()
    ...
    def test_streaming_response_list(self, client: EventPortal) -> None:
        with client.api.v2.architecture.event_apis.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_method_delete(self, client: EventPortal) -> None:
        event_api = client.api.v2.architecture.event_apis.delete(
            "id",
        )
        assert event_api is None

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_delete(self, client: EventPortal) -> None:
        response = client.api.v2.architecture.event_apis.with_raw_response.delete(
            "id",
        )
    ...
    def test_streaming_response_delete(self, client: EventPortal) -> None:
        with client.api.v2.architecture.event_apis.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_delete(self, client: EventPortal) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            client.api.v2.architecture.event_apis.with_raw_response.delete(
                "",
            )


class TestAsyncEventAPIs:
    parametrize = pytest.mark.parametrize("async_client", [False, True], indirect=True, ids=["loose", "strict"])

    @pytest.mark.skip()
    @parametrize
    async def test_method_create(self, async_client: AsyncEventPortal) -> None:
        event_api = await async_client.api.v2.architecture.event_apis.create()
        assert_matches_type(EventAPIResponse, event_api, path=["response"])
    ...
    async def test_raw_response_create(self, async_client: AsyncEventPortal) -> None:
        response = await async_client.api.v2.architecture.event_apis.with_raw_response.create()

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        event_api = await response.parse()
        assert_matches_type(EventAPIResponse, event_api, path=["response"])

    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncEventPortal) -> None:
        async with async_client.api.v2.architecture.event_apis.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_retrieve(self, async_client: AsyncEventPortal) -> None:
        event_api = await async_client.api.v2.architecture.event_apis.retrieve(
            "id",
        )
        assert_matches_type(EventAPIResponse, event_api, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncEventPortal) -> None:
        response = await async_client.api.v2.architecture.event_apis.with_raw_response.retrieve(
            "id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncEventPortal) -> None:
        async with async_client.api.v2.architecture.event_apis.with_streaming_response.retrieve(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncEventPortal) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v2.architecture.event_apis.with_raw_response.retrieve(
                "",
            )
    ...
    async def test_method_update(self, async_client: AsyncEventPortal) -> None:
        event_api = await async_client.api.v2.architecture.event_apis.update(
            id="id",
        )
        assert_matches_type(EventAPIResponse, event_api, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncEventPortal) -> None:
        response = await async_client.api.v2.architecture.event_apis.with_raw_response.update(
            id="id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncEventPortal) -> None:
        async with async_client.api.v2.architecture.event_apis.with_streaming_response.update(
            id="id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_update(self, async_client: AsyncEventPortal) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v2.architecture.event_apis.with_raw_response.update(
                id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncEventPortal) -> None:
        event_api = await async_client.api.v2.architecture.event_apis.list()
        assert_matches_type(EventAPIListResponse, event_api, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncEventPortal) -> None:
        response = await async_client.api.v2.architecture.event_apis.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncEventPortal) -> None:
        async with async_client.api.v2.architecture.event_apis.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_delete(self, async_client: AsyncEventPortal) -> None:
        event_api = await async_client.api.v2.architecture.event_apis.delete(
            "id",
        )
        assert event_api is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncEventPortal) -> None:
        response = await async_client.api.v2.architecture.event_apis.with_raw_response.delete(
            "id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncEventPortal) -> None:
        async with async_client.api.v2.architecture.event_apis.with_streaming_response.delete(
            "id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_delete(self, async_client: AsyncEventPortal) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `id` but received ''"):
            await async_client.api.v2.architecture.event_apis.with_raw_response.delete(
                "",
            )
