...
class TestExports:
    ...
    def test_method_get_async_api(self, client: EventPortal) -> None:
        export = client.api.v2.architecture.application_versions.exports.get_async_api(
    ...
    def test_raw_response_get_async_api(self, client: EventPortal) -> None:
        response = client.api.v2.architecture.application_versions.exports.with_raw_response.get_async_api(
            application_version_id="applicationVersionId",
        )
    ...
    def test_streaming_response_get_async_api(self, client: EventPortal) -> None:
        with client.api.v2.architecture.application_versions.exports.with_streaming_response.get_async_api(
            application_version_id="applicationVersionId",
        ) as response:
    ...
    def test_path_params_get_async_api(self, client: EventPortal) -> None:
        with pytest.raises(
            ...
            client.api.v2.architecture.application_versions.exports.with_raw_response.get_async_api(
...
class TestAsyncExports:
    ...
    async def test_method_get_async_api(self, async_client: AsyncEventPortal) -> None:
        export = await async_client.api.v2.architecture.application_versions.exports.get_async_api(
            application_version_id="applicationVersionId",
        )
        assert_matches_type(str, export, path=["response"])
    ...
    async def test_raw_response_get_async_api(self, async_client: AsyncEventPortal) -> None:
        response = await async_client.api.v2.architecture.application_versions.exports.with_raw_response.get_async_api(
            application_version_id="applicationVersionId",
        )
    ...
    async def test_streaming_response_get_async_api(self, async_client: AsyncEventPortal) -> None:
        async with async_client.api.v2.architecture.application_versions.exports.with_streaming_response.get_async_api(
            application_version_id="applicationVersionId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get_async_api(self, async_client: AsyncEventPortal) -> None:
        with pytest.raises(
            ...
            await async_client.api.v2.architecture.application_versions.exports.with_raw_response.get_async_api(
                application_version_id="",
            )
