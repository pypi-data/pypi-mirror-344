...
__all__ = ["CustomAttributeDefinitionUpdateParams", "AssociatedEntity"]


class CustomAttributeDefinitionUpdateParams(TypedDict, total=False):
    path_application_domain_id: Required[Annotated[str, PropertyInfo(alias="applicationDomainId")]]

    scope: Required[Literal["organization", "applicationDomain"]]

    id: str

    body_application_domain_id: Annotated[str, PropertyInfo(alias="applicationDomainId")]
