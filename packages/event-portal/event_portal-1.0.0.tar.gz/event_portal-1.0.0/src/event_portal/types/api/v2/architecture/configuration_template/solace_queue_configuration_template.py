...
__all__ = ["SolaceQueueConfigurationTemplate"]


class SolaceQueueConfigurationTemplate(BaseModel):
    id: Optional[str] = None

    associated_consumer_ids: Optional[List[str]] = FieldInfo(alias="associatedConsumerIds", default=None)
    """
    The list of consumer IDs associated with this Solace Queue Configuration
    template
    """
    ...
    """
    The list of environment IDs associated with this Solace Queue Configuration
    template
    """
