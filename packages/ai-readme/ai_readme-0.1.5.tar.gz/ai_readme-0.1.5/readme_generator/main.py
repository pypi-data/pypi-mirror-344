...
def parse_args():
    ...
    parser.add_argument(
        "--max_chars", type=int, default=10000, help="Max characters to read per file"
    )
...
def main():
    ...
    try:
        generator = ReadmeGenerator(
            lang=args.lang, provider=args.provider, max_chars=args.max_chars
        )
        generator.run()
