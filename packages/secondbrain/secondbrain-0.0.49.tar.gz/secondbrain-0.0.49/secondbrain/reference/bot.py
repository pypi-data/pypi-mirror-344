...
def load_bot(bot_id, config=None, workspace_path=None):
    global bot_index
...
@lru_cache()
def load_bot_cached(bot_id, config=None, workspace_path=None):
    return load_bot(bot_id, config, workspace_path)