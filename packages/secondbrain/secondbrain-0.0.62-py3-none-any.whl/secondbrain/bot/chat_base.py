...
async def handle_user_inputs(
    conversation_history, user_input, cwd, abilities, mcp_servers, bot_setting, bot_setting_file:str
):
    # 将用户消息添加到对话历史
    ...
    try:
        agent = Agent(
            ...
            model=MODEL_NAME,
            model_settings=ModelSettings(temperature=bot_setting["temperature"]),
        )
