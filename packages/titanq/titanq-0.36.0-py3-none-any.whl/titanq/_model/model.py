...
from titanq._event import EventEmitterFactory
...
class Model:
    ...
    def __init__(
        ...
        *,
        ...
        log_mode: Union[str, List[str], None] = "pretty"
        ) -> None:
        """
        ...
        log_mode
            Specifies the logging mode(s). Can be:
              - A single string (e.g. "pretty_text" or "text")
              - A list of strings to enable multiple modes (e.g. ["pretty_text", "text"])
              - "off" or None to disable logging entirely
        ...
        # setup the logging/sinks
        self._event_emitter = EventEmitterFactory().create(log_mode)
    ...
    def _solve(
        ...
        """
        self._event_emitter.emit(PreparingDataEvent())
        ...
        self._event_emitter.emit(UploadStartEvent())
        with self._storage_client as storage:
            ...
            self._event_emitter.emit(UploadEndEvent())
            ...
            self._event_emitter.emit(SendingRequestEvent())
            ...
            self._event_emitter.emit(OptimizationCompletedEvent())
