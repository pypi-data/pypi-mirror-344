...
STOREVALUE_ANY_OF_SCHEMAS = ["Dict[str, object]", "List[float]", "List[object]", "Pose", "bool", "bytearray", "float", "int", "str"]
...
class StoreValue(BaseModel):
    ...
    # data type: Pose
    anyof_schema_6_validator: Optional[Pose] = None
    # data type: List[float]
    anyof_schema_7_validator: Optional[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=3, max_length=3)]] = Field(default=None, description="A three-dimensional vector [x, y, z] with double precision. ")
    # data type: List[object]
    anyof_schema_8_validator: Optional[List[Any]] = None
    # data type: Dict[str, object]
    anyof_schema_9_validator: Optional[Dict[str, Any]] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[Dict[str, object], List[float], List[object], Pose, bool, bytearray, float, int, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "Dict[str, object]", "List[float]", "List[object]", "Pose", "bool", "bytearray", "float", "int", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        try:
            ...
            error_messages.append(str(e))
        # validate data type: Pose
        if not isinstance(v, Pose):
            error_messages.append(f"Error! Input type `{type(v)}` is not `Pose`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in StoreValue with anyOf schemas: Dict[str, object], List[float], List[object], Pose, bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_6_validator: Optional[Pose] = None
        try:
            instance.actual_instance = Pose.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into StoreValue with anyOf schemas: Dict[str, object], List[float], List[object], Pose, bool, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], Dict[str, object], List[float], List[object], Pose, bool, bytearray, float, int, str]]:
