...
class EUCaimDirectoryResources(StructuredDirectory):
    """
    ...
    def __init__(self):
        ...
        super(EUCaimDirectoryResources, self).__init__()

    def _sample_to_outpath(self, url, sample):
        return self.url_to_path(url / sample.project_name / sample.subject_label / sample.experiment_label / f'{sample.scan_id}_{sample.scan_type}' / f'{sample.filename}')
