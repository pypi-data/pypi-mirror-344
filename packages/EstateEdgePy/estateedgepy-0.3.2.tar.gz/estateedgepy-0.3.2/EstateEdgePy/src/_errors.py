...
class PyRealtyErrors(Exception):
    def __init__(
            self,
        ...
        super(PyRealtyErrors, self).__init__(self._format_message())
...
class ClientResponseError(PyRealtyErrors):
...
class ClientConnectionError(PyRealtyErrors):
...
class ClientTimeoutError(PyRealtyErrors):
    pass


class InvalidURLError(PyRealtyErrors):
    pass


class ClientPayloadError(PyRealtyErrors):
    pass


class ServerDisconnectedError(PyRealtyErrors):
    pass


class TooManyRedirectsError(PyRealtyErrors):
    pass


class ContentTypeError(PyRealtyErrors):
    pass


class UnexpectedError(PyRealtyErrors):
    pass
