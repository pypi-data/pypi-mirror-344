...
from fused._str_utils import is_uuid
...
class FusedAPI:
    ...
    def delete_cache(self, id: str, client_id: Optional[str] = None):
        if client_id is None:
    ...
    def list(
        ...
        if scheme not in supported_schemes:
            ...
            raise ValueError(f"'path' must start with one of {choice_str}.")
    ...
    def upload(
        self, path: str, data: Union[bytes, BinaryIO], timeout: Optional[float] = None
    ) -> None:
