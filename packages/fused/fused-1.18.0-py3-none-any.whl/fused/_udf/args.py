...
from fused._optional_deps import HAS_GEOPANDAS, HAS_MERCANTILE, HAS_PANDAS, HAS_SHAPELY
...
def coerce_arg(val: Any, param: inspect.Parameter) -> Any:
    ...
    if HAS_GEOPANDAS and annotation is gpd.GeoDataFrame:
        # load as geojson
        return _parse_to_gdf(val)
    if HAS_PANDAS and annotation is pd.DataFrame:
        # load as json
