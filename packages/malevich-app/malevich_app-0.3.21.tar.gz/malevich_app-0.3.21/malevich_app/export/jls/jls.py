...
def processor(id: Optional[str] = None, finish_msg: Optional[str] = None, drop_internal: bool = True, get_scale_part_all: bool = False, cpu_bound: bool = False, tags: Dict[str, str] = None, **kwargs):
    def wrap_input(fun):
        Wrapper.app.register_processor(fun, id, finish_msg=finish_msg, cpu_bound=cpu_bound, tags=__tags(tags, **kwargs), drop_internal=drop_internal, get_scale_part_all=get_scale_part_all)
        return fun
    return wrap_input
