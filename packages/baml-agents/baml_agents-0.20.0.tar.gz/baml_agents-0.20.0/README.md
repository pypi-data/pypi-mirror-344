...
[![Available on PyPI](https://img.shields.io/badge/v0.20.0-version?color=43cd0f&style=flat&label=pypi)](https://pypi.org/project/baml-agents)
...
```bash
pip install "baml-agents>=0.20.0,<0.21.0"
```
