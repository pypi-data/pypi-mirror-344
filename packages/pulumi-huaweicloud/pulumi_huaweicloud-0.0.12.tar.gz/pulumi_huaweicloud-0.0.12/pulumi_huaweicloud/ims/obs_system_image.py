...
class ObsSystemImageArgs:
    def __init__(__self__, *,
                 ...
                 is_quick_import: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] is_quick_import: Specifies whether to use the image file quick import method to create
        ...
        :param pulumi.Input[str] os_type: Specifies the operating system type of the image. The value can be
               **Windows** or **Linux**. Changing this parameter will create a new resource.
        :param pulumi.Input[str] os_version: Specifies the operating system version of the image. This field is
    ...
    def is_quick_import(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def is_quick_import(self, value: Optional[pulumi.Input[bool]]):
...
class ObsSystemImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None,
            visibility: Optional[pulumi.Input[str]] = None) -> 'ObsSystemImage':
        """
    ...
    @property
    @pulumi.getter(name="isQuickImport")
    def is_quick_import(self) -> pulumi.Output[Optional[bool]]:
        """
        Specifies whether to use the image file quick import method to create
        an image. The value can be **true** or **false**. Changing this parameter will create a new resource.
        For constraints and limitations on fast import of image files,
