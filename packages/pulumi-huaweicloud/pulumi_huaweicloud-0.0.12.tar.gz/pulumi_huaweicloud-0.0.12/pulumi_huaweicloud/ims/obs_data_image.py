...
class ObsDataImageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] min_disk: Specifies the minimum size of the system disk, in GB unit. The value ranges
...
class _ObsDataImageState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] description: Specifies the description of the image.
        :param pulumi.Input[str] disk_format: The image format. The value can be **zvhd2**, **vhd**, **zvhd**, **raw**, **qcow2**, or **iso**.
        :param pulumi.Input[str] enterprise_project_id: Specifies the enterprise project ID to which the IMS image belongs.
               For enterprise users, if omitted, default enterprise project will be used.
...
class ObsDataImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[str]]]] = None,
            updated_at: Optional[pulumi.Input[str]] = None,
            visibility: Optional[pulumi.Input[str]] = None) -> 'ObsDataImage':
        """
