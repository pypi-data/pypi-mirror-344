...
class GetListenersResult:
    ...
    def client_ca_tls_container_ref(self) -> Optional[str]:
        """
...
def get_listeners(client_ca_tls_container_ref: Optional[str] = None,
    ...
    :param str http2_enable: Whether the ELB listener uses HTTP/2. Value options: **true**, **false**.
    :param str listener_id: ID of the listener.
    :param str loadbalancer_id: The ID of the load balancer that the listener is added to.
    ...
    return AwaitableGetListenersResult(
        client_ca_tls_container_ref=__ret__.client_ca_tls_container_ref,
        default_pool_id=__ret__.default_pool_id,
        default_tls_container_ref=__ret__.default_tls_container_ref,
...
def get_listeners_output(client_ca_tls_container_ref: Optional[pulumi.Input[Optional[str]]] = None,
                         default_pool_id: Optional[pulumi.Input[Optional[str]]] = None,
                         default_tls_container_ref: Optional[pulumi.Input[Optional[str]]] = None,
