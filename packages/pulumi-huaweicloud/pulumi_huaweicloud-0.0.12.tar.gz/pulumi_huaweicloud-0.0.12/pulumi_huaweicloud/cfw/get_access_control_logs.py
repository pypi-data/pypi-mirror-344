...
def get_access_control_logs(action: Optional[str] = None,
...
@_utilities.lift_output_func(get_access_control_logs)
def get_access_control_logs_output(action: Optional[pulumi.Input[Optional[str]]] = None,
                                   app: Optional[pulumi.Input[Optional[str]]] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetAccessControlLogsResult]:
    """
    Use this data source to get the list of CFW access control logs.
