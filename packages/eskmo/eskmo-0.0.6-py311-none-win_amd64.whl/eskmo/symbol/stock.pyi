...
class StockInfoHandler(Extension):
    ...
    stockDict: dict[str, self.symbolInfoClass]
    pendingStockDict: dict[str, self.symbolInfoClass]
    stockIdxDict: dict[int, dict[str, str]]
    ...
    def requestTickRule(self, pid, apiName, account, tag, data, **kwargs) -> None: ...
    ...
    def onSkcomNewSymbols(self, quotes: dict, page: int, infos: dict): ...
    ...
    def requestSkcomTickRule(self, symbolCode): ...
...
class StockInfo(SubscribableInfo):
    ...
    def addSymbolInfo(self, info) -> None: ...
