...
class CustomEndpoint(AbstractEndpoint):
    def get_custom(self, url: str, agent_id: str | None = None, user_id: str | None = None) -> Any:
        """
        ...
        """
        return self.get(url, agent_id=agent_id, user_id=user_id)

    def post_custom(
        self, url: str, payload: Dict[str, Any] | None = None, agent_id: str | None = None, user_id: str | None = None
    ) -> Any:
        """
        ...
        :return Any, the response from the custom endpoint
        """
        return self.post_json(url, payload=payload, agent_id=agent_id, user_id=user_id)
    ...
    def put_custom(
        ...
        :return Any, the response from the custom endpoint
        """
        return self.put(url, payload=payload, agent_id=agent_id, user_id=user_id)
    ...
    def delete_custom(
        ...
        :return Any, the response from the custom endpoint
        """
        return self.delete(url, payload=payload, agent_id=agent_id, user_id=user_id)
