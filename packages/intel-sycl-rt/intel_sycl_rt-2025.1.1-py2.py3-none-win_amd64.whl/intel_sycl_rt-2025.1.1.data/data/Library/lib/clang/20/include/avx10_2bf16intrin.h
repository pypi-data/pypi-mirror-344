...
_mm256_fmadd_pbh(__m256bh __A, __m256bh __B, __m256bh __C) {
  return (__m256bh)__builtin_ia32_vfmaddpbh256((__v16bf)__A, (__v16bf)__B,
                                                 (__v16bf)__C);
}

static __inline__ __m256bh __DEFAULT_FN_ATTRS256 _mm256_mask_fmadd_pbh(
...
static __inline__ __m256bh __DEFAULT_FN_ATTRS256 _mm256_mask_fmsub_pbh(
    __m256bh __A, __mmask16 __U, __m256bh __B, __m256bh __C) {
  return (__m256bh)__builtin_ia32_selectpbf_256(
      (__mmask16)__U,
...
static __inline__ __m128bh __DEFAULT_FN_ATTRS128 _mm_fmadd_pbh(__m128bh __A,
                                                                 __m128bh __B,
                                                                 __m128bh __C) {
  return (__m128bh)__builtin_ia32_vfmaddpbh128((__v8bf)__A, (__v8bf)__B,
                                                 (__v8bf)__C);
}
