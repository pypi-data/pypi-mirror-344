...
import luann.local_llm.llm_chat_completion_wrappers.airoboros as airoboros
import luann.local_llm.llm_chat_completion_wrappers.chatml as chatml
import luann.local_llm.llm_chat_completion_wrappers.configurable_wrapper as configurable_wrapper
import luann.local_llm.llm_chat_completion_wrappers.dolphin as dolphin
import luann.local_llm.llm_chat_completion_wrappers.llama3 as llama3
from luann.schemas.openai.chat_completion_request import Tool, ToolCall
...
def num_tokens_from_functions(functions: List[dict], model: str = "gpt-4"):
    ...
    Copied from luann.https://community.openai.com/t/how-to-calculate-the-tokens-when-using-function-call/266573/11
    """
    try:
        encoding = tiktoken.encoding_for_model(model)
    except KeyError:
