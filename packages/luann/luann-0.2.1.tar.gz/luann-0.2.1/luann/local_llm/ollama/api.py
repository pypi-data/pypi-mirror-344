...
from luann.errors import LocalLLMError
from luann.local_llm.settings.settings import get_completions_settings
from luann.local_llm.utils import post_json_auth_request
from luann.utils import count_tokens
...
def get_ollama_completion(endpoint, auth_type, auth_key, model, prompt, context_window, grammar=None):
    ...
    usage = {
        "prompt_tokens": prompt_tokens,  # can also grab from luann."prompt_eval_count"
