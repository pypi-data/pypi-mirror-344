...
from luann.constants import LUANN_DIR


def get_system_text(key):
    filename = f"{key}.txt"
    file_path = os.path.join(os.path.dirname(__file__), "default_system_prompt", filename)
    ...
    if os.path.exists(file_path):
        ...
        # try looking in ~/.luann/system_prompts/*.txt
        user_system_prompts_dir = os.path.join(LUANN_DIR, "system_prompts")
