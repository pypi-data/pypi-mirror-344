...
class LuannError(Exception):
    """Base class for all luann related errors."""
...
class BedrockPermissionError(LuannError):
...
class LuannConfigurationError(LuannError):
...
class LuannAgentNotFoundError(LuannError):
    """Error raised when an agent is not found."""


class LuannUserNotFoundError(LuannError):
    """Error raised when a user is not found."""


class LLMError(LuannError):
    pass


class LLMJSONParsingError(LuannError):
...
class LocalLLMError(LuannError):
...
class LocalLLMConnectionError(LuannError):
...
class ContextWindowExceededError(LuannError):
...
class RateLimitExceededError(LuannError):
...
class LuannMessageError(LuannError):
    """Base error class for handling message-related errors."""

    messages: List[Union["Message", "LuannMessage"]]
    default_error_message: str = "An error occurred with the message."

    def __init__(self, *, messages: List[Union["Message", "LuannMessage"]], explanation: Optional[str] = None) -> None:
        error_msg = self.construct_error_message(messages, self.default_error_message, explanation)
        super().__init__(error_msg)
        self.messages = messages

    @staticmethod
    def construct_error_message(messages: List[Union["Message", "LuannMessage"]], error_msg: str, explanation: Optional[str] = None) -> str:
