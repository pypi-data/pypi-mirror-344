...
# from luann.colorama import Fore, Style, init
from rich.console import Console
from rich.live import Live
from rich.markup import escape

from luann.interface import CLIInterface
from luann.local_llm.constants import ASSISTANT_MESSAGE_CLI_SYMBOL, INNER_THOUGHTS_CLI_SYMBOL
from luann.schemas.message import Message
from luann.schemas.openai.chat_completion_response import ChatCompletionChunkResponse, ChatCompletionResponse
...
class AgentChunkStreamingInterface(ABC):
    """Interfaces handle -related events (observer pattern)
    ...
    def internal_monologue(self, msg: str, msg_obj: Optional[Message] = None):
        """ generates some internal monologue"""
        raise NotImplementedError
