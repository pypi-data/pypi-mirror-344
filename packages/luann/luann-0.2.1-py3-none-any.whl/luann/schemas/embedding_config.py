...
class EmbeddingConfig(BaseModel):
    ...
    Embedding model configuration. This object specifies all the information necessary to access an embedding model to usage with Luann, except for secret keys.
    ...
    def default_config(cls, model_name: Optional[str] = None, provider: Optional[str] = None):
        ...
        if model_name == "text-embedding-ada-002" or (not model_name and provider == "openai"):
            ...
            return cls(
                embedding_endpoint="https://embeddings.luann.ai",
