...
from luann.schemas.luann_base import LuannBase, OrmMetadataBase
...
class SandboxRunResult(BaseModel):
    ...
    stdout: Optional[List[str]] = Field(None, description="Captured stdout (e.g. prints, logs) from luann.the function invocation")
    stderr: Optional[List[str]] = Field(None, description="Captured stderr from luann.the function invocation")
...
class LocalSandboxConfig(BaseModel):
    ...
    venv_name: str = Field(
        "venv",
        description="The name for the venv in the sandbox directory. We first search for an existing venv with this name, otherwise, we make it from luann.the requirements.txt.",
    )
...
class SandboxEnvironmentVariableCreate(LuannBase):
    key: str = Field(..., description="The name of the environment variable.")
    value: str = Field(..., description="The value of the environment variable.")
    description: Optional[str] = Field(None, description="An optional description of the environment variable.")


class SandboxEnvironmentVariableUpdate(LuannBase):
