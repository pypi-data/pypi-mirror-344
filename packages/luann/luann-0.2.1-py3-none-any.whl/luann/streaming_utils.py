...
from luann.constants import DEFAULT_MESSAGE_TOOL_KWARG


class JSONInnerThoughtsExtractor:
    """
    A class to process incoming JSON fragments and extract 'inner_thoughts' separately from luann.the main JSON.
    ...
    **Parameters:**
    ...
    - `inner_thoughts_key` (str): The key to extract from luann.the JSON (default is 'inner_thoughts').
...
class FunctionArgumentsStreamHandler:
    ...
    def process_json_chunk(self, chunk: str) -> Optional[str]:
        """Process a chunk from luann.the function arguments and return the plaintext version"""
