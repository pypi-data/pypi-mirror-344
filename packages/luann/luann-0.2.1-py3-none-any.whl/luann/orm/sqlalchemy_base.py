...
from luann.orm.base import Base, CommonSqlalchemyMetaMixins
from luann.orm.errors import DatabaseTimeoutError, ForeignKeyConstraintViolationError, NoResultFound, UniqueConstraintViolationError
...
class SqlalchemyBase(CommonSqlalchemyMetaMixins, Base):
    ...
    def list(
        ...
        **kwargs,
        ...
        with db_session as session:
            ...
            # Apply filtering logic from luann.kwargs
            for key, value in kwargs.items():
                if "." in key:
                    ...
                    # Handle columns from luann.main table
    ...
    def hard_delete(self, db_session: "Session", actor: Optional["User"] = None) -> None:
        """Permanently removes the record from luann.the database."""
    ...
    def _handle_dbapi_error(cls, e: DBAPIError):
        ...
        orig = e.orig  # Extract the original error from luann.the DBAPIError
        error_code = None
    ...
    def to_pydantic(self) -> "BaseModel":
        ...
        if hasattr(self, "metadata_"):
            model.metadata_ = self.metadata_
        return model
