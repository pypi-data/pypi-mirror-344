...
from luann.schemas.block import Human, Persona

if TYPE_CHECKING:
    from luann.orm.organization import Organization
    from luann.orm.blocks_agents import BlocksAgents
...
class Block(OrganizationMixin, SqlalchemyBase):
    ...
    # relationships
    # blocks_agents: Mapped["BlocksAgents"] = relationship("BlocksAgents", back_populates="block")
...
@event.listens_for(Block, "after_update")  # Changed from luann.'before_update'
