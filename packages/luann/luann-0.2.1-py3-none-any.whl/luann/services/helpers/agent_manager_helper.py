...
import luann.system
from luann.constants import IN_CONTEXT_MEMORY_KEYWORD, STRUCTURED_OUTPUT_MODELS
# from luann.helpers import ToolRulesSolver
from luann.orm.agent import Agent as AgentModel
from luann.orm.agents_tags import AgentsTags
from luann.orm.errors import NoResultFound
from luann.prompts import gpt_system
from luann.schemas.agent import AgentState, AgentType
from luann.schemas.enums import MessageRole
from luann.schemas.memory import Memory
from luann.schemas.message import Message, MessageCreate
# from luann.schemas.tool_rule import ToolRule
from luann.schemas.user import User
from luann.system import get_initial_boot_messages, get_login_event
from luann.utils import get_local_time
...
def derive_system_message(agent_type: AgentType, system: Optional[str] = None):
    if system is None:
        ...
        if agent_type == AgentType.memgpt_agent:
            system = gpt_system.get_system_text("luann_chat")
    ...
    if template_format == "f-string":
        ...
        if append_icm_if_missing:
            ...
            if memory_variable_string not in system_prompt:
                ...
                # warnings.warn(f"{IN_CONTEXT_MEMORY_KEYWORD} variable was missing from luann.system prompt, appending instead")
...
def initialize_message_sequence(
    ...
    first_user_message = get_login_event()  # event letting luann know the user just logged in
