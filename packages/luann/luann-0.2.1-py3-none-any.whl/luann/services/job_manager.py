...
from luann.orm.job import Job as JobModel
# from luann.orm.job_messages import JobMessag/e
from luann.orm.message import Message as MessageModel
from luann.orm.sqlalchemy_base import AccessType
...
from luann.schemas.job import JobUpdate, LuannRequestConfig
from luann.schemas.luann_message import LuannMessage
from luann.schemas.message import Message as PydanticMessage
# from luann.schemas.run import Run as PydanticRun
from luann.schemas.usage import LuannUsageStatistics
from luann.schemas.user import User as PydanticUser
from luann.utils import enforce_types, get_utc_time
...
class JobManager:
    ...
    @enforce_types
    def create_job(self, pydantic_job: Union[PydanticJob], actor: PydanticUser) -> Union[PydanticJob]:
    ...
    # @enforce_types
    # def get_job_usage(self, job_id: str, actor: PydanticUser) -> LuannUsageStatistics:
    #     """
    ...
    #     Returns:
    #         List of luannMessages associated with the job
    ...
    #     messages = PydanticMessage.to_luann_messages_from_list(
    #         messages=messages,
    ...
    def _get_run_request_config(self, run_id: str) -> LuannRequestConfig:
        """
        ...
        with self.session_maker() as session:
            ...
            request_config = job.request_config or LuannRequestConfig()
