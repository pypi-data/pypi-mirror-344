...
class Airoboros21Wrapper(LLMChatCompletionWrapper):
    ...
    def chat_completion_to_prompt(self, messages, functions, function_documentation=None):
        ...
        Functions support: https://huggingface.co/jondurbin/airoboros-l2-70b-2.1#agentfunction-calling
            ...
            As an AI assistant, please select the most suitable function and parameters from luann.the list of available functions below, based on the user's input. Provide your response in JSON format.
        ...
        prompt += f"\nPlease select the most suitable function and parameters from luann.the list of available functions below, based on the ongoing conversation. Provide your response in JSON format."
        prompt += f"\nAvailable functions:"
...
class Airoboros21InnerMonologueWrapper(Airoboros21Wrapper):
    """Still expect only JSON outputs from luann.model, but add inner monologue as a field"""
