...
from luann.local_llm.utils import count_tokens, post_json_auth_request
...
def get_vllm_completion(endpoint, auth_type, auth_key, model, prompt, context_window, user, grammar=None):
    ...
    usage = {
        "prompt_tokens": prompt_tokens,  # can grab from luann.usage dict, but it's usually wrong (set to 0)
