...
from luann.constants import OPENAI_CONTEXT_WINDOW_ERROR_SUBSTRING
from luann.errors import LLMError
from luann.llm_api.helpers import add_inner_thoughts_to_functions, convert_to_structured_output, make_post_request
from luann.local_llm.constants import INNER_THOUGHTS_KWARG, INNER_THOUGHTS_KWARG_DESCRIPTION
...
from luann.schemas.message import Message as _Message
from luann.schemas.message import MessageRole as _MessageRole
from luann.schemas.openai.chat_completion_request import ChatCompletionRequest
from luann.schemas.openai.chat_completion_request import FunctionCall as ToolFunctionChoiceFunctionCall
from luann.schemas.openai.chat_completion_request import Tool, ToolFunctionChoice, cast_message_to_subtype
from luann.schemas.openai.chat_completion_response import (
...
from luann.utils import get_tool_call_id, smart_urljoin
...
def openai_get_model_list(
    ...
    # In luann config the address for vLLM is w/o a /v1 suffix for simplicity
    ...
    try:
        ...
        response = response.json()  # convert to dict from luann.string
...
def openai_chat_completions_process_stream(
    ...
    To "stream" the response in luann, we want to call a streaming-compatible interface function
    on the chunks received from luann.the OpenAI-compatible server POST SSE response.
    """
