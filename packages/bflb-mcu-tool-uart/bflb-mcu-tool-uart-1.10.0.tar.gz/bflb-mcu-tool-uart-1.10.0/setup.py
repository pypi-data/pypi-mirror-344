...
longdesc = """
## Bouffalolab Mcu Command Tool For Uart
====================================
...
entry_points = {"console_scripts": ["bflb-mcu-tool-uart = bflb_mcu_tool.__main__:run_main"]}

setup(
    name="bflb-mcu-tool-uart",
    version="1.10.0",
    author="bouffalolab",
    ...
    license="MIT",
    url="https://pypi.org/project/bflb-mcu-tool-uart/",
