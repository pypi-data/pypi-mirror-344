...
class Flag(Generic[_T]):
  ...
  Attributes:
    ...
    parser: an :class:`~turbo.flags.ArgumentParser` object
  ...
  typically only called by a :class:`~turbo.flags.FlagValues` object.  The
  :meth:`parse` method is a thin wrapper around the
  :meth:`ArgumentParser.parse()<turbo.flags.ArgumentParser.parse>` method.  The
