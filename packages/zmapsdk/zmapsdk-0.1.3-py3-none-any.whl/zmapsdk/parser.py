...
class ZMapParser:
    ...
    @staticmethod
    def parse_csv_results(file_path: str, fields: Optional[List[str]] = None) -> List[Dict[str, str]]:
        """
        ...
        try:
            ...
            raise ZMapParserError(f"Failed to parse CSV results: {str(e)}")
    ...
    def parse_json_results(file_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise ZMapParserError(f"Failed to parse JSON results: {str(e)}")
    ...
    def parse_metadata(file_path: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise ZMapParserError(f"Failed to parse metadata: {str(e)}")
    ...
    def parse_status_updates(file_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise ZMapParserError(f"Failed to parse status updates: {str(e)}")
    
    @staticmethod
    def extract_ips(results: List[Dict[str, Any]], ip_field: str = 'saddr') -> List[str]:
        """
    ...
    @staticmethod
    def stream_results(file_path: str, fields: Optional[List[str]] = None) -> Iterator[Dict[str, str]]:
        """
    ...
    def count_results(file_path: str) -> int:
        ...
        try:
            ...
            raise ZMapParserError(f"Failed to read results file: {str(e)}") 