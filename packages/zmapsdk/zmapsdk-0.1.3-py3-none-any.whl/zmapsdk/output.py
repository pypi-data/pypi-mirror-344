...
class ZMapOutput:
    ...
    def __init__(self):
        ...
        self.output_fields: Optional[Union[List[str], str]] = None
        self.output_module: Optional[str] = None
        self.output_filter: Optional[str] = None
        self.output_args: Optional[str] = None
        self.log_file: Optional[str] = None
        self.log_directory: Optional[str] = None
        self.metadata_file: Optional[str] = None
        self.status_updates_file: Optional[str] = None
    ...
    def set_output_fields(self, fields: Union[List[str], str]) -> None:
        """
    ...
    def set_status_updates_file(self, file_path: str) -> None:
        ...
        if directory and not os.access(directory, os.W_OK):
            raise ZMapOutputError(f"Status updates directory is not writable: {directory}")
    ...
    def set_verbosity(self, level: int) -> None:
        ...
        """
        if not 0 <= level <= 5:
            raise ZMapOutputError(f"Verbosity level must be between 0 and 5, got {level}")
