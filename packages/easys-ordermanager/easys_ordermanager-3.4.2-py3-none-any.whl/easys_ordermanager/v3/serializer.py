...
class OrderLineInAppSerializer(serializers.Serializer):
    ...
    """
    creatives_template = serializers.ChoiceField(choices=INAPP_BANNER_TEMPLATE_CHOICES, required=False)
    ...
    def validate(self, data):
        ...
        if data.get("creatives_creator") != INAPP_BANNERS_CREATOR_CUSTOMER and not data.get("creatives_template"):
