...
from kivy.graphics import Color, Line, RoundedRectangle, StencilPush, StencilUse, StencilPop, StencilUnUse
...
class OpenCVImage(Widget):
    def __init__(self, window=None, x=0, y=0, width=640, height=480,
...
if __name__ == "__main__":
    ...
    image_widget = OpenCVImage(
        window=window, x=50, y=50, width=640, height=480,
        border_color=(1, 0, 0, 1), border_thickness=2, corner_radius=20
    )

    # Simulate video frames
    cap = cv2.VideoCapture(1)  # Open webcam or replace with your video source
