...
class Tabs(Widget):
    def __init__(self, window, x=100, y=400, content_area_width=500, content_area_height=200,
                 ...
                 corner_radius=0,show_add_tab_button=True,
    ...
    def _set_tab_position(self,*args, **kwargs):
        ...
        #     window=None,  # The button is added to the layout, not directly to the window
    ...
    def add_tab(self, tab_name):
        ...
        button = BasicButton(
            window=None,  # Add to the layout, not directly to the window
...
if __name__ == "__main__":
    ...
    tabs4.add_to_tab("Tab 1",[pv.BasicButton(None)])
