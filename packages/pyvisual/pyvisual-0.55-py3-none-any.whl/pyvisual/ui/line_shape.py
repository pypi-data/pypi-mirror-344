...
class LineShape(Widget):
    def __init__(self, window, points, thickness=1, color=(0, 0, 1, 1), is_visible=True, opacity=1, tag=None):
...
if __name__ == "__main__":
    ...
    # Create a line
    line = LineShape(window, points=[0, 0, 100, 100], thickness=5, color=(0, 0.8, 0, 1),
