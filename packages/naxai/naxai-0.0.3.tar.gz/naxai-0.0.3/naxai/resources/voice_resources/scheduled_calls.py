...
class ScheduledCallsResource:
    ...
    async def list(self,
        ...
        Example:
            >>> scheduled_calls = await client.scheduled_calls.list(
            ...     to="+1234567890",
            ...     page=1,
            ...     page_size=10
            ... )
    ...
    async def get(self, call_id: str):
        ...
        Example:
            >>> call_details = await client.scheduled_calls.get(
            ...     call_id="abc123xyz"
            ... )
        """
        logger.debug("Getting call details for call_id: %s on %s", call_id, self.root_path + "/" + call_id)
    ...
    async def cancel(self, call_id: str):
        ...
        Example:
            >>> cancellation_result = await client.scheduled_calls.cancel(
            ...     call_id="abc123xyz"
            ... )
        ...
        """
        return await self._client._request("POST", self.root_path + "/cancel/call", json={"callId": call_id}, headers=self.headers)
    ...
    async def cancel_batch(self, batch_id: str):
        ...
        Example:
            >>> batch_cancellation_result = await client.scheduled_calls.cancel_batch(
        ...
        """
        return await self._client._request("POST", self.root_path + "/cancel/batch", json={"batchId": batch_id}, headers=self.headers)