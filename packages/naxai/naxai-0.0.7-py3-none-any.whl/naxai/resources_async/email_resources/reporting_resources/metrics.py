...
class MetricsResource:
    ...
    async def list(self,
        ...
        """
        Retrieves a list of metrics for a given time period and filters.
        ...
        Returns:
            dict: The API response containing the list of metrics.

        Example:
            >>> response = await client.email.reporting.metrics.list(start=1625097600, stop=1627689600)
        """
        params = {
            "start": start,
            "stop": stop,
