...
class TemplatesResource:
    ...
    def list_shared(self,
        ...
        Example:
            >>> response = client.email.templates.list_shared(page=1, page_size=10, tags=["tag1", "tag2"])
        """
        params = {
            "page": page,
            "pagesize": page_size,
        ...
        return self._client._request("GET", self.previous_root + "/shared-templates", params=params, headers=self.headers)
    ...
    def delete(self, template_id: str):
        ...
        Example:
            >>> response = client.email.templates.delete(template_id="XXX")
        """
    ...
    def update(self, template_id: str, data: CreateEmailTemplateRequest):
        ...
        Example:
            ...
            ... )
            >>> response = client.email.templates.update(template_id="XXX", data=template_data)
        """
        return self._client._request("PUT", self.root_path + "/" + template_id, data=data.model_dump(by_alias=True, exclude_none=True), headers=self.headers)
    ...
    def list(self,
        ...
        Example:
            >>> response = client.email.templates.list(page=1, page_size=10)
        """
        params = {
            "page": page,
            "pagesize": page_size
    ...
    def create(self, data: CreateEmailTemplateRequest):
        ...
        Example:
            ...
            ... )
            >>> response = client.email.templates.create(data=template_data)
        """
