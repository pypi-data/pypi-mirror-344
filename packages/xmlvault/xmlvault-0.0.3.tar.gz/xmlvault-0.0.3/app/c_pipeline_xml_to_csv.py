from .pipeline_xml_connect import f_pipe_load_xml # local neighbour call
...
def f_xml_2_csv_namespace(v_xpath: str) -> None:  # in future change it, this should be reflecting xml_config_name, not xslt path
    xml_tree, xml_xslt, xpath_string = f_pipe_load_xml(v_xpath) # in future change it, this should be reflecting xml_config_name, not xslt path
