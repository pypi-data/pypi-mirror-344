...
class SnowflakeIntegration:
    ...
    @staticmethod
    def truncate_table(database: str, schema: str, table: str, connection, profile: str = "default", verbose: bool = False):
    ...
    def load_to_snowflake(stage: str, stage_key: str, database: str = None, schema: str = None, table: str = None, profile: str = "default", verbose: bool = False):
        ...
        try:
            cur.execute(f"COPY INTO {database}.{schema}.{table} FROM @{stage}/{stage_key} FILE_FORMAT=(TYPE=CSV FIELD_OPTIONALLY_ENCLOSED_BY='\"' NULL_IF = ('NULL', ''))")
