from src.taxonlib.canonical_name import canonize
from src.taxonlib.tools.taxa import QualifiedName
            ...
            case [genus, species, *infra_epithet]:
                ...
                if "gr." in infra_epithet:
                    ...
                    if "'" in " ".join(infra_epithet):
                        ...
                        infra_modifiers = ["var.", "subsp.", "teleomorf"]  # TODO: consider alternative spellings
                        for token in tokens:
