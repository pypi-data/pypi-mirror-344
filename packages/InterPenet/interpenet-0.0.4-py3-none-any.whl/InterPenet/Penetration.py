...
class AlyLi(penMed):
    ...
    ***variables***
    ...
    def Validation(self,data):
        ...
        res=[]
        if self.i_Valid:
            res.append(super().check('b/d',v_b/v_d))
            return res
        else:
            ii=0
...
class THOR(penMed):
    ...
    def Validation(self,data):
        if self.i_Valid:
            res=['Validation process is not defined.']
            return res
        else:
            return 0
    def MatList(self):
...
class BRL(penMed):
    ...
    ***constants***
    ...
    def Validation(self,data):
        ...
        res=[]
        if self.i_Valid:
            res.append(super().check('v_bl',v_bl))
            res.append(super().check('Limp/d',Limp/d))
            res.append(super().check('b/d',b/d))
            res.append(super().check('Lsh/d',Lsh/d))
            res.append(super().check('Su',Su))
            return res
        else:
            ii=0
...
class Jowett(penMed):
    ...
    ***constants***
    ...
    def Validation(self,data):
        ...
        res=[]
        if self.i_Valid:
            res.append(super().check('vbl',vbl))
            res.append(super().check('Su',Su))
            res.append(super().check('Limp/d',Limp/d))
            res.append(super().check('b/d',b/d))
            return res
...
class Lambert(penMed):
    ...
    ***constants***   
    ...
    def Validation(self,data):
        ...
        res=[]
        if self.i_Valid:
            res.append(super().check('b',b))
            res.append(super().check('d',d))
            res.append(super().check('m',m))
            res.append(super().check('th',th))
            res.append(super().check('Limp/d',Limp/d))
            res.append(super().check('ro_imp',ro_imp))
            return res
        else:
            ii=0
...
class Ohte(penMed):
    ...
    def Validation(self,data):
        ...
        if self.i_Valid:
            ...
            res.append(super().check('Su',Su))
            res.append(super().check('b',b))
            res.append(super().check('Lsh/b',Lsh/b))
            res.append(super().check('d',d))
            return res
        else:
            ii=0
...
class SRI(penMed):
    ...
    def Validation(self,data):
        ...
        if self.i_Valid:
            ...
            res.append(super().check('b/d',b/d))
            res.append(super().check('Lsh/d',Lsh/d))
            res.append(super().check('b/Lsh',b/Lsh))
            res.append(super().check('Lsh/b',Lsh/b))
            res.append(super().check('Limp/d',Limp/d))
            return res
        else:
