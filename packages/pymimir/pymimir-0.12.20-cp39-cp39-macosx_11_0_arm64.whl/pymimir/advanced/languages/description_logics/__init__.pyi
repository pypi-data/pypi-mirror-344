...
class StateListRefinementPruningFunction(IRefinementPruningFunction):
    ...
    @overload
    def __init__(self, state_partitioning: Mapping[pymimir.advanced.formalism.Problem, pymimir.advanced.search.StateList], ref_denotation_repositories: DenotationRepositories) -> None: ...
