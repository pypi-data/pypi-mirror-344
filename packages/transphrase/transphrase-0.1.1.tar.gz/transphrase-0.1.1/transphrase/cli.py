...
def get_config() -> TranslationConfig:
    ...
    """
    console.print("[bold green]TransPhrase: Webnovel Translator & Rephraser[/bold green]\n")
    ...
    console.print(f"[green]Translation: {source_language} → {target_language}[/green]")
    ...
    # Adjust system prompt creation for translation to use the languages
    if prompt_type == "tl" and not use_custom_template:
        system_prompt = TRANSLATION_PROMPT_TEMPLATE.format(
            source_language=source_language, target_language=target_language
        )
    elif prompt_type == "pl" and not use_custom_template:
