...
required_modules = ["scipy==1.13.1", "tqdm==4.66.4", "pandas==2.2.2", "networkx==3.3", "seaborn==0.13.2", "numpy==1.26.4", "matplotlib==3.9.0", "colorama==0.4.6", "cupy-cuda12x", "psutil==6.1.1"]
