...
from abstract_utilities import try_func
import logging
# Suppress logs below WARNING level
logging.basicConfig(level=logging.WARNING)
def make_request(url, data=None, headers=None, get_post=None, endpoint=None, status_code=False, retry_after=False, raw_response=False, response_result=None, load_nested_json=True,auth=None,logger=True,**kwargs):
    response = None
    data = try_func(json.dumps, data or kwargs, logger=logger)
...
def postRequest(url, data=None, headers=None, endpoint=None, status_code=False, retry_after=False, raw_response=False, response_result=None, load_nested_json=True,auth=None,**kwargs):
    data = data or kwargs
...
def getRequest(url, data=None, headers=None, endpoint=None, status_code=False, retry_after=False, raw_response=False, response_result=None, load_nested_json=True,auth=None,**kwargs):
    data = data or kwargs
