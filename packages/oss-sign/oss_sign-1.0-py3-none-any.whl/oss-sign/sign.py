...
# 拼接callback
def get_callback(oss_callback_url, oss_callback_body):
...
# 计算阿里云OSS上传签名
def get_sign_v1(Date, security_token, bucket_name, object_path, object_name, secret_access_key, access_key_id, callback=None):
    VERB = "PUT"
    content_md5 = ""
