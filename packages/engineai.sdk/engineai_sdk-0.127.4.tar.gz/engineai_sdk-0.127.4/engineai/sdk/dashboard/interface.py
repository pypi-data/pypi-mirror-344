...
class RowInterface(AbstractLayoutItem):
    """Specs for Row  Interface."""


class FluidRowInterface(AbstractLayoutItem):
    """Specs for FluidRow  Interface."""


class ColumnInterface(AbstractLayoutItem):
    """Specs for Column Interface."""
...
class SelectableItemInterface(AbstractLayoutItem):
    """Specs for Selectable Item Interface."""


class WidgetInterface(AbstractLayoutItem):
