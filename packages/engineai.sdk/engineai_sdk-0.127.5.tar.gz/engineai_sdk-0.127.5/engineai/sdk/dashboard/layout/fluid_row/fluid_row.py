...
from engineai.sdk.dashboard.interface import FluidRowInterface
from engineai.sdk.dashboard.widgets.base import Widget


class FluidRow(FluidRowInterface):
    ...
    compatibilities: CompatibilityItem = CompatibilityItem([Widget], None)
    ...
    def __init__(
        ...
        *items: Widget,
        ...
        """
        super().__init__()
        self.__items: List[Widget] = self.__set_items(*items)
    ...
    def height(self) -> float:
        """Calculate height of fluid row."""
        self.__height = max([item.height() for item in self.__items])
        return self.__height

    def __set_items(self, *items: Widget) -> List[Widget]:
