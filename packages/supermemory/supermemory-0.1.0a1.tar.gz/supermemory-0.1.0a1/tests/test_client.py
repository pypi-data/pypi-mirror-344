...
def _get_open_connections(client: Supermemory | AsyncSupermemory) -> int:
...
class TestSupermemory:
    ...
    def test_multipart_repeating_array(self, client: Supermemory) -> None:
        request = client._build_request(
    ...
    def test_base_url_trailing_slash(self, client: Supermemory) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Supermemory) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Supermemory) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Supermemory(base_url=base_url, api_key=api_key, _strict_response_validation=True)
...
class TestAsyncSupermemory:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncSupermemory) -> None:
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncSupermemory(base_url=base_url, api_key=api_key, _strict_response_validation=True)
