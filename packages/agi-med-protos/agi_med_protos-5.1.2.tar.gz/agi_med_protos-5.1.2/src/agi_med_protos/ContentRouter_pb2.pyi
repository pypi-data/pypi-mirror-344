...
class ContentRouterRequest(_message.Message):
    __slots__ = ("RequestId", "OuterContext", "ResourceId", "Kind", "Query")
    ...
    Kind: str
    Query: str
    def __init__(self, RequestId: _Optional[str] = ..., OuterContext: _Optional[_Union[_commons_pb2.OuterContextItem, _Mapping]] = ..., ResourceId: _Optional[str] = ..., Kind: _Optional[str] = ..., Query: _Optional[str] = ...) -> None: ...
