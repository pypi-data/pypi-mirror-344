...
from ysyangtree import context, ymodels
...
class TestYSContextModule(unittest.TestCase):
    ...
    def test_validate_positive(self):
        ...
        self.assertIn(
            {
                ...
                'usable': False,
                'errors': [
                    'CRITICAL ERROR line 40: unterminated statement '
                    'definition for keyword "description", looking at t'],
                'warnings': None,
            },
            result,
        )
        ...
        self.assertTrue(
            ...
            } in result or
            {
                ...
                'errors': None,
                'warnings': [
                    'WARNING line 309: node "openconfig-interfaces::type" is '
                    'not found in "openconfig-interfaces::interface"'
                ],
            } in result
        )
        ...
        self.assertTrue(
            ...
            } in result or
            {
                ...
                'usable': True,
                'errors': [
                    'CRITICAL ERROR line 13: module "openconfig-extensions" '
    ...
    def test_repository_variants(self):
        ...
        self.assertIsInstance(ctx4.repository, FileRepository)
