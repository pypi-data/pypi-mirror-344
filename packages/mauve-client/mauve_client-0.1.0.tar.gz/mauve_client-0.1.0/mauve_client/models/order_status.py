...
class OrderStatus(object):
    ...
    def status(self):
        ...
        The current status of the order (possible values: Unrocessed, InProgress, Shipped) (as soon as the order is not in the unprocessed state it can be fetched by the endpoint \"documents\" by its order number)  # noqa: E501
