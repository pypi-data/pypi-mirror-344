...
class GroupCallParticipantVideoSourceGroup:  # type: ignore
    ...
    QUALNAME = "alphagram.raw.base.GroupCallParticipantVideoSourceGroup"

    def __init__(self):
        raise TypeError("Base types can only be used for type checking purposes: "
                        "you tried to use a base type instance as argument, "
                        "but you need to instantiate one of its constructors instead. "
                        "More info: https://docs.alphagram.org/telegram/base/group-call-participant-video-source-group")
