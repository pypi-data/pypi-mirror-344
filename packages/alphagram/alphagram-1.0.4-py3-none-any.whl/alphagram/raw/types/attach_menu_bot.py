...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <alphagram.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <alphagram.raw.base.AttachMenuBotIcon>`):
            N/A
