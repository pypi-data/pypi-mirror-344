...
class MegagroupStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.stats.MegagroupStats`.
    ...
    Parameters:
        period (:obj:`StatsDateRangeDays <alphagram.raw.base.StatsDateRangeDays>`):
            N/A

        members (:obj:`StatsAbsValueAndPrev <alphagram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        messages (:obj:`StatsAbsValueAndPrev <alphagram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        viewers (:obj:`StatsAbsValueAndPrev <alphagram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        posters (:obj:`StatsAbsValueAndPrev <alphagram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        growth_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        members_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        new_members_by_source_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        messages_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        actions_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        weekdays_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        top_posters (List of :obj:`StatsGroupTopPoster <alphagram.raw.base.StatsGroupTopPoster>`):
            N/A

        top_admins (List of :obj:`StatsGroupTopAdmin <alphagram.raw.base.StatsGroupTopAdmin>`):
            N/A

        top_inviters (List of :obj:`StatsGroupTopInviter <alphagram.raw.base.StatsGroupTopInviter>`):
            N/A
