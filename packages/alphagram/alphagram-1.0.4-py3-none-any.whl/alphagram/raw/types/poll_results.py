...
class PollResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.PollResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`PollAnswerVoters <alphagram.raw.base.PollAnswerVoters>`, *optional*):
            N/A
        ...
        solution_entities (List of :obj:`MessageEntity <alphagram.raw.base.MessageEntity>`, *optional*):
            N/A
