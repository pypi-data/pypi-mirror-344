...
class SearchResultsCalendar(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.messages.SearchResultsCalendar`.
    ...
    Parameters:
        ...
        periods (List of :obj:`SearchResultsCalendarPeriod <alphagram.raw.base.SearchResultsCalendarPeriod>`):
            N/A
