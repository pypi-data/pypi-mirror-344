...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <alphagram.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <alphagram.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <alphagram.raw.base.InlineBotWebView>`, *optional*):
            N/A
