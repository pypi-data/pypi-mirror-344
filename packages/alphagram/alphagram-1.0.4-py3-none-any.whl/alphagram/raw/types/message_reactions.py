...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <alphagram.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <alphagram.raw.base.MessagePeerReaction>`, *optional*):
            N/A
