...
class GroupCallStreamChannels(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.phone.GroupCallStreamChannels`.
    ...
    Parameters:
        channels (List of :obj:`GroupCallStreamChannel <alphagram.raw.base.GroupCallStreamChannel>`):
            N/A
