...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <alphagram.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <alphagram.raw.base.GroupCallParticipant>`):
            N/A
