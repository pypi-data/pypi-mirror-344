...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <alphagram.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <alphagram.raw.base.PageRelatedArticle>`):
            N/A
