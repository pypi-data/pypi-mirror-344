...
class GroupCallParticipantVideo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.GroupCallParticipantVideo`.
    ...
    Parameters:
        ...
        source_groups (List of :obj:`GroupCallParticipantVideoSourceGroup <alphagram.raw.base.GroupCallParticipantVideoSourceGroup>`):
            N/A
