...
class WebPageAttributeTheme(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.WebPageAttribute`.
    ...
    Parameters:
        documents (List of :obj:`Document <alphagram.raw.base.Document>`, *optional*):
            N/A

        settings (:obj:`ThemeSettings <alphagram.raw.base.ThemeSettings>`, *optional*):
            N/A
