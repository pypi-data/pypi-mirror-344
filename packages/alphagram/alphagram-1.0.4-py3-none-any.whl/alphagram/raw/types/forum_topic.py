...
class ForumTopic(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.ForumTopic`.
    ...
    Parameters:
        ...
        from_id (:obj:`Peer <alphagram.raw.base.Peer>`):
            N/A
        ...
        draft (:obj:`DraftMessage <alphagram.raw.base.DraftMessage>`, *optional*):
            N/A
