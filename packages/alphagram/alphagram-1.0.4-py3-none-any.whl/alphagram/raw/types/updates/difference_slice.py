...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <alphagram.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <alphagram.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <alphagram.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <alphagram.raw.base.updates.State>`):
            N/A
