...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <alphagram.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <alphagram.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <alphagram.raw.base.SecureValueError>`):
            N/A
