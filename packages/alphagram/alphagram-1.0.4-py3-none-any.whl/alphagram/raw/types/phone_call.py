...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <alphagram.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <alphagram.raw.base.PhoneConnection>`):
            N/A
