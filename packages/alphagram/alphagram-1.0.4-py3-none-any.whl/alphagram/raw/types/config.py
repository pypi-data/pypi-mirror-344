...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <alphagram.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <alphagram.raw.base.Reaction>`, *optional*):
            N/A
