...
class AttachMenuBotIcon(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.AttachMenuBotIcon`.
    ...
    Parameters:
        ...
        icon (:obj:`Document <alphagram.raw.base.Document>`):
            N/A

        colors (List of :obj:`AttachMenuBotIconColor <alphagram.raw.base.AttachMenuBotIconColor>`, *optional*):
            N/A
