...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <alphagram.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <alphagram.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <alphagram.raw.base.WebDocument>`, *optional*):
            N/A
