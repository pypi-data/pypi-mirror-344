...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <alphagram.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <alphagram.raw.base.VideoSize>`, *optional*):
            N/A
