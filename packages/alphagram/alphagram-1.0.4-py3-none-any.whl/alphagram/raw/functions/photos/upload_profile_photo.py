...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <alphagram.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <alphagram.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <alphagram.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <alphagram.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <alphagram.raw.base.photos.Photo>`
    """
