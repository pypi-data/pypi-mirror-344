...
class SendPaymentForm(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        credentials (:obj:`InputPaymentCredentials <alphagram.raw.base.InputPaymentCredentials>`):
            N/A
    ...
    Returns:
        :obj:`payments.PaymentResult <alphagram.raw.base.payments.PaymentResult>`
    """
