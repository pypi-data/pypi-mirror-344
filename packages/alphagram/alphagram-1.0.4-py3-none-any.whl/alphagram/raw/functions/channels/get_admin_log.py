...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <alphagram.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <alphagram.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <alphagram.raw.base.channels.AdminLogResults>`
    """
