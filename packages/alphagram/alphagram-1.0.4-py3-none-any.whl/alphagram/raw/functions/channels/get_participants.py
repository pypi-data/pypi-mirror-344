...
class GetParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`ChannelParticipantsFilter <alphagram.raw.base.ChannelParticipantsFilter>`):
            N/A
    ...
    Returns:
        :obj:`channels.ChannelParticipants <alphagram.raw.base.channels.ChannelParticipants>`
    """
