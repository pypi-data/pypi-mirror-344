...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~alphagram.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~alphagram.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~alphagram.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "alphagram". Get the first 50 results
                async for message in app.search_global("alphagram", limit=50):
                    print(message.text)
