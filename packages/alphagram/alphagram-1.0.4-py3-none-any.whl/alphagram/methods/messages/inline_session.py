...
from alphagram.errors import AuthBytesInvalid
from alphagram.session import Session
from alphagram.session.auth import Auth


async def get_session(client: "alphagram.Client", dc_id: int):
