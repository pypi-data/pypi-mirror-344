...
from alphagram.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia:
    async def download_media(
        ...
        Parameters:
            message (:obj:`~alphagram.types.Message` | ``str``):
        ...
        Returns:
            ...
            :meth:`~alphagram.Client.stop_transmission`, None is returned.
