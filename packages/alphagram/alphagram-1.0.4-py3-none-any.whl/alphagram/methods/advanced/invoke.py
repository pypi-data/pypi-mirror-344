...
class Invoke:
    async def invoke(
        ...
        Available functions are listed in the :obj:`functions <alphagram.api.functions>` package and may accept compound
        data types from :obj:`types <alphagram.api.types>` as well as bare types such as ``int``, ``str``, etc...
