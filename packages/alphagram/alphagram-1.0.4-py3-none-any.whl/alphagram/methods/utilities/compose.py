...
async def compose(
    clients: List["alphagram.Client"],
    sequential: bool = False
):
    """Run multiple clients at once.

    This method can be used to run multiple clients at once and can be found directly in the ``alphagram`` package.

    If you want to run a single client, you can use Client's bound method :meth:`~alphagram.Client.run`.

    Parameters:
        clients (List of :obj:`~alphagram.Client`):
    ...
    Example:
        .. code-block:: python
            ...
            import asyncio
            from alphagram import Client, compose
