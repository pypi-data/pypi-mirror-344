...
class Restart:
    async def restart(
        ...
        This method will first call :meth:`~alphagram.Client.stop` and then :meth:`~alphagram.Client.start` in a row in
        ...
        Returns:
            :obj:`~alphagram.Client`: The restarted client itself.
