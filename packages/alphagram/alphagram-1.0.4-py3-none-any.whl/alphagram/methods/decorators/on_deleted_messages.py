...
class OnDeletedMessages:
    def on_deleted_messages(
        ...
        :obj:`~alphagram.handlers.DeletedMessagesHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, alphagram.Client):
                self.add_handler(alphagram.handlers.DeletedMessagesHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        alphagram.handlers.DeletedMessagesHandler(func, self),
