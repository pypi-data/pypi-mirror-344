...
class OnInlineQuery:
    def on_inline_query(
        ...
        :obj:`~alphagram.handlers.InlineQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, alphagram.Client):
                self.add_handler(alphagram.handlers.InlineQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        alphagram.handlers.InlineQueryHandler(func, self),
