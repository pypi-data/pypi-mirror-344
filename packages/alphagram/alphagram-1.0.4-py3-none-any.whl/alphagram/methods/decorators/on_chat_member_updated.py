...
class OnChatMemberUpdated:
    def on_chat_member_updated(
        ...
        :obj:`~alphagram.handlers.ChatMemberUpdatedHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, alphagram.Client):
                self.add_handler(alphagram.handlers.ChatMemberUpdatedHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        alphagram.handlers.ChatMemberUpdatedHandler(func, self),
