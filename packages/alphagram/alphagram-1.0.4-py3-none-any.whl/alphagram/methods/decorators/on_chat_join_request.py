...
class OnChatJoinRequest:
    def on_chat_join_request(
        ...
        :obj:`~alphagram.handlers.ChatJoinRequestHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, alphagram.Client):
                self.add_handler(alphagram.handlers.ChatJoinRequestHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        alphagram.handlers.ChatJoinRequestHandler(func, self),
