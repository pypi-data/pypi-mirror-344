...
from alphagram.connection import Connection
from alphagram.crypto import aes, rsa, prime
from alphagram.errors import SecurityCheckMismatch
from alphagram.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "alphagram.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
