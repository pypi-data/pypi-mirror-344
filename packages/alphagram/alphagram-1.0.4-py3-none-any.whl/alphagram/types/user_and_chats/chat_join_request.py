...
class ChatJoinRequest(Object, Update):
    ...
    Parameters:
        ...
        invite_link (:obj:`~alphagram.types.ChatInviteLink`, *optional*):
    ...
    async def approve(self) -> bool:
        """Bound method *approve* of :obj:`~alphagram.types.ChatJoinRequest`.
    ...
    async def decline(self) -> bool:
        """Bound method *decline* of :obj:`~alphagram.types.ChatJoinRequest`.
