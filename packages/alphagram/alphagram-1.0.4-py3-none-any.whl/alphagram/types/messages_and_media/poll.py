...
import alphagram
from alphagram import raw, enums, utils
...
class Poll(Object, Update):
    ...
    Parameters:
        ...
        options (List of :obj:`~alphagram.types.PollOption`):
        ...
        explanation_entities (List of :obj:`~alphagram.types.MessageEntity`, *optional*):
