...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <alphagram.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <alphagram.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <alphagram.raw.base.PremiumSubscriptionOption>`):
            N/A
