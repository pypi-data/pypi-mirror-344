...
class TopPeerCategoryPeers(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.TopPeerCategoryPeers`.
    ...
    Parameters:
        category (:obj:`TopPeerCategory <alphagram.raw.base.TopPeerCategory>`):
            N/A

        count (``int`` ``32-bit``):
            N/A

        peers (List of :obj:`TopPeer <alphagram.raw.base.TopPeer>`):
            N/A
