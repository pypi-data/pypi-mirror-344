...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <alphagram.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <alphagram.raw.base.VideoSize>`, *optional*):
            N/A
