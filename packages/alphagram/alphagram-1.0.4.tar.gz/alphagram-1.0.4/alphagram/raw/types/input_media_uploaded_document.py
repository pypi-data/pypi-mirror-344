...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <alphagram.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <alphagram.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <alphagram.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <alphagram.raw.base.InputDocument>`, *optional*):
            N/A
