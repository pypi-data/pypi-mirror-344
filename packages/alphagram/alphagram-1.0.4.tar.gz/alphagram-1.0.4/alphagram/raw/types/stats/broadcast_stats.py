...
class BroadcastStats(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.stats.BroadcastStats`.
    ...
    Parameters:
        ...
        followers (:obj:`StatsAbsValueAndPrev <alphagram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        views_per_post (:obj:`StatsAbsValueAndPrev <alphagram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        shares_per_post (:obj:`StatsAbsValueAndPrev <alphagram.raw.base.StatsAbsValueAndPrev>`):
            N/A

        enabled_notifications (:obj:`StatsPercentValue <alphagram.raw.base.StatsPercentValue>`):
            N/A

        growth_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        followers_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        mute_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        top_hours_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        interactions_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        iv_interactions_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        views_by_source_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        new_followers_by_source_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        languages_graph (:obj:`StatsGraph <alphagram.raw.base.StatsGraph>`):
            N/A

        recent_message_interactions (List of :obj:`MessageInteractionCounters <alphagram.raw.base.MessageInteractionCounters>`):
            N/A
