...
class ChannelAdminLogEventActionParticipantToggleAdmin(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <alphagram.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <alphagram.raw.base.ChannelParticipant>`):
            N/A
