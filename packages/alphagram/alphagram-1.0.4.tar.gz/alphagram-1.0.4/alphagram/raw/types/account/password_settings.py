...
class PasswordSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.account.PasswordSettings`.
    ...
    Parameters:
        ...
        secure_settings (:obj:`SecureSecretSettings <alphagram.raw.base.SecureSecretSettings>`, *optional*):
            N/A
