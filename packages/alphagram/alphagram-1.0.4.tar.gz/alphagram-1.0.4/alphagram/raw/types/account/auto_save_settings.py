...
class AutoSaveSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.account.AutoSaveSettings`.
    ...
    Parameters:
        users_settings (:obj:`AutoSaveSettings <alphagram.raw.base.AutoSaveSettings>`):
            N/A

        chats_settings (:obj:`AutoSaveSettings <alphagram.raw.base.AutoSaveSettings>`):
            N/A

        broadcasts_settings (:obj:`AutoSaveSettings <alphagram.raw.base.AutoSaveSettings>`):
            N/A

        exceptions (List of :obj:`AutoSaveException <alphagram.raw.base.AutoSaveException>`):
            N/A
