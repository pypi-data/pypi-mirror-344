...
class PasswordInputSettings(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.account.PasswordInputSettings`.
    ...
    Parameters:
        new_algo (:obj:`PasswordKdfAlgo <alphagram.raw.base.PasswordKdfAlgo>`, *optional*):
            N/A
        ...
        new_secure_settings (:obj:`SecureSecretSettings <alphagram.raw.base.SecureSecretSettings>`, *optional*):
            N/A
