...
class SearchResultsPositions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.messages.SearchResultsPositions`.
    ...
    Parameters:
        ...
        positions (List of :obj:`SearchResultsPosition <alphagram.raw.base.SearchResultsPosition>`):
            N/A
