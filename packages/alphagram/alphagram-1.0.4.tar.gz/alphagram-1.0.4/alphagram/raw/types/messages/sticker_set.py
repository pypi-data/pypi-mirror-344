...
class StickerSet(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.messages.StickerSet`.
    ...
    Parameters:
        set (:obj:`StickerSet <alphagram.raw.base.StickerSet>`):
            N/A

        packs (List of :obj:`StickerPack <alphagram.raw.base.StickerPack>`):
            N/A

        keywords (List of :obj:`StickerKeyword <alphagram.raw.base.StickerKeyword>`):
            N/A

        documents (List of :obj:`Document <alphagram.raw.base.Document>`):
            N/A
