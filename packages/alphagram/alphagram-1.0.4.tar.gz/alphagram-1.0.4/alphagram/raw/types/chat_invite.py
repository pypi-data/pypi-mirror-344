...
class ChatInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.ChatInvite`.
    ...
    Parameters:
        ...
        photo (:obj:`Photo <alphagram.raw.base.Photo>`):
            N/A
        ...
        participants (List of :obj:`User <alphagram.raw.base.User>`, *optional*):
            N/A
