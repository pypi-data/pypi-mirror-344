...
class Found(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.contacts.Found`.
    ...
    Parameters:
        my_results (List of :obj:`Peer <alphagram.raw.base.Peer>`):
            N/A

        results (List of :obj:`Peer <alphagram.raw.base.Peer>`):
            N/A
