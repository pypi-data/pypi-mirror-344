...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <alphagram.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <alphagram.raw.base.PopularContact>`):
            N/A
