...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <alphagram.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <alphagram.raw.base.Peer>`):
            N/A
