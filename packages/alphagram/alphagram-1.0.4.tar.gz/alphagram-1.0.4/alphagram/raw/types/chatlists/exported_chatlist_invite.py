...
class ExportedChatlistInvite(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.chatlists.ExportedChatlistInvite`.
    ...
    Parameters:
        filter (:obj:`DialogFilter <alphagram.raw.base.DialogFilter>`):
            N/A

        invite (:obj:`ExportedChatlistInvite <alphagram.raw.base.ExportedChatlistInvite>`):
            N/A
