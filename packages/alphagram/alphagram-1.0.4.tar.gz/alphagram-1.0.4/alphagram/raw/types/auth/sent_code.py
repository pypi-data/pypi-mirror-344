...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~alphagram.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <alphagram.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <alphagram.raw.base.auth.CodeType>`, *optional*):
            N/A
