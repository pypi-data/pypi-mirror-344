...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <alphagram.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <alphagram.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <alphagram.raw.base.account.EmailVerified>`
    """
