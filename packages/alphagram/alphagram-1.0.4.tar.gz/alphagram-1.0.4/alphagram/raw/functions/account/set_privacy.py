...
class SetPrivacy(TLObject):  # type: ignore
    ...
    Parameters:
        key (:obj:`InputPrivacyKey <alphagram.raw.base.InputPrivacyKey>`):
            N/A

        rules (List of :obj:`InputPrivacyRule <alphagram.raw.base.InputPrivacyRule>`):
            N/A

    Returns:
        :obj:`account.PrivacyRules <alphagram.raw.base.account.PrivacyRules>`
    """
