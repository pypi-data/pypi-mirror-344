...
class ValidateRequestedInfo(TLObject):  # type: ignore
    ...
    Parameters:
        invoice (:obj:`InputInvoice <alphagram.raw.base.InputInvoice>`):
            N/A

        info (:obj:`PaymentRequestedInfo <alphagram.raw.base.PaymentRequestedInfo>`):
            N/A
    ...
    Returns:
        :obj:`payments.ValidatedRequestedInfo <alphagram.raw.base.payments.ValidatedRequestedInfo>`
    """
