...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <alphagram.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <alphagram.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <alphagram.raw.base.messages.Messages>`
    """
