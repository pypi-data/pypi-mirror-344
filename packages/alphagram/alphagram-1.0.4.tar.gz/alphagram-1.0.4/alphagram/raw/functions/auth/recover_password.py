...
class RecoverPassword(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        new_settings (:obj:`account.PasswordInputSettings <alphagram.raw.base.account.PasswordInputSettings>`, *optional*):
            N/A

    Returns:
        :obj:`auth.Authorization <alphagram.raw.base.auth.Authorization>`
    """
