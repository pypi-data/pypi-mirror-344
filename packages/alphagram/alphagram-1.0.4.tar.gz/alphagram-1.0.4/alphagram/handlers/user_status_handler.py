...
class UserStatusHandler(Handler):
    ...
    It is intended to be used with :meth:`~alphagram.Client.add_handler`.

    For a nicer way to register this handler, have a look at the :meth:`~alphagram.Client.on_user_status` decorator.
