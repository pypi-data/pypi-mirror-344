...
class DeletedMessagesHandler(Handler):
    ...
    (private, group, channel). It is intended to be used with :meth:`~alphagram.Client.add_handler`

    For a nicer way to register this handler, have a look at the
    :meth:`~alphagram.Client.on_deleted_messages` decorator.
    ...
    Other parameters:
        ...
        messages (List of :obj:`~alphagram.types.Message`):
    ...
    async def check(self, client: "alphagram.Client", messages: List[Message]):
