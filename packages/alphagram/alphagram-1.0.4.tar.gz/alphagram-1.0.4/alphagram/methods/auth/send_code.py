...
from alphagram.errors import PhoneMigrate, NetworkMigrate
from alphagram.session import Session, Auth
...
class SendCode:
    async def send_code(
        ...
        Returns:
            :obj:`~alphagram.types.SentCode`: On success, an object containing information on the sent confirmation code
            is returned.
