...
import alphagram
from alphagram import StopTransmission, enums
from alphagram import raw
from alphagram import types
from alphagram import utils
from alphagram.errors import FilePartMissing
from alphagram.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~alphagram.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~alphagram.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~alphagram.Client.stop_transmission`, None is returned.
