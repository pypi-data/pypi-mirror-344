...
import alphagram
from alphagram import raw, utils, enums
...
class SendMessage:
    async def send_message(
        ...
        Returns:
            :obj:`~alphagram.types.Message`: On success, the sent text message is returned.

        Example:
            .. code-block:: python

                # Simple example
                await app.send_message("me", "Message sent with **Alphagram**!")

                # Disable web page previews
                await app.send_message("me", "https://docs.alphagram.org",
                ...
                await app.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [InlineKeyboardButton("Docs", url="https://docs.alphagram.org")]
                        ]))
        """
