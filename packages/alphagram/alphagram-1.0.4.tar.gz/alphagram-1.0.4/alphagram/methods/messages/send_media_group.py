...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~alphagram.types.InputMediaPhoto`, :obj:`~alphagram.types.InputMediaVideo`, :obj:`~alphagram.types.InputMediaAudio` and :obj:`~alphagram.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~alphagram.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from alphagram.types import InputMediaPhoto, InputMediaVideo
