...
class OnCallbackQuery:
    def on_callback_query(
        ...
        :obj:`~alphagram.handlers.CallbackQueryHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, alphagram.Client):
                self.add_handler(alphagram.handlers.CallbackQueryHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        alphagram.handlers.CallbackQueryHandler(func, self),
