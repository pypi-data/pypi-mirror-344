...
class OnEditedMessage:
    def on_edited_message(
        ...
        :obj:`~alphagram.handlers.EditedMessageHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, alphagram.Client):
                self.add_handler(alphagram.handlers.EditedMessageHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        alphagram.handlers.EditedMessageHandler(func, self),
