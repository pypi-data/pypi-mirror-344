...
class OnChosenInlineResult:
    def on_chosen_inline_result(
        ...
        :obj:`~alphagram.handlers.ChosenInlineResultHandler`.
        ...
        def decorator(func: Callable) -> Callable:
            if isinstance(self, alphagram.Client):
                self.add_handler(alphagram.handlers.ChosenInlineResultHandler(func, filters), group)
                ...
                func.handlers.append(
                    (
                        alphagram.handlers.ChosenInlineResultHandler(func, self),
