...
import alphagram
from alphagram import raw, types
...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~alphagram.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~alphagram.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~alphagram.types.BotCommand`: On success, the list of bot commands is returned.
