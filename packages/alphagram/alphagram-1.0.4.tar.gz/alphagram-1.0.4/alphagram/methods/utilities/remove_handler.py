...
import alphagram
from alphagram.handlers import DisconnectHandler
...
class RemoveHandler:
    def remove_handler(
        ...
        :meth:`~alphagram.Client.add_handler` method, a tuple of *(handler, group)*, and pass it directly.
        ...
        Example:
            .. code-block:: python
                ...
                from alphagram.handlers import MessageHandler
