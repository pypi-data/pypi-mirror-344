...
class Object:
    def __init__(self, client: "alphagram.Client" = None):
        self._client = client

    def bind(self, client: "alphagram.Client"):
        """Bind a Client instance to this and to all nested Alphagram objects.

        Parameters:
            client (:obj:`~alphagram.types.Client`):
                The Client instance to bind this object with. Useful to re-enable bound methods after serializing and
                deserializing Alphagram objects with ``repr`` and ``eval``.
        """
        self._client = client
    ...
    def default(obj: "Object"):
        ...
        # https://t.me/alphagramchat/167281
