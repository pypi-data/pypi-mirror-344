...
from alphagram import types, utils, enums
...
class ChatEvent(Object):
    ...
    Parameters:
        ...
        action (:obj:`~alphagram.enums.ChatEventAction`):
            Event action.

        user (:obj:`~alphagram.types.User`):
            User that triggered the event.

        old_description, new_description (``str``, *optional*):
            Previous and new chat description.
            For :obj:`~alphagram.enums.ChatEventAction.DESCRIPTION_CHANGED` action only.

        old_history_ttl, new_history_ttl (``int``, *optional*):
            Previous and new chat history TTL.
            For :obj:`~alphagram.enums.ChatEventAction.HISTORY_TTL_CHANGED` action only.

        old_linked_chat, new_linked_chat (:obj:`~alphagram.types.Chat`, *optional*):
            Previous and new linked chat.
            For :obj:`~alphagram.enums.ChatEventAction.LINKED_CHAT_CHANGED` action only.

        old_photo, new_photo (:obj:`~alphagram.types.Photo`, *optional*):
            Previous and new chat photo.
            For :obj:`~alphagram.enums.ChatEventAction.PHOTO_CHANGED` action only.

        old_title, new_title (``str``, *optional*):
            Previous and new chat title.
            For :obj:`~alphagram.enums.ChatEventAction.TITLE_CHANGED` action only.

        old_username, new_username (``str``, *optional*):
            Previous and new chat username.
            For :obj:`~alphagram.enums.ChatEventAction.USERNAME_CHANGED` action only.

        old_chat_permissions, new_chat_permissions (:obj:`~alphagram.types.ChatPermissions`, *optional*):
            Previous and new default chat permissions.
            For :obj:`~alphagram.enums.ChatEventAction.CHAT_PERMISSIONS_CHANGED` action only.

        deleted_message (:obj:`~alphagram.types.Message`, *optional*):
            Deleted message.
            For :obj:`~alphagram.enums.ChatEventAction.MESSAGE_DELETED` action only.

        old_message, new_message (:obj:`~alphagram.types.Message`, *optional*):
            Previous and new message before it has been edited.
            For :obj:`~alphagram.enums.ChatEventAction.MESSAGE_EDITED` action only.

        invited_member (:obj:`~alphagram.types.ChatMember`, *optional*):
            New invited chat member.
            For :obj:`~alphagram.enums.ChatEventAction.MEMBER_INVITED` action only.

        old_administrator_privileges, new_administrator_privileges (:obj:`~alphagram.types.ChatMember`, *optional*):
            Previous and new administrator privileges.
            For :obj:`~alphagram.enums.ChatEventAction.ADMINISTRATOR_PRIVILEGES_CHANGED` action only.

        old_member_permissions, new_member_permissions (:obj:`~alphagram.types.ChatMember`, *optional*):
            Previous and new member permissions.
            For :obj:`~alphagram.enums.ChatEventAction.MEMBER_PERMISSIONS_CHANGED` action only.

        stopped_poll (:obj:`~alphagram.types.Message`, *optional*):
            Message containing the stopped poll.
            For :obj:`~alphagram.enums.ChatEventAction.POLL_STOPPED` action only.

        invites_enabled (``bool``, *optional*):
            If chat invites were enabled (True) or disabled (False).
            For :obj:`~alphagram.enums.ChatEventAction.INVITES_ENABLED` action only.

        history_hidden (``bool``, *optional*):
            If chat history has been hidden (True) or unhidden (False).
            For :obj:`~alphagram.enums.ChatEventAction.HISTORY_HIDDEN` action only.

        signatures_enabled (``bool``, *optional*):
            If message signatures were enabled (True) or disabled (False).
            For :obj:`~alphagram.enums.ChatEventAction.SIGNATURES_ENABLED` action only.

        old_slow_mode, new_slow_mode (``int``, *optional*):
            Previous and new slow mode value in seconds.
            For :obj:`~alphagram.enums.ChatEventAction.SLOW_MODE_CHANGED` action only.

        pinned_message (:obj:`~alphagram.types.Message`, *optional*):
            Pinned message.
            For :obj:`~alphagram.enums.ChatEventAction.MESSAGE_PINNED` action only.

        unpinned_message (:obj:`~alphagram.types.Message`, *optional*):
            Unpinned message.
            For :obj:`~alphagram.enums.ChatEventAction.MESSAGE_UNPINNED` action only.

        old_invite_link, new_invite_link (:obj:`~alphagram.types.ChatInviteLink`, *optional*):
            Previous and new edited invite link.
            For :obj:`~alphagram.enums.ChatEventAction.INVITE_LINK_EDITED` action only.

        revoked_invite_link (:obj:`~alphagram.types.ChatInviteLink`, *optional*):
            Revoked invite link.
            For :obj:`~alphagram.enums.ChatEventAction.INVITE_LINK_REVOKED` action only.

        deleted_invite_link (:obj:`~alphagram.types.ChatInviteLink`, *optional*):
            Deleted invite link.
            For :obj:`~alphagram.enums.ChatEventAction.INVITE_LINK_DELETED` action only.
    """
