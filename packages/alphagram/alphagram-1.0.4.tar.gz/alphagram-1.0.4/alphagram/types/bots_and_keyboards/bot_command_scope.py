...
class BotCommandScope(Object):
    ...
    - :obj:`~alphagram.types.BotCommandScopeDefault`
    - :obj:`~alphagram.types.BotCommandScopeAllPrivateChats`
    - :obj:`~alphagram.types.BotCommandScopeAllGroupChats`
    - :obj:`~alphagram.types.BotCommandScopeAllChatAdministrators`
    - :obj:`~alphagram.types.BotCommandScopeChat`
    - :obj:`~alphagram.types.BotCommandScopeChatAdministrators`
    - :obj:`~alphagram.types.BotCommandScopeChatMember`
    ...
    **Commands in group and supergroup chats**
    ...
    async def write(self, client: "alphagram.Client") -> "raw.base.BotCommandScope":
