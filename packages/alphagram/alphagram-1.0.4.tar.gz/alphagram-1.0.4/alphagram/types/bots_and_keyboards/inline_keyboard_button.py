...
class InlineKeyboardButton(Object):
    ...
    Parameters:
        ...
        web_app (:obj:`~alphagram.types.WebAppInfo`, *optional*):
            ...
            method :meth:`~alphagram.Client.answer_web_app_query`. Available only in private chats between a user and the
            bot.

        login_url (:obj:`~alphagram.types.LoginUrl`, *optional*):
        ...
        callback_game (:obj:`~alphagram.types.CallbackGame`, *optional*):
