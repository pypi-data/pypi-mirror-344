...
class InputMedia(Object):
    ...
    - :obj:`~alphagram.types.InputMediaAnimation`
    - :obj:`~alphagram.types.InputMediaDocument`
    - :obj:`~alphagram.types.InputMediaAudio`
    - :obj:`~alphagram.types.InputMediaPhoto`
    - :obj:`~alphagram.types.InputMediaVideo`
    """
