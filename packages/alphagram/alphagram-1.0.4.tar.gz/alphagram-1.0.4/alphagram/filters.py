...
from alphagram.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "alphagram.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~alphagram.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~alphagram.handlers.MessageHandler` the *update* argument will be a :obj:`~alphagram.types.Message`; in a :obj:`~alphagram.handlers.CallbackQueryHandler` the *update* will be a :obj:`~alphagram.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~alphagram.filters.command` or :meth:`~alphagram.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~alphagram.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Document` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Game` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Video` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Location` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~alphagram.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~alphagram.types.Message`.
    ...
    async def func(flt, client: alphagram.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~alphagram.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~alphagram.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~alphagram.types.InlineQuery`: The filter will match ``query``.
