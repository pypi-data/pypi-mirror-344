...
def confusion_matrix(true_labels: np.ndarray, predict_labels: np.ndarray) -> tuple[np.ndarray, np.ndarray]:
    """
    ...
    assert true_labels.shape == predict_labels.shape, "true_labels и predict_labels должны иметь одинаковую длину"
