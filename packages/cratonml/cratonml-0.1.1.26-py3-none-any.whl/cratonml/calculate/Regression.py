...
class RANSACRegression:
    ...
    @staticmethod
    def get_model(x_train: np.ndarray, y_train: np.ndarray) -> linear_model.RANSACRegressor:
        """
        ...
        assert y_train.ndim == 1 or y_train.ndim == 2, "y_train: Ожидался 1D или 2D массив"
        assert x_train.shape[0] == y_train.shape[0], "Длина массивов x_train и y_train должна быть равна"
    ...
    @staticmethod
    def get_coeffs(model: linear_model.RANSACRegressor) -> tuple[np.ndarray, float | np.ndarray]:
        """
...
class LinearRegression:
    ...
    @staticmethod
    def get_model(x_train: np.ndarray, y_train: np.ndarray) -> linear_model.LinearRegression:
        """
        Возвращает модель обученную на тренировочных данных.
    ...
    @staticmethod
    def get_coeffs(model: linear_model.LinearRegression) -> tuple[np.ndarray, float | np.ndarray]:
        """
         Получает коэффициенты линейной регрессии.
