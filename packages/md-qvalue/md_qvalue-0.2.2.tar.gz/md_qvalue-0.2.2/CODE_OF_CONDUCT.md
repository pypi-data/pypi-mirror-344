...
The Qvalue *Code of Conduct* sets the rules for the behavior of
every member in the Qvalue community so that everyone can
...
Qvalue is part of an engaged and respectful community made up of people from all
...
avoid, you will help us make Qvalue a welcoming and productive community.
...
7. **When we disagree, try to understand why**. Disagreements, both social and
   technical, happen all the time and Qvalue is no exception. It is important
   that we resolve disagreements and differing views constructively. Remember
   that we’re different. The strength of Qvalue comes from its varied community
