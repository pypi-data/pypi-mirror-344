...
class AbMediaCompute18(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    v3: AbMediaComputeV3
...
class AbMediaCompute19(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    v4: AbMediaComputeV4
...
class AbMediaComputeOrUnknown(RootModel[Optional[AbMediaCompute14]]):
    root: Optional[AbMediaCompute14]
