    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.conv1 = GATv2Conv(
            self.num_features, int(self.dim*factor), dropout=self.dropout_gat, heads=self.num_heads
        )

        self.fc1 = Linear(int(self.dim* factor * self.num_heads), int(self.dim*factor))
        self.fc2 = Linear(int(self.dim*factor), int(self.num_classes))
