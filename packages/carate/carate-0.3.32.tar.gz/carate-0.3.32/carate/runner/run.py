...
class Run(DefaultObject):
    ...
    def run(self) -> None:
        ...
        self.Evaluation.cv(
            ...
            normalize_scaling = self.normalize_scaling,
...
class RunInitializer:
    ...
    def __init_config(cls, config: Config) -> Run:
        ...
        model_net = config.model.Net(
            ...
            dropout_forward=float(config.dropout_forward),
            dropout_forward2=float(config.dropout_forward2)
        ).to(config.device)
        ...
        return Run(
            ...
            normalize_scaling=config.normalize_scaling,
