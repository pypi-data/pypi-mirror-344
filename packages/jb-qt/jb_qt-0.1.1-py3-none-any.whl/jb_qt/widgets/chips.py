...
from jb_qt.widgets.chip_button import ChipButton
from jb_qt.widgets.multiselect import MultiSelectComboBox
from jb_qt.widgets.widget_utils import debug_scroll_pos
...
class ChipsWidget(QWidget):
    ...
    def __init__(
        ...
        if isinstance(data, dict):
            ...
            self.list_widget.selectedChanged.connect(self.handle_multiselect_change)
        ...
        # list_widget = GroupedComboBox(options)
