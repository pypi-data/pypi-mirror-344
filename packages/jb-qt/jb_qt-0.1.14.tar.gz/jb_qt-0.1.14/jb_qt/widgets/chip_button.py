...
from jb_qt.common.consts import STYLES, COLORS
from jb_qt.models import IChipButton
from jb_qt.widgets.simple import ClickableLabel
from jb_qt.dialogs import InputDialog
from jb_qt.widgets.widget_utils import (
    debug_scroll_pos,
    preserve_scroll,
)


class ChipButton(IChipButton, QWidget):
    def __init__(
        self,
        tag: str,
        on_update: Callable,
