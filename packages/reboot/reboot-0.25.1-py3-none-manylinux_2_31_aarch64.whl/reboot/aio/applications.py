...
class Application:
    ...
    def __init__(
        ...
        *,
        ...
        try:
            ...
            # manully call `Reboot.up` to create a cluster.
            #
    ...
    def legacy_grpc_servicers(self):
        return self._legacy_grpc_servicers
    ...
    def initialize(
        self,
    ) -> Optional[Callable[[ExternalContext], Awaitable[None]]]:
