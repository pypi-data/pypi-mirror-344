...
# update 0.5.0
- massive overhaul of the rl.py script 
- rl now includes more advanced things for more advanced people and retains defualts for people who just want something simple
- moved update to the top of the readme
