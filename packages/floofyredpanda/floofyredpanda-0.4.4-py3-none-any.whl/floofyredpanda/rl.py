...
class DQNAgent:
    ...
    def replay(self):
        ...
        # current Q
        print("states_v shape:", states_v.shape)  # should be [batch_size, state_size]
        print("actions_v shape:", actions_v.shape)  # should be [batch_size, 1]
        print("model output shape:", self.model(states_v).shape)
        print("actions_v:", actions_v)
        print("model(states_v):", self.model(states_v))
