...
```
# update 0.4.2
- changed floofyredpanda.nn to .infer (this was still the case in 0.4.1 i just forgot to change it)
- added more args that can be passed to .train while keeping older stuff still working
- added update section in the readme
- added safety to .infer (this will break some scripts useing .infer)
