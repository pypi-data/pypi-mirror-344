from yta_google_drive_downloader.constants import DRIVE_RESOURCE_URL, CONFIRMATION_STRING, FILE_NOT_FOUND_ERROR_STRING
...
def get_filename_from_url(
    ...
    response_content = requests.get(drive_url).content
...
def is_valid_shareable_google_drive_url(
    ...
    try:
        print(GoogleDriveResource(drive_url).filename)
    except:
        return False
