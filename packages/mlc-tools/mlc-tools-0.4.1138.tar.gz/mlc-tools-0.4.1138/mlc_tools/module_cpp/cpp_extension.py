...
namespace @{namespace}
{
    ...
    template<typename T> struct Default { static constexpr T value = T(); };
    template<> struct Default<int> {static constexpr int value = 0;};
    template<> struct Default<unsigned int> {static constexpr unsigned int value = 0;};
    template<> struct Default<int64t> {static constexpr int64t value = 0;};
    template<> struct Default<uint64_t> {static constexpr uint64_t value = 0;};
    template<> struct Default<float> {static constexpr float value = 0.f;};
    template<> struct Default<double> {static constexpr double value = 0.;};
