"""
Settings for Linets with pickit courier are all namespaced in the LINETS setting.
...
class APISettings:
    ...
    def user_settings(self):
        if not hasattr(self, '_user_settings'):
            self._user_settings = getattr(settings, 'DJANGO_PICKIT', {})
