...
class UpdateSubscriptionRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cancel_at_end", "collection_method", "coupon_id", "custom_fields", "description", "is_preview", "items", "net_d", "new_period_end", "payment_method_id", "preview_renewal_invoices", "promotion_code", "proration_behavior", "trial_end", "trial_period_days"]
