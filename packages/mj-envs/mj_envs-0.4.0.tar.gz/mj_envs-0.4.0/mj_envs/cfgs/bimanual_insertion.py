...
task_cfg = { 
    ...
    "objects": ["bimanual_insertion_peg", "bimanual_insertion_hole3"], 
    ...
    "default_poses": {
        "bimanual_insertion_peg": [0.0, 0.3, 0.1] + R.from_euler('xyz', [0, 0, 0], degrees = True).as_quat(scalar_first = True).tolist(), 
        "bimanual_insertion_hole3": [0.0, 0.1, 0.1] + R.from_euler('xyz', [0, 0, 0], degrees = True).as_quat(scalar_first = True).tolist(),
    }, 
