...
task_cfg = { 
    ...
    "objects": ["long_bumper", "long_bumper_2x"], 
    ...
    "default_poses": {
        "long_bumper": [0.0, 0.3, 0.1] + \
            R.from_euler('xyz', [0, 0, 0], degrees = True).as_quat(scalar_first = True).tolist(), 
        "long_bumper_2x": [0.0, 0.1, 0.1] + \
            R.from_euler('xyz', [0, 0, 0], degrees = True).as_quat(scalar_first = True).tolist(),
    }, 
