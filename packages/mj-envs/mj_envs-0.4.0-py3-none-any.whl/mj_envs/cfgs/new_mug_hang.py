...
def random_xyz(i):
    return [random.uniform(-0.2, 0.2), random.uniform(0.2, 0.4), 0.05 + 0.03 * i ]
...
task_cfg = { 
    ...
    "objects": ["cambridge_mug", "new_hanger"], 
    ...
    "default_poses": {
        "cambridge_mug": [0, 0.3, 0.05] + R.from_euler('xyz', [90, 0, 0], degrees = True).as_quat(scalar_first = True).tolist(), 
