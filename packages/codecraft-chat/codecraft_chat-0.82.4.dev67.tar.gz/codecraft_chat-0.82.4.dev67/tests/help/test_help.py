...
class TestHelp(unittest.TestCase):
    ...
    def test_fname_to_url_unix(self):
        ...
        self.assertEqual(
            fname_to_url("website/docs/usage.md"), "https://codecraft.chat/docs/usage.html"
        )
        ...
        self.assertEqual(
            ...
            "https://codecraft.chat/docs/usage.html",
        )
    ...
    def test_fname_to_url_windows(self):
        ...
        self.assertEqual(
            fname_to_url(r"website\docs\usage.md"), "https://codecraft.chat/docs/usage.html"
        )
