...
from codecraft.coders.base_coder import FinishReasonLength, UnknownEditFormat
...
from codecraft.sendchat import sanity_check_messages
...
"""
    ...
    def test_skip_codecraftignored_files(self):
        with GitTemporaryDirectory():
            repo = git.Repo()
...
This command will print 'Hello, World!' to the console."""
    ...
    def test_architect_coder_auto_accept_true(self):
        with GitTemporaryDirectory():
            ...
            with patch("codecraft.coders.architect_coder.AskCoder.__init__", return_value=None):
                from codecraft.coders.architect_coder import ArchitectCoder
                ...
                with patch("codecraft.coders.architect_coder.Coder.create", return_value=mock_editor):
