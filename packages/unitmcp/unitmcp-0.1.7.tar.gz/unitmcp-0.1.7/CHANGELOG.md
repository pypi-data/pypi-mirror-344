...
### Added
- Changes in src/unitmcp/dsl/parsers/starlark_parser_fixed.py
...
- Changes in src/unitmcp/core/logging.py
- Changes in src/unitmcp/core/mcp.py
- Changes in src/unitmcp/core/utils.py
- Changes in src/unitmcp/device_managers/__init__.py
- Changes in src/unitmcp/device_managers/local_devices.py
- Changes in src/unitmcp/device_managers/network_devices.py

### Changed
- Changes in TODO.txt
- Changes in examples/dsl/README.md
- Changes in src/unitmcp/main.py
...
### Removed
- Changes in src/unitmcp/dsl/base_fixed.py
- Changes in src/unitmcp/dsl/parsers/hcl_parser_fixed.py
...
- Changes in src/unitmcp/dsl/base.py

### Fixed
- Changes in src/unitmcp/dsl/parsers/hcl_parser.py
...
- Changes in src/unitmcp/cli/dsl_commands.py
- Changes in src/unitmcp/config/__init__.py
- Changes in src/unitmcp/config/loader.py
- Changes in src/unitmcp/dsl/README.md
- Changes in src/unitmcp/dsl/__init__.py
- Changes in src/unitmcp/dsl/base.py
- Changes in src/unitmcp/dsl/examples/__init__.py
- Changes in src/unitmcp/dsl/examples/advanced/README.md
- Changes in src/unitmcp/dsl/examples/advanced/__init__.py
- Changes in src/unitmcp/dsl/examples/advanced/base_config.yaml
- Changes in src/unitmcp/dsl/examples/advanced/devices.hcl
- Changes in src/unitmcp/dsl/examples/advanced/multi_format_example.py
- Changes in src/unitmcp/dsl/examples/advanced/pipelines.star
- Changes in src/unitmcp/dsl/examples/config.hcl
- Changes in src/unitmcp/dsl/examples/config.star
- Changes in src/unitmcp/dsl/examples/config.yaml
- Changes in src/unitmcp/dsl/examples/simple.ua
- Changes in src/unitmcp/dsl/parsers/__init__.py
- Changes in src/unitmcp/dsl/parsers/hcl_parser.py
- Changes in src/unitmcp/dsl/parsers/simple_parser.py
- Changes in src/unitmcp/dsl/parsers/starlark_parser.py
- Changes in src/unitmcp/dsl/parsers/yaml_parser.py
- Changes in src/unitmcp/dsl/runtime/__init__.py
- Changes in src/unitmcp/dsl/runtime/context.py
- Changes in src/unitmcp/dsl/runtime/executor.py
- Changes in src/unitmcp/dsl/validators/__init__.py
- Changes in src/unitmcp/dsl/validators/schema.py
...
- Changes in src/unitmcp/core/client_fixed.py
- Changes in src/unitmcp/devices/gamepad.py
- Changes in src/unitmcp/devices/keyboard.py
- Changes in src/unitmcp/devices/mouse.py
- Changes in src/unitmcp/devices/touchscreen.py
...
- Changes in src.md
- Changes in src/unitmcp/core/__init__.py
- Changes in src/unitmcp/core/client.py
- Changes in src/unitmcp/core/server.py
- Changes in src/unitmcp/devices/__init__.py
- Changes in src/unitmcp/devices/base.py
- Changes in src/unitmcp/devices/camera.py
- Changes in src/unitmcp/devices/gpio.py
- Changes in src/unitmcp/devices/microphone.py
- Changes in src/unitmcp/devices/remote_speaker_device.py
- Changes in src/unitmcp/devices/remote_speaker_service.py
- Changes in src/unitmcp/protocols/__init__.py
- Changes in src/unitmcp/protocols/base.py
- Changes in src/unitmcp/protocols/mqtt.py
- Changes in src/unitmcp/protocols/websocket.py
- Changes in src/unitmcp/security/__init__.py
- Changes in src/unitmcp/security/access_control.py
- Changes in src/unitmcp/security/authentication.py
- Changes in src/unitmcp/security/encryption.py
- Changes in tests/__init__.py
- Changes in tests/test_client.py
