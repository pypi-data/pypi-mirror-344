import { B as Block, S as Static, Q as BlockTitle, i as Empty, aq as LineChart, ak as globals } from './2-BghaG1V3.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-Cm-4e963.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index27-jag8RMcd.js.map
