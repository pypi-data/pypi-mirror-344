...
import { B as Block, S as Static, g as BlockLabel, z as File$1, i as Empty, U as UploadText, j as IconButtonWrapper, k as IconButton, K as Undo, n as Download } from './2-BghaG1V3.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-BaEeh7P8.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-CimzbxoX.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-DXA3RI3b.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-Cfd9lWez.js.map
