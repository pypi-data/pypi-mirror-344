import { B as Block, S as Static, Q as BlockTitle, i as Empty, aq as LineChart, ak as globals } from './2-BF-YoEic.js';
...
const Index = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  async function load_chart() {
    ...
    if (!vegaEmbed) {
      vegaEmbed = (await import('./vega-embed.module-Cr_sAJX6.js')).default;
    }
    vegaEmbed(chart_element, spec, { actions: false }).then(function(result) {
      view = result.view;
      resizeObserver.observe(chart_element);
...
//# sourceMappingURL=Index27-B3Qp_YbS.js.map
