...
import { B as Block, S as Static, g as BlockLabel, z as File$1, i as Empty, U as UploadText, j as IconButtonWrapper, k as IconButton, K as Undo, n as Download } from './2-BF-YoEic.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-BcyEbYuM.js';
export { default as BaseExample } from './Example18-BpMcGr5w.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-dYobOZan.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-BU3WErtR.js');
  return module.default;
}
...
//# sourceMappingURL=Index56-mdEf4k9Y.js.map
