...
import { I as IconButton } from "./2.PUtrIOKS.js";
...
function instance($$self, $$props, $$invalidate) {
  ...
  let { is_full_screen = false } = $$props;
  onMount(() => {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("is_full_screen" in $$props2)
      $$invalidate(0, is_full_screen = $$props2.is_full_screen);
  };
...
class FullscreenButton extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance, create_fragment, safe_not_equal, { container: 2, is_full_screen: 0 });
  }
}
export {
