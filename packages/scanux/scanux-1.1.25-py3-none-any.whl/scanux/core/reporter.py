...
class Reporter:
    ...
    def _create_system_info_table(self, sys_info: Dict[str, Any]) -> Table:
        ...
        table.add_column("Category", style="info", width=15)
        table.add_column("Details", style="normal")
    ...
    def _create_module_table(self, module_name: str, module_data: Dict[str, Any]) -> Table:
        ...
        table.add_column("Category", style="info", width=20)
        table.add_column("Status", justify="center", width=15)
        table.add_column("Details", style="normal", width=35)
        table.add_column("Recommendation", style="normal", width=30)
        ...
        for key, value in metrics.items():
            if key == "error":
                table.add_row(
                    ...
                    Text("⚠️", style="error"),
                    Text(str(value), style="error"),
                    Text("Check module configuration", style="error")
                )
                continue
            ...
            table.add_row(
                ...
                Text(recommendation, style="normal")
            )
    ...
    def _create_summary_table(self, summary: Dict[str, Any]) -> Table:
        ...
        table = Table(box=ROUNDED, show_header=False, border_style="bright_blue", padding=(0, 1))
        table.add_column("Category", style="info", width=20)
        table.add_column("Value", style="normal")
