...
class Reporter:
    ...
    def _create_module_table(self, module_name: str, module_data: Dict[str, Any]) -> Table:
        ...
        table.add_column("Details", style="default", width=35)
        table.add_column("Recommendation", style="default", width=30)
        ...
        for key, value in metrics.items():
            ...
            table.add_row(
                Text(key, style="info"),
                status,
                Text(details, style="default"),
                Text(recommendation, style="default")
            )
