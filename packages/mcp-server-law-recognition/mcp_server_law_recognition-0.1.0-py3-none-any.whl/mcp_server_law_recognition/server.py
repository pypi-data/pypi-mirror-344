...
LAW_RECOGNITION_API_BASE = "http://api-ailab-test.pkulaw.com/fabaoAI/tools/law_recognition"
MISSING_AUTH_TOKEN_MESSAGE = (
    """Legal Text token not found. Please specify your Legal Text token."""
)

@dataclass
class Law_RecognitionIssueData:
    text: str
    original: str
    fulltext: str
    source: str
...
async def handle_law_recognition_text(
    ...
    try:
        ...
        # return Law_RecognitionIssueData(
        #     # text=law_recognition_data[0]["text"],
        #     # original=law_recognition_data[0]["original"],
        #     # fulltext=law_recognition_data[0]["fulltext"],
        #     # source=law_recognition_data[0]["source"]
        #     text = "1",
        #     original = "2",
        #     fulltext = "3",
        #     source = "4",
    ...
    # except Law_recognitionError as e:
    #     raise ValueError(str(e))
    # except httpx.HTTPStatusError as e:
    #     raise ValueError(f"Error fetching Law issue: {str(e)}")
