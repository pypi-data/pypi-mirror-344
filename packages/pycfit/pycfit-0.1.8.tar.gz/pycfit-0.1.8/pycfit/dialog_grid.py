...
class GridDialog(QDialog):
    ...
    def mask_point(self):
        _, mask_x, mask_y = self.GM.analysis_point.get_point()
        self.GM.toggle_mask((mask_x, mask_y))
    ...
    def redo_fit_point(self):  # Opens a single spectra dialog box to adjust the fit at one (X,Y) point
        ...
        nanvals_mask = self.GM.get_data_subset(self.GM._data_mask, fixed_x=True, fixed_y=True).copy()
