...
#--------------------- Keystack -----------------------#
from commonLib import removeGunicornErrorLogFile, removeNginxErrorLogFile, logDebugMsg, getHttpIpAndPort, syncTestResultsWithRedis
...
# logServiceObj = Serviceware.KeystackServices(typeOfService='KeystackDeleteLogs', isFromKeystackUI=True)
# logServiceObj.restartService('keystackAwsS3')

# schedulerServiceObj = Serviceware.KeystackServices(typeOfService='KeystackScheduler', isFromKeystackUI=True)
# schedulerServiceObj.restartService('keystackScheduler')
...
JobSchedulerAssistant().syncCronJobs(dbName)
