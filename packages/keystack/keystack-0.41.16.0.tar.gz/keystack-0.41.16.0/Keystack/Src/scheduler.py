...
class JobSchedulerAssistant():
    ...
    def removeCronJobs(self, listOfJobsToRemove, dbObj=None, queryName=None):
        """
        This function is called by envViews.py:DeleteScheduledEnv and keystackScheduler.py
        KeystackScheduler removes tasks from /etc/crontab
