...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_core_tmp_.ipynb.
...
# %% ../nbs/00_core_tmp_.ipynb 16
def _mk_list(t, v): return [t(o) for o in listify(v)]

# %% ../nbs/00_core_tmp_.ipynb 18
fh_cfg = AttrDict(indent=True)

# %% ../nbs/00_core_tmp_.ipynb 19
def _fix_anno(t, o):
...
# %% ../nbs/00_core_tmp_.ipynb 23
@dataclass
class HttpHeader: k:str;v:str

# %% ../nbs/00_core_tmp_.ipynb 24
...
# %% ../nbs/00_core_tmp_.ipynb 71
async def _wrap_call(f, req, params):
    wreq = await _wrap_req(req, params)
    return await _handle(f, wreq)

# %% ../nbs/00_core_tmp_.ipynb 72
htmx_exts = {
...
# %% ../nbs/00_core_tmp_.ipynb 89
all_meths = 'get post put delete patch head trace options'.split()

# %% ../nbs/00_core_tmp_.ipynb 90
@patch
...
# %% ../nbs/00_core_tmp_.ipynb 94
def nested_name(f):
    "Get name of function `f` using '_' to join nested function names"
    return f.__qualname__.replace('.<locals>.', '_')

# %% ../nbs/00_core_tmp_.ipynb 97
@patch
