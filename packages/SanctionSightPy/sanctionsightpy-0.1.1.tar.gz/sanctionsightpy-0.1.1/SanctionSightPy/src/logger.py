...
from SanctionSightPy.src._errors import SanctionErrors
    ...
    def __init__(
        ...
        try:
            ...
            if not log_file_name.endswith(".log"):
                raise SanctionErrors("Log file name must end with '.log'")
        ...
        except SanctionErrors as error:
            raise SanctionErrors(f"Invalid log directory or file name: {error}")
