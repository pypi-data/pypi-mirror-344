...
class SanctionErrors(Exception):
    def __init__(
            self,
        ...
        super(SanctionErrors, self).__init__(self._format_message())
...
class ClientResponseError(SanctionErrors):
...
class ClientConnectionError(SanctionErrors):
...
class ClientTimeoutError(SanctionErrors):
    pass


class InvalidURLError(SanctionErrors):
    pass


class ClientPayloadError(SanctionErrors):
    pass


class ServerDisconnectedError(SanctionErrors):
    pass


class TooManyRedirectsError(SanctionErrors):
    pass


class ContentTypeError(SanctionErrors):
    pass


class UnexpectedError(SanctionErrors):
    pass
