import asyncio
import logging
from typing import Any, AsyncGenerator, BinaryIO, Dict, Mapping
...
class UploadHandler:
    ...
    async def _upload_from_local_file(self, httpx_client: httpx.AsyncClient, upload_spec: UploadSpec):
        ...
        await self._upload(httpx_client, upload_spec, UploadHandler._file_stream(upload_spec.filename))
