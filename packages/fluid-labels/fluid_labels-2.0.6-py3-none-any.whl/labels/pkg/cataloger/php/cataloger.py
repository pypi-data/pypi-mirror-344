...
from labels.pkg.cataloger.php.parse_composer_json import (
    parse_composer_json,
)
from labels.pkg.cataloger.php.parse_composer_lock import (
    parse_composer_lock,
)
from labels.pkg.cataloger.php.parse_installed_json import (
    parse_installed_json,
)
from labels.pkg.cataloger.php.parse_serialized import (
