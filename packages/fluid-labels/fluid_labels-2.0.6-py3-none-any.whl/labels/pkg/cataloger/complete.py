...
from labels.pkg.cataloger.alpine import (
    package as package_alpine,
)
from labels.pkg.cataloger.cpp import (
    package as package_cpp,
)
from labels.pkg.cataloger.dart import (
    package as package_dart,
)
from labels.pkg.cataloger.debian import (
    package as package_debian,
)
from labels.pkg.cataloger.dotnet import (
    package as package_dotnet,
)
from labels.pkg.cataloger.elixir import (
    package as package_elixir,
)
from labels.pkg.cataloger.github import (
    package as package_github,
)
from labels.pkg.cataloger.golang import (
    package as package_go,
)
from labels.pkg.cataloger.java import (
    package as package_java,
)
from labels.pkg.cataloger.javascript import (
    package as package_js,
)
from labels.pkg.cataloger.php import (
    package as package_php,
)
from labels.pkg.cataloger.python import (
    package as package_python,
)
from labels.pkg.cataloger.ruby import (
    package as package_ruby,
)
from labels.pkg.cataloger.rust import (
    package as package_rust,
)
from labels.pkg.cataloger.swift import (
