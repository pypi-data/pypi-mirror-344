...
from labels.pkg.cataloger.dotnet.parse_csproj import (
    parse_csproj,
)
from labels.pkg.cataloger.dotnet.parse_dotnet_exe_config import (
    parse_dotnet_config_executable,
)
from labels.pkg.cataloger.dotnet.parse_dotnet_package_config import (
    parse_dotnet_pkgs_config,
)
from labels.pkg.cataloger.dotnet.parse_dotnet_package_lock import (
    parse_dotnet_package_lock,
)
from labels.pkg.cataloger.dotnet.parse_dotnet_portable_executable import (
