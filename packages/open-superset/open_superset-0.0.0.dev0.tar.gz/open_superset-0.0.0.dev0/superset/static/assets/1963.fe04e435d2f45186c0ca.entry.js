...
`,L=i.I4.i`
  margin-top: 2px;
`;function R(e){const{locale:a,languages:t,...n}=e,l=(0,i.DP)();return(0,q.Y)(z,{css:o.AH`
        [data-icon='caret-down'] {
          color: ${l.colors.grayscale.base};
          font-size: ${l.typography.sizes.xxs}px;
          margin-left: ${l.gridUnit}px;
        }
      `,"aria-label":"Languages",title:(0,q.Y)("div",{className:"f16",children:(0,q.Y)(L,{className:`flag ${t[a].flag}`})}),icon:(0,q.Y)(b.F.CaretDownOutlined,{iconSize:"xs"}),...n,children:Object.keys(t).map((e=>(0,q.Y)(h.NG.Item,{style:{whiteSpace:"normal",height:"auto"},children:(0,q.FD)(M,{className:"f16",children:[(0,q.Y)("i",{className:`flag ${t[e].flag}`}),(0,q.Y)("a",{href:t[e].url,children:t[e].name})]})},e)))})}var H=t(3139);const j=(0,F.a)(),V=e=>o.AH`
...
`,{SubMenu:X}=h.W1,Z=(0,i.I4)(X)`
  ...
  `}
`,ee=({align:e,settings:a,navbarRight:t,isFrontendRoute:n,environmentTag:l,setQuery:s})=>{const d=(0,S.d4)((e=>e.user)),c=(0,S.d4)((e=>{var a;return null==(a=e.dashboardInfo)?void 0:a.id})),p=d||{},{roles:g}=p,{CSV_EXTENSIONS:v,COLUMNAR_EXTENSIONS:f,EXCEL_EXTENSIONS:y,ALLOWED_EXTENSIONS:x,HAS_GSHEETS_INSTALLED:w}=(0,S.d4)((e=>e.common.conf)),[A,F]=(0,r.useState)(!1),[z,M]=(0,r.useState)(!1),[L,X]=(0,r.useState)(!1),[ee,ae]=(0,r.useState)(!1),[te,ne]=(0,r.useState)(""),le=(0,$.L)("can_sqllab","Superset",g),re=(0,$.L)("can_write","Dashboard",g),ie=(0,$.L)("can_write","Chart",g),oe=(0,$.L)("can_write","Database",g),se=(0,$.L)("can_write","Dataset",g),{canUploadData:de,canUploadCSV:ce,canUploadColumnar:he,canUploadExcel:ue}=(0,P.c8)(g,v,f,y,x),pe=le||ie||re,[me,ge]=(0,r.useState)(!1),[be,ve]=(0,r.useState)(!1),fe=(0,I.N6)(d),ye=me||fe,_e=[{label:(0,D.t)("Data"),icon:"fa-database",childs:[{label:(0,D.t)("Connect database"),name:H.$.DbConnection,perm:oe&&!be},{label:(0,D.t)("Create dataset"),name:H.$.DatasetCreation,url:"/dataset/add/",perm:se&&be},{label:(0,D.t)("Connect Google Sheet"),name:H.$.GoogleSheets,perm:oe&&w},{label:(0,D.t)("Upload CSV to database"),name:H.$.CSVUpload,perm:ce&&ye,disable:fe&&!me},{label:(0,D.t)("Upload Excel to database"),name:H.$.ExcelUpload,perm:ue&&ye,disable:fe&&!me},{label:(0,D.t)("Upload Columnar file to database"),name:H.$.ColumnarUpload,perm:he&&ye,disable:fe&&!me}]},{label:(0,D.t)("SQL query"),url:"/sqllab?new=true",icon:"fa-fw fa-search",perm:"can_sqllab",view:"Superset"},{label:(0,D.t)("Chart"),url:Number.isInteger(c)?`/chart/add?dashboard_id=${c}`:"/chart/add",icon:"fa-fw fa-bar-chart",perm:"can_write",view:"Chart"},{label:(0,D.t)("Dashboard"),url:"/dashboard/new",icon:"fa-fw fa-dashboard",perm:"can_write",view:"Dashboard"}],xe=()=>{N.A.get({endpoint:`/api/v1/database/?q=${C().encode({filters:[{col:"allow_file_upload",opr:"upload_is_enabled",value:!0}]})}`}).then((({json:e})=>{var a;const t=(null==e||null==(a=e.result)?void 0:a.filter((e=>{var a;return null==e||null==(a=e.engine_information)?void 0:a.supports_file_upload})))||[];ge((null==t?void 0:t.length)>=1)}))},Ye=()=>{N.A.get({endpoint:`/api/v1/database/?q=${C().encode({filters:[{col:"database_name",opr:"neq",value:"examples"}]})}`}).then((({json:e})=>{ve(e.count>=1)}))};(0,r.useEffect)((()=>{de&&xe()}),[de]),(0,r.useEffect)((()=>{(oe||se)&&Ye()}),[oe,se]);const we=e=>(0,q.Y)("i",{className:`fa ${e.icon}`}),Ce=(0,D.t)("Enable 'Allow file uploads to database' in any database's settings"),Se=e=>e.disable?(0,q.Y)(h.W1.Item,{css:B,disabled:!0,children:(0,q.Y)(u.m_,{placement:"top",title:Ce,children:e.label})},e.name):(0,q.Y)(h.W1.Item,{css:J,children:e.url?(0,q.FD)("a",{href:(0,k.A)(e.url),children:[" ",e.label," "]}):e.label},e.name),Ae=j.get("navbar.right"),Fe=j.get("navbar.right-menu.item.icon"),De=(0,i.DP)();return(0,q.FD)(K,{align:e,children:[oe&&(0,q.Y)(T.Ay,{onHide:()=>{ne(""),F(!1)},show:A,dbEngine:te,onDatabaseAdd:()=>s({databaseAdded:!0})}),ce&&(0,q.Y)(U.A,{onHide:()=>M(!1),show:z,allowedExtensions:v,type:"csv"}),ue&&(0,q.Y)(U.A,{onHide:()=>X(!1),show:L,allowedExtensions:y,type:"excel"}),he&&(0,q.Y)(U.A,{onHide:()=>ae(!1),show:ee,allowedExtensions:f,type:"columnar"}),(null==l?void 0:l.text)&&(0,q.Y)(E.Ay,{css:(0,o.AH)({borderRadius:125*De.gridUnit+"px"},"",""),color:/^#(?:[0-9a-f]{3}){1,2}$/i.test(l.color)?l.color:Y()(De.colors,l.color),children:(0,q.Y)("span",{css:Q,children:l.text})}),(0,q.FD)(h.W1,{css:o.AH`
          display: flex;
          flex-direction: row;
        `,selectable:!1,mode:"horizontal",onClick:e=>{e.key===H.$.DbConnection?F(!0):e.key===H.$.GoogleSheets?(F(!0),ne("Google Sheets")):e.key===H.$.CSVUpload?M(!0):e.key===H.$.ExcelUpload?X(!0):e.key===H.$.ColumnarUpload&&ae(!0)},onOpenChange:e=>(e.length>1&&!_()(null==e?void 0:e.filter((e=>{var a;return e.includes(`sub2_${null==_e||null==(a=_e[0])?void 0:a.label}`)})))&&(de&&xe(),(oe||se)&&Ye()),null),disabledOverflow:!0,children:[Ae&&(0,q.Y)(Ae,{}),!t.user_is_anonymous&&pe&&(0,q.Y)(Z,{title:(0,q.Y)(b.F.PlusOutlined,{iconColor:De.colors.primary.dark1}),icon:(0,q.Y)(b.F.CaretDownOutlined,{iconSize:"xs"}),children:null==_e||null==_e.map?void 0:_e.map((e=>{var a;const t=null==(a=e.childs)?void 0:a.some((e=>"object"==typeof e&&!!e.perm));if(e.childs){var l;if(t)return(0,q.Y)(Z,{className:"data-menu",title:e.label,icon:we(e),children:null==e||null==(l=e.childs)||null==l.map?void 0:l.map(((e,a)=>"string"!=typeof e&&e.name&&e.perm?(0,q.FD)(r.Fragment,{children:[3===a&&(0,q.Y)(h.W1.Divider,{}),Se(e)]},e.name):null))},`sub2_${e.label}`);if(!e.url)return null}return(0,$.L)(e.perm,e.view,g)&&(0,q.Y)(h.W1.Item,{children:n(e.url)?(0,q.FD)(m.N_,{to:e.url||"",children:[(0,q.Y)("i",{className:`fa ${e.icon}`})," ",e.label]}):(0,q.FD)("a",{href:(0,k.A)(e.url||""),children:[(0,q.Y)("i",{className:`fa ${e.icon}`})," ",e.label]})},e.label)}))},"sub1"),(0,q.FD)(Z,{title:(0,D.t)("Settings"),icon:(0,q.Y)(b.F.CaretDownOutlined,{iconSize:"xs"}),children:[null==a||null==a.map?void 0:a.map(((e,t)=>{var l;return[(0,q.Y)(h.W1.ItemGroup,{title:e.label,children:null==e||null==(l=e.childs)||null==l.map?void 0:l.map((e=>{if("string"!=typeof e){const a=Fe?(0,q.FD)(W,{children:[e.label,(0,q.Y)(Fe,{menuChild:e})]}):e.label;return(0,q.Y)(h.W1.Item,{children:n(e.url)?(0,q.Y)(m.N_,{to:e.url||"",children:a}):(0,q.Y)("a",{href:e.url||"",children:a})},`${e.label}`)}return null}))},`${e.label}`),t<a.length-1&&(0,q.Y)(h.W1.Divider,{},`divider_${t}`)]})),!t.user_is_anonymous&&[(0,q.Y)(h.W1.Divider,{},"user-divider"),(0,q.FD)(h.W1.ItemGroup,{title:(0,D.t)("User"),children:[t.user_info_url&&(0,q.Y)(h.W1.Item,{children:(0,q.Y)("a",{href:t.user_info_url,children:(0,D.t)("Info")})},"info"),(0,q.Y)(h.W1.Item,{onClick:()=>{localStorage.removeItem("redux")},children:(0,q.Y)("a",{href:t.user_logout_url,children:(0,D.t)("Logout")})},"logout")]},"user-section")],(t.version_string||t.version_sha)&&[(0,q.Y)(h.W1.Divider,{},"version-info-divider"),(0,q.Y)(h.W1.ItemGroup,{title:(0,D.t)("About"),children:(0,q.FD)("div",{className:"about-section",children:[t.show_watermark&&(0,q.Y)("div",{css:V,children:(0,D.t)("Powered by Apache Superset")}),t.version_string&&(0,q.FD)("div",{css:V,children:[(0,D.t)("Version"),": ",t.version_string]}),t.version_sha&&(0,q.FD)("div",{css:V,children:[(0,D.t)("SHA"),": ",t.version_sha]}),t.build_number&&(0,q.FD)("div",{css:V,children:[(0,D.t)("Build"),": ",t.build_number]})]})},"about-section")]]},"sub3_settings"),t.show_language_picker&&(0,q.Y)(R,{locale:t.locale,languages:t.languages})]}),t.documentation_url&&(0,q.FD)(q.FK,{children:[(0,q.Y)(G,{href:t.documentation_url,target:"_blank",rel:"noreferrer",title:t.documentation_text||(0,D.t)("Documentation"),children:t.documentation_icon?(0,q.Y)("i",{className:t.documentation_icon}):(0,q.Y)("i",{className:"fa fa-question"})}),(0,q.Y)("span",{children:" "})]}),t.bug_report_url&&(0,q.FD)(q.FK,{children:[(0,q.Y)(G,{href:t.bug_report_url,target:"_blank",rel:"noreferrer",title:t.bug_report_text||(0,D.t)("Report a bug"),children:t.bug_report_icon?(0,q.Y)("i",{className:t.bug_report_icon}):(0,q.Y)("i",{className:"fa fa-bug"})}),(0,q.Y)("span",{children:" "})]}),t.user_is_anonymous&&(0,q.FD)(G,{href:t.user_login_url,children:[(0,q.Y)("i",{className:"fa fa-fw fa-sign-in"}),(0,D.t)("Login")]}),(0,q.Y)(O,{version:t.version_string,sha:t.version_sha,build:t.build_number})]})},ae=e=>{const[,a]=(0,A.sq)({databaseAdded:A.sJ,datasetAdded:A.sJ});return(0,q.Y)(ee,{setQuery:a,...e})};class te extends r.PureComponent{constructor(...e){super(...e),this.state={hasError:!1},this.noop=()=>{}}static getDerivedStateFromError(){return{hasError:!0}}render(){return this.state.hasError?(0,q.Y)(ee,{setQuery:this.noop,...this.props}):this.props.children}}const ne=e=>(0,q.Y)(te,{...e,children:(0,q.Y)(ae,{...e})}),le=i.I4.header`
...
`,{SubMenu:re}=h.NG,ie=(0,i.I4)(re)`
  ...
  `}
`,{useBreakpoint:oe}=c.xA;function se({data:{menu:e,brand:a,navbar_right:t,settings:n,environment_tag:i},isFrontendRoute:o=()=>!1}){const[y,_]=(0,r.useState)("horizontal"),x=oe(),Y=(0,v.Q1)();let w;(0,r.useEffect)((()=>{function e(){window.innerWidth<=767?_("inline"):_("horizontal")}e();const a=l()((()=>e()),10);return window.addEventListener("resize",a),()=>window.removeEventListener("resize",a)}),[]),function(e){e.Explore="/explore",e.Dashboard="/dashboard",e.Chart="/chart",e.Datasets="/tablemodelview"}(w||(w={}));const C=[],[S,A]=(0,r.useState)(C),F=(0,p.zy)();return(0,r.useEffect)((()=>{const e=F.pathname;switch(!0){case e.startsWith(w.Dashboard):A(["Dashboards"]);break;case e.startsWith(w.Chart)||e.startsWith(w.Explore):A(["Charts"]);break;case e.startsWith(w.Datasets):A(["Datasets"]);break;default:A(C)}}),[F.pathname]),(0,d.P3)(f.vX.standalone)||Y.hideNav?(0,q.Y)(q.FK,{}):(0,q.Y)(le,{className:"top",id:"main-menu",role:"navigation",children:(0,q.FD)(c.fI,{children:[(0,q.FD)(c.fv,{md:16,xs:24,children:[(0,q.Y)(u.m_,{id:"brand-tooltip",placement:"bottomLeft",title:a.tooltip,arrow:{pointAtCenter:!0},children:o(window.location.pathname)?(0,q.Y)(g.K,{className:"navbar-brand",to:a.path,children:(0,q.Y)("img",{src:(0,s.u)(a.icon),alt:a.alt})}):(0,q.Y)("a",{className:"navbar-brand",href:a.path,tabIndex:-1,children:(0,q.Y)("img",{src:(0,s.u)(a.icon),alt:a.alt})})}),a.text&&(0,q.Y)("div",{className:"navbar-brand-text",children:(0,q.Y)("span",{children:a.text})}),(0,q.Y)(h.NG,{mode:y,className:"main-nav",selectedKeys:S,disabledOverflow:!0,children:e.map(((e,a)=>{var t;return(({label:e,childs:a,url:t,index:n,isFrontendRoute:l})=>t&&l?(0,q.Y)(h.NG.Item,{role:"presentation",children:(0,q.Y)(m.k2,{role:"button",to:t,activeClassName:"is-active",children:e})},e):t?(0,q.Y)(h.NG.Item,{children:(0,q.Y)("a",{href:t,children:e})},e):(0,q.Y)(ie,{title:e,icon:"inline"===y?(0,q.Y)(q.FK,{}):(0,q.Y)(b.F.CaretDownOutlined,{iconSize:"xs"}),children:null==a?void 0:a.map(((a,t)=>"string"==typeof a&&"-"===a&&"Data"!==e?(0,q.Y)(h.NG.Divider,{},`$${t}`):"string"!=typeof a?(0,q.Y)(h.NG.Item,{children:a.isFrontendRoute?(0,q.Y)(m.k2,{to:a.url||"",exact:!0,activeClassName:"is-active",children:a.label}):(0,q.Y)("a",{href:a.url,children:a.label})},`${a.label}`):null))},n))({index:a,...e,isFrontendRoute:o(e.url),childs:null==(t=e.childs)?void 0:t.map((e=>"string"==typeof e?e:{...e,isFrontendRoute:o(e.url)}))})}))})]}),(0,q.Y)(c.fv,{md:8,xs:24,children:(0,q.Y)(ne,{align:x.md?"flex-end":"flex-start",settings:n,navbarRight:t,isFrontendRoute:o,environmentTag:i})})]})})}function de({data:e,...a}){const t={...e},n={Data:!0,Security:!0,Manage:!0},l=[],r=[];return t.menu.forEach((e=>{if(!e)return;const a=[],t={...e};e.childs&&(e.childs.forEach((e=>{("string"==typeof e||e.label)&&a.push(e)})),t.childs=a),n.hasOwnProperty(e.name)?r.push(t):l.push(t)})),t.menu=l,t.settings=r,(0,q.Y)(se,{data:t,...a})}},85994:(e,a,t)=>{t.d(a,{A:()=>p});var n=t(96540),l=t(96453),r=t(67073),i=t(2445);const o=l.I4.label`
  cursor: pointer;
  display: inline-block;
  margin-bottom: 0;
