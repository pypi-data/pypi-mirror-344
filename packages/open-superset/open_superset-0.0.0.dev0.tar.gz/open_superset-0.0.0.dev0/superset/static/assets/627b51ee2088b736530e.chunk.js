...
`;var F=n(2445);const z=(0,l.t)("New dataset"),P={text:(0,l.t)("Select a database table and create dataset"),placement:"bottomRight"},R=()=>(0,F.FD)(p.A,{buttonStyle:"primary",tooltip:null==P?void 0:P.text,placement:null==P?void 0:P.placement,disabled:!0,css:E,children:[(0,F.Y)(m.F.SaveOutlined,{iconSize:"m"}),(0,l.t)("Save")]}),N=()=>(0,F.FD)(f.W1,{children:[(0,F.Y)(f.W1.Item,{children:(0,l.t)("Settings")}),(0,F.Y)(f.W1.Item,{children:(0,l.t)("Delete")})]});function O({setDataset:e,title:t=z,editing:n=!1}){const a={title:null!=t?t:z,placeholder:z,onSave:t=>{e({type:h.ChangeDataset,payload:{name:"dataset_name",value:t}})},canEdit:!1,label:(0,l.t)("dataset name")};return(0,F.Y)(k,{children:n?(0,F.Y)(g.U,{editableTitleProps:a,showTitlePanelItems:!1,showFaveStar:!1,faveStarProps:{itemId:1,saveFaveStar:()=>{}},titlePanelAdditionalItems:(0,F.Y)(F.FK,{}),rightPanelAdditionalItems:R(),additionalActionsMenu:N(),menuDropdownProps:{disabled:!0},tooltipProps:P}):(0,F.Y)(I,{children:t||z})})}var L=n(69945),j=n(48327),M=n(71519),W=n(62952),K=n(51003),q=n(50455),H=n(46e3),B=n(5261),V=n(50500),X=n(39854),Q=n(7089),G=n(47163),J=n(19129);const Z=b.I4.div`
  & > span {
    width: 100%;
    display: flex;
...
`;function ie({items:e,renderVisibleItem:t=e=>e,renderTooltipItem:n=e=>e,getKey:i=e=>e,maxLinks:r=20}){const[o,s,d,c]=(0,G.A)(),u=(0,a.useMemo)((()=>e.length>r?e.length-r:void 0),[e,r]),h=(0,a.useMemo)((()=>(0,F.Y)(ee,{ref:o,children:e.map((e=>(0,F.Y)(te,{children:t(e)},i(e))))})),[i,e,t]),g=(0,a.useMemo)((()=>e.slice(0,r).map((e=>(0,F.Y)(ne,{children:n(e)},i(e))))),[i,e,r,n]);return(0,F.Y)(Z,{children:(0,F.FD)(J.m_,{placement:"top",title:d?(0,F.FD)(F.FK,{children:[g,u&&(0,F.Y)("span",{children:(0,l.t)("+ %s more",u)})]}):null,children:[h,c&&(0,F.FD)(ae,{ref:s,children:["+",d]})]})})}const re=e=>({key:e.id,to:`/superset/dashboard/${e.id}`,target:"_blank",rel:"noreferer noopener",children:e.dashboard_title}),le=e=>v.AH`
  color: ${e.colors.grayscale.light5};
  text-decoration: underline;
  &:hover {
    color: inherit;
  }
`,oe=[{key:"slice_name",title:(0,l.t)("Chart"),width:"320px",sorter:!0,render:(e,t)=>(0,F.Y)(M.N_,{to:t.url,children:t.slice_name})},{key:"owners",title:(0,l.t)("Chart owners"),width:"242px",render:(e,t)=>{var n,a;return(0,F.Y)(ie,{items:null!=(n=null==(a=t.owners)?void 0:a.map((e=>`${e.first_name} ${e.last_name}`)))?n:[]})}},{key:"last_saved_at",title:(0,l.t)("Chart last modified"),width:"209px",sorter:!0,defaultSortOrder:"descend",render:(e,t)=>t.last_saved_at?Q.XV.utc(t.last_saved_at).fromNow():null},{key:"last_saved_by.first_name",title:(0,l.t)("Chart last modified by"),width:"216px",sorter:!0,render:(e,t)=>t.last_saved_by?`${t.last_saved_by.first_name} ${t.last_saved_by.last_name}`:null},{key:"dashboards",title:(0,l.t)("Dashboard usage"),width:"420px",render:(e,t)=>(0,F.Y)(ie,{items:t.dashboards,renderVisibleItem:e=>(0,F.Y)(M.N_,{...re(e)}),renderTooltipItem:e=>(0,F.Y)(M.N_,{...re(e),css:le}),getKey:e=>e.id})}],se=e=>v.AH`
  && th.ant-table-cell {
    color: ${e.colors.grayscale.light1};
  }
