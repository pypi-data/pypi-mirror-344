"use strict";(globalThis.webpackChunksuperset=globalThis.webpackChunksuperset||[]).push([[7745],{26526:(e,t,i)=>{i.d(t,{$:()=>o});var n=i(89516),r=i(2445);function o(e){return(0,r.Y)(n.A,{...e})}},31641:(e,t,i)=>{i.d(t,{A:()=>g});var n=i(96453),r=i(17437),o=i(19129),l=i(67073),a=i(2445);const s=(0,n.I4)(o.m_)`
  cursor: pointer;
`,d=n.I4.span`
  display: -webkit-box;
...
`,g=({name:e,label:t,description:i,validationErrors:g=[],renderTrigger:m=!1,rightNode:u,leftNode:b,onClick:f,hovered:v=!1,tooltipOnClick:$=()=>{},warning:x,danger:w})=>{const{gridUnit:y,colors:k}=(0,o.DP)(),F=(0,n.useRef)(!1),I=(0,n.useMemo)((()=>(g.length||(F.current=!0),F.current?g.length?k.error.base:"unset":k.warning.base)),[k.error.base,k.warning.base,g.length]);return t?(0,h.FD)("div",{className:"ControlHeader",children:[(0,h.Y)("div",{className:"pull-left",children:(0,h.FD)(d.lR,{css:e=>r.AH`
            margin-bottom: ${.5*e.gridUnit}px;
            position: relative;
          `,children:[b&&(0,h.Y)("span",{children:b}),(0,h.Y)("span",{role:"button",tabIndex:0,onClick:f,style:{cursor:f?"pointer":""},children:t})," ",x&&(0,h.FD)("span",{children:[(0,h.Y)(s.m_,{id:"error-tooltip",placement:"top",title:x,children:(0,h.Y)(c.F.WarningOutlined,{iconColor:k.warning.base,css:r.AH`
                    vertical-align: baseline;
                  `,iconSize:"s"})})," "]}),w&&(0,h.FD)("span",{children:[(0,h.Y)(s.m_,{id:"error-tooltip",placement:"top",title:w,children:(0,h.Y)(c.F.ExclamationCircleOutlined,{iconColor:k.error.base,iconSize:"s"})})," "]}),(null==g?void 0:g.length)>0&&(0,h.FD)("span",{children:[(0,h.Y)(s.m_,{id:"error-tooltip",placement:"top",title:null==g?void 0:g.join(" "),children:(0,h.Y)(c.F.ExclamationCircleOutlined,{css:r.AH`
                    ${p};
                    color: ${I};
          ...
          white-space: nowrap;
        `,children:[i&&(0,h.FD)("span",{children:[(0,h.Y)(s.m_,{id:"description-tooltip",title:i,placement:"top",children:(0,h.Y)(c.F.InfoCircleOutlined,{css:p,onClick:$})})," "]}),m&&(0,h.FD)("span",{children:[(0,h.Y)(a.W,{label:(0,l.t)("bolt"),tooltip:(0,l.t)("Changing this control takes effect instantly"),placement:"top",icon:"bolt"})," "]})]}):null]})}),u&&(0,h.Y)("div",{className:"pull-right",children:u}),(0,h.Y)("div",{className:"clearfix"})]}):null}},67874:(e,t,i)=>{i.d(t,{JF:()=>a,Mo:()=>s,YH:()=>o,j3:()=>l});var n=i(96453),r=i(86523);const o=0,l=n.I4.div`
...
`,I=({label:e,validationMethods:t,errorMessage:i,helpText:n,required:r=!1,hasTooltip:s=!1,tooltipText:p,id:g,className:m,visibilityToggle:f,get_url:I,description:S,...A})=>(0,v.FD)(w,{className:m,children:[(0,v.FD)(y,{children:[(0,v.Y)(k,{htmlFor:g,required:r,children:e}),s&&(0,v.Y)(d.A,{tooltip:`${p}`})]}),(0,v.FD)(b.A,{css:e=>((e,t)=>o.AH`
...
`)(e,!!i),validateTrigger:Object.keys(t),validateStatus:i?"error":"success",help:i||n,hasFeedback:!!i,children:[f||"password"===A.name?(0,v.Y)(x,{...A,...t,iconRender:e=>e?(0,v.Y)(a.m_,{title:(0,l.t)("Hide password."),children:(0,v.Y)(c.F.EyeInvisibleOutlined,{iconSize:"m",css:F})}):(0,v.Y)(a.m_,{title:(0,l.t)("Show password."),children:(0,v.Y)(c.F.EyeOutlined,{iconSize:"m",css:F})}),role:"textbox"}):(0,v.Y)($,{...A,...t}),I&&S?(0,v.FD)(h.A,{type:"link",htmlType:"button",buttonStyle:"default",onClick:()=>(window.open(I),!0),children:["Get ",S]}):(0,v.Y)("br",{})]})]})}}]);