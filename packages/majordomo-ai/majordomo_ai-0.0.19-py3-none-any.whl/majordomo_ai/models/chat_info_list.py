...
class ChatInfoList(BaseModel):
    ...
    """ # noqa: E501
    chats: Optional[List[ChatInfoResponse]] = Field(default=None, description="The list of chats along with their last updated timestamp.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chats": [ChatInfoResponse.from_dict(_item) for _item in obj["chats"]] if obj.get("chats") is not None else None
        })
        return _obj
