...
class QueryPipelineRun(BaseModel):
    """
    ...
    query_string: StrictStr = Field(description="The query user wants to ask based on the Query Pipeline.")
    __properties: ClassVar[List[str]] = ["workspace", "name", "query_string"]
