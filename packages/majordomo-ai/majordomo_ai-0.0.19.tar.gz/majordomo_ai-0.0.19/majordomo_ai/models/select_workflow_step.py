...
class SelectWorkflowStep(BaseModel):
    """
    ...
    workflows: List[Workflow] = Field(description="Workflow list")
    __properties: ClassVar[List[str]] = ["llm_model_profile", "llm_model_name", "query_params", "workflows"]
