...
class InferenceProfileCommandResponse(BaseModel):
    """
    InferenceProfileCommandResponse
    """ # noqa: E501
    status: StrictBool = Field(description="The result of the inference profile command.")
    message: StrictStr = Field(description="The message returned for the inference profile command operation.")
