...
class TestChunkingStep(unittest.TestCase):
    """ChunkingStep unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChunkingStep:
        """Test ChunkingStep
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChunkingStep`
        """
        model = ChunkingStep()
        if include_optional:
            return ChunkingStep(
