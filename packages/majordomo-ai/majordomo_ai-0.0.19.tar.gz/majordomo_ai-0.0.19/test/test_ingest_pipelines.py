...
class TestIngestPipelines(unittest.TestCase):
    """IngestPipelines unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IngestPipelines:
        """Test IngestPipelines
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IngestPipelines`
        """
        model = IngestPipelines()
        if include_optional:
            return IngestPipelines(
                ingest_pipelines = [
                    majordomo_ai.models.ingest_pipeline_response.Ingest Pipeline Response(
                        created_by = '', 
