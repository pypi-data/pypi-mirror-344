...
class storeErrorLogging():
    ...
    def __init__(self, pathToDB = "../allData/errorLogging.db", includeStackForPrint = True, includeStackForError = True, saveEntireFileContentsAtStart=True, stackLimit = 20):
        '''
        ...
        def saveDatabase( pathToDB ):
            ...
            basedir = importRelative.relativeToAbsolute( pathToDB )
        ...
        def handleRecordingOverallRun(self):    
            currentPath = importRelative.getCurrentFilePath()
        ...
        def setup_logging():
            ...
            def handleFlaskLogging(db_handler):
                ...
                flask_logger.setLevel(logging.DEBUG) #INFO)
                flask_logger.addHandler(db_handler)

                werkzeug_logger = logging.getLogger("werkzeug")
                werkzeug_logger.setLevel(logging.DEBUG) #.INFO)
