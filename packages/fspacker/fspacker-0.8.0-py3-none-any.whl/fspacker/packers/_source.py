...
class SourceResPacker(BasePacker):
    ...
    def pack(self) -> None:
        dest_dir = self.parent.dist_dir / "src"
        source_files = list(file for file in self.parent.project_dir.rglob("*.py") if self._valid_file(file))
        ...
        for source_file in source_files:
            ...
            raise ProjectPackError("未找到入口 Python 文件, 退出")
