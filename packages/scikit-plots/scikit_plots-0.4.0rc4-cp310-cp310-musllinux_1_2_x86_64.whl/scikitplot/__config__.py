...
CONFIG = _cleanup(
  {
    "Build Dependencies": {
      "blas": {
        ...
        "include directory": r"/opt/_internal/cpython-3.10.17/lib/python3.10/site-packages/scipy_openblas64/include",
        "lib directory": r"/opt/_internal/cpython-3.10.17/lib/python3.10/site-packages/scipy_openblas64/lib",
    ...
    "Python Information": {
      "path": r"/tmp/build-env-72h94115/bin/python",
      "version": "3.10",
    },
  }
)
