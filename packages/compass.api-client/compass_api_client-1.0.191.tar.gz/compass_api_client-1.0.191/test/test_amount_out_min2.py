...
class TestAmountOutMin2(unittest.TestCase):
    """AmountOutMin2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AmountOutMin2:
        """Test AmountOutMin2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AmountOutMin2`
        """
        model = AmountOutMin2()
        if include_optional:
            return AmountOutMin2(
            )
        else:
            return AmountOutMin2(
        )
