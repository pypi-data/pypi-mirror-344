...
class TestAmount0Desired1(unittest.TestCase):
    """Amount0Desired1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Amount0Desired1:
        """Test Amount0Desired1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Amount0Desired1`
        """
        model = Amount0Desired1()
        if include_optional:
            return Amount0Desired1(
            )
        else:
            return Amount0Desired1(
        )
