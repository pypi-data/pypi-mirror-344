...
class TestMulticallAction(unittest.TestCase):
    """MulticallAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MulticallAction:
        """Test MulticallAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MulticallAction`
        """
        model = MulticallAction()
        if include_optional:
