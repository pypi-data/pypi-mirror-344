...
class TestSignedAuthorization(unittest.TestCase):
    """SignedAuthorization unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SignedAuthorization:
        """Test SignedAuthorization
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SignedAuthorization`
        """
        model = SignedAuthorization()
        if include_optional:
    ...
    def testSignedAuthorization(self):
        """Test SignedAuthorization"""
