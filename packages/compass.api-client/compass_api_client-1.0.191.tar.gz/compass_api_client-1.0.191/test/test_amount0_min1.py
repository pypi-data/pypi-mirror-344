...
class TestAmount0Min1(unittest.TestCase):
    """Amount0Min1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Amount0Min1:
        """Test Amount0Min1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Amount0Min1`
        """
        model = Amount0Min1()
        if include_optional:
            return Amount0Min1(
