...
class TestMulticallAuthorizationRequest(unittest.TestCase):
    """MulticallAuthorizationRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MulticallAuthorizationRequest:
        """Test MulticallAuthorizationRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MulticallAuthorizationRequest`
        """
        model = MulticallAuthorizationRequest()
        if include_optional:
            return MulticallAuthorizationRequest(
                chain = 'base:mainnet',
    ...
    def testMulticallAuthorizationRequest(self):
        """Test MulticallAuthorizationRequest"""
