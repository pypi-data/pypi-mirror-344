...
class TestAaveWithdrawParams(unittest.TestCase):
    """AaveWithdrawParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveWithdrawParams:
        """Test AaveWithdrawParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveWithdrawParams`
        """
        model = AaveWithdrawParams()
        if include_optional:
            return AaveWithdrawParams(
                asset = '1INCH',
                amount = None,
                recipient = ''
            )
    ...
    def testAaveWithdrawParams(self):
        """Test AaveWithdrawParams"""
