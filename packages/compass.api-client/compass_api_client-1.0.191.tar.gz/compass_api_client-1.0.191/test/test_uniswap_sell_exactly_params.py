...
class TestUniswapSellExactlyParams(unittest.TestCase):
    """UniswapSellExactlyParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapSellExactlyParams:
        """Test UniswapSellExactlyParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapSellExactlyParams`
        """
        model = UniswapSellExactlyParams()
        if include_optional:
            return UniswapSellExactlyParams(
                token_in = '1INCH',
                token_out = '1INCH',
                fee = '0.01',
                amount_in = None,
    ...
    def testUniswapSellExactlyParams(self):
        """Test UniswapSellExactlyParams"""
