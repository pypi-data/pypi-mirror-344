...
class TestUniswapPositionsSolidityResponse(unittest.TestCase):
    """UniswapPositionsSolidityResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapPositionsSolidityResponse:
        """Test UniswapPositionsSolidityResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapPositionsSolidityResponse`
        """
        model = UniswapPositionsSolidityResponse()
        if include_optional:
            return UniswapPositionsSolidityResponse(
                nonce = 56,
                operator = '',
                token0 = '',
                token1 = '',
    ...
    def testUniswapPositionsSolidityResponse(self):
        """Test UniswapPositionsSolidityResponse"""
