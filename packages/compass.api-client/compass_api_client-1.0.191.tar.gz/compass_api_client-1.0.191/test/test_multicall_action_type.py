...
class TestMulticallActionType(unittest.TestCase):
    """MulticallActionType unit test stubs"""
    ...
    def testMulticallActionType(self):
        """Test MulticallActionType"""
        # inst = MulticallActionType()
