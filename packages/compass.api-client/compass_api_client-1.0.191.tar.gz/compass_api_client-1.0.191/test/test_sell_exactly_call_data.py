...
class TestSellExactlyCallData(unittest.TestCase):
    """SellExactlyCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SellExactlyCallData:
        """Test SellExactlyCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SellExactlyCallData`
        """
        model = SellExactlyCallData()
        if include_optional:
            return SellExactlyCallData(
                token_in = '1INCH',
                token_out = '1INCH',
                fee = '0.01',
                amount_in = None,
    ...
    def testSellExactlyCallData(self):
        """Test SellExactlyCallData"""
