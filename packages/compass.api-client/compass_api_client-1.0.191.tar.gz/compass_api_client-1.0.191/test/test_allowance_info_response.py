...
class TestAllowanceInfoResponse(unittest.TestCase):
    """AllowanceInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllowanceInfoResponse:
        """Test AllowanceInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllowanceInfoResponse`
        """
        model = AllowanceInfoResponse()
        if include_optional:
    ...
    def testAllowanceInfoResponse(self):
        """Test AllowanceInfoResponse"""
