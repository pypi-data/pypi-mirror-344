...
class TestBalanceInfoResponse(unittest.TestCase):
    """BalanceInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceInfoResponse:
        """Test BalanceInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceInfoResponse`
        """
        model = BalanceInfoResponse()
        if include_optional:
    ...
    def testBalanceInfoResponse(self):
        """Test BalanceInfoResponse"""
