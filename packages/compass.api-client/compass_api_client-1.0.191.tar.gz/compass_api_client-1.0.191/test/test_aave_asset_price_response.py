...
class TestAaveAssetPriceResponse(unittest.TestCase):
    """AaveAssetPriceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveAssetPriceResponse:
        """Test AaveAssetPriceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveAssetPriceResponse`
        """
        model = AaveAssetPriceResponse()
        if include_optional:
            return AaveAssetPriceResponse(
                price = ''
            )
        else:
            return AaveAssetPriceResponse(
    ...
    def testAaveAssetPriceResponse(self):
        """Test AaveAssetPriceResponse"""
