...
class TestCompassApiBackendModelsUniswapResponsePosition(unittest.TestCase):
    """CompassApiBackendModelsUniswapResponsePosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompassApiBackendModelsUniswapResponsePosition:
        """Test CompassApiBackendModelsUniswapResponsePosition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompassApiBackendModelsUniswapResponsePosition`
        """
        model = CompassApiBackendModelsUniswapResponsePosition()
        if include_optional:
            return CompassApiBackendModelsUniswapResponsePosition(
                nonce = 56,
                operator = '',
                token0 = '1INCH',
                token1 = '1INCH',
    ...
    def testCompassApiBackendModelsUniswapResponsePosition(self):
        """Test CompassApiBackendModelsUniswapResponsePosition"""
