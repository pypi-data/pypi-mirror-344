...
class TestUniswapBuyExactlyParams(unittest.TestCase):
    """UniswapBuyExactlyParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapBuyExactlyParams:
        """Test UniswapBuyExactlyParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapBuyExactlyParams`
        """
        model = UniswapBuyExactlyParams()
        if include_optional:
            return UniswapBuyExactlyParams(
                token_in = '1INCH',
                token_out = '1INCH',
                fee = '0.01',
                amount_out = None,
    ...
    def testUniswapBuyExactlyParams(self):
        """Test UniswapBuyExactlyParams"""
