...
class TestTransferEthCallData(unittest.TestCase):
    """TransferEthCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransferEthCallData:
        """Test TransferEthCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransferEthCallData`
        """
        model = TransferEthCallData()
        if include_optional:
            return TransferEthCallData(
                amount = None,
                to = ''
            )
        else:
    ...
    def testTransferEthCallData(self):
        """Test TransferEthCallData"""
