...
class TestAaveUserPositionPerTokenResponse(unittest.TestCase):
    """AaveUserPositionPerTokenResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveUserPositionPerTokenResponse:
        """Test AaveUserPositionPerTokenResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveUserPositionPerTokenResponse`
        """
        model = AaveUserPositionPerTokenResponse()
        if include_optional:
            return AaveUserPositionPerTokenResponse(
                token_balance = '',
                stable_debt = '',
                variable_debt = '',
    ...
    def testAaveUserPositionPerTokenResponse(self):
        """Test AaveUserPositionPerTokenResponse"""
