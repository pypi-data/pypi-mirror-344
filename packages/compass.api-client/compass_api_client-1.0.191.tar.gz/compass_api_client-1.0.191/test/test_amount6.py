...
class TestAmount6(unittest.TestCase):
    """Amount6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Amount6:
        """Test Amount6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Amount6`
        """
        model = Amount6()
        if include_optional:
            return Amount6(
