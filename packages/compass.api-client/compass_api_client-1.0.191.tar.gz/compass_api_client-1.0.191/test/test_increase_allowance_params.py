...
class TestIncreaseAllowanceParams(unittest.TestCase):
    """IncreaseAllowanceParams unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncreaseAllowanceParams:
        """Test IncreaseAllowanceParams
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncreaseAllowanceParams`
        """
        model = IncreaseAllowanceParams()
        if include_optional:
    ...
    def testIncreaseAllowanceParams(self):
        """Test IncreaseAllowanceParams"""
