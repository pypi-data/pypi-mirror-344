...
class TestAmount7(unittest.TestCase):
    """Amount7 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Amount7:
        """Test Amount7
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Amount7`
        """
        model = Amount7()
        if include_optional:
            return Amount7(
