...
class TestEnsNameInfoResponse(unittest.TestCase):
    """EnsNameInfoResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EnsNameInfoResponse:
        """Test EnsNameInfoResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EnsNameInfoResponse`
        """
        model = EnsNameInfoResponse()
        if include_optional:
            return EnsNameInfoResponse(
                wallet_address = '',
                registrant = ''
            )
        else:
    ...
    def testEnsNameInfoResponse(self):
        """Test EnsNameInfoResponse"""
