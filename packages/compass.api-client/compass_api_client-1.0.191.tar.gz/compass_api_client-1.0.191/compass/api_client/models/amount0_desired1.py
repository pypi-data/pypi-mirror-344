...
AMOUNT0DESIRED1_ANY_OF_SCHEMAS = ["float", "str"]

class Amount0Desired1(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = Amount0Desired1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Amount0Desired1 with anyOf schemas: float, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Amount0Desired1 with anyOf schemas: float, str. Details: " + ", ".join(error_messages))
        else:
            return instance
