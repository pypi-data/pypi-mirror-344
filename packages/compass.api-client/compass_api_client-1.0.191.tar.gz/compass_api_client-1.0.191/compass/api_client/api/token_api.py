...
class TokenApi:
    ...
    def token_address(
        ...
        _param = self._token_address_serialize(
    ...
    @validate_call
    def token_address_with_http_info(
        self,
        address_request: AddressRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def token_address_without_preload_content(
        self,
        address_request: AddressRequest,
        _request_timeout: Union[
            None,
    ...
    def _token_address_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v0/token/address/get',
