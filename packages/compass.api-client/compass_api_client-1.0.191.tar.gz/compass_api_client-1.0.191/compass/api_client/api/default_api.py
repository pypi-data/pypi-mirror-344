...
class DefaultApi:
    ...
    def login_page_auth_login_get(
        ...
        _param = self._login_page_auth_login_get_serialize(
    ...
    @validate_call
    def login_page_auth_login_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def login_page_auth_login_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _login_page_auth_login_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
