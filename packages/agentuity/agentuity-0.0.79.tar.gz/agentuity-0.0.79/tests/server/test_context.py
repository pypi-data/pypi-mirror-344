...
class TestAgentContext:
    ...
    @pytest.fixture
    def agent_context(self, mock_services, mock_logger, mock_tracer, mock_agent, mock_agents_by_id):
    ...
    def test_init(self, agent_context, mock_services, mock_logger, mock_tracer, mock_agent):
    ...
    def test_environment_variables(self):
        ...
        with patch('agentuity.server.context.create_logger'), \
    ...
    def test_environment_variables_defaults(self, mock_services, mock_logger, mock_tracer, mock_agent, mock_agents_by_id):
