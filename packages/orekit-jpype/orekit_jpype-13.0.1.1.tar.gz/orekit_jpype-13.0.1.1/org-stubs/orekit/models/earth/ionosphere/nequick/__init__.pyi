...
class NeQuickModel(org.orekit.models.earth.ionosphere.IonosphericModel):
    ...
    """
    _electronDensity_1__T = typing.TypeVar('_electronDensity_1__T', bound=org.hipparchus.CalculusFieldElement)  # <T>
    @typing.overload
    def electronDensity(self, dateTimeComponents: org.orekit.time.DateTimeComponents, double: float, double2: float, double3: float, double4: float) -> float:
        ...
        ...
    @typing.overload
    def electronDensity(self, dateTimeComponents: org.orekit.time.DateTimeComponents, t: _electronDensity_1__T, t2: _electronDensity_1__T, t3: _electronDensity_1__T, t4: _electronDensity_1__T) -> _electronDensity_1__T:
        """
            Computes the electron density at a given height.
