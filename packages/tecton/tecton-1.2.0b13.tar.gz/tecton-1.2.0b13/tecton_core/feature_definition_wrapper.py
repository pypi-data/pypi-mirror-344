...
class FeatureDefinitionWrapper:
    ...
    @property
    def partial_aggregate_compaction_online_group_by_columns(self) -> List[str]:
        """
        ...
        This is used only for compaction-enabled Feature Views
        """
        if not self.is_temporal_aggregate:
    ...
    def partial_aggregate_group_by_columns(self) -> List[str]:
        ...
        aggregation secondary key if configured.
        """
        group_by_columns = self.partial_aggregate_compaction_online_group_by_columns
