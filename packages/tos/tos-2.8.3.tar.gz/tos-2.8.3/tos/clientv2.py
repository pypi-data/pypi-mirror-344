...
class TosClientV2(TosClient):
    ...
    def delete_object(self, bucket: str, key: str, version_id: str = None, recursive: bool = None, generic_input: GenericInput = None):
        """删除对象
    ...
    def delete_multi_objects(self, bucket: str, objects: [], quiet: bool = False, recursive: bool  = None, generic_input: GenericInput = None):
        """批量删除对象
