...
from libs.bl616d.bootheader_cfg_keys import bootheader_cfg_keys as flash_cfg_keys
...
def create_flashcfg_table(start_addr):
    ...
    table_file = os.path.join(app_path, "utils", "flash", "bl616d", "flashcfg_list.csv")
    with open(table_file, "r", encoding="utf-8-sig") as csvfile:
        ...
        for cfgfile in cfgfile_list:
            cfgfile = os.path.join(app_path, "utils", "flash", "bl616d", cfgfile)
