...
if not conf_sign:
    ...
    list_chip_no_encrypt = ["BL808", "BL606P", "BL616/618", "BL628", "BL702L/704L", "BL616L", "BL616D"]
...
# BL616L
xtal_type["bl616l"] = ["None", "24M", "32M", "38.4M", "40M", "26M", "RC32M", "Auto"]
xtal_type_["bl616l"] = ["XTAL_" + item for item in xtal_type["bl616l"]]
pll_clk["bl616l"] = ["WIFIPLL 320M", "Manual"]
encrypt_type["bl616l"] = [
    "None",
    "AES CTR128",
    "AES CTR256",
...
key_sel["bl616l"] = ["0", "1", "2", "3"]
sign_type["bl616l"] = ["None", "ECC"]
cache_way_disable["bl616l"] = ["None", "OneWay", "TwoWay", "ThreeWay", "FourWay"]
flash_clk_type["bl616l"] = ["XTAL", "Manual"]
crc_ignore["bl616l"] = ["False", "True"]
hash_ignore["bl616l"] = ["False", "True"]
img_type["bl616l"] = ["SingleCPU", "RAW"]
boot_src["bl616l"] = ["Flash", "UART/USB"]

# BL616D
xtal_type["bl616d"] = ["None", "24M", "32M", "38.4M", "40M", "26M", "RC32M", "Auto"]
xtal_type_["bl616d"] = ["XTAL_" + item for item in xtal_type["bl616l"]]
pll_clk["bl616d"] = ["WIFIPLL 320M", "Manual"]
encrypt_type["bl616d"] = [
    "None",
    "AES CTR128",
    "AES CTR256",
...
key_sel["bl616d"] = ["0", "1", "2", "3"]
sign_type["bl616d"] = ["None", "ECC"]
cache_way_disable["bl616d"] = ["None", "OneWay", "TwoWay", "ThreeWay", "FourWay"]
flash_clk_type["bl616d"] = ["XTAL", "Manual"]
crc_ignore["bl616d"] = ["False", "True"]
hash_ignore["bl616d"] = ["False", "True"]
img_type["bl616d"] = ["SingleCPU", "RAW"]
boot_src["bl616d"] = ["Flash", "UART/USB"]
