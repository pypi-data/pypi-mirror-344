...
from sureverify import Verify, AsyncVerify, APIResponseValidationError
from sureverify._types import Omit
from sureverify._models import BaseModel, FinalRequestOptions
from sureverify._exceptions import VerifyError, APIResponseValidationError
from sureverify._base_client import (
    DEFAULT_TIMEOUT,
...
class TestVerify:
    client = Verify(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "sureverify/_legacy_response.py",
                        "sureverify/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "sureverify/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(VerifyError):
            with update_env(**{"VERIFY_BEARER_TOKEN": Omit()}):
                client2 = Verify(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Verify) -> None:
        request = client._build_request(
    ...
    def test_base_url_env(self) -> None:
        with update_env(VERIFY_BASE_URL="http://localhost:5000/from/env"):
            client = Verify(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: Verify) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Verify) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Verify) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Verify(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Verify(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    @mock.patch("sureverify._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/api/v1/addresses").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: Verify, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.addresses.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.addresses.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncVerify:
    client = AsyncVerify(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(VerifyError):
            with update_env(**{"VERIFY_BEARER_TOKEN": Omit()}):
                client2 = AsyncVerify(base_url=base_url, bearer_token=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, async_client: AsyncVerify) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(VERIFY_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncVerify(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncVerify) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncVerify) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncVerify) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncVerify(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncVerify(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.addresses.with_raw_response.list()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncVerify, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.addresses.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.addresses.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
    ...
    def test_get_platform(self) -> None:
        ...
        from sureverify._utils import asyncify
        from sureverify._base_client import get_platform
