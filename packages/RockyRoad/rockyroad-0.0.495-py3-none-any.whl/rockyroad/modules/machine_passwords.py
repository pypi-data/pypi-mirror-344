...
class Machine_Passwords(Consumer):
    ...
    @returns.json
    @json
    @post("machine-passwords/generate")
    def generate(self, machine_password_request: Body):
        """This call will generate a new password for the specified machine."""

    @returns.json
    @json
    @post("machine-passwords/verify")
    def verify(self, machine_password_request: Body):
    ...
    class _Requests(Consumer):
        ...
        @returns.json
        @http_get("machine-passwords/requests")
        def list(self):
            """This call will return a list of machine password requests."""

        @returns.json
        @json
        @post("machine-passwords/requests")
        ...
        @delete("machine-passwords/requests/{uid}")
