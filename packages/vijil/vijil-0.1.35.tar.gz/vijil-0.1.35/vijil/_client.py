...
class Evaluations:
    ...
    def create(
        ...
        :param harness_params: Set optional parameters, defaults to {}
        ...
        if "trust_score" in harnesses:
            ...
            harnesses_modified = []
            for h in harnesses:
                if h in DIMENSION_LIST:
                    harnesses_modified.append(f"{h}_Small")
                else:
                    harnesses_modified.append(h)
