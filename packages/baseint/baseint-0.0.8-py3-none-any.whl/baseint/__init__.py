...
class BaseInt:
    ...
    """
    def __init__(self,values,base=10,forceUpper=False,charmap=CHARMAP):
    ...
    def toDecimal(self):
        ...
        return result
    @staticmethod
    def dec2base(n,base,charmap=CHARMAP):
        ...
        while n>0:
            ...
            n//=base
        res.reverse()
        return BaseInt(res,base,charmap=charmap)
    def sconvert(self,base):
        """Returns a new BaseInt converted to the new base."""
        dec=self.toDecimal()
        return BaseInt.dec2base(dec,base,charmap=self.charmap)
