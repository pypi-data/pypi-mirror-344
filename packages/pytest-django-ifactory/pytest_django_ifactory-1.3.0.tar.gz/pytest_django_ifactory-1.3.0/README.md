...
This project uses [ruff][] to lint and format the code, [mypy][] to
type check it, [pytest][] to test it, and finally [check-manifest][]
to check the project's [MANIFEST.in](MANIFEST.in). To facilitate (and
...
Gitlab CI is configured to run the tests with Python 3.9-3.13 and all
