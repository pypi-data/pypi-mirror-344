...
def comm_protocol_encode(prog_list, config: CommProtocolConfig = ...) -> bytes:
    """comm_protocol_encode(prog_list: list[QPanda3::QProg], config: utils.utils.CommProtocolConfig = <utils.utils.CommProtocolConfig object at 0x000001FC79C8B9F0>) -> bytes
