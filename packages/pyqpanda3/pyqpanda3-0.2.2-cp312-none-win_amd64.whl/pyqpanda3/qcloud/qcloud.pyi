...
class QCloudBackend:
    ...
    def expval_hamiltonian(self, prog, hamiltonian, shots: int = ..., noise_model: QCloudNoiseModel = ...) -> float:
        ...
        1. expval_hamiltonian(self: qcloud.qcloud.QCloudBackend, prog: QPanda3::QProg, hamiltonian: QPanda3::Hamiltonian, shots: int = 1000, noise_model: qcloud.qcloud.QCloudNoiseModel = <qcloud.qcloud.QCloudNoiseModel object at 0x000001C44260DC30>) -> float
    ...
    def expval_pauli_operator(self, prog, pauli_operator, shots: int = ..., noise_model: QCloudNoiseModel = ...) -> float:
        ...
        1. expval_pauli_operator(self: qcloud.qcloud.QCloudBackend, prog: QPanda3::QProg, pauli_operator: QPanda3::PauliOperator, shots: int = 1000, noise_model: qcloud.qcloud.QCloudNoiseModel = <qcloud.qcloud.QCloudNoiseModel object at 0x000001C441BD6D30>) -> float
    ...
    def run(self, prog, shots: int, model: QCloudNoiseModel = ...) -> QCloudJob:
        ...
        1. run(self: qcloud.qcloud.QCloudBackend, prog: QPanda3::QProg, shots: int, model: qcloud.qcloud.QCloudNoiseModel = <qcloud.qcloud.QCloudNoiseModel object at 0x000001C44260D8F0>) -> qcloud.qcloud.QCloudJob
