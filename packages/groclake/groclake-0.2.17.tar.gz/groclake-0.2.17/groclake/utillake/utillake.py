            ...
            system_prompt = f"""
                          ...
                          ### **Guidelines for Query Rewriting**
                            ...
                            9. **Language Consistency**:
                               - Always rewrite the query in the **same language** as the user’s input.
                            10. **Analyze Past Conversations**:  
                               ...
                               - Example:  
                                ...
                                - ** Hinglish **
                                - Previous: "Mera order kab aayega?"
                                - Current: "Usse cancel kar do"
                                - Rewritten: "Mera order jo track ho raha tha usse cancel kar do."

                                - ** Marathi **
                                - Previous: "माझं ऑर्डर कधी येणार?"
                                - Current: "ते रद्द कर"
                                - Rewritten: "माझं ऑर्डर जे येणार होतं ते रद्द कर.

                                - ** Hindi **
                                - Current: "मुझे अपना ऑर्डर रद्द करना है।"
                                - Rewritten: "मुझे अपना ऑर्डर रद्द करना है।".                         
                          """
