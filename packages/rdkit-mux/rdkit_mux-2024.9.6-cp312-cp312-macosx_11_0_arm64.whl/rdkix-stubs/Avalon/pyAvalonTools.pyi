...
def GetAvalonCountFP(molData: str, isSmiles: bool, nBits: int = 512, isQuery: bool = False, bitFlags: int = 15761407) -> typing.Any:
    """
        ...
        C++ signature :
            RDKix::SparseIntVect<unsigned int>* GetAvalonCountFP(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>,bool [,unsigned int=512 [,bool=False [,unsigned int=15761407]]])
    """
@typing.overload
...
def GetCanonSmiles(mol: typing.Any, flags: int = -1) -> str:
    """
        ...
        C++ signature :
            std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> GetCanonSmiles(RDKix::ROMol {lvalue} [,int=-1])
    """
@typing.overload
