...
class Coulomb(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeCharge: float = 1.0, absVal: bool = False, chargeKey: str = '_GasteigerCharge', softcoreParam: float = 0.0, cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(_object*,RDKix::ROMol [,int=-1 [,double=1.0 [,bool=False [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>='_GasteigerCharge' [,double=0.0 [,double=1.0]]]]]])
        """
    @typing.overload
...
class CoulombDielectric(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeCharge: float = 1.0, absVal: bool = False, chargeKey: str = '_GasteigerCharge', softcoreParam: float = 0.0, cutoff: float = 1.0, epsilon: float = 80.0, xi: float = 4.0) -> None:
        """
            ...
            C++ signature :
                void __init__(_object*,RDKix::ROMol [,int=-1 [,double=1.0 [,bool=False [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>='_GasteigerCharge' [,double=0.0 [,double=1.0 [,double=80.0 [,double=4.0]]]]]]]])
        """
    @typing.overload
...
class HBond(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeAtomType: str = 'OH', fixed: bool = True, cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(_object*,RDKix::ROMol {lvalue} [,int=-1 [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>='OH' [,bool=True [,double=1.0]]]])
        """
class Hydrophilic(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, fixed: bool = True, cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(_object*,RDKix::ROMol {lvalue} [,int=-1 [,bool=True [,double=1.0]]])
        """
class MMFFVdWaals(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeAtomType: int = 6, scaling: bool = False, cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(_object*,RDKix::ROMol [,int=-1 [,unsigned int=6 [,bool=False [,double=1.0]]]])
        """
class UFFVdWaals(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeAtomType: str = 'O_3', cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(_object*,RDKix::ROMol [,int=-1 [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>='O_3' [,double=1.0]]])
        """
@typing.overload
...
def ConstructGrid(mol: Mol, confId: int = -1, margin: float = 5.0, spacing: float = 0.5) -> UniformRealValueGrid3D:
    """
        ...
        C++ signature :
            RDGeom::UniformRealValueGrid3D* ConstructGrid(RDKix::ROMol [,int=-1 [,double=5.0 [,double=0.5]]])
    """
...
def WriteToCubeFile(grid: UniformRealValueGrid3D, filename: str, mol: Mol = None, confId: int = -1) -> None:
    """
        ...
        C++ signature :
            void WriteToCubeFile(RDGeom::UniformRealValueGrid3D,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> [,RDKix::ROMol const*=None [,int=-1]])
    """
