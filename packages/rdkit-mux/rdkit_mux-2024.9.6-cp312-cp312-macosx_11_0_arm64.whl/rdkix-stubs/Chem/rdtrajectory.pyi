...
class Snapshot(Boost.Python.instance):
    ...
    def GetEnergy(self) -> float:
        """
            ...
            C++ signature :
                double GetEnergy(RDKix::Snapshot {lvalue})
        """
    def GetPoint2D(self, pointNum: int) -> Point2D:
        """
            ...
            C++ signature :
                RDGeom::Point2D GetPoint2D(RDKix::Snapshot {lvalue},unsigned int)
        """
    def GetPoint3D(self, pointNum: int) -> Point3D:
        """
            ...
            C++ signature :
                RDGeom::Point3D GetPoint3D(RDKix::Snapshot {lvalue},unsigned int)
        """
    def SetEnergy(self, energy: float) -> None:
        """
            ...
            C++ signature :
                void SetEnergy(RDKix::Snapshot {lvalue},double)
        """
    @typing.overload
    ...
    def __init__(self, other: Snapshot) -> typing.Any:
        """
            ...
            C++ signature :
                void* __init__(boost::python::api::object,RDKix::Snapshot*)
        """
class Trajectory(Boost.Python.instance):
    ...
    def AddConformersToMol(self, mol: Mol, fromCid: int = -1, toCid: int = -1) -> int:
        """
            ...
            C++ signature :
                unsigned int AddConformersToMol(RDKix::Trajectory {lvalue},RDKix::ROMol {lvalue} [,int=-1 [,int=-1]])
        """
    def AddSnapshot(self, s: Snapshot) -> int:
        """
            ...
            C++ signature :
                unsigned int AddSnapshot(RDKix::Trajectory {lvalue},RDKix::Snapshot)
        """
    def Clear(self) -> None:
        """
            ...
            C++ signature :
                void Clear(RDKix::Trajectory {lvalue})
        """
    def Dimension(self) -> int:
        """
            ...
            C++ signature :
                unsigned int Dimension(RDKix::Trajectory {lvalue})
        """
    def GetSnapshot(self, snapshotNum: int) -> Snapshot:
        """
            ...
            C++ signature :
                RDKix::Snapshot* GetSnapshot(RDKix::Trajectory*,unsigned int)
        """
    def InsertSnapshot(self, snapshotNum: int, s: Snapshot) -> int:
        """
            ...
            C++ signature :
                unsigned int InsertSnapshot(RDKix::Trajectory {lvalue},unsigned int,RDKix::Snapshot)
        """
    def NumPoints(self) -> int:
        """
            ...
            C++ signature :
                unsigned int NumPoints(RDKix::Trajectory {lvalue})
        """
    def RemoveSnapshot(self, snapshotNum: int) -> int:
        """
            ...
            C++ signature :
                unsigned int RemoveSnapshot(RDKix::Trajectory {lvalue},unsigned int)
        """
    @typing.overload
    ...
    def __init__(self, other: Trajectory) -> typing.Any:
        """
            ...
            C++ signature :
                void* __init__(boost::python::api::object,RDKix::Trajectory*)
        """
    def __len__(self) -> int:
        """
            C++ signature :
                unsigned long __len__(RDKix::Trajectory {lvalue})
        """
def ReadAmberTrajectory(fName: str, traj: Trajectory) -> int:
    """
        ...
        C++ signature :
            unsigned int ReadAmberTrajectory(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>,RDKix::Trajectory {lvalue})
    """
def ReadGromosTrajectory(fName: str, traj: Trajectory) -> int:
    """
        ...
        C++ signature :
            unsigned int ReadGromosTrajectory(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>,RDKix::Trajectory {lvalue})
    """
