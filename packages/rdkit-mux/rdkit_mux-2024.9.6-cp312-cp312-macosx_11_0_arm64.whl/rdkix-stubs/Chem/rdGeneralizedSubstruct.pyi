...
class ExtendedQueryMol(Boost.Python.instance):
    ...
    def InitFromBinary(self, pkl: str) -> None:
        """
            C++ signature :
                void InitFromBinary(RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue},std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
        """
    def InitFromJSON(self, text: str) -> None:
        """
            C++ signature :
                void InitFromJSON(RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue},std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
        """
    def PatternFingerprintQuery(self, fingerprintSize: int = 2048) -> typing.Any:
        """
            C++ signature :
                std::__1::unique_ptr<ExplicitBitVect, std::__1::default_delete<ExplicitBitVect>> PatternFingerprintQuery(RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue} [,unsigned int=2048])
        """
    def ToBinary(self) -> typing.Any:
        """
            C++ signature :
                boost::python::api::object ToBinary(RDKix::GeneralizedSubstruct::ExtendedQueryMol)
        """
    def ToJSON(self) -> str:
        """
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> ToJSON(RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue})
        """
...
def CreateExtendedQueryMol(mol: Mol, doEnumeration: bool = True, doTautomers: bool = True, adjustQueryProperties: bool = False, adjustQueryParameters: AdjustQueryParameters = None) -> ExtendedQueryMol:
    """
        ...
        C++ signature :
            RDKix::GeneralizedSubstruct::ExtendedQueryMol* CreateExtendedQueryMol(RDKix::ROMol [,bool=True [,bool=True [,bool=False [,RDKix::MolOps::AdjustQueryParameters*=None]]]])
    """
def MolGetSubstructMatch(mol: Mol, query: ExtendedQueryMol, params: SubstructMatchParameters = None) -> typing.Any:
    """
        ...
        C++ signature :
            _object* MolGetSubstructMatch(RDKix::ROMol,RDKix::GeneralizedSubstruct::ExtendedQueryMol [,RDKix::SubstructMatchParameters*=None])
    """
def MolGetSubstructMatches(mol: Mol, query: ExtendedQueryMol, params: SubstructMatchParameters = None) -> typing.Any:
    """
        ...
        C++ signature :
            _object* MolGetSubstructMatches(RDKix::ROMol,RDKix::GeneralizedSubstruct::ExtendedQueryMol [,RDKix::SubstructMatchParameters*=None])
    """
def MolHasSubstructMatch(mol: Mol, query: ExtendedQueryMol, params: SubstructMatchParameters = None) -> bool:
    """
        ...
        C++ signature :
            bool MolHasSubstructMatch(RDKix::ROMol,RDKix::GeneralizedSubstruct::ExtendedQueryMol [,RDKix::SubstructMatchParameters*=None])
    """
def PatternFingerprintTarget(target: Mol, fingerprintSize: int = 2048) -> typing.Any:
    """
        ...
        C++ signature :
            std::__1::unique_ptr<ExplicitBitVect, std::__1::default_delete<ExplicitBitVect>> PatternFingerprintTarget(RDKix::ROMol [,unsigned int=2048])
    """
