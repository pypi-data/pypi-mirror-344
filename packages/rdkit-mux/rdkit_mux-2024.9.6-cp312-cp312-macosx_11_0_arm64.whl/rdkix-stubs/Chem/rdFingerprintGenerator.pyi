...
class AdditionalOutput(Boost.Python.instance):
    ...
    def AllocateAtomCounts(self) -> None:
        """
            ...
            C++ signature :
                void AllocateAtomCounts(RDKix::AdditionalOutput {lvalue})
        """
    def AllocateAtomToBits(self) -> None:
        """
            ...
            C++ signature :
                void AllocateAtomToBits(RDKix::AdditionalOutput {lvalue})
        """
    def AllocateBitInfoMap(self) -> None:
        """
            ...
            C++ signature :
                void AllocateBitInfoMap(RDKix::AdditionalOutput {lvalue})
        """
    def AllocateBitPaths(self) -> None:
        """
            ...
            C++ signature :
                void AllocateBitPaths(RDKix::AdditionalOutput {lvalue})
        """
    def CollectAtomCounts(self) -> None:
        """
            ...
            C++ signature :
                void CollectAtomCounts(RDKix::AdditionalOutput {lvalue})
        """
    def CollectAtomToBits(self) -> None:
        """
            ...
            C++ signature :
                void CollectAtomToBits(RDKix::AdditionalOutput {lvalue})
        """
    def CollectBitInfoMap(self) -> None:
        """
            ...
            C++ signature :
                void CollectBitInfoMap(RDKix::AdditionalOutput {lvalue})
        """
    def CollectBitPaths(self) -> None:
        """
            ...
            C++ signature :
                void CollectBitPaths(RDKix::AdditionalOutput {lvalue})
        """
    def GetAtomCounts(self) -> typing.Any:
        """
            C++ signature :
                boost::python::api::object GetAtomCounts(RDKix::AdditionalOutput)
        """
    def GetAtomToBits(self) -> typing.Any:
        """
            C++ signature :
                boost::python::api::object GetAtomToBits(RDKix::AdditionalOutput)
        """
    def GetBitInfoMap(self) -> typing.Any:
        """
            C++ signature :
                boost::python::api::object GetBitInfoMap(RDKix::AdditionalOutput)
        """
    def GetBitPaths(self) -> typing.Any:
        """
            C++ signature :
                boost::python::api::object GetBitPaths(RDKix::AdditionalOutput)
        """
...
class FingerprintGenerator32(Boost.Python.instance):
    ...
    def GetCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> UIntSparseIntVect:
        """
            ...
            C++ signature :
                RDKix::SparseIntVect<unsigned int>* GetCountFingerprint(RDKix::FingerprintGenerator<unsigned int> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            ...
            C++ signature :
                boost::python::api::object GetCountFingerprintAsNumPy(RDKix::FingerprintGenerator<unsigned int> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            ...
            C++ signature :
                boost::python::tuple GetCountFingerprints(RDKix::FingerprintGenerator<unsigned int> const*,boost::python::api::object [,int=1])
        """
    def GetFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> ExplicitBitVect:
        """
            ...
            C++ signature :
                ExplicitBitVect* GetFingerprint(RDKix::FingerprintGenerator<unsigned int> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            ...
            C++ signature :
                boost::python::api::object GetFingerprintAsNumPy(RDKix::FingerprintGenerator<unsigned int> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            ...
            C++ signature :
                boost::python::tuple GetFingerprints(RDKix::FingerprintGenerator<unsigned int> const*,boost::python::api::object [,int=1])
        """
    def GetInfoString(self) -> str:
        """
            ...
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> GetInfoString(RDKix::FingerprintGenerator<unsigned int> const*)
        """
    def GetOptions(self) -> FingerprintOptions:
        """
            ...
            C++ signature :
                RDKix::FingerprintArguments* GetOptions(RDKix::FingerprintGenerator<unsigned int>*)
        """
    def GetSparseCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> UIntSparseIntVect:
        """
            ...
            C++ signature :
                RDKix::SparseIntVect<unsigned int>* GetSparseCountFingerprint(RDKix::FingerprintGenerator<unsigned int> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetSparseCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            ...
            C++ signature :
                boost::python::tuple GetSparseCountFingerprints(RDKix::FingerprintGenerator<unsigned int> const*,boost::python::api::object [,int=1])
        """
    def GetSparseFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> SparseBitVect:
        """
            ...
            C++ signature :
                SparseBitVect* GetSparseFingerprint(RDKix::FingerprintGenerator<unsigned int> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetSparseFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            ...
            C++ signature :
                boost::python::tuple GetSparseFingerprints(RDKix::FingerprintGenerator<unsigned int> const*,boost::python::api::object [,int=1])
        """
class FingerprintGenerator64(Boost.Python.instance):
    ...
    def GetCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> UIntSparseIntVect:
        """
            ...
            C++ signature :
                RDKix::SparseIntVect<unsigned int>* GetCountFingerprint(RDKix::FingerprintGenerator<unsigned long long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            Generates a count fingerprint
            ...
            C++ signature :
                boost::python::api::object GetCountFingerprintAsNumPy(RDKix::FingerprintGenerator<unsigned long long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates count fingerprints for a sequence of molecules
            ...
            C++ signature :
                boost::python::tuple GetCountFingerprints(RDKix::FingerprintGenerator<unsigned long long> const*,boost::python::api::object [,int=1])
        """
    def GetFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> ExplicitBitVect:
        """
            Generates a fingerprint
            ...
            C++ signature :
                ExplicitBitVect* GetFingerprint(RDKix::FingerprintGenerator<unsigned long long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            Generates a fingerprint
            ...
            C++ signature :
                boost::python::api::object GetFingerprintAsNumPy(RDKix::FingerprintGenerator<unsigned long long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates fingerprints for a sequence of molecules
            ...
            C++ signature :
                boost::python::tuple GetFingerprints(RDKix::FingerprintGenerator<unsigned long long> const*,boost::python::api::object [,int=1])
        """
    def GetInfoString(self) -> str:
        """
            Returns a string containing information about the fingerprint generator
            ...
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> GetInfoString(RDKix::FingerprintGenerator<unsigned long long> const*)
        """
    def GetOptions(self) -> FingerprintOptions:
        """
            return the fingerprint options object
            ...
            C++ signature :
                RDKix::FingerprintArguments* GetOptions(RDKix::FingerprintGenerator<unsigned long long>*)
        """
    def GetSparseCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> ULongSparseIntVect:
        """
            ...
            C++ signature :
                RDKix::SparseIntVect<unsigned long long>* GetSparseCountFingerprint(RDKix::FingerprintGenerator<unsigned long long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetSparseCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates sparse count fingerprints for a sequence of molecules
            ...
            C++ signature :
                boost::python::tuple GetSparseCountFingerprints(RDKix::FingerprintGenerator<unsigned long long> const*,boost::python::api::object [,int=1])
        """
    def GetSparseFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> SparseBitVect:
        """
            Generates a sparse fingerprint
            ...
            C++ signature :
                SparseBitVect* GetSparseFingerprint(RDKix::FingerprintGenerator<unsigned long long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetSparseFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates sparse fingerprints for a sequence of molecules
            ...
            C++ signature :
                boost::python::tuple GetSparseFingerprints(RDKix::FingerprintGenerator<unsigned long long> const*,boost::python::api::object [,int=1])
        """
class FingerprintOptions(Boost.Python.instance):
    ...
    def SetCountBounds(self, bounds: typing.Any) -> None:
        """
            ...
            C++ signature :
                void SetCountBounds(RDKix::FingerprintArguments {lvalue},boost::python::api::object)
        """
    @property
...
def GetAtomPairAtomInvGen(includeChirality: bool = False) -> AtomInvariantsGenerator:
    """
        ...
        C++ signature :
            RDKix::AtomInvariantsGenerator* GetAtomPairAtomInvGen([ bool=False])
    """
def GetAtomPairGenerator(minDistance: int = 1, maxDistance: int = 30, includeChirality: bool = False, use2D: bool = True, countSimulation: bool = True, countBounds: typing.Any = None, fpSize: int = 2048, atomInvariantsGenerator: typing.Any = None) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            RDKix::FingerprintGenerator<unsigned long long>* GetAtomPairGenerator([ unsigned int=1 [,unsigned int=30 [,bool=False [,bool=True [,bool=True [,boost::python::api::object {lvalue}=None [,unsigned int=2048 [,boost::python::api::object {lvalue}=None]]]]]]]])
    """
def GetCountFPs(molecules: list = [], fpType: FPType = ...) -> list:
    """
        C++ signature :
            boost::python::list GetCountFPs([ boost::python::list {lvalue}=[] [,RDKix::FPType=rdkix.Chem.rdFingerprintGenerator.FPType.MorganFP]])
    """
def GetFPs(molecules: list = [], fpType: FPType = ...) -> list:
    """
        C++ signature :
            boost::python::list GetFPs([ boost::python::list {lvalue}=[] [,RDKix::FPType=rdkix.Chem.rdFingerprintGenerator.FPType.MorganFP]])
    """
def GetMorganAtomInvGen(includeRingMembership: bool = False) -> AtomInvariantsGenerator:
    """
        ...
        C++ signature :
            RDKix::AtomInvariantsGenerator* GetMorganAtomInvGen([ bool=False])
    """
def GetMorganBondInvGen(useBondTypes: bool = True, useChirality: bool = False) -> BondInvariantsGenerator:
    """
        ...
        C++ signature :
            RDKix::BondInvariantsGenerator* GetMorganBondInvGen([ bool=True [,bool=False]])
    """
def GetMorganFeatureAtomInvGen(patterns: typing.Any = None) -> AtomInvariantsGenerator:
    """
        ...
        C++ signature :
            RDKix::AtomInvariantsGenerator* GetMorganFeatureAtomInvGen([ boost::python::api::object {lvalue}=None])
    """
def GetMorganGenerator(radius: int = 3, countSimulation: bool = False, includeChirality: bool = False, useBondTypes: bool = True, onlyNonzeroInvariants: bool = False, includeRingMembership: bool = True, countBounds: typing.Any = None, fpSize: int = 2048, atomInvariantsGenerator: typing.Any = None, bondInvariantsGenerator: typing.Any = None, includeRedundantEnvironments: bool = False) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            RDKix::FingerprintGenerator<unsigned long long>* GetMorganGenerator([ unsigned int=3 [,bool=False [,bool=False [,bool=True [,bool=False [,bool=True [,boost::python::api::object {lvalue}=None [,unsigned int=2048 [,boost::python::api::object {lvalue}=None [,boost::python::api::object {lvalue}=None [,bool=False]]]]]]]]]]])
    """
def GetRDKixAtomInvGen() -> AtomInvariantsGenerator:
    """
        ...
        C++ signature :
            RDKix::AtomInvariantsGenerator* GetRDKixAtomInvGen()
    """
def GetRDKixFPGenerator(minPath: int = 1, maxPath: int = 7, useHs: bool = True, branchedPaths: bool = True, useBondOrder: bool = True, countSimulation: bool = False, countBounds: typing.Any = None, fpSize: int = 2048, numBitsPerFeature: int = 2, atomInvariantsGenerator: typing.Any = None) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            RDKix::FingerprintGenerator<unsigned long long>* GetRDKixFPGenerator([ unsigned int=1 [,unsigned int=7 [,bool=True [,bool=True [,bool=True [,bool=False [,boost::python::api::object {lvalue}=None [,unsigned int=2048 [,unsigned int=2 [,boost::python::api::object {lvalue}=None]]]]]]]]]])
    """
def GetSparseCountFPs(molecules: list = [], fpType: FPType = ...) -> list:
    """
        C++ signature :
            boost::python::list GetSparseCountFPs([ boost::python::list {lvalue}=[] [,RDKix::FPType=rdkix.Chem.rdFingerprintGenerator.FPType.MorganFP]])
    """
def GetSparseFPs(molecules: list = [], fpType: FPType = ...) -> list:
    """
        C++ signature :
            boost::python::list GetSparseFPs([ boost::python::list {lvalue}=[] [,RDKix::FPType=rdkix.Chem.rdFingerprintGenerator.FPType.MorganFP]])
    """
def GetTopologicalTorsionGenerator(includeChirality: bool = False, torsionAtomCount: int = 4, countSimulation: bool = True, countBounds: typing.Any = None, fpSize: int = 2048, atomInvariantsGenerator: typing.Any = None) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            RDKix::FingerprintGenerator<unsigned long long>* GetTopologicalTorsionGenerator([ bool=False [,unsigned int=4 [,bool=True [,boost::python::api::object {lvalue}=None [,unsigned int=2048 [,boost::python::api::object {lvalue}=None]]]]]])
    """
