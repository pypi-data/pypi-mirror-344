...
import rdkix.Dbase.DbConnection
from rdkix.Dbase.DbConnection import DbConnect
from rdkix.Dbase import DbModule
__all__ = ['Chem', 'DataStructs', 'DbConnect', 'DbFpSupplier', 'DbModule', 'FingerprintMols', 'GetFingerprints', 'ScreenFingerprints', 'ScreenFromDetails', 'ScreenInDb', 'TopNContainer', 'pickle']
...
def ScreenInDb(details, mol):
    ...
def _ConnectToDatabase(details) -> rdkix.Dbase.DbConnection.DbConnect:
    ...
