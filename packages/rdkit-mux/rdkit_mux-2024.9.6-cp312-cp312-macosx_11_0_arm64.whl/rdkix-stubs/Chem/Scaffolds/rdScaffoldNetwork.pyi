...
class NetworkEdge(Boost.Python.instance):
    ...
    def __str__(self) -> typing.Any:
        """
            C++ signature :
                _object* __str__(RDKix::ScaffoldNetwork::NetworkEdge {lvalue})
        """
    @property
...
class NetworkEdge_VECT(Boost.Python.instance):
    ...
    def __contains__(self, item: typing.Any) -> bool:
        """
            C++ signature :
                bool __contains__(std::__1::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::__1::allocator<RDKix::ScaffoldNetwork::NetworkEdge>> {lvalue},_object*)
        """
    def __delitem__(self, item: typing.Any) -> None:
        """
            C++ signature :
                void __delitem__(std::__1::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::__1::allocator<RDKix::ScaffoldNetwork::NetworkEdge>> {lvalue},_object*)
        """
    def __getitem__(self, item: typing.Any) -> typing.Any:
        """
            C++ signature :
                boost::python::api::object __getitem__(boost::python::back_reference<std::__1::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::__1::allocator<RDKix::ScaffoldNetwork::NetworkEdge>>&>,_object*)
        """
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                boost::python::objects::iterator_range<boost::python::return_internal_reference<1ul, boost::python::default_call_policies>, std::__1::__wrap_iter<RDKix::ScaffoldNetwork::NetworkEdge*>> __iter__(boost::python::back_reference<std::__1::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::__1::allocator<RDKix::ScaffoldNetwork::NetworkEdge>>&>)
        """
    def __len__(self) -> int:
        """
            C++ signature :
                unsigned long __len__(std::__1::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::__1::allocator<RDKix::ScaffoldNetwork::NetworkEdge>> {lvalue})
        """
    def __setitem__(self, item: typing.Any, value: typing.Any) -> None:
        """
            C++ signature :
                void __setitem__(std::__1::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::__1::allocator<RDKix::ScaffoldNetwork::NetworkEdge>> {lvalue},_object*,_object*)
        """
    def append(self, item: typing.Any) -> None:
        """
            C++ signature :
                void append(std::__1::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::__1::allocator<RDKix::ScaffoldNetwork::NetworkEdge>> {lvalue},boost::python::api::object)
        """
    def extend(self, other: typing.Any) -> None:
        """
            C++ signature :
                void extend(std::__1::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::__1::allocator<RDKix::ScaffoldNetwork::NetworkEdge>> {lvalue},boost::python::api::object)
        """
class ScaffoldNetwork(Boost.Python.instance):
    ...
    def __getinitargs__(self) -> tuple:
        """
            C++ signature :
                boost::python::tuple __getinitargs__(RDKix::ScaffoldNetwork::ScaffoldNetwork)
        """
...
def BRICSScaffoldParams() -> ScaffoldNetworkParams:
    """
        ...
        C++ signature :
            RDKix::ScaffoldNetwork::ScaffoldNetworkParams* BRICSScaffoldParams()
    """
def CreateScaffoldNetwork(mols: typing.Any, params: ScaffoldNetworkParams) -> ScaffoldNetwork:
    """
        ...
        C++ signature :
            RDKix::ScaffoldNetwork::ScaffoldNetwork* CreateScaffoldNetwork(boost::python::api::object,RDKix::ScaffoldNetwork::ScaffoldNetworkParams)
    """
def UpdateScaffoldNetwork(mols: typing.Any, network: ScaffoldNetwork, params: ScaffoldNetworkParams) -> None:
    """
        ...
        C++ signature :
            void UpdateScaffoldNetwork(boost::python::api::object,RDKix::ScaffoldNetwork::ScaffoldNetwork {lvalue},RDKix::ScaffoldNetwork::ScaffoldNetworkParams)
    """
