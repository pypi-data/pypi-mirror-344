...
__all__ = ['AllChem', 'Chem', 'GetScaffoldForMol', 'MakeScaffoldGeneric', 'MurckoScaffoldSmiles', 'MurckoScaffoldSmilesFromSmiles', 'aromaticNTransform', 'murckoPatts', 'murckoQ', 'murckoTransforms']
def GetScaffoldForMol(mol):
    """
     Return molecule object containing scaffold of mol
      ...
      >>> GetScaffoldForMol(m)
      <rdkix.Chem.rdchem.Mol object at 0x...>
...
def _runDoctests(verbose = None):
    ...
aromaticNTransform: rdkix.Chem.rdChemReactions.ChemicalReaction  # value = <rdkix.Chem.rdChemReactions.ChemicalReaction object>
murckoPatts: list  # value = [<rdkix.Chem.rdchem.Mol object>, <rdkix.Chem.rdchem.Mol object>, <rdkix.Chem.rdchem.Mol object>]
murckoQ: rdkix.Chem.rdchem.Mol  # value = <rdkix.Chem.rdchem.Mol object>
murckoTransforms: list  # value = [<rdkix.Chem.rdChemReactions.ChemicalReaction object>, <rdkix.Chem.rdChemReactions.ChemicalReaction object>, <rdkix.Chem.rdChemReactions.ChemicalReaction object>, <rdkix.Chem.rdChemReactions.ChemicalReaction object>]
