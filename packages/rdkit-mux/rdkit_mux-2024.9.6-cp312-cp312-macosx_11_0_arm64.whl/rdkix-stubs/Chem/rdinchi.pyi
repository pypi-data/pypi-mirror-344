...
def MolToInchi(mol: Mol, options: str = '') -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple MolToInchi(RDKix::ROMol [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>=''])
    """
def MolToInchiKey(mol: Mol, options: str = '') -> str:
    """
        ...
        C++ signature :
            std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> MolToInchiKey(RDKix::ROMol [,char const*=''])
    """
