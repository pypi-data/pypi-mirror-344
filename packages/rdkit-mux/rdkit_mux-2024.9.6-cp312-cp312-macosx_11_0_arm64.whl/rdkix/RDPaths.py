...
RDCodeDir=os.path.join(r'/Users/runner/work/rdkix-pypi/rdkix-pypi/build/temp.macosx-11.0-arm64-cpython-312/rdkix_install/lib/python3.12/site-packages','rdkix')
