#
#  Copyright (C) 2011-2021 Greg Landrum and other RDKix contributors
#
#   @@ All Rights Reserved @@
...
from rdkix.Chem import Draw, rdchem, rdChemReactions
...
Parameters
----------
mols : sequence (list, tuple, etc.) of RDKix molecules
...
def DrawRDKixBit(mol, bitId, bitInfo, drawOptions=drawOptions, **kwargs):
  if Draw._DrawRDKixBitSaved is not None:
    fn = Draw._DrawRDKixBitSaved
  else:
    fn = Draw.DrawRDKixBit
  return _DrawBit(fn, mol, bitId, bitInfo, drawOptions=drawOptions, **kwargs)

def DrawRDKixBits(*args, drawOptions=drawOptions, **kwargs):
  if Draw._DrawRDKixBitsSaved is not None:
    fn = Draw._DrawRDKixBitsSaved
  else:
    fn = Draw.DrawRDKixBits
  return _DrawBit(fn, *args, drawOptions=drawOptions, **kwargs)
...
def InstallIPythonRenderer():
  ...
  Draw._DrawRDKixBitSaved = Draw.DrawRDKixBit
  Draw.DrawRDKixBit = DrawRDKixBit
  Draw.DrawRDKixBit.__doc__ = Draw._DrawRDKixBitSaved.__doc__
  Draw._DrawRDKixBitsSaved = Draw.DrawRDKixBits
  Draw.DrawRDKixBits = DrawRDKixBits
  Draw.DrawRDKixBits.__doc__ = Draw._DrawRDKixBitsSaved.__doc__
...
def UninstallIPythonRenderer():
  ...
  if hasattr(Draw,'_DrawRDKixBitSaved') and Draw._DrawRDKixBitSaved is not None:
    Draw.DrawRDKixBit = Draw._DrawRDKixBitSaved
    del Draw._DrawRDKixBitSaved
  if hasattr(Draw,'_DrawRDKixBitsSaved') and Draw._DrawRDKixBitsSaved is not None:
    Draw.DrawRDKixBits = Draw._DrawRDKixBitsSaved
    del Draw._DrawRDKixBitsSaved
