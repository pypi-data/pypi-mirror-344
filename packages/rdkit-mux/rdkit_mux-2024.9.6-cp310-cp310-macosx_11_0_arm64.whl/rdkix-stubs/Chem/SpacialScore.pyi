...
class _SpacialScore:
    ...
    """
    _hybridisations: typing.ClassVar[collections.defaultdict]  # value = defaultdict(<function _SpacialScore.<lambda> at 0x108396830>, {rdkix.Chem.rdchem.HybridizationType.SP: 1, rdkix.Chem.rdchem.HybridizationType.SP2: 2, rdkix.Chem.rdchem.HybridizationType.SP3: 3})
