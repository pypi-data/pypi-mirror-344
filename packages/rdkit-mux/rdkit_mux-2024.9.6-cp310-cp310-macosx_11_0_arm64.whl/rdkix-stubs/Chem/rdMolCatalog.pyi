...
class MolCatalog(Boost.Python.instance):
    ...
    def GetBitDescription(self, idx: int) -> str:
        """
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> GetBitDescription(RDCatalog::HierarchCatalog<RDKix::MolCatalogEntry, RDKix::MolCatalogParams, int> const*,unsigned int)
        """
    ...
    def GetEntryDescription(self, idx: int) -> str:
        """
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> GetEntryDescription(RDCatalog::HierarchCatalog<RDKix::MolCatalogEntry, RDKix::MolCatalogParams, int> const*,unsigned int)
        """
    def GetEntryDownIds(self, idx: int) -> typing.Sequence[int]:
        """
            C++ signature :
                std::__1::vector<int, std::__1::allocator<int>> GetEntryDownIds(RDCatalog::HierarchCatalog<RDKix::MolCatalogEntry, RDKix::MolCatalogParams, int> const*,unsigned int)
        """
    ...
    def Serialize(self) -> str:
        """
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> Serialize(RDCatalog::HierarchCatalog<RDKix::MolCatalogEntry, RDKix::MolCatalogParams, int> {lvalue})
        """
...
class MolCatalogEntry(Boost.Python.instance):
    ...
    def GetDescription(self) -> str:
        """
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> GetDescription(RDKix::MolCatalogEntry {lvalue})
        """
    ...
    def SetDescription(self, val: str) -> None:
        """
            C++ signature :
                void SetDescription(RDKix::MolCatalogEntry {lvalue},std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
        """
