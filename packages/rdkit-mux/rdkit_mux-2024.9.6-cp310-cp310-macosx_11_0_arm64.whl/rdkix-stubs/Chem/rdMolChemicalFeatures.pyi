...
class MolChemicalFeature(Boost.Python.instance):
    ...
    def GetFamily(self) -> str:
        """
            ...
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> GetFamily(RDKix::MolChemicalFeature {lvalue})
        """
    def GetId(self) -> int:
        """
    ...
    def GetType(self) -> str:
        """
            ...
            C++ signature :
                std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>> GetType(RDKix::MolChemicalFeature {lvalue})
        """
...
class MolChemicalFeatureFactory(Boost.Python.instance):
    ...
    def GetMolFeature(self, mol: Mol, idx: int, includeOnly: str = '', recompute: bool = True, confId: int = -1) -> MolChemicalFeature:
        """
            ...
            C++ signature :
                boost::shared_ptr<RDKix::MolChemicalFeature> GetMolFeature(RDKix::MolChemicalFeatureFactory,RDKix::ROMol,int [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>='' [,bool=True [,int=-1]]])
        """
    ...
    def GetNumMolFeatures(self, mol: Mol, includeOnly: str = '') -> int:
        """
            ...
            C++ signature :
                int GetNumMolFeatures(RDKix::MolChemicalFeatureFactory,RDKix::ROMol [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>=''])
        """
def BuildFeatureFactory(fileName: str) -> MolChemicalFeatureFactory:
    """
        ...
        C++ signature :
            RDKix::MolChemicalFeatureFactory* BuildFeatureFactory(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
    """
def BuildFeatureFactoryFromString(fdefString: str) -> MolChemicalFeatureFactory:
    """
        ...
        C++ signature :
            RDKix::MolChemicalFeatureFactory* BuildFeatureFactoryFromString(std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
    """
