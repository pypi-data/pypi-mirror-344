...
class SynthonSpace(Boost.Python.instance):
    ...
    def BuildSynthonFingerprints(self, fingerprintGenerator: typing.Any) -> None:
        """
            ...
            C++ signature :
                void BuildSynthonFingerprints(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},RDKix::FingerprintGenerator<unsigned long>)
        """
    ...
    def GetNumProducts(self) -> int:
        """
            ...
            C++ signature :
                long GetNumProducts(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue})
        """
    ...
    def ReadDBFile(self, inFile: str) -> None:
        """
            ...
            C++ signature :
                void ReadDBFile(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},std::string)
        """
    def ReadTextFile(self, inFile: str) -> None:
        """
            ...
            C++ signature :
                void ReadTextFile(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},std::string)
        """
    ...
    def WriteDBFile(self, outFile: str) -> None:
        """
            ...
            C++ signature :
                void WriteDBFile(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},std::string)
        """
    def WriteEnumeratedFile(self, outFile: str) -> None:
        """
            ...
            C++ signature :
                void WriteEnumeratedFile(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},std::string)
        """
