...
class EmbedFailureCauses(Boost.Python.enum):
    BAD_DOUBLE_BOND_STEREO: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.BAD_DOUBLE_BOND_STEREO
    CHECK_CHIRAL_CENTERS: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_CHIRAL_CENTERS
    CHECK_CHIRAL_CENTERS2: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_CHIRAL_CENTERS2
    CHECK_TETRAHEDRAL_CENTERS: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_TETRAHEDRAL_CENTERS
    ETK_MINIMIZATION: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.ETK_MINIMIZATION
    FINAL_CENTER_IN_VOLUME: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.FINAL_CENTER_IN_VOLUME
    FINAL_CHIRAL_BOUNDS: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.FINAL_CHIRAL_BOUNDS
    FIRST_MINIMIZATION: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.FIRST_MINIMIZATION
    INITIAL_COORDS: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.INITIAL_COORDS
    LINEAR_DOUBLE_BOND: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.LINEAR_DOUBLE_BOND
    MINIMIZE_FOURTH_DIMENSION: typing.ClassVar[EmbedFailureCauses]  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.MINIMIZE_FOURTH_DIMENSION
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'INITIAL_COORDS': rdkix.Chem.rdDistGeom.EmbedFailureCauses.INITIAL_COORDS, 'FIRST_MINIMIZATION': rdkix.Chem.rdDistGeom.EmbedFailureCauses.FIRST_MINIMIZATION, 'CHECK_TETRAHEDRAL_CENTERS': rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_TETRAHEDRAL_CENTERS, 'CHECK_CHIRAL_CENTERS': rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_CHIRAL_CENTERS, 'MINIMIZE_FOURTH_DIMENSION': rdkix.Chem.rdDistGeom.EmbedFailureCauses.MINIMIZE_FOURTH_DIMENSION, 'ETK_MINIMIZATION': rdkix.Chem.rdDistGeom.EmbedFailureCauses.ETK_MINIMIZATION, 'FINAL_CHIRAL_BOUNDS': rdkix.Chem.rdDistGeom.EmbedFailureCauses.FINAL_CHIRAL_BOUNDS, 'FINAL_CENTER_IN_VOLUME': rdkix.Chem.rdDistGeom.EmbedFailureCauses.FINAL_CENTER_IN_VOLUME, 'LINEAR_DOUBLE_BOND': rdkix.Chem.rdDistGeom.EmbedFailureCauses.LINEAR_DOUBLE_BOND, 'BAD_DOUBLE_BOND_STEREO': rdkix.Chem.rdDistGeom.EmbedFailureCauses.BAD_DOUBLE_BOND_STEREO, 'CHECK_CHIRAL_CENTERS2': rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_CHIRAL_CENTERS2}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdDistGeom.EmbedFailureCauses.INITIAL_COORDS, 1: rdkix.Chem.rdDistGeom.EmbedFailureCauses.FIRST_MINIMIZATION, 2: rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_TETRAHEDRAL_CENTERS, 3: rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_CHIRAL_CENTERS, 4: rdkix.Chem.rdDistGeom.EmbedFailureCauses.MINIMIZE_FOURTH_DIMENSION, 5: rdkix.Chem.rdDistGeom.EmbedFailureCauses.ETK_MINIMIZATION, 6: rdkix.Chem.rdDistGeom.EmbedFailureCauses.FINAL_CHIRAL_BOUNDS, 7: rdkix.Chem.rdDistGeom.EmbedFailureCauses.FINAL_CENTER_IN_VOLUME, 8: rdkix.Chem.rdDistGeom.EmbedFailureCauses.LINEAR_DOUBLE_BOND, 9: rdkix.Chem.rdDistGeom.EmbedFailureCauses.BAD_DOUBLE_BOND_STEREO, 10: rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_CHIRAL_CENTERS2}
...
def EmbedMolecule(mol: Mol, maxAttempts: int = 0, randomSeed: int = -1, clearConfs: bool = True, useRandomCoords: bool = False, boxSizeMult: float = 2.0, randNegEig: bool = True, numZeroFail: int = 1, coordMap: dict = {}, forceTol: float = 0.001, ignoreSmoothingFailures: bool = False, enforceChirality: bool = True, useExpTorsionAnglePrefs: bool = True, useBasicKnowledge: bool = True, printExpTorsionAngles: bool = False, useSmallRingTorsions: bool = False, useMacrocycleTorsions: bool = True, ETversion: int = 2, useMacrocycle14config: bool = True) -> int:
    """
        ...
        C++ signature :
            int EmbedMolecule(class RDKix::ROMol {lvalue} [,unsigned int=0 [,int=-1 [,bool=True [,bool=False [,double=2.0 [,bool=True [,unsigned int=1 [,class boost::python::dict {lvalue}={} [,double=0.001 [,bool=False [,bool=True [,bool=True [,bool=True [,bool=False [,bool=False [,bool=True [,unsigned int=2 [,bool=True]]]]]]]]]]]]]]]]]])
    """
@typing.overload
def EmbedMolecule(mol: Mol, params: EmbedParameters) -> int:
    """
        ...
        C++ signature :
            int EmbedMolecule(class RDKix::ROMol {lvalue},struct RDKix::DGeomHelpers::EmbedParameters {lvalue})
    """
@typing.overload
...
def EmbedMultipleConfs(mol: Mol, numConfs: int, params: EmbedParameters) -> _vectint:
    """
        ...
        C++ signature :
            class std::vector<int,class std::allocator<int> > EmbedMultipleConfs(class RDKix::ROMol {lvalue},unsigned int,struct RDKix::DGeomHelpers::EmbedParameters {lvalue})
    """
@typing.overload
def GetExperimentalTorsions(mol: Mol, useExpTorsionAnglePrefs: bool = True, useSmallRingTorsions: bool = False, useMacrocycleTorsions: bool = True, useBasicKnowledge: bool = True, ETversion: int = 2, printExpTorsionAngles: bool = False) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GetExperimentalTorsions(class RDKix::ROMol [,bool=True [,bool=False [,bool=True [,bool=True [,unsigned int=2 [,bool=False]]]]]])
    """
@typing.overload
def GetExperimentalTorsions(mol: Mol, embedParams: EmbedParameters) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GetExperimentalTorsions(class RDKix::ROMol,struct RDKix::DGeomHelpers::EmbedParameters)
    """
def GetMoleculeBoundsMatrix(mol: Mol, set15bounds: bool = True, scaleVDW: bool = False, doTriangleSmoothing: bool = True, useMacrocycle14config: bool = False) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetMoleculeBoundsMatrix(class RDKix::ROMol {lvalue} [,bool=True [,bool=False [,bool=True [,bool=False]]]])
    """
...
def srETKDGv3() -> EmbedParameters:
    ...
    """
BAD_DOUBLE_BOND_STEREO: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.BAD_DOUBLE_BOND_STEREO
CHECK_CHIRAL_CENTERS: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_CHIRAL_CENTERS
CHECK_CHIRAL_CENTERS2: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_CHIRAL_CENTERS2
CHECK_TETRAHEDRAL_CENTERS: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.CHECK_TETRAHEDRAL_CENTERS
ETK_MINIMIZATION: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.ETK_MINIMIZATION
FINAL_CENTER_IN_VOLUME: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.FINAL_CENTER_IN_VOLUME
FINAL_CHIRAL_BOUNDS: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.FINAL_CHIRAL_BOUNDS
FIRST_MINIMIZATION: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.FIRST_MINIMIZATION
INITIAL_COORDS: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.INITIAL_COORDS
LINEAR_DOUBLE_BOND: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.LINEAR_DOUBLE_BOND
MINIMIZE_FOURTH_DIMENSION: EmbedFailureCauses  # value = rdkix.Chem.rdDistGeom.EmbedFailureCauses.MINIMIZE_FOURTH_DIMENSION
