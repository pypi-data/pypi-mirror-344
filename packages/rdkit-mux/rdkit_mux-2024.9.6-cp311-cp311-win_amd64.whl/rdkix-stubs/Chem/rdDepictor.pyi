...
class ConstrainedDepictionParams(Boost.Python.instance):
    ...
    def existingConfId(*args, **kwargs):
        ...
    @property
    def forceRDKix(*args, **kwargs):
        """
        if True, use RDKix to generate coordinates even if preferCoordGen is set to True; defaults to False
        """
    @forceRDKix.setter
    def forceRDKix(*args, **kwargs):
        ...
...
def AddRingSystemTemplates(templatePath: str) -> None:
    ...
    """
def Compute2DCoords(mol: Mol, canonOrient: bool = True, clearConfs: bool = True, coordMap: dict = {}, nFlipsPerSample: int = 0, nSample: int = 0, sampleSeed: int = 0, permuteDeg4Nodes: bool = False, bondLength: float = -1.0, forceRDKix: bool = False, useRingTemplates: bool = False) -> int:
    """
        ...
        C++ signature :
            unsigned int Compute2DCoords(class RDKix::ROMol {lvalue} [,bool=True [,bool=True [,class boost::python::dict {lvalue}={} [,unsigned int=0 [,unsigned int=0 [,int=0 [,bool=False [,double=-1.0 [,bool=False [,bool=False]]]]]]]]]])
    """
def Compute2DCoordsMimicDistmat(mol: Mol, distMat: typing.Any, canonOrient: bool = False, clearConfs: bool = True, weightDistMat: float = 0.5, nFlipsPerSample: int = 3, nSample: int = 100, sampleSeed: int = 100, permuteDeg4Nodes: bool = True, bondLength: float = -1.0, forceRDKix: bool = False) -> int:
    """
        ...
        C++ signature :
            unsigned int Compute2DCoordsMimicDistmat(class RDKix::ROMol {lvalue},class boost::python::api::object [,bool=False [,bool=True [,double=0.5 [,unsigned int=3 [,unsigned int=100 [,int=100 [,bool=True [,double=-1.0 [,bool=False]]]]]]]]])
    """
@typing.overload
def GenerateDepictionMatching2DStructure(mol: Mol, reference: Mol, confId: int = -1, refPatt: typing.Any = None, params: typing.Any = None) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GenerateDepictionMatching2DStructure(class RDKix::ROMol {lvalue},class RDKix::ROMol [,int=-1 [,class boost::python::api::object=None [,class boost::python::api::object=None]]])
    """
@typing.overload
def GenerateDepictionMatching2DStructure(mol: Mol, reference: Mol, confId: int = -1, refPatt: typing.Any = None, acceptFailure: bool = False, forceRDKix: bool = False, allowRGroups: bool = False) -> tuple:
    """
        Generate a depiction for a molecule where a piece of the 
          molecule is constrained to have the same coordinates as a reference. 
        ...
        C++ signature :
            class boost::python::tuple GenerateDepictionMatching2DStructure(class RDKix::ROMol {lvalue},class RDKix::ROMol [,int=-1 [,class boost::python::api::object=None [,bool=False [,bool=False [,bool=False]]]]])
    """
@typing.overload
def GenerateDepictionMatching2DStructure(mol: Mol, reference: Mol, atomMap: typing.Any, confId: int = -1, params: typing.Any = None) -> None:
    """
        ...
        C++ signature :
            void GenerateDepictionMatching2DStructure(class RDKix::ROMol {lvalue},class RDKix::ROMol,class boost::python::api::object [,int=-1 [,class boost::python::api::object=None]])
    """
@typing.overload
def GenerateDepictionMatching2DStructure(mol: Mol, reference: Mol, atomMap: typing.Any, confId: int, forceRDKix: bool) -> None:
    """
        Generate a depiction for a molecule where a piece of the 
          molecule is constrained to have the same coordinates as a reference. 
        ...
        C++ signature :
            void GenerateDepictionMatching2DStructure(class RDKix::ROMol {lvalue},class RDKix::ROMol,class boost::python::api::object,int,bool)
    """
def GenerateDepictionMatching3DStructure(mol: Mol, reference: Mol, confId: int = -1, refPatt: typing.Any = None, acceptFailure: bool = False, forceRDKix: bool = False) -> None:
    """
        ...
        C++ signature :
            void GenerateDepictionMatching3DStructure(class RDKix::ROMol {lvalue},class RDKix::ROMol {lvalue} [,int=-1 [,class boost::python::api::object=None [,bool=False [,bool=False]]]])
    """
def GetPreferCoordGen() -> bool:
    """
        Return whether or not the CoordGen library is used for coordinate generation in the RDKix depiction library.
...
def NormalizeDepiction(mol: Mol, confId: int = -1, canonicalize: int = 1, scaleFactor: float = -1.0) -> float:
    """
        ...
        C++ signature :
            double NormalizeDepiction(class RDKix::ROMol {lvalue} [,int=-1 [,int=1 [,double=-1.0]]])
    """
def SetPreferCoordGen(val: bool) -> None:
    """
        Sets whether or not the CoordGen library should be preferred to the RDKix depiction library.
...
def StraightenDepiction(mol: Mol, confId: int = -1, minimizeRotation: bool = False) -> None:
    """
        ...
        C++ signature :
            void StraightenDepiction(class RDKix::ROMol {lvalue} [,int=-1 [,bool=False]])
    """
