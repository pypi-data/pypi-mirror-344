...
f: _io.BufferedReader  # value = <_io.BufferedReader name='C:\\rdkix\\build\\temp.win-amd64-cpython-311\\Release\\rdkix_install\\Lib\\site-packages\\rdkix\\sping\\PIL\\pilfonts\\metrics.dat'>
figureArc: int = 2
figureCurve: int = 3
figureLine: int = 1
