...
import rdkix.Chem.ChemUtils.DescriptorUtilities as _du
...
from rdkix.Chem.EState.EState import (MaxAbsEStateIndex, MaxEStateIndex, MinAbsEStateIndex,
                                      MinEStateIndex)
...
def _setupDescriptors(namespace):
  ...
  from rdkix.Chem import (Crippen, Descriptors3D, Fragments, GraphDescriptors, Lipinski, MolSurf,
                          SpacialScore)
  from rdkix.Chem.EState import EState_VSA
  _descList.clear()
