...
def CreateEmptyForceFieldForMol(mol: Mol, confId: int = -1) -> typing.Any:
    """
        ...
        C++ signature :
            class ForceFields::PyForceField * __ptr64 CreateEmptyForceFieldForMol(class RDKix::ROMol {lvalue} [,int=-1])
    """
def GetUFFAngleBendParams(mol: Mol, idx1: int, idx2: int, idx3: int) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetUFFAngleBendParams(class RDKix::ROMol,unsigned int,unsigned int,unsigned int)
    """
def GetUFFBondStretchParams(mol: Mol, idx1: int, idx2: int) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetUFFBondStretchParams(class RDKix::ROMol,unsigned int,unsigned int)
    """
def GetUFFInversionParams(mol: Mol, idx1: int, idx2: int, idx3: int, idx4: int) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetUFFInversionParams(class RDKix::ROMol,unsigned int,unsigned int,unsigned int,unsigned int)
    """
def GetUFFTorsionParams(mol: Mol, idx1: int, idx2: int, idx3: int, idx4: int) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetUFFTorsionParams(class RDKix::ROMol,unsigned int,unsigned int,unsigned int,unsigned int)
    """
def GetUFFVdWParams(mol: Mol, idx1: int, idx2: int) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetUFFVdWParams(class RDKix::ROMol,unsigned int,unsigned int)
    """
def MMFFGetMoleculeForceField(mol: Mol, pyMMFFMolProperties: typing.Any, nonBondedThresh: float = 100.0, confId: int = -1, ignoreInterfragInteractions: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            class ForceFields::PyForceField * __ptr64 MMFFGetMoleculeForceField(class RDKix::ROMol {lvalue},class ForceFields::PyMMFFMolProperties * __ptr64 [,double=100.0 [,int=-1 [,bool=True]]])
    """
def MMFFGetMoleculeProperties(mol: Mol, mmffVariant: str = 'MMFF94', mmffVerbosity: int = 0) -> typing.Any:
    """
        ...
        C++ signature :
            class ForceFields::PyMMFFMolProperties * __ptr64 MMFFGetMoleculeProperties(class RDKix::ROMol {lvalue} [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='MMFF94' [,unsigned int=0]])
    """
def MMFFHasAllMoleculeParams(mol: Mol) -> bool:
    """
        ...
        C++ signature :
            bool MMFFHasAllMoleculeParams(class RDKix::ROMol)
    """
def MMFFOptimizeMolecule(mol: Mol, mmffVariant: str = 'MMFF94', maxIters: int = 200, nonBondedThresh: float = 100.0, confId: int = -1, ignoreInterfragInteractions: bool = True) -> int:
    """
        ...
        C++ signature :
            int MMFFOptimizeMolecule(class RDKix::ROMol {lvalue} [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='MMFF94' [,int=200 [,double=100.0 [,int=-1 [,bool=True]]]]])
    """
def MMFFOptimizeMoleculeConfs(self: Mol, numThreads: int = 1, maxIters: int = 200, mmffVariant: str = 'MMFF94', nonBondedThresh: float = 100.0, ignoreInterfragInteractions: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            class boost::python::api::object MMFFOptimizeMoleculeConfs(class RDKix::ROMol {lvalue} [,int=1 [,int=200 [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='MMFF94' [,double=100.0 [,bool=True]]]]])
    """
def MMFFSanitizeMolecule(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int MMFFSanitizeMolecule(class RDKix::ROMol {lvalue})
    """
...
def OptimizeMoleculeConfs(mol: Mol, ff: typing.Any, numThreads: int = 1, maxIters: int = 200) -> typing.Any:
    """
        ...
        C++ signature :
            class boost::python::api::object OptimizeMoleculeConfs(class RDKix::ROMol {lvalue},class ForceFields::PyForceField {lvalue} [,int=1 [,int=200]])
    """
def UFFGetMoleculeForceField(mol: Mol, vdwThresh: float = 10.0, confId: int = -1, ignoreInterfragInteractions: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            class ForceFields::PyForceField * __ptr64 UFFGetMoleculeForceField(class RDKix::ROMol {lvalue} [,double=10.0 [,int=-1 [,bool=True]]])
    """
def UFFHasAllMoleculeParams(mol: Mol) -> bool:
    """
        ...
        C++ signature :
            bool UFFHasAllMoleculeParams(class RDKix::ROMol)
    """
def UFFOptimizeMolecule(self: Mol, maxIters: int = 200, vdwThresh: float = 10.0, confId: int = -1, ignoreInterfragInteractions: bool = True) -> int:
    """
        ...
        C++ signature :
            int UFFOptimizeMolecule(class RDKix::ROMol {lvalue} [,int=200 [,double=10.0 [,int=-1 [,bool=True]]]])
    """
def UFFOptimizeMoleculeConfs(self: Mol, numThreads: int = 1, maxIters: int = 200, vdwThresh: float = 10.0, ignoreInterfragInteractions: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            class boost::python::api::object UFFOptimizeMoleculeConfs(class RDKix::ROMol {lvalue} [,int=1 [,int=200 [,double=10.0 [,bool=True]]]])
    """
