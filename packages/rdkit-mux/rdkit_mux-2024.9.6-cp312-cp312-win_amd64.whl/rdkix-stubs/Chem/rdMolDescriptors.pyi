...
class AtomPairsParameters(Boost.Python.instance):
    ...
    atomTypes: typing.ClassVar[rdkix.rdBase._vectunsigned int]  # value = <rdkix.rdBase._vectunsigned int object at 0x0000020D8C551DC0>
...
class DoubleCubicLatticeVolume(Boost.Python.instance):
    ...
    def GetCompactness(arg1: DoubleCubicLatticeVolume) -> float:
        """
            ...
            C++ signature :
                double GetCompactness(class RDKix::Descriptors::DoubleCubicLatticeVolume {lvalue})
        """
    @staticmethod
    def GetPackingDensity(arg1: DoubleCubicLatticeVolume) -> float:
        """
            ...
            C++ signature :
                double GetPackingDensity(class RDKix::Descriptors::DoubleCubicLatticeVolume {lvalue})
        """
    @staticmethod
    def GetSurfaceArea(arg1: DoubleCubicLatticeVolume) -> float:
        """
            ...
            C++ signature :
                double GetSurfaceArea(class RDKix::Descriptors::DoubleCubicLatticeVolume {lvalue})
        """
    @staticmethod
    def GetVDWVolume(arg1: DoubleCubicLatticeVolume) -> float:
        """
            ...
            C++ signature :
                double GetVDWVolume(class RDKix::Descriptors::DoubleCubicLatticeVolume {lvalue})
        """
    @staticmethod
    def GetVolume(arg1: DoubleCubicLatticeVolume) -> float:
        """
            ...
            C++ signature :
                double GetVolume(class RDKix::Descriptors::DoubleCubicLatticeVolume {lvalue})
        """
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
    def __init__(self, mol: Mol, isProtein: bool = False, includeLigand: bool = True, probeRadius: float = 1.2, depth: int = 4, dotDensity: int = 0) -> None:
        """
            ...
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKix::ROMol [,bool=False [,bool=True [,double=1.2 [,int=4 [,int=0]]]]])
        """
class NumRotatableBondsOptions(Boost.Python.enum):
    ...
    """
    Default: typing.ClassVar[NumRotatableBondsOptions]  # value = rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.Default
    NonStrict: typing.ClassVar[NumRotatableBondsOptions]  # value = rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.NonStrict
    Strict: typing.ClassVar[NumRotatableBondsOptions]  # value = rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.Strict
    StrictLinkages: typing.ClassVar[NumRotatableBondsOptions]  # value = rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.StrictLinkages
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'NonStrict': rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.NonStrict, 'Strict': rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.Strict, 'StrictLinkages': rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.StrictLinkages, 'Default': rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.Default}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.NonStrict, 1: rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.Strict, 2: rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.StrictLinkages, -1: rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.Default}
class Properties(Boost.Python.instance):
    ...
    def GetProperty(propName: str) -> PropertyFunctor:
        """
            ...
            C++ signature :
                class boost::shared_ptr<struct RDKix::Descriptors::PropertyFunctor> GetProperty(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
        """
    @staticmethod
    def GetPropertyNames(*args, **kwargs) -> ...:
        """
            ...
            C++ signature :
                class std::vector<class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >,class std::allocator<class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > > > GetPropertyNames(class RDKix::Descriptors::Properties {lvalue})
        """
    @staticmethod
    ...
    def AnnotateProperties(self, mol: Mol) -> None:
        """
            ...
            C++ signature :
                void AnnotateProperties(class RDKix::Descriptors::Properties {lvalue},class RDKix::ROMol {lvalue})
        """
    def ComputeProperties(self, mol: Mol, annotateMol: bool = False) -> _vectdouble:
        """
            ...
            C++ signature :
                class std::vector<double,class std::allocator<double> > ComputeProperties(class RDKix::Descriptors::Properties {lvalue},class RDKix::ROMol [,bool=False])
        """
    @typing.overload
    def __init__(self) -> None:
        """
...
class PropertyFunctor(Boost.Python.instance):
    ...
    def GetName(self) -> str:
        """
            ...
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > GetName(struct RDKix::Descriptors::PropertyFunctor {lvalue})
        """
    def GetVersion(self) -> str:
        """
            ...
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > GetVersion(struct RDKix::Descriptors::PropertyFunctor {lvalue})
        """
    def __call__(self, mol: Mol) -> float:
        """
            ...
            C++ signature :
                double __call__(struct RDKix::Descriptors::PropertyFunctor {lvalue},class RDKix::ROMol)
        """
class PropertyRangeQuery(Boost.Python.instance):
    ...
    def Match(self, what: Mol) -> bool:
        """
            C++ signature :
                bool Match(class Queries::RangeQuery<double,class RDKix::ROMol const & __ptr64,1> {lvalue},class RDKix::ROMol)
        """
class PythonPropertyFunctor(PropertyFunctor):
    ...
    def __call__(self, mol: Mol) -> float:
        """
            ...
            C++ signature :
                double __call__(struct `anonymous namespace'::PythonPropertyFunctor {lvalue},class RDKix::ROMol)
        """
...
def BCUT2D(mol: Mol) -> list:
    """
        ...
        C++ signature :
            class boost::python::list BCUT2D(class RDKix::ROMol)
    """
@typing.overload
def BCUT2D(mol: Mol, atom_props: list) -> tuple:
    """
        ...
        C++ signature :
            struct std::pair<double,double> BCUT2D(class RDKix::ROMol,class boost::python::list)
    """
@typing.overload
def BCUT2D(mol: Mol, atom_props: tuple) -> tuple:
    """
        ...
        C++ signature :
            struct std::pair<double,double> BCUT2D(class RDKix::ROMol,class boost::python::tuple)
    """
@typing.overload
def BCUT2D(mol: Mol, atom_propname: str) -> tuple:
    """
        ...
        C++ signature :
            struct std::pair<double,double> BCUT2D(class RDKix::ROMol,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
    """
def CalcAUTOCORR2D(mol: Mol, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            class boost::python::list CalcAUTOCORR2D(class RDKix::ROMol [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >=''])
    """
def CalcAUTOCORR3D(mol: Mol, confId: int = -1, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            class boost::python::list CalcAUTOCORR3D(class RDKix::ROMol [,int=-1 [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='']])
    """
def CalcAsphericity(mol: Mol, confId: int = -1, useAtomicMasses: bool = True, force: bool = True) -> float:
    """
        C++ signature :
            double CalcAsphericity(class RDKix::ROMol [,int=-1 [,bool=True [,bool=True]]])
    """
def CalcChi0n(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi0n(class RDKix::ROMol [,bool=False])
    """
def CalcChi0v(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi0v(class RDKix::ROMol [,bool=False])
    """
def CalcChi1n(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi1n(class RDKix::ROMol [,bool=False])
    """
def CalcChi1v(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi1v(class RDKix::ROMol [,bool=False])
    """
def CalcChi2n(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi2n(class RDKix::ROMol [,bool=False])
    """
def CalcChi2v(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi2v(class RDKix::ROMol [,bool=False])
    """
def CalcChi3n(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi3n(class RDKix::ROMol [,bool=False])
    """
def CalcChi3v(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi3v(class RDKix::ROMol [,bool=False])
    """
def CalcChi4n(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi4n(class RDKix::ROMol [,bool=False])
    """
def CalcChi4v(mol: Mol, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChi4v(class RDKix::ROMol [,bool=False])
    """
def CalcChiNn(mol: Mol, n: int, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChiNn(class RDKix::ROMol,unsigned int [,bool=False])
    """
def CalcChiNv(mol: Mol, n: int, force: bool = False) -> float:
    """
        C++ signature :
            double CalcChiNv(class RDKix::ROMol,unsigned int [,bool=False])
    """
def CalcCoulombMat(mol: Mol, confId: int = -1) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple CalcCoulombMat(class RDKix::ROMol [,int=-1])
    """
def CalcCrippenDescriptors(mol: Mol, includeHs: bool = True, force: bool = False) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple CalcCrippenDescriptors(class RDKix::ROMol [,bool=True [,bool=False]])
    """
def CalcEEMcharges(mol: Mol, confId: int = -1) -> list:
    """
        ...
        C++ signature :
            class boost::python::list CalcEEMcharges(class RDKix::ROMol {lvalue} [,int=-1])
    """
def CalcEccentricity(mol: Mol, confId: int = -1, useAtomicMasses: bool = True, force: bool = True) -> float:
    """
        C++ signature :
            double CalcEccentricity(class RDKix::ROMol [,int=-1 [,bool=True [,bool=True]]])
    """
def CalcExactMolWt(mol: Mol, onlyHeavy: bool = False) -> float:
    """
        ...
        C++ signature :
            double CalcExactMolWt(class RDKix::ROMol [,bool=False])
    """
def CalcFractionCSP3(mol: Mol) -> float:
    """
        ...
        C++ signature :
            double CalcFractionCSP3(class RDKix::ROMol)
    """
def CalcGETAWAY(mol: Mol, confId: int = -1, precision: float = 2, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            class boost::python::list CalcGETAWAY(class RDKix::ROMol [,int=-1 [,double=2 [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='']]])
    """
def CalcHallKierAlpha(mol: Mol, atomContribs: AtomPairsParameters = None) -> float:
    """
        C++ signature :
            double CalcHallKierAlpha(class RDKix::ROMol [,class boost::python::api::object=None])
    """
def CalcInertialShapeFactor(mol: Mol, confId: int = -1, useAtomicMasses: bool = True, force: bool = True) -> float:
    """
        C++ signature :
            double CalcInertialShapeFactor(class RDKix::ROMol [,int=-1 [,bool=True [,bool=True]]])
    """
def CalcKappa1(mol: Mol) -> float:
    """
        C++ signature :
            double CalcKappa1(class RDKix::ROMol)
    """
def CalcKappa2(mol: Mol) -> float:
    """
        C++ signature :
            double CalcKappa2(class RDKix::ROMol)
    """
def CalcKappa3(mol: Mol) -> float:
    """
        C++ signature :
            double CalcKappa3(class RDKix::ROMol)
    """
def CalcLabuteASA(mol: Mol, includeHs: bool = True, force: bool = False) -> float:
    """
        ...
        C++ signature :
            double CalcLabuteASA(class RDKix::ROMol [,bool=True [,bool=False]])
    """
def CalcMORSE(mol: Mol, confId: int = -1, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            class boost::python::list CalcMORSE(class RDKix::ROMol [,int=-1 [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='']])
    """
def CalcMolFormula(mol: Mol, separateIsotopes: bool = False, abbreviateHIsotopes: bool = True) -> str:
    """
        ...
        C++ signature :
            class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > CalcMolFormula(class RDKix::ROMol [,bool=False [,bool=True]])
    """
def CalcNPR1(mol: Mol, confId: int = -1, useAtomicMasses: bool = True, force: bool = True) -> float:
    """
        C++ signature :
            double CalcNPR1(class RDKix::ROMol [,int=-1 [,bool=True [,bool=True]]])
    """
def CalcNPR2(mol: Mol, confId: int = -1, useAtomicMasses: bool = True, force: bool = True) -> float:
    """
        C++ signature :
            double CalcNPR2(class RDKix::ROMol [,int=-1 [,bool=True [,bool=True]]])
    """
def CalcNumAliphaticCarbocycles(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumAliphaticCarbocycles(class RDKix::ROMol)
    """
def CalcNumAliphaticHeterocycles(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumAliphaticHeterocycles(class RDKix::ROMol)
    """
def CalcNumAliphaticRings(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumAliphaticRings(class RDKix::ROMol)
    """
def CalcNumAmideBonds(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumAmideBonds(class RDKix::ROMol)
    """
def CalcNumAromaticCarbocycles(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumAromaticCarbocycles(class RDKix::ROMol)
    """
def CalcNumAromaticHeterocycles(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumAromaticHeterocycles(class RDKix::ROMol)
    """
def CalcNumAromaticRings(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumAromaticRings(class RDKix::ROMol)
    """
def CalcNumAtomStereoCenters(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumAtomStereoCenters(class RDKix::ROMol)
    """
def CalcNumAtoms(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumAtoms(class RDKix::ROMol)
    """
def CalcNumBridgeheadAtoms(mol: Mol, atoms: AtomPairsParameters = None) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumBridgeheadAtoms(class RDKix::ROMol [,class boost::python::api::object=None])
    """
def CalcNumHBA(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumHBA(class RDKix::ROMol)
    """
def CalcNumHBD(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumHBD(class RDKix::ROMol)
    """
def CalcNumHeavyAtoms(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumHeavyAtoms(class RDKix::ROMol)
    """
def CalcNumHeteroatoms(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumHeteroatoms(class RDKix::ROMol)
    """
def CalcNumHeterocycles(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumHeterocycles(class RDKix::ROMol)
    """
def CalcNumLipinskiHBA(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumLipinskiHBA(class RDKix::ROMol)
    """
def CalcNumLipinskiHBD(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumLipinskiHBD(class RDKix::ROMol)
    """
def CalcNumRings(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumRings(class RDKix::ROMol)
    """
@typing.overload
def CalcNumRotatableBonds(mol: Mol, strict: bool) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumRotatableBonds(class RDKix::ROMol,bool)
    """
@typing.overload
def CalcNumRotatableBonds(mol: Mol, strict: NumRotatableBondsOptions = ...) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumRotatableBonds(class RDKix::ROMol [,enum RDKix::Descriptors::NumRotatableBondsOptions=rdkix.Chem.rdMolDescriptors.NumRotatableBondsOptions.Default])
    """
def CalcNumSaturatedCarbocycles(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumSaturatedCarbocycles(class RDKix::ROMol)
    """
def CalcNumSaturatedHeterocycles(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumSaturatedHeterocycles(class RDKix::ROMol)
    """
def CalcNumSaturatedRings(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumSaturatedRings(class RDKix::ROMol)
    """
def CalcNumSpiroAtoms(mol: Mol, atoms: AtomPairsParameters = None) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumSpiroAtoms(class RDKix::ROMol [,class boost::python::api::object=None])
    """
def CalcNumUnspecifiedAtomStereoCenters(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int CalcNumUnspecifiedAtomStereoCenters(class RDKix::ROMol)
    """
def CalcOxidationNumbers(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void CalcOxidationNumbers(class RDKix::ROMol)
    """
...
def CalcRDF(mol: Mol, confId: int = -1, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            class boost::python::list CalcRDF(class RDKix::ROMol [,int=-1 [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='']])
    """
def CalcRadiusOfGyration(mol: Mol, confId: int = -1, useAtomicMasses: bool = True, force: bool = True) -> float:
    """
        C++ signature :
            double CalcRadiusOfGyration(class RDKix::ROMol [,int=-1 [,bool=True [,bool=True]]])
    """
def CalcSpherocityIndex(mol: Mol, confId: int = -1, force: bool = True) -> float:
    """
        C++ signature :
            double CalcSpherocityIndex(class RDKix::ROMol [,int=-1 [,bool=True]])
    """
def CalcTPSA(mol: Mol, force: bool = False, includeSandP: bool = False) -> float:
    """
        ...
        C++ signature :
            double CalcTPSA(class RDKix::ROMol [,bool=False [,bool=False]])
    """
def CalcWHIM(mol: Mol, confId: int = -1, thresh: float = 0.001, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            class boost::python::list CalcWHIM(class RDKix::ROMol [,int=-1 [,double=0.001 [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='']]])
    """
def CustomProp_VSA_(mol: Mol, customPropName: str, bins: AtomPairsParameters, force: bool = False) -> list:
    """
        C++ signature :
            class boost::python::list CustomProp_VSA_(class RDKix::ROMol,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >,class boost::python::api::object [,bool=False])
    """
def GetAtomFeatures(mol: Mol, atomid: int, addchiral: bool = False) -> list:
    """
        ...
        C++ signature :
            class boost::python::list GetAtomFeatures(class RDKix::ROMol,int [,bool=False])
    """
def GetAtomPairAtomCode(atom: Atom, branchSubtract: int = 0, includeChirality: bool = False) -> int:
    """
        ...
        C++ signature :
            unsigned int GetAtomPairAtomCode(class RDKix::Atom const * __ptr64 [,unsigned int=0 [,bool=False]])
    """
...
def GetAtomPairFingerprint(mol: Mol, minLength: int = 1, maxLength: int = 30, fromAtoms: AtomPairsParameters = 0, ignoreAtoms: AtomPairsParameters = 0, atomInvariants: AtomPairsParameters = 0, includeChirality: bool = False, use2D: bool = True, confId: int = -1) -> IntSparseIntVect:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<int> * __ptr64 GetAtomPairFingerprint(class RDKix::ROMol [,unsigned int=1 [,unsigned int=30 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,bool=False [,bool=True [,int=-1]]]]]]]])
    """
def GetConnectivityInvariants(mol: Mol, includeRingMembership: bool = True) -> list:
    """
        ...
        C++ signature :
            class boost::python::list GetConnectivityInvariants(class RDKix::ROMol [,bool=True])
    """
def GetFeatureInvariants(mol: Mol) -> list:
    """
        ...
        C++ signature :
            class boost::python::list GetFeatureInvariants(class RDKix::ROMol)
    """
def GetHashedAtomPairFingerprint(mol: Mol, nBits: int = 2048, minLength: int = 1, maxLength: int = 30, fromAtoms: AtomPairsParameters = 0, ignoreAtoms: AtomPairsParameters = 0, atomInvariants: AtomPairsParameters = 0, includeChirality: bool = False, use2D: bool = True, confId: int = -1) -> IntSparseIntVect:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<int> * __ptr64 GetHashedAtomPairFingerprint(class RDKix::ROMol [,unsigned int=2048 [,unsigned int=1 [,unsigned int=30 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,bool=False [,bool=True [,int=-1]]]]]]]]])
    """
def GetHashedAtomPairFingerprintAsBitVect(mol: Mol, nBits: int = 2048, minLength: int = 1, maxLength: int = 30, fromAtoms: AtomPairsParameters = 0, ignoreAtoms: AtomPairsParameters = 0, atomInvariants: AtomPairsParameters = 0, nBitsPerEntry: int = 4, includeChirality: bool = False, use2D: bool = True, confId: int = -1) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 GetHashedAtomPairFingerprintAsBitVect(class RDKix::ROMol [,unsigned int=2048 [,unsigned int=1 [,unsigned int=30 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,unsigned int=4 [,bool=False [,bool=True [,int=-1]]]]]]]]]])
    """
def GetHashedMorganFingerprint(mol: Mol, radius: int, nBits: int = 2048, invariants: AtomPairsParameters = [], fromAtoms: AtomPairsParameters = [], useChirality: bool = False, useBondTypes: bool = True, useFeatures: bool = False, bitInfo: AtomPairsParameters = None, includeRedundantEnvironments: bool = False) -> UIntSparseIntVect:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<unsigned int> * __ptr64 GetHashedMorganFingerprint(class RDKix::ROMol,unsigned int [,unsigned int=2048 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,bool=False [,bool=True [,bool=False [,class boost::python::api::object=None [,bool=False]]]]]]]])
    """
def GetHashedTopologicalTorsionFingerprint(mol: Mol, nBits: int = 2048, targetSize: int = 4, fromAtoms: AtomPairsParameters = 0, ignoreAtoms: AtomPairsParameters = 0, atomInvariants: AtomPairsParameters = 0, includeChirality: bool = False) -> LongSparseIntVect:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<__int64> * __ptr64 GetHashedTopologicalTorsionFingerprint(class RDKix::ROMol [,unsigned int=2048 [,unsigned int=4 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,bool=False]]]]]])
    """
def GetHashedTopologicalTorsionFingerprintAsBitVect(mol: Mol, nBits: int = 2048, targetSize: int = 4, fromAtoms: AtomPairsParameters = 0, ignoreAtoms: AtomPairsParameters = 0, atomInvariants: AtomPairsParameters = 0, nBitsPerEntry: int = 4, includeChirality: bool = False) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 GetHashedTopologicalTorsionFingerprintAsBitVect(class RDKix::ROMol [,unsigned int=2048 [,unsigned int=4 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,unsigned int=4 [,bool=False]]]]]]])
    """
def GetMACCSKeysFingerprint(mol: Mol) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 GetMACCSKeysFingerprint(class RDKix::ROMol)
    """
def GetMorganFingerprint(mol: Mol, radius: int, invariants: AtomPairsParameters = [], fromAtoms: AtomPairsParameters = [], useChirality: bool = False, useBondTypes: bool = True, useFeatures: bool = False, useCounts: bool = True, bitInfo: AtomPairsParameters = None, includeRedundantEnvironments: bool = False) -> UIntSparseIntVect:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<unsigned int> * __ptr64 GetMorganFingerprint(class RDKix::ROMol,unsigned int [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,bool=False [,bool=True [,bool=False [,bool=True [,class boost::python::api::object=None [,bool=False]]]]]]]])
    """
def GetMorganFingerprintAsBitVect(mol: Mol, radius: int, nBits: int = 2048, invariants: AtomPairsParameters = [], fromAtoms: AtomPairsParameters = [], useChirality: bool = False, useBondTypes: bool = True, useFeatures: bool = False, bitInfo: AtomPairsParameters = None, includeRedundantEnvironments: bool = False) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 GetMorganFingerprintAsBitVect(class RDKix::ROMol,unsigned int [,unsigned int=2048 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,bool=False [,bool=True [,bool=False [,class boost::python::api::object=None [,bool=False]]]]]]]])
    """
def GetTopologicalTorsionFingerprint(mol: Mol, targetSize: int = 4, fromAtoms: AtomPairsParameters = 0, ignoreAtoms: AtomPairsParameters = 0, atomInvariants: AtomPairsParameters = 0, includeChirality: bool = False) -> LongSparseIntVect:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<__int64> * __ptr64 GetTopologicalTorsionFingerprint(class RDKix::ROMol [,unsigned int=4 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,bool=False]]]]])
    """
def GetUSR(mol: Mol, confId: int = -1) -> list:
    """
        ...
        C++ signature :
            class boost::python::list GetUSR(class RDKix::ROMol [,int=-1])
    """
def GetUSRCAT(mol: Mol, atomSelections: AtomPairsParameters = None, confId: int = -1) -> list:
    """
        ...
        C++ signature :
            class boost::python::list GetUSRCAT(class RDKix::ROMol [,class boost::python::api::object=None [,int=-1]])
    """
...
def MQNs_(mol: Mol, force: bool = False) -> list:
    """
        C++ signature :
            class boost::python::list MQNs_(class RDKix::ROMol [,bool=False])
    """
def MakePropertyRangeQuery(name: str, min: float, max: float) -> PropertyRangeQuery:
    """
        ...
        C++ signature :
            class Queries::RangeQuery<double,class RDKix::ROMol const & __ptr64,1> * __ptr64 MakePropertyRangeQuery(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >,double,double)
    """
def PEOE_VSA_(mol: Mol, bins: AtomPairsParameters = [], force: bool = False) -> list:
    """
        C++ signature :
            class boost::python::list PEOE_VSA_(class RDKix::ROMol [,class boost::python::api::object=[] [,bool=False]])
    """
def SMR_VSA_(mol: Mol, bins: AtomPairsParameters = [], force: bool = False) -> list:
    """
        C++ signature :
            class boost::python::list SMR_VSA_(class RDKix::ROMol [,class boost::python::api::object=[] [,bool=False]])
    """
def SlogP_VSA_(mol: Mol, bins: AtomPairsParameters = [], force: bool = False) -> list:
    """
        C++ signature :
            class boost::python::list SlogP_VSA_(class RDKix::ROMol [,class boost::python::api::object=[] [,bool=False]])
    """
def _CalcCrippenContribs(mol: Mol, force: bool = False, atomTypes: list = [], atomTypeLabels: list = []) -> list:
    """
        ...
        C++ signature :
            class boost::python::list _CalcCrippenContribs(class RDKix::ROMol [,bool=False [,class boost::python::list=[] [,class boost::python::list=[]]]])
    """
def _CalcLabuteASAContribs(mol: Mol, includeHs: bool = True, force: bool = False) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple _CalcLabuteASAContribs(class RDKix::ROMol [,bool=True [,bool=False]])
    """
def _CalcMolWt(mol: Mol, onlyHeavy: bool = False) -> float:
    """
        ...
        C++ signature :
            double _CalcMolWt(class RDKix::ROMol [,bool=False])
    """
def _CalcTPSAContribs(mol: Mol, force: bool = False, includeSandP: bool = False) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple _CalcTPSAContribs(class RDKix::ROMol [,bool=False [,bool=False]])
    """
