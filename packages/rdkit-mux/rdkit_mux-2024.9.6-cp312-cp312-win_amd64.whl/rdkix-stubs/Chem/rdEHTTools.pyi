...
class EHTResults(Boost.Python.instance):
    ...
    def GetAtomicCharges(self) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetAtomicCharges(struct RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetHamiltonian(self) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetHamiltonian(struct RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetOrbitalEnergies(self) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetOrbitalEnergies(struct RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetOverlapMatrix(self) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetOverlapMatrix(struct RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetReducedChargeMatrix(self) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetReducedChargeMatrix(struct RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetReducedOverlapPopulationMatrix(self) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetReducedOverlapPopulationMatrix(struct RDKix::EHTTools::EHTResults {lvalue})
        """
    @property
...
def RunMol(mol: Mol, confId: int = -1, keepOverlapAndHamiltonianMatrices: bool = False) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple RunMol(class RDKix::ROMol [,int=-1 [,bool=False]])
    """
