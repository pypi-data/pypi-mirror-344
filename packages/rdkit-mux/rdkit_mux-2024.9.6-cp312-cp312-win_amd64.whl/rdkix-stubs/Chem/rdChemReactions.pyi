...
def CreateDifferenceFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> UIntSparseIntVect:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<unsigned int> * __ptr64 CreateDifferenceFingerprintForReaction(class RDKix::ChemicalReaction [,struct RDKix::ReactionFingerprintParams=<rdkix.Chem.rdChemReactions.ReactionFingerprintParams object at 0x00000187680A2AC0>])
    """
def CreateStructuralFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 CreateStructuralFingerprintForReaction(class RDKix::ChemicalReaction [,struct RDKix::ReactionFingerprintParams=<rdkix.Chem.rdChemReactions.ReactionFingerprintParams object at 0x00000187680A2B40>])
    """
...
def SanitizeRxn(rxn: ChemicalReaction, sanitizeOps: int = 4294967295, params: AdjustQueryParameters = ..., catchErrors: bool = False) -> SanitizeFlags:
    """
        ...
        C++ signature :
            enum RDKix::RxnOps::SanitizeRxnFlags SanitizeRxn(class RDKix::ChemicalReaction {lvalue} [,unsigned __int64=4294967295 [,struct RDKix::MolOps::AdjustQueryParameters=<rdkix.Chem.rdmolops.AdjustQueryParameters object at 0x00000187680AA0C0> [,bool=False]]])
    """
