...
try:
  ...
  from rdkix.piddle import piddle
import numpy
...
def ClusterToPDF(cluster, fileName, size=(300, 300), ptColors=[], lineWidth=None, showIndices=0,
  ...
  """
  try:
    from rdkix.sping.PDF import pidPDF
  except ImportError:
    from rdkix.piddle import piddlePDF
    pidPDF = piddlePDF
...
def ClusterToSVG(cluster, fileName, size=(300, 300), ptColors=[], lineWidth=None, showIndices=0,
  ...
  """
  try:
    from rdkix.sping.SVG import pidSVG
  except ImportError:
    from rdkix.piddle.piddleSVG import piddleSVG
    pidSVG = piddleSVG
...
def ClusterToImg(cluster, fileName, size=(300, 300), ptColors=[], lineWidth=None, showIndices=0,
  ...
  """
  try:
    from rdkix.sping.PIL import pidPIL
  except ImportError:
    from rdkix.piddle import piddlePIL
    pidPIL = piddlePIL
