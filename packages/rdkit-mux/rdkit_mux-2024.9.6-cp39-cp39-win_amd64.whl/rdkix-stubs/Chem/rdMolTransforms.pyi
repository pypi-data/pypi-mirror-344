...
def CanonicalizeConformer(conf: Conformer, center: Point3D = None, normalizeCovar: bool = False, ignoreHs: bool = True) -> None:
    """
        ...
        C++ signature :
            void CanonicalizeConformer(class RDKix::Conformer {lvalue} [,class RDGeom::Point3D const * __ptr64=None [,bool=False [,bool=True]]])
    """
def CanonicalizeMol(mol: Mol, normalizeCovar: bool = False, ignoreHs: bool = True) -> None:
    """
        ...
        C++ signature :
            void CanonicalizeMol(class RDKix::ROMol {lvalue} [,bool=False [,bool=True]])
    """
def ComputeCanonicalTransform(conf: Conformer, center: Point3D = None, normalizeCovar: bool = False, ignoreHs: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 ComputeCanonicalTransform(class RDKix::Conformer [,class RDGeom::Point3D const * __ptr64=None [,bool=False [,bool=True]]])
    """
def ComputeCentroid(conf: Conformer, ignoreHs: bool = True, weights: _vectdouble = None) -> Point3D:
    """
        ...
        C++ signature :
            class RDGeom::Point3D ComputeCentroid(class RDKix::Conformer [,bool=True [,class std::vector<double,class std::allocator<double> > const * __ptr64=None]])
    """
def ComputePrincipalAxesAndMoments(conf: Conformer, ignoreHs: bool = True, weights: typing.Any = None) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 ComputePrincipalAxesAndMoments(class RDKix::Conformer [,bool=True [,class boost::python::api::object=None]])
    """
def ComputePrincipalAxesAndMomentsFromGyrationMatrix(conf: Conformer, ignoreHs: bool = True, weights: typing.Any = None) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 ComputePrincipalAxesAndMomentsFromGyrationMatrix(class RDKix::Conformer [,bool=True [,class boost::python::api::object=None]])
    """
def GetAngleDeg(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetAngleDeg(class RDKix::Conformer,unsigned int,unsigned int,unsigned int)
    """
def GetAngleRad(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetAngleRad(class RDKix::Conformer,unsigned int,unsigned int,unsigned int)
    """
def GetBondLength(conf: Conformer, iAtomId: int, jAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetBondLength(class RDKix::Conformer,unsigned int,unsigned int)
    """
def GetDihedralDeg(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, lAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetDihedralDeg(class RDKix::Conformer,unsigned int,unsigned int,unsigned int,unsigned int)
    """
def GetDihedralRad(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, lAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetDihedralRad(class RDKix::Conformer,unsigned int,unsigned int,unsigned int,unsigned int)
    """
def SetAngleDeg(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetAngleDeg(class RDKix::Conformer {lvalue},unsigned int,unsigned int,unsigned int,double)
    """
def SetAngleRad(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetAngleRad(class RDKix::Conformer {lvalue},unsigned int,unsigned int,unsigned int,double)
    """
def SetBondLength(conf: Conformer, iAtomId: int, jAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetBondLength(class RDKix::Conformer {lvalue},unsigned int,unsigned int,double)
    """
def SetDihedralDeg(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, lAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetDihedralDeg(class RDKix::Conformer {lvalue},unsigned int,unsigned int,unsigned int,unsigned int,double)
    """
def SetDihedralRad(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, lAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetDihedralRad(class RDKix::Conformer {lvalue},unsigned int,unsigned int,unsigned int,unsigned int,double)
    """
def TransformConformer(conf: Conformer, trans: typing.Any) -> None:
    """
        ...
        C++ signature :
            void TransformConformer(class RDKix::Conformer {lvalue},class boost::python::api::object)
    """
