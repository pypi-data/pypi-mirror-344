...
class Coulomb(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeCharge: float = 1.0, absVal: bool = False, chargeKey: str = '_GasteigerCharge', softcoreParam: float = 0.0, cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKix::ROMol [,int=-1 [,double=1.0 [,bool=False [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='_GasteigerCharge' [,double=0.0 [,double=1.0]]]]]])
        """
    @typing.overload
...
class CoulombDielectric(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeCharge: float = 1.0, absVal: bool = False, chargeKey: str = '_GasteigerCharge', softcoreParam: float = 0.0, cutoff: float = 1.0, epsilon: float = 80.0, xi: float = 4.0) -> None:
        """
            ...
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKix::ROMol [,int=-1 [,double=1.0 [,bool=False [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='_GasteigerCharge' [,double=0.0 [,double=1.0 [,double=80.0 [,double=4.0]]]]]]]])
        """
    @typing.overload
...
class HBond(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeAtomType: str = 'OH', fixed: bool = True, cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKix::ROMol {lvalue} [,int=-1 [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='OH' [,bool=True [,double=1.0]]]])
        """
class Hydrophilic(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, fixed: bool = True, cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKix::ROMol {lvalue} [,int=-1 [,bool=True [,double=1.0]]])
        """
class MMFFVdWaals(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeAtomType: int = 6, scaling: bool = False, cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKix::ROMol [,int=-1 [,unsigned int=6 [,bool=False [,double=1.0]]]])
        """
class UFFVdWaals(Boost.Python.instance):
    ...
    def __init__(self, mol: Mol, confId: int = -1, probeAtomType: str = 'O_3', cutoff: float = 1.0) -> None:
        """
            ...
            C++ signature :
                void __init__(struct _object * __ptr64,class RDKix::ROMol [,int=-1 [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='O_3' [,double=1.0]]])
        """
@typing.overload
...
def ConstructGrid(mol: Mol, confId: int = -1, margin: float = 5.0, spacing: float = 0.5) -> UniformRealValueGrid3D:
    """
        ...
        C++ signature :
            class RDGeom::UniformRealValueGrid3D * __ptr64 ConstructGrid(class RDKix::ROMol [,int=-1 [,double=5.0 [,double=0.5]]])
    """
...
def WriteToCubeFile(grid: UniformRealValueGrid3D, filename: str, mol: Mol = None, confId: int = -1) -> None:
    """
        ...
        C++ signature :
            void WriteToCubeFile(class RDGeom::UniformRealValueGrid3D,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > [,class RDKix::ROMol const * __ptr64=None [,int=-1]])
    """
