...
class AtomCompare(Boost.Python.enum):
    CompareAny: typing.ClassVar[AtomCompare]  # value = rdkix.Chem.rdFMCS.AtomCompare.CompareAny
    CompareAnyHeavyAtom: typing.ClassVar[AtomCompare]  # value = rdkix.Chem.rdFMCS.AtomCompare.CompareAnyHeavyAtom
    CompareElements: typing.ClassVar[AtomCompare]  # value = rdkix.Chem.rdFMCS.AtomCompare.CompareElements
    CompareIsotopes: typing.ClassVar[AtomCompare]  # value = rdkix.Chem.rdFMCS.AtomCompare.CompareIsotopes
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'CompareAny': rdkix.Chem.rdFMCS.AtomCompare.CompareAny, 'CompareElements': rdkix.Chem.rdFMCS.AtomCompare.CompareElements, 'CompareIsotopes': rdkix.Chem.rdFMCS.AtomCompare.CompareIsotopes, 'CompareAnyHeavyAtom': rdkix.Chem.rdFMCS.AtomCompare.CompareAnyHeavyAtom}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdFMCS.AtomCompare.CompareAny, 1: rdkix.Chem.rdFMCS.AtomCompare.CompareElements, 2: rdkix.Chem.rdFMCS.AtomCompare.CompareIsotopes, 3: rdkix.Chem.rdFMCS.AtomCompare.CompareAnyHeavyAtom}
class BondCompare(Boost.Python.enum):
    CompareAny: typing.ClassVar[BondCompare]  # value = rdkix.Chem.rdFMCS.BondCompare.CompareAny
    CompareOrder: typing.ClassVar[BondCompare]  # value = rdkix.Chem.rdFMCS.BondCompare.CompareOrder
    CompareOrderExact: typing.ClassVar[BondCompare]  # value = rdkix.Chem.rdFMCS.BondCompare.CompareOrderExact
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'CompareAny': rdkix.Chem.rdFMCS.BondCompare.CompareAny, 'CompareOrder': rdkix.Chem.rdFMCS.BondCompare.CompareOrder, 'CompareOrderExact': rdkix.Chem.rdFMCS.BondCompare.CompareOrderExact}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdFMCS.BondCompare.CompareAny, 1: rdkix.Chem.rdFMCS.BondCompare.CompareOrder, 2: rdkix.Chem.rdFMCS.BondCompare.CompareOrderExact}
class MCSAcceptance(Boost.Python.instance):
    ...
    def __call__(self) -> bool:
        """
            ...
            C++ signature :
                bool __call__(struct RDKix::PyMCSAcceptance {lvalue})
        """
...
class MCSAtomCompare(Boost.Python.instance):
    ...
    def CheckAtomCharge(self, parameters: MCSAtomCompareParameters, mol1: Mol, atom1: int, mol2: Mol, atom2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckAtomCharge(struct RDKix::PyMCSAtomCompare {lvalue},struct RDKix::MCSAtomCompareParameters,class RDKix::ROMol,unsigned int,class RDKix::ROMol,unsigned int)
        """
    def CheckAtomChirality(self, parameters: MCSAtomCompareParameters, mol1: Mol, atom1: int, mol2: Mol, atom2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckAtomChirality(struct RDKix::PyMCSAtomCompare {lvalue},struct RDKix::MCSAtomCompareParameters,class RDKix::ROMol,unsigned int,class RDKix::ROMol,unsigned int)
        """
    def CheckAtomRingMatch(self, parameters: MCSAtomCompareParameters, mol1: Mol, atom1: int, mol2: Mol, atom2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckAtomRingMatch(struct RDKix::PyMCSAtomCompare {lvalue},struct RDKix::MCSAtomCompareParameters,class RDKix::ROMol,unsigned int,class RDKix::ROMol,unsigned int)
        """
    def __call__(self, parameters: MCSAtomCompareParameters, mol1: Mol, atom1: int, mol2: Mol, atom2: int) -> bool:
        """
            ...
            C++ signature :
                bool __call__(struct RDKix::PyMCSAtomCompare {lvalue},struct RDKix::MCSAtomCompareParameters,class RDKix::ROMol,unsigned int,class RDKix::ROMol,unsigned int)
        """
    def __init__(self) -> None:
        """
            C++ signature :
...
class MCSBondCompare(Boost.Python.instance):
    ...
    def CheckBondRingMatch(self, parameters: MCSBondCompareParameters, mol1: Mol, bond1: int, mol2: Mol, bond2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckBondRingMatch(struct RDKix::PyMCSBondCompare {lvalue},struct RDKix::MCSBondCompareParameters,class RDKix::ROMol,unsigned int,class RDKix::ROMol,unsigned int)
        """
    def CheckBondStereo(self, parameters: MCSBondCompareParameters, mol1: Mol, bond1: int, mol2: Mol, bond2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckBondStereo(struct RDKix::PyMCSBondCompare {lvalue},struct RDKix::MCSBondCompareParameters,class RDKix::ROMol,unsigned int,class RDKix::ROMol,unsigned int)
        """
    def __call__(self, parameters: MCSBondCompareParameters, mol1: Mol, bond1: int, mol2: Mol, bond2: int) -> bool:
        """
            ...
            C++ signature :
                bool __call__(struct RDKix::PyMCSBondCompare {lvalue},struct RDKix::MCSBondCompareParameters,class RDKix::ROMol,unsigned int,class RDKix::ROMol,unsigned int)
        """
    def __init__(self) -> None:
        """
            C++ signature :
...
class MCSFinalMatchCheck(Boost.Python.instance):
    ...
    def __call__(self) -> bool:
        """
            ...
            C++ signature :
                bool __call__(struct RDKix::PyMCSFinalMatchCheck {lvalue})
        """
    def __init__(self) -> None:
        """
            C++ signature :
...
class MCSProgress(Boost.Python.instance):
    ...
    def __call__(self, stat: typing.Any, parameters: typing.Any) -> bool:
        """
            ...
            C++ signature :
                bool __call__(struct RDKix::PyMCSProgress {lvalue},struct RDKix::MCSProgressData,struct RDKix::MCSParameters)
        """
    def __init__(self) -> None:
        """
            C++ signature :
...
class RingCompare(Boost.Python.enum):
    IgnoreRingFusion: typing.ClassVar[RingCompare]  # value = rdkix.Chem.rdFMCS.RingCompare.IgnoreRingFusion
    PermissiveRingFusion: typing.ClassVar[RingCompare]  # value = rdkix.Chem.rdFMCS.RingCompare.PermissiveRingFusion
    StrictRingFusion: typing.ClassVar[RingCompare]  # value = rdkix.Chem.rdFMCS.RingCompare.StrictRingFusion
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'IgnoreRingFusion': rdkix.Chem.rdFMCS.RingCompare.IgnoreRingFusion, 'PermissiveRingFusion': rdkix.Chem.rdFMCS.RingCompare.PermissiveRingFusion, 'StrictRingFusion': rdkix.Chem.rdFMCS.RingCompare.StrictRingFusion}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdFMCS.RingCompare.IgnoreRingFusion, 1: rdkix.Chem.rdFMCS.RingCompare.PermissiveRingFusion, 2: rdkix.Chem.rdFMCS.RingCompare.StrictRingFusion}
@typing.overload
def FindMCS(mols: typing.Any, maximizeBonds: bool = True, threshold: float = 1.0, timeout: int = 3600, verbose: bool = False, matchValences: bool = False, ringMatchesRingOnly: bool = False, completeRingsOnly: bool = False, matchChiralTag: bool = False, atomCompare: AtomCompare = ..., bondCompare: BondCompare = ..., ringCompare: RingCompare = ..., seedSmarts: str = '') -> MCSResult:
    """
        ...
        C++ signature :
            struct RDKix::MCSResult * __ptr64 FindMCS(class boost::python::api::object [,bool=True [,double=1.0 [,unsigned int=3600 [,bool=False [,bool=False [,bool=False [,bool=False [,bool=False [,enum RDKix::AtomComparator=rdkix.Chem.rdFMCS.AtomCompare.CompareElements [,enum RDKix::BondComparator=rdkix.Chem.rdFMCS.BondCompare.CompareOrder [,enum RDKix::RingComparator=rdkix.Chem.rdFMCS.RingCompare.IgnoreRingFusion [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='']]]]]]]]]]]])
    """
@typing.overload
def FindMCS(mols: typing.Any, parameters: MCSParameters) -> MCSResult:
    """
        ...
        C++ signature :
            struct RDKix::MCSResult * __ptr64 FindMCS(class boost::python::api::object,class RDKix::PyMCSParameters {lvalue})
    """
