...
def MolHash(mol: Mol, func: HashFunction, useCxSmiles: bool = False, cxFlagsToSkip: int = 0) -> str:
    """
        ...
        C++ signature :
            class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > MolHash(class RDKix::ROMol,enum RDKix::MolHash::HashFunction [,bool=False [,unsigned int=0]])
    """
