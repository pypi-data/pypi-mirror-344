...
class JSONWriteParameters(Boost.Python.instance):
    ...
    def __init__(self) -> None:
        ...
        """
    @property
    def useRDKixExtensions(*args, **kwargs):
        """
        use RDKix extensions to the commonchem format
        """
    @useRDKixExtensions.setter
    def useRDKixExtensions(*args, **kwargs):
        ...
...
def MolToJSON(mol: Mol, params: typing.Any = None) -> str:
    """
        ...
        C++ signature :
            class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > MolToJSON(class RDKix::ROMol [,class boost::python::api::object=None])
    """
