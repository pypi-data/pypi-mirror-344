...
def CanonicalizeConformer(conf: Conformer, center: Point3D = None, normalizeCovar: bool = False, ignoreHs: bool = True) -> None:
    """
        ...
        C++ signature :
            void CanonicalizeConformer(RDKix::Conformer {lvalue} [,RDGeom::Point3D const*=None [,bool=False [,bool=True]]])
    """
def CanonicalizeMol(mol: Mol, normalizeCovar: bool = False, ignoreHs: bool = True) -> None:
    """
        ...
        C++ signature :
            void CanonicalizeMol(RDKix::ROMol {lvalue} [,bool=False [,bool=True]])
    """
def ComputeCanonicalTransform(conf: Conformer, center: Point3D = None, normalizeCovar: bool = False, ignoreHs: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            _object* ComputeCanonicalTransform(RDKix::Conformer [,RDGeom::Point3D const*=None [,bool=False [,bool=True]]])
    """
def ComputeCentroid(conf: Conformer, ignoreHs: bool = True, weights: _vectd = None) -> Point3D:
    """
        ...
        C++ signature :
            RDGeom::Point3D ComputeCentroid(RDKix::Conformer [,bool=True [,std::__1::vector<double, std::__1::allocator<double>> const*=None]])
    """
def ComputePrincipalAxesAndMoments(conf: Conformer, ignoreHs: bool = True, weights: typing.Any = None) -> typing.Any:
    """
        ...
        C++ signature :
            _object* ComputePrincipalAxesAndMoments(RDKix::Conformer [,bool=True [,boost::python::api::object=None]])
    """
def ComputePrincipalAxesAndMomentsFromGyrationMatrix(conf: Conformer, ignoreHs: bool = True, weights: typing.Any = None) -> typing.Any:
    """
        ...
        C++ signature :
            _object* ComputePrincipalAxesAndMomentsFromGyrationMatrix(RDKix::Conformer [,bool=True [,boost::python::api::object=None]])
    """
def GetAngleDeg(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetAngleDeg(RDKix::Conformer,unsigned int,unsigned int,unsigned int)
    """
def GetAngleRad(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetAngleRad(RDKix::Conformer,unsigned int,unsigned int,unsigned int)
    """
def GetBondLength(conf: Conformer, iAtomId: int, jAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetBondLength(RDKix::Conformer,unsigned int,unsigned int)
    """
def GetDihedralDeg(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, lAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetDihedralDeg(RDKix::Conformer,unsigned int,unsigned int,unsigned int,unsigned int)
    """
def GetDihedralRad(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, lAtomId: int) -> float:
    """
        ...
        C++ signature :
            double GetDihedralRad(RDKix::Conformer,unsigned int,unsigned int,unsigned int,unsigned int)
    """
def SetAngleDeg(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetAngleDeg(RDKix::Conformer {lvalue},unsigned int,unsigned int,unsigned int,double)
    """
def SetAngleRad(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetAngleRad(RDKix::Conformer {lvalue},unsigned int,unsigned int,unsigned int,double)
    """
def SetBondLength(conf: Conformer, iAtomId: int, jAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetBondLength(RDKix::Conformer {lvalue},unsigned int,unsigned int,double)
    """
def SetDihedralDeg(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, lAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetDihedralDeg(RDKix::Conformer {lvalue},unsigned int,unsigned int,unsigned int,unsigned int,double)
    """
def SetDihedralRad(conf: Conformer, iAtomId: int, jAtomId: int, kAtomId: int, lAtomId: int, value: float) -> None:
    """
        ...
        C++ signature :
            void SetDihedralRad(RDKix::Conformer {lvalue},unsigned int,unsigned int,unsigned int,unsigned int,double)
    """
def TransformConformer(conf: Conformer, trans: typing.Any) -> None:
    """
        ...
        C++ signature :
            void TransformConformer(RDKix::Conformer {lvalue},boost::python::api::object)
    """
