...
__all__ = ['RDConfig', 'binaryHolder', 'binaryTypeName', 'connect', 'dbFileWildcard', 'fileWildcard', 'getDbSql', 'getTablesAndViewsSql', 'getTablesSql', 'placeHolder', 'sqlBinTypes', 'sqlFloatTypes', 'sqlIntTypes', 'sqlTextTypes', 'sqlite']
def connect(x, *args):
    ...
