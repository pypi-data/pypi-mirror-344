...
class UniformGrid3D_(Boost.Python.instance):
    ...
    def GetOccupancyVect(self) -> DiscreteValueVect:
        """
            ...
            C++ signature :
                RDKix::DiscreteValueVect const* GetOccupancyVect(RDGeom::UniformGrid3D {lvalue})
        """
...
class UniformRealValueGrid3D(Boost.Python.instance):
    ...
    def GetOccupancyVect(arg1: UniformRealValueGrid3D) -> RealValueVect:
        """
            ...
            C++ signature :
                RDKix::RealValueVect const* GetOccupancyVect(RDGeom::UniformRealValueGrid3D {lvalue})
        """
    @staticmethod
...
def UniformGrid3D(dimX: float, dimY: float, dimZ: float, spacing: float = 0.5, valType: DiscreteValueType = ..., offSet: Point3D = None) -> UniformGrid3D_:
    """
        ...
        C++ signature :
            RDGeom::UniformGrid3D* UniformGrid3D(double,double,double [,double=0.5 [,RDKix::DiscreteValueVect::DiscreteValueType=rdkix.DataStructs.cDataStructs.DiscreteValueType.TWOBITVALUE [,RDGeom::Point3D const*=None]]])
    """
