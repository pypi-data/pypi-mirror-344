...
class RascalResult(Boost.Python.instance):
    ...
    def atomMatches(self) -> list:
        """
            ...
            C++ signature :
                class boost::python::list atomMatches(class RDKix::RascalMCES::RascalResult)
        """
    def bondMatches(self) -> list:
        """
            ...
            C++ signature :
                class boost::python::list bondMatches(class RDKix::RascalMCES::RascalResult)
        """
    def largestFragmentOnly(self) -> None:
        """
            ...
            C++ signature :
                void largestFragmentOnly(class RDKix::RascalMCES::RascalResult {lvalue})
        """
    @property
...
def FindMCES(mol1: Mol, mol2: Mol, opts: typing.Any = None) -> list:
    """
        ...
        C++ signature :
            class boost::python::list FindMCES(class RDKix::ROMol,class RDKix::ROMol [,class boost::python::api::object=None])
    """
