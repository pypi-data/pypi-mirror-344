...
class MolChemicalFeature(Boost.Python.instance):
    ...
    def ClearCache(self) -> None:
        """
            ...
            C++ signature :
                void ClearCache(class RDKix::MolChemicalFeature {lvalue})
        """
    def GetActiveConformer(self) -> int:
        """
            ...
            C++ signature :
                int GetActiveConformer(class RDKix::MolChemicalFeature {lvalue})
        """
    def GetAtomIds(self) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetAtomIds(class RDKix::MolChemicalFeature)
        """
    def GetFactory(self) -> MolChemicalFeatureFactory:
        """
            ...
            C++ signature :
                class RDKix::MolChemicalFeatureFactory const * __ptr64 GetFactory(class RDKix::MolChemicalFeature {lvalue})
        """
    def GetFamily(self) -> str:
        """
            ...
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > GetFamily(class RDKix::MolChemicalFeature {lvalue})
        """
    def GetId(self) -> int:
        """
            ...
            C++ signature :
                int GetId(class RDKix::MolChemicalFeature {lvalue})
        """
    def GetMol(self) -> rdkix.Chem.Mol:
        """
            ...
            C++ signature :
                class RDKix::ROMol const * __ptr64 GetMol(class RDKix::MolChemicalFeature {lvalue})
        """
    @typing.overload
    def GetPos(self, confId: int) -> Point3D:
        """
            ...
            C++ signature :
                class RDGeom::Point3D GetPos(class RDKix::MolChemicalFeature {lvalue},int)
        """
    @typing.overload
    def GetPos(self) -> Point3D:
        """
            ...
            C++ signature :
                class RDGeom::Point3D GetPos(class RDKix::MolChemicalFeature {lvalue})
        """
    def GetType(self) -> str:
        """
            ...
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > GetType(class RDKix::MolChemicalFeature {lvalue})
        """
    def SetActiveConformer(self, confId: int) -> None:
        """
            ...
            C++ signature :
                void SetActiveConformer(class RDKix::MolChemicalFeature {lvalue},int)
        """
class MolChemicalFeatureFactory(Boost.Python.instance):
    ...
    def GetFeatureDefs(self) -> dict:
        """
            ...
            C++ signature :
                class boost::python::dict GetFeatureDefs(class RDKix::MolChemicalFeatureFactory)
        """
    def GetFeatureFamilies(self) -> tuple:
        """
            ...
            C++ signature :
                class boost::python::tuple GetFeatureFamilies(class RDKix::MolChemicalFeatureFactory)
        """
    def GetMolFeature(self, mol: Mol, idx: int, includeOnly: str = '', recompute: bool = True, confId: int = -1) -> MolChemicalFeature:
        """
            ...
            C++ signature :
                class boost::shared_ptr<class RDKix::MolChemicalFeature> GetMolFeature(class RDKix::MolChemicalFeatureFactory,class RDKix::ROMol,int [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='' [,bool=True [,int=-1]]])
        """
    def GetNumFeatureDefs(self) -> int:
        """
            ...
            C++ signature :
                int GetNumFeatureDefs(class RDKix::MolChemicalFeatureFactory {lvalue})
        """
    def GetNumMolFeatures(self, mol: Mol, includeOnly: str = '') -> int:
        """
            ...
            C++ signature :
                int GetNumMolFeatures(class RDKix::MolChemicalFeatureFactory,class RDKix::ROMol [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >=''])
        """
def BuildFeatureFactory(fileName: str) -> MolChemicalFeatureFactory:
    """
        ...
        C++ signature :
            class RDKix::MolChemicalFeatureFactory * __ptr64 BuildFeatureFactory(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
    """
def BuildFeatureFactoryFromString(fdefString: str) -> MolChemicalFeatureFactory:
    """
        ...
        C++ signature :
            class RDKix::MolChemicalFeatureFactory * __ptr64 BuildFeatureFactoryFromString(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
    """
