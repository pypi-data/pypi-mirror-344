...
def ComputeConfBox(conf: Conformer, trans: typing.Any = None, padding: float = 2.0) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple ComputeConfBox(class RDKix::Conformer [,class boost::python::api::object=None [,double=2.0]])
    """
def ComputeConfDimsAndOffset(conf: Conformer, trans: typing.Any = None, padding: float = 2.0) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple ComputeConfDimsAndOffset(class RDKix::Conformer [,class boost::python::api::object=None [,double=2.0]])
    """
...
def EncodeShape(mol: Mol, grid: UniformGrid3D_, confId: int = -1, trans: typing.Any = None, vdwScale: float = 0.8, stepSize: float = 0.25, maxLayers: int = -1, ignoreHs: bool = True) -> None:
    """
        ...
        C++ signature :
            void EncodeShape(class RDKix::ROMol,class RDGeom::UniformGrid3D {lvalue} [,int=-1 [,class boost::python::api::object=None [,double=0.8 [,double=0.25 [,int=-1 [,bool=True]]]]]])
    """
def ShapeProtrudeDist(mol1: Mol, mol2: Mol, confId1: int = -1, confId2: int = -1, gridSpacing: float = 0.5, bitsPerPoint: DiscreteValueType = ..., vdwScale: float = 0.8, stepSize: float = 0.25, maxLayers: int = -1, ignoreHs: bool = True, allowReordering: bool = True) -> float:
    """
        ...
        C++ signature :
            double ShapeProtrudeDist(class RDKix::ROMol,class RDKix::ROMol [,int=-1 [,int=-1 [,double=0.5 [,enum RDKix::DiscreteValueVect::DiscreteValueType=rdkix.DataStructs.cDataStructs.DiscreteValueType.TWOBITVALUE [,double=0.8 [,double=0.25 [,int=-1 [,bool=True [,bool=True]]]]]]]]])
    """
def ShapeTanimotoDist(mol1: Mol, mol2: Mol, confId1: int = -1, confId2: int = -1, gridSpacing: float = 0.5, bitsPerPoint: DiscreteValueType = ..., vdwScale: float = 0.8, stepSize: float = 0.25, maxLayers: int = -1, ignoreHs: bool = True) -> float:
    """
        ...
        C++ signature :
            double ShapeTanimotoDist(class RDKix::ROMol,class RDKix::ROMol [,int=-1 [,int=-1 [,double=0.5 [,enum RDKix::DiscreteValueVect::DiscreteValueType=rdkix.DataStructs.cDataStructs.DiscreteValueType.TWOBITVALUE [,double=0.8 [,double=0.25 [,int=-1 [,bool=True]]]]]]]])
    """
def ShapeTverskyIndex(mol1: Mol, mol2: Mol, alpha: float, beta: float, confId1: int = -1, confId2: int = -1, gridSpacing: float = 0.5, bitsPerPoint: DiscreteValueType = ..., vdwScale: float = 0.8, stepSize: float = 0.25, maxLayers: int = -1, ignoreHs: bool = True) -> float:
    """
        ...
        C++ signature :
            double ShapeTverskyIndex(class RDKix::ROMol,class RDKix::ROMol,double,double [,int=-1 [,int=-1 [,double=0.5 [,enum RDKix::DiscreteValueVect::DiscreteValueType=rdkix.DataStructs.cDataStructs.DiscreteValueType.TWOBITVALUE [,double=0.8 [,double=0.25 [,int=-1 [,bool=True]]]]]]]])
    """
