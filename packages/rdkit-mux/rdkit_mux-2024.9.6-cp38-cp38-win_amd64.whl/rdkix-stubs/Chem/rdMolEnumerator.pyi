...
class MolEnumeratorParams(Boost.Python.instance):
    ...
    def SetEnumerationOperator(self, typ: EnumeratorType) -> None:
        """
            ...
            C++ signature :
                void SetEnumerationOperator(struct RDKix::MolEnumerator::MolEnumeratorParams * __ptr64,enum `anonymous namespace'::EnumeratorTypes)
        """
    @typing.overload
...
def Enumerate(mol: Mol, maxPerOperation: int = 0) -> rdkix.Chem.MolBundle:
    """
        ...
        C++ signature :
            class RDKix::MolBundle * __ptr64 Enumerate(class RDKix::ROMol [,unsigned int=0])
    """
@typing.overload
def Enumerate(mol: Mol, enumParams: MolEnumeratorParams) -> rdkix.Chem.MolBundle:
    """
        ...
        C++ signature :
            class RDKix::MolBundle * __ptr64 Enumerate(class RDKix::ROMol,struct RDKix::MolEnumerator::MolEnumeratorParams)
    """
