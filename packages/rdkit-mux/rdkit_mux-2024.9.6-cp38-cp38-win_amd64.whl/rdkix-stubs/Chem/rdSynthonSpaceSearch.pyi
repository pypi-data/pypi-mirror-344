...
class SubstructureResult(Boost.Python.instance):
    ...
    def GetCancelled(arg1: SubstructureResult) -> bool:
        """
            ...
            C++ signature :
                bool GetCancelled(class RDKix::SynthonSpaceSearch::SearchResults {lvalue})
        """
    @staticmethod
    def GetMaxNumResults(arg1: SubstructureResult) -> int:
        """
            ...
            C++ signature :
                unsigned __int64 GetMaxNumResults(class RDKix::SynthonSpaceSearch::SearchResults {lvalue})
        """
    @staticmethod
    def GetTimedOut(arg1: SubstructureResult) -> bool:
        """
            ...
            C++ signature :
                bool GetTimedOut(class RDKix::SynthonSpaceSearch::SearchResults {lvalue})
        """
    @staticmethod
    ...
    def GetHitMolecules(self) -> list:
        """
            ...
            C++ signature :
                class boost::python::list GetHitMolecules(class RDKix::SynthonSpaceSearch::SearchResults)
        """
class SynthonSpace(Boost.Python.instance):
    ...
    def BuildSynthonFingerprints(self, fingerprintGenerator: typing.Any) -> None:
        """
            ...
            C++ signature :
                void BuildSynthonFingerprints(class RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},class RDKix::FingerprintGenerator<unsigned __int64>)
        """
    def FingerprintSearch(self, query: Mol, fingerprintGenerator: typing.Any, params: typing.Any = None) -> SubstructureResult:
        """
            ...
            C++ signature :
                class RDKix::SynthonSpaceSearch::SearchResults FingerprintSearch(class RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},class RDKix::ROMol,class boost::python::api::object [,class boost::python::api::object=None])
        """
    def GetNumProducts(self) -> int:
        """
            ...
            C++ signature :
                __int64 GetNumProducts(class RDKix::SynthonSpaceSearch::SynthonSpace {lvalue})
        """
    def GetNumReactions(self) -> int:
        """
            ...
            C++ signature :
                unsigned __int64 GetNumReactions(class RDKix::SynthonSpaceSearch::SynthonSpace {lvalue})
        """
    def ReadDBFile(self, inFile: str) -> None:
        """
            ...
            C++ signature :
                void ReadDBFile(class RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
        """
    def ReadTextFile(self, inFile: str) -> None:
        """
            ...
            C++ signature :
                void ReadTextFile(class RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
        """
    def SubstructureSearch(self, query: Mol, params: typing.Any = None) -> SubstructureResult:
        """
            ...
            C++ signature :
                class RDKix::SynthonSpaceSearch::SearchResults SubstructureSearch(class RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},class RDKix::ROMol [,class boost::python::api::object=None])
        """
    def Summarise(self) -> None:
        """
            ...
            C++ signature :
                void Summarise(class RDKix::SynthonSpaceSearch::SynthonSpace)
        """
    def WriteDBFile(self, outFile: str) -> None:
        """
            ...
            C++ signature :
                void WriteDBFile(class RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
        """
    def WriteEnumeratedFile(self, outFile: str) -> None:
        """
            ...
            C++ signature :
                void WriteEnumeratedFile(class RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
        """
...
class SynthonSpaceSearchParams(Boost.Python.instance):
    ...
    def approxSimilarityAdjuster(*args, **kwargs):
        """
        The fingerprint search uses an approximate similarity method before building a product and doing a final check.  The similarityCutoff is reduced by this value for the approximate check.  A lower value will give faster run times at the risk of missing some hits.  The value you use should have a positive correlation with your FOMO.  The default of 0.1 is appropriate for Morgan fingerprints.  With RDKix fingerprints, 0.05 is adequate, and higher than that has been seen to produce long run times.
        """
