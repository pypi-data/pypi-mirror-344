...
def ConfigToNumElectrons(config, ignoreFullD = 0, ignoreFullF = 0):
    ...
    """
def GetAtomicData(atomDict, descriptorsDesired, dBase = '/project/build/temp.linux-aarch64-cpython-39/rdkix_install/share/RDKix/Data/atomdb.gdb', table = 'atomic_data', where = '', user = 'sysdba', password = 'masterkey', includeElCounts = 0):
    """
...
def SplitComposition(compStr):
    ...
    """
_atomDbName: str = '/project/build/temp.linux-aarch64-cpython-39/rdkix_install/share/RDKix/Data/atomdb.gdb'
