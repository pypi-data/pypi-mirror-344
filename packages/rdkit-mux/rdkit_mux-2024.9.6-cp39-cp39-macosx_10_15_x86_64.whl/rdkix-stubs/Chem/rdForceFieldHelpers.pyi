...
def CreateEmptyForceFieldForMol(mol: Mol, confId: int = -1) -> typing.Any:
    """
        ...
        C++ signature :
            ForceFields::PyForceField* CreateEmptyForceFieldForMol(RDKix::ROMol {lvalue} [,int=-1])
    """
def GetUFFAngleBendParams(mol: Mol, idx1: int, idx2: int, idx3: int) -> typing.Any:
    """
        ...
        C++ signature :
            _object* GetUFFAngleBendParams(RDKix::ROMol,unsigned int,unsigned int,unsigned int)
    """
def GetUFFBondStretchParams(mol: Mol, idx1: int, idx2: int) -> typing.Any:
    """
        ...
        C++ signature :
            _object* GetUFFBondStretchParams(RDKix::ROMol,unsigned int,unsigned int)
    """
def GetUFFInversionParams(mol: Mol, idx1: int, idx2: int, idx3: int, idx4: int) -> typing.Any:
    """
        ...
        C++ signature :
            _object* GetUFFInversionParams(RDKix::ROMol,unsigned int,unsigned int,unsigned int,unsigned int)
    """
def GetUFFTorsionParams(mol: Mol, idx1: int, idx2: int, idx3: int, idx4: int) -> typing.Any:
    """
        ...
        C++ signature :
            _object* GetUFFTorsionParams(RDKix::ROMol,unsigned int,unsigned int,unsigned int,unsigned int)
    """
def GetUFFVdWParams(mol: Mol, idx1: int, idx2: int) -> typing.Any:
    """
        ...
        C++ signature :
            _object* GetUFFVdWParams(RDKix::ROMol,unsigned int,unsigned int)
    """
def MMFFGetMoleculeForceField(mol: Mol, pyMMFFMolProperties: typing.Any, nonBondedThresh: float = 100.0, confId: int = -1, ignoreInterfragInteractions: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            ForceFields::PyForceField* MMFFGetMoleculeForceField(RDKix::ROMol {lvalue},ForceFields::PyMMFFMolProperties* [,double=100.0 [,int=-1 [,bool=True]]])
    """
def MMFFGetMoleculeProperties(mol: Mol, mmffVariant: str = 'MMFF94', mmffVerbosity: int = 0) -> typing.Any:
    """
        ...
        C++ signature :
            ForceFields::PyMMFFMolProperties* MMFFGetMoleculeProperties(RDKix::ROMol {lvalue} [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>='MMFF94' [,unsigned int=0]])
    """
def MMFFHasAllMoleculeParams(mol: Mol) -> bool:
    """
        ...
        C++ signature :
            bool MMFFHasAllMoleculeParams(RDKix::ROMol)
    """
def MMFFOptimizeMolecule(mol: Mol, mmffVariant: str = 'MMFF94', maxIters: int = 200, nonBondedThresh: float = 100.0, confId: int = -1, ignoreInterfragInteractions: bool = True) -> int:
    """
        ...
        C++ signature :
            int MMFFOptimizeMolecule(RDKix::ROMol {lvalue} [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>='MMFF94' [,int=200 [,double=100.0 [,int=-1 [,bool=True]]]]])
    """
def MMFFOptimizeMoleculeConfs(self: Mol, numThreads: int = 1, maxIters: int = 200, mmffVariant: str = 'MMFF94', nonBondedThresh: float = 100.0, ignoreInterfragInteractions: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object MMFFOptimizeMoleculeConfs(RDKix::ROMol {lvalue} [,int=1 [,int=200 [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>='MMFF94' [,double=100.0 [,bool=True]]]]])
    """
def MMFFSanitizeMolecule(mol: Mol) -> int:
    """
        ...
        C++ signature :
            unsigned int MMFFSanitizeMolecule(RDKix::ROMol {lvalue})
    """
...
def OptimizeMoleculeConfs(mol: Mol, ff: typing.Any, numThreads: int = 1, maxIters: int = 200) -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object OptimizeMoleculeConfs(RDKix::ROMol {lvalue},ForceFields::PyForceField {lvalue} [,int=1 [,int=200]])
    """
def UFFGetMoleculeForceField(mol: Mol, vdwThresh: float = 10.0, confId: int = -1, ignoreInterfragInteractions: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            ForceFields::PyForceField* UFFGetMoleculeForceField(RDKix::ROMol {lvalue} [,double=10.0 [,int=-1 [,bool=True]]])
    """
def UFFHasAllMoleculeParams(mol: Mol) -> bool:
    """
        ...
        C++ signature :
            bool UFFHasAllMoleculeParams(RDKix::ROMol)
    """
def UFFOptimizeMolecule(self: Mol, maxIters: int = 200, vdwThresh: float = 10.0, confId: int = -1, ignoreInterfragInteractions: bool = True) -> int:
    """
        ...
        C++ signature :
            int UFFOptimizeMolecule(RDKix::ROMol {lvalue} [,int=200 [,double=10.0 [,int=-1 [,bool=True]]]])
    """
def UFFOptimizeMoleculeConfs(self: Mol, numThreads: int = 1, maxIters: int = 200, vdwThresh: float = 10.0, ignoreInterfragInteractions: bool = True) -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object UFFOptimizeMoleculeConfs(RDKix::ROMol {lvalue} [,int=1 [,int=200 [,double=10.0 [,bool=True]]]])
    """
