...
from rdkix.Chem.EState.EState import EStateIndices as EStateIndices_
from rdkix.Chem.MolSurf import _LabuteHelper as VSAContribs_
__all__ = ['EStateIndices_', 'EState_VSA1', 'EState_VSA10', 'EState_VSA11', 'EState_VSA2', 'EState_VSA3', 'EState_VSA4', 'EState_VSA5', 'EState_VSA6', 'EState_VSA7', 'EState_VSA8', 'EState_VSA9', 'EState_VSA_', 'VSAContribs_', 'VSA_EState_', 'bisect', 'estateBins', 'numpy', 'vsaBins']
def EState_VSA1(mol):
    """
