...
def Compute2DCoords(mol: Mol, canonOrient: bool = True, clearConfs: bool = True, coordMap: dict = {}, nFlipsPerSample: int = 0, nSample: int = 0, sampleSeed: int = 0, permuteDeg4Nodes: bool = False, bondLength: float = -1.0, forceRDKix: bool = False, useRingTemplates: bool = False) -> int:
    """
        ...
        C++ signature :
            unsigned int Compute2DCoords(RDKix::ROMol {lvalue} [,bool=True [,bool=True [,boost::python::dict {lvalue}={} [,unsigned int=0 [,unsigned int=0 [,int=0 [,bool=False [,double=-1.0 [,bool=False [,bool=False]]]]]]]]]])
    """
def Compute2DCoordsMimicDistmat(mol: Mol, distMat: typing.Any, canonOrient: bool = False, clearConfs: bool = True, weightDistMat: float = 0.5, nFlipsPerSample: int = 3, nSample: int = 100, sampleSeed: int = 100, permuteDeg4Nodes: bool = True, bondLength: float = -1.0, forceRDKix: bool = False) -> int:
    """
        ...
        C++ signature :
            unsigned int Compute2DCoordsMimicDistmat(RDKix::ROMol {lvalue},boost::python::api::object [,bool=False [,bool=True [,double=0.5 [,unsigned int=3 [,unsigned int=100 [,int=100 [,bool=True [,double=-1.0 [,bool=False]]]]]]]]])
    """
@typing.overload
def GenerateDepictionMatching2DStructure(mol: Mol, reference: Mol, confId: int = -1, refPatt: typing.Any = None, params: typing.Any = None) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple GenerateDepictionMatching2DStructure(RDKix::ROMol {lvalue},RDKix::ROMol [,int=-1 [,boost::python::api::object=None [,boost::python::api::object=None]]])
    """
@typing.overload
def GenerateDepictionMatching2DStructure(mol: Mol, reference: Mol, confId: int = -1, refPatt: typing.Any = None, acceptFailure: bool = False, forceRDKix: bool = False, allowRGroups: bool = False) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple GenerateDepictionMatching2DStructure(RDKix::ROMol {lvalue},RDKix::ROMol [,int=-1 [,boost::python::api::object=None [,bool=False [,bool=False [,bool=False]]]]])
    """
@typing.overload
def GenerateDepictionMatching2DStructure(mol: Mol, reference: Mol, atomMap: typing.Any, confId: int = -1, params: typing.Any = None) -> None:
    """
        ...
        C++ signature :
            void GenerateDepictionMatching2DStructure(RDKix::ROMol {lvalue},RDKix::ROMol,boost::python::api::object [,int=-1 [,boost::python::api::object=None]])
    """
@typing.overload
def GenerateDepictionMatching2DStructure(mol: Mol, reference: Mol, atomMap: typing.Any, confId: int, forceRDKix: bool) -> None:
    """
        ...
        C++ signature :
            void GenerateDepictionMatching2DStructure(RDKix::ROMol {lvalue},RDKix::ROMol,boost::python::api::object,int,bool)
    """
def GenerateDepictionMatching3DStructure(mol: Mol, reference: Mol, confId: int = -1, refPatt: typing.Any = None, acceptFailure: bool = False, forceRDKix: bool = False) -> None:
    """
        ...
        C++ signature :
            void GenerateDepictionMatching3DStructure(RDKix::ROMol {lvalue},RDKix::ROMol {lvalue} [,int=-1 [,boost::python::api::object=None [,bool=False [,bool=False]]]])
    """
...
def NormalizeDepiction(mol: Mol, confId: int = -1, canonicalize: int = 1, scaleFactor: float = -1.0) -> float:
    """
        ...
        C++ signature :
            double NormalizeDepiction(RDKix::ROMol {lvalue} [,int=-1 [,int=1 [,double=-1.0]]])
    """
...
def StraightenDepiction(mol: Mol, confId: int = -1, minimizeRotation: bool = False) -> None:
    """
        ...
        C++ signature :
            void StraightenDepiction(RDKix::ROMol {lvalue} [,int=-1 [,bool=False]])
    """
