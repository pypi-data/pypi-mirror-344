...
class MolDraw2D(Boost.Python.instance):
    ...
    def DrawMolecule(self, mol: Mol, highlightAtoms: typing.Any = None, highlightAtomColors: typing.Any = None, highlightAtomRadii: typing.Any = None, confId: int = -1, legend: str = '') -> None:
        """
            ...
            C++ signature :
                void DrawMolecule(RDKix::MolDraw2D {lvalue},RDKix::ROMol [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,int=-1 [,std::string='']]]]])
        """
    @typing.overload
    def DrawMolecule(self, mol: Mol, highlightAtoms: typing.Any, highlightBonds: typing.Any, highlightAtomColors: typing.Any = None, highlightBondColors: typing.Any = None, highlightAtomRadii: typing.Any = None, confId: int = -1, legend: str = '') -> None:
        """
            ...
            C++ signature :
                void DrawMolecule(RDKix::MolDraw2D {lvalue},RDKix::ROMol,boost::python::api::object,boost::python::api::object [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,int=-1 [,std::string='']]]]])
        """
    def DrawMoleculeWithHighlights(self, mol: Mol, legend: str, highlight_atom_map: typing.Any, highlight_bond_map: typing.Any, highlight_radii: typing.Any, highlight_linewidth_multipliers: typing.Any, confId: int = -1) -> None:
        """
            ...
            C++ signature :
                void DrawMoleculeWithHighlights(RDKix::MolDraw2D {lvalue},RDKix::ROMol,std::string,boost::python::api::object,boost::python::api::object,boost::python::api::object,boost::python::api::object [,int=-1])
        """
    ...
    def DrawString(self, string: str, pos: Point2D, rawCoords: bool = False) -> None:
        """
            ...
            C++ signature :
                void DrawString(RDKix::MolDraw2D {lvalue},std::string,RDGeom::Point2D [,bool=False])
        """
    @typing.overload
    def DrawString(self, string: str, pos: Point2D, align: int, rawCoords: bool = False) -> None:
        """
            ...
            C++ signature :
                void DrawString(RDKix::MolDraw2D {lvalue},std::string,RDGeom::Point2D,int [,bool=False])
        """
    ...
    def GetMolSize(self, mol: Mol, highlightAtoms: typing.Any = None, highlightBonds: typing.Any = None, highlightAtomColors: typing.Any = None, highlightBondColors: typing.Any = None, highlightAtomRadii: typing.Any = None, confId: int = -1, legend: str = '') -> tuple:
        """
            ...
            C++ signature :
                boost::python::tuple GetMolSize(RDKix::MolDraw2D {lvalue},RDKix::ROMol [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,int=-1 [,std::string='']]]]]]])
        """
    def Height(self) -> int:
        """
...
class MolDraw2DCairo(MolDraw2D):
    ...
    def WriteDrawingText(self, fName: str) -> None:
        """
            ...
            C++ signature :
                void WriteDrawingText(RDKix::MolDraw2DCairo {lvalue},std::string)
        """
...
class MolDraw2DSVG(MolDraw2D):
    ...
    def GetDrawingText(self) -> str:
        """
            ...
            C++ signature :
                std::string GetDrawingText(RDKix::MolDraw2DSVG {lvalue})
        """
...
def ContourAndDrawGaussians(drawer: MolDraw2D, locs: typing.Any, heights: typing.Any, widths: typing.Any, nContours: int = 10, levels: typing.Any = None, params: ContourParams = ..., mol: typing.Any = None) -> None:
    """
        ...
        */
        ...
        C++ signature :
            void ContourAndDrawGaussians(RDKix::MolDraw2D {lvalue},boost::python::api::object,boost::python::api::object,boost::python::api::object [,unsigned int=10 [,boost::python::api::object=None [,RDKix::MolDraw2DUtils::ContourParams=<rdkix.Chem.Draw.rdMolDraw2D.ContourParams object at 0xffeb7df34930> [,boost::python::api::object=None]]]])
    """
def ContourAndDrawGrid(drawer: MolDraw2D, data: typing.Any, xcoords: typing.Any, ycoords: typing.Any, nContours: int = 10, levels: typing.Any = None, params: ContourParams = ..., mol: typing.Any = None) -> None:
    """
        ...
        */
        ...
        C++ signature :
            void ContourAndDrawGrid(RDKix::MolDraw2D {lvalue},boost::python::api::object {lvalue},boost::python::api::object {lvalue},boost::python::api::object {lvalue} [,unsigned int=10 [,boost::python::api::object {lvalue}=None [,RDKix::MolDraw2DUtils::ContourParams=<rdkix.Chem.Draw.rdMolDraw2D.ContourParams object at 0xffeb7df34a00> [,boost::python::api::object=None]]]])
    """
def DrawMoleculeACS1996(drawer: MolDraw2D, mol: Mol, legend: str = '', highlightAtoms: typing.Any = None, highlightBonds: typing.Any = None, highlightAtomColors: typing.Any = None, highlightBondColors: typing.Any = None, highlightAtomRadii: typing.Any = None, confId: int = -1) -> None:
    """
        ...
        C++ signature :
            void DrawMoleculeACS1996(RDKix::MolDraw2D {lvalue},RDKix::ROMol [,std::string='' [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,int=-1]]]]]]])
    """
...
def MolToACS1996SVG(mol: Mol, legend: str = '', highlightAtoms: typing.Any = None, highlightBonds: typing.Any = None, highlightAtomColors: typing.Any = None, highlightBondColors: typing.Any = None, highlightAtomRadii: typing.Any = None, confId: int = -1) -> str:
    """
        ...
        C++ signature :
            std::string MolToACS1996SVG(RDKix::ROMol [,std::string='' [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,int=-1]]]]]]])
    """
def MolToSVG(mol: Mol, width: int = 300, height: int = 300, highlightAtoms: typing.Any = None, kekulize: bool = True, lineWidthMult: int = 1, fontSize: bool = 12, includeAtomCircles: int = True) -> str:
    """
        ...
        C++ signature :
            std::string MolToSVG(RDKix::ROMol [,unsigned int=300 [,unsigned int=300 [,boost::python::api::object=None [,bool=True [,unsigned int=1 [,bool=12 [,int=True]]]]]]])
    """
def PrepareAndDrawMolecule(drawer: MolDraw2D, mol: Mol, legend: str = '', highlightAtoms: typing.Any = None, highlightBonds: typing.Any = None, highlightAtomColors: typing.Any = None, highlightBondColors: typing.Any = None, highlightAtomRadii: typing.Any = None, confId: int = -1, kekulize: bool = True) -> None:
    """
        ...
        C++ signature :
            void PrepareAndDrawMolecule(RDKix::MolDraw2D {lvalue},RDKix::ROMol [,std::string='' [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,boost::python::api::object=None [,int=-1 [,bool=True]]]]]]]])
    """
...
def UpdateDrawerParamsFromJSON(drawer: MolDraw2D, json: str) -> None:
    """
        C++ signature :
            void UpdateDrawerParamsFromJSON(RDKix::MolDraw2D {lvalue},std::string)
    """
def UpdateMolDrawOptionsFromJSON(opts: MolDrawOptions, json: str) -> None:
    """
        C++ signature :
            void UpdateMolDrawOptionsFromJSON(RDKix::MolDrawOptions {lvalue},std::string)
    """
