...
from rdkix.Chem.Draw.rdMolDraw2D import ContourParams
from rdkix.Chem.Draw.rdMolDraw2D import IntStringMap
from rdkix.Chem.Draw.rdMolDraw2D import MolDraw2D
from rdkix.Chem.Draw.rdMolDraw2D import MolDraw2DCairo
from rdkix.Chem.Draw.rdMolDraw2D import MolDraw2DSVG
from rdkix.Chem.Draw.rdMolDraw2D import MolDrawOptions
from rdkix.Chem.Draw.rdMolDraw2D import MultiColourHighlightStyle
from rdkix.Chem.Draw.rdMolDraw2D import map_indexing_suite_IntStringMap_entry
...
def DrawMorganEnvs(envs, molsPerRow = 3, subImgSize = (150, 150), baseRad = 0.3, useSVG = True, aromaticColor = (0.9, 0.9, 0.2), ringColor = (0.8, 0.8, 0.8), centerColor = (0.6, 0.6, 0.9), extraColor = (0.9, 0.9, 0.9), legends = None, drawOptions = None, **kwargs):
    ...
def DrawRDKixBit(mol, bitId, bitInfo, whichExample = 0, **kwargs):
    ...
def DrawRDKixBits(tpls, **kwargs):
    ...
def DrawRDKixEnv(mol, bondPath, molSize = (150, 150), baseRad = 0.3, useSVG = True, aromaticColor = (0.9, 0.9, 0.2), extraColor = (0.9, 0.9, 0.9), nonAromaticColor = None, drawOptions = None, **kwargs):
    ...
def DrawRDKixEnvs(envs, molsPerRow = 3, subImgSize = (150, 150), baseRad = 0.3, useSVG = True, aromaticColor = (0.9, 0.9, 0.2), extraColor = (0.9, 0.9, 0.9), nonAromaticColor = None, legends = None, drawOptions = None, **kwargs):
    ...
    ...
    Creates a mol grid image from a nested data structure (where each data substructure represents a row),
      padding rows as needed so all rows are the length of the longest row
          ...
          ARGUMENTS:
            ...
            - molsMatrix: A two-deep nested data structure of RDKix molecules to draw,
              iterable of iterables (for example list of lists) of RDKix molecules
          ...
          EXAMPLES:
            ...
            from rdkix import Chem
            from rdkix.Chem.Draw import MolsMatrixToGridImage, rdMolDraw2D
...
def SetComicMode(opts):
    ...
def ShowMol(mol, size = (300, 300), kekulize = True, wedgeBonds = True, title = 'RDKix Molecule', stayInFront = True, **kwargs):
    """
...
def _getMorganEnv(mol, atomId, radius, baseRad, aromaticColor, ringColor, centerColor, extraColor, **kwargs):
    ...
def _getRDKixEnv(mol, bondPath, baseRad, aromaticColor, extraColor, nonAromaticColor, **kwargs):
    ...
...
def shouldKekulize(mol, kekulize):
    ...
CircleAndLine: rdMolDraw2D.MultiColourHighlightStyle  # value = rdkix.Chem.Draw.rdMolDraw2D.MultiColourHighlightStyle.CircleAndLine
Lasso: rdMolDraw2D.MultiColourHighlightStyle  # value = rdkix.Chem.Draw.rdMolDraw2D.MultiColourHighlightStyle.Lasso
