...
class RascalResult(Boost.Python.instance):
    ...
    def atomMatches(self) -> list:
        """
            ...
            C++ signature :
                boost::python::list atomMatches(RDKix::RascalMCES::RascalResult)
        """
    def bondMatches(self) -> list:
        """
            ...
            C++ signature :
                boost::python::list bondMatches(RDKix::RascalMCES::RascalResult)
        """
    def largestFragmentOnly(self) -> None:
        """
            ...
            C++ signature :
                void largestFragmentOnly(RDKix::RascalMCES::RascalResult {lvalue})
        """
    @property
...
def FindMCES(mol1: Mol, mol2: Mol, opts: typing.Any = None) -> list:
    """
        ...
        C++ signature :
            boost::python::list FindMCES(RDKix::ROMol,RDKix::ROMol [,boost::python::api::object=None])
    """
