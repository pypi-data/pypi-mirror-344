...
class TautomerQuery(Boost.Python.instance):
    ...
    def GetModifiedAtoms(self) -> UnsignedLong_Vect:
        """
            C++ signature :
                std::vector<unsigned long, std::allocator<unsigned long> > GetModifiedAtoms(RDKix::TautomerQuery {lvalue})
        """
    def GetModifiedBonds(self) -> UnsignedLong_Vect:
        """
            C++ signature :
                std::vector<unsigned long, std::allocator<unsigned long> > GetModifiedBonds(RDKix::TautomerQuery {lvalue})
        """
    @typing.overload
    ...
    def __init__(self, arg1: Mol, arg2: str) -> typing.Any:
        """
            C++ signature :
                void* __init__(boost::python::api::object,RDKix::ROMol,std::string)
        """
    @typing.overload
