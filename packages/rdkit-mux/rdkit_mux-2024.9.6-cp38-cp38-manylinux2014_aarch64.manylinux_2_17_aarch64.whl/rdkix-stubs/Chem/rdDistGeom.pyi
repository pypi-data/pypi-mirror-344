...
def EmbedMultipleConfs(mol: Mol, numConfs: int, params: EmbedParameters) -> typing.Sequence[int]:
    """
        ...
        C++ signature :
            std::vector<int, std::allocator<int> > EmbedMultipleConfs(RDKix::ROMol {lvalue},unsigned int,RDKix::DGeomHelpers::EmbedParameters {lvalue})
    """
@typing.overload
