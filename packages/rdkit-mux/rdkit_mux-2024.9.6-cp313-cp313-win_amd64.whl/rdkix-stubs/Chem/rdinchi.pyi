...
def MolToInchi(mol: Mol, options: str = '') -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple MolToInchi(class RDKix::ROMol [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >=''])
    """
def MolToInchiKey(mol: Mol, options: str = '') -> str:
    """
        ...
        C++ signature :
            class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > MolToInchiKey(class RDKix::ROMol [,char const * __ptr64=''])
    """
