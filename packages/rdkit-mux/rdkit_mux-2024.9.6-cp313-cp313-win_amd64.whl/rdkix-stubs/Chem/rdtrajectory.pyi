...
class Snapshot(Boost.Python.instance):
    ...
    def GetEnergy(self) -> float:
        """
            ...
            C++ signature :
                double GetEnergy(class RDKix::Snapshot {lvalue})
        """
    def GetPoint2D(self, pointNum: int) -> Point2D:
        """
            ...
            C++ signature :
                class RDGeom::Point2D GetPoint2D(class RDKix::Snapshot {lvalue},unsigned int)
        """
    def GetPoint3D(self, pointNum: int) -> Point3D:
        """
            ...
            C++ signature :
                class RDGeom::Point3D GetPoint3D(class RDKix::Snapshot {lvalue},unsigned int)
        """
    def SetEnergy(self, energy: float) -> None:
        """
            ...
            C++ signature :
                void SetEnergy(class RDKix::Snapshot {lvalue},double)
        """
    @typing.overload
    ...
    def __init__(self, other: Snapshot) -> typing.Any:
        """
            ...
            C++ signature :
                void * __ptr64 __init__(class boost::python::api::object,class RDKix::Snapshot * __ptr64)
        """
class Trajectory(Boost.Python.instance):
    ...
    def AddConformersToMol(self, mol: Mol, fromCid: int = -1, toCid: int = -1) -> int:
        """
            ...
            C++ signature :
                unsigned int AddConformersToMol(class RDKix::Trajectory {lvalue},class RDKix::ROMol {lvalue} [,int=-1 [,int=-1]])
        """
    def AddSnapshot(self, s: Snapshot) -> int:
        """
            ...
            C++ signature :
                unsigned int AddSnapshot(class RDKix::Trajectory {lvalue},class RDKix::Snapshot)
        """
    def Clear(self) -> None:
        """
            ...
            C++ signature :
                void Clear(class RDKix::Trajectory {lvalue})
        """
    def Dimension(self) -> int:
        """
            ...
            C++ signature :
                unsigned int Dimension(class RDKix::Trajectory {lvalue})
        """
    def GetSnapshot(self, snapshotNum: int) -> Snapshot:
        """
            ...
            C++ signature :
                class RDKix::Snapshot * __ptr64 GetSnapshot(class RDKix::Trajectory * __ptr64,unsigned int)
        """
    def InsertSnapshot(self, snapshotNum: int, s: Snapshot) -> int:
        """
            ...
            C++ signature :
                unsigned int InsertSnapshot(class RDKix::Trajectory {lvalue},unsigned int,class RDKix::Snapshot)
        """
    def NumPoints(self) -> int:
        """
            ...
            C++ signature :
                unsigned int NumPoints(class RDKix::Trajectory {lvalue})
        """
    def RemoveSnapshot(self, snapshotNum: int) -> int:
        """
            ...
            C++ signature :
                unsigned int RemoveSnapshot(class RDKix::Trajectory {lvalue},unsigned int)
        """
    @typing.overload
    ...
    def __init__(self, other: Trajectory) -> typing.Any:
        """
            ...
            C++ signature :
                void * __ptr64 __init__(class boost::python::api::object,class RDKix::Trajectory * __ptr64)
        """
    def __len__(self) -> int:
        """
            C++ signature :
                unsigned __int64 __len__(class RDKix::Trajectory {lvalue})
        """
def ReadAmberTrajectory(fName: str, traj: Trajectory) -> int:
    """
        ...
        C++ signature :
            unsigned int ReadAmberTrajectory(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >,class RDKix::Trajectory {lvalue})
    """
def ReadGromosTrajectory(fName: str, traj: Trajectory) -> int:
    """
        ...
        C++ signature :
            unsigned int ReadGromosTrajectory(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >,class RDKix::Trajectory {lvalue})
    """
