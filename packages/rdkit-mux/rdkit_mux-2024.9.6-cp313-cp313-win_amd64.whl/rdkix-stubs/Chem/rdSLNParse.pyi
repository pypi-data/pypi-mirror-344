...
def MolFromQuerySLN(SLN: str, mergeHs: bool = True, debugParser: bool = False) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 MolFromQuerySLN(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > [,bool=True [,bool=False]])
    """
def MolFromSLN(SLN: str, sanitize: bool = True, debugParser: bool = False) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 MolFromSLN(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > [,bool=True [,bool=False]])
    """
