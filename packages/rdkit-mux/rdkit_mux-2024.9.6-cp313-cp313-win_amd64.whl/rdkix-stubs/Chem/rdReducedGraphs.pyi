...
def GenerateErGFingerprintForReducedGraph(mol: Mol, atomTypes: typing.Any = 0, fuzzIncrement: float = 0.3, minPath: int = 1, maxPath: int = 15) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GenerateErGFingerprintForReducedGraph(class RDKix::ROMol [,class boost::python::api::object=0 [,double=0.3 [,int=1 [,int=15]]]])
    """
def GenerateMolExtendedReducedGraph(mol: Mol, atomTypes: typing.Any = 0) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 GenerateMolExtendedReducedGraph(class RDKix::ROMol [,class boost::python::api::object=0])
    """
def GetErGFingerprint(mol: Mol, atomTypes: typing.Any = 0, fuzzIncrement: float = 0.3, minPath: int = 1, maxPath: int = 15) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetErGFingerprint(class RDKix::ROMol [,class boost::python::api::object=0 [,double=0.3 [,int=1 [,int=15]]]])
    """
