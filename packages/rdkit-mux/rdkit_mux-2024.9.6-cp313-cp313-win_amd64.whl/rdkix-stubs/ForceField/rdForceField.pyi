...
class MMFFMolProperties(Boost.Python.instance):
    ...
    def GetMMFFAngleBendParams(self, mol: typing.Any, idx1: int, idx2: int, idx3: int) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetMMFFAngleBendParams(class ForceFields::PyMMFFMolProperties {lvalue},class RDKix::ROMol,unsigned int,unsigned int,unsigned int)
        """
    ...
    def GetMMFFBondStretchParams(self, mol: typing.Any, idx1: int, idx2: int) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetMMFFBondStretchParams(class ForceFields::PyMMFFMolProperties {lvalue},class RDKix::ROMol,unsigned int,unsigned int)
        """
    ...
    def GetMMFFOopBendParams(self, mol: typing.Any, idx1: int, idx2: int, idx3: int, idx4: int) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetMMFFOopBendParams(class ForceFields::PyMMFFMolProperties {lvalue},class RDKix::ROMol,unsigned int,unsigned int,unsigned int,unsigned int)
        """
    ...
    def GetMMFFStretchBendParams(self, mol: typing.Any, idx1: int, idx2: int, idx3: int) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetMMFFStretchBendParams(class ForceFields::PyMMFFMolProperties {lvalue},class RDKix::ROMol,unsigned int,unsigned int,unsigned int)
        """
    def GetMMFFTorsionParams(self, mol: typing.Any, idx1: int, idx2: int, idx3: int, idx4: int) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 GetMMFFTorsionParams(class ForceFields::PyMMFFMolProperties {lvalue},class RDKix::ROMol,unsigned int,unsigned int,unsigned int,unsigned int)
        """
