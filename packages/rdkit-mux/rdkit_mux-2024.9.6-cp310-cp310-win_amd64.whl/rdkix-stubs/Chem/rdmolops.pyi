...
class AdjustQueryParameters(Boost.Python.instance):
    ...
    def NoAdjustments() -> AdjustQueryParameters:
        """
            ...
            C++ signature :
                struct RDKix::MolOps::AdjustQueryParameters NoAdjustments()
        """
    @staticmethod
...
class AdjustQueryWhichFlags(Boost.Python.enum):
    ADJUST_IGNOREALL: typing.ClassVar[AdjustQueryWhichFlags]  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREALL
    ADJUST_IGNORECHAINS: typing.ClassVar[AdjustQueryWhichFlags]  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORECHAINS
    ADJUST_IGNOREDUMMIES: typing.ClassVar[AdjustQueryWhichFlags]  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREDUMMIES
    ADJUST_IGNOREMAPPED: typing.ClassVar[AdjustQueryWhichFlags]  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREMAPPED
    ADJUST_IGNORENONDUMMIES: typing.ClassVar[AdjustQueryWhichFlags]  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORENONDUMMIES
    ADJUST_IGNORENONE: typing.ClassVar[AdjustQueryWhichFlags]  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORENONE
    ADJUST_IGNORERINGS: typing.ClassVar[AdjustQueryWhichFlags]  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORERINGS
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'ADJUST_IGNORENONE': rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORENONE, 'ADJUST_IGNORECHAINS': rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORECHAINS, 'ADJUST_IGNORERINGS': rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORERINGS, 'ADJUST_IGNOREDUMMIES': rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREDUMMIES, 'ADJUST_IGNORENONDUMMIES': rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORENONDUMMIES, 'ADJUST_IGNOREMAPPED': rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREMAPPED, 'ADJUST_IGNOREALL': rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREALL}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORENONE, 1: rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORECHAINS, 4: rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORERINGS, 2: rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREDUMMIES, 8: rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORENONDUMMIES, 16: rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREMAPPED, 268435455: rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREALL}
class AromaticityModel(Boost.Python.enum):
    AROMATICITY_CUSTOM: typing.ClassVar[AromaticityModel]  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_CUSTOM
    AROMATICITY_DEFAULT: typing.ClassVar[AromaticityModel]  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_DEFAULT
    AROMATICITY_MDL: typing.ClassVar[AromaticityModel]  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MDL
    AROMATICITY_MMFF94: typing.ClassVar[AromaticityModel]  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MMFF94
    AROMATICITY_RDKIX: typing.ClassVar[AromaticityModel]  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_RDKIX
    AROMATICITY_SIMPLE: typing.ClassVar[AromaticityModel]  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_SIMPLE
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'AROMATICITY_DEFAULT': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_DEFAULT, 'AROMATICITY_RDKIX': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_RDKIX, 'AROMATICITY_SIMPLE': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_SIMPLE, 'AROMATICITY_MDL': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MDL, 'AROMATICITY_MMFF94': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MMFF94, 'AROMATICITY_CUSTOM': rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_CUSTOM}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_DEFAULT, 1: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_RDKIX, 2: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_SIMPLE, 4: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MDL, 8: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MMFF94, 268435455: rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_CUSTOM}
...
class MolzipLabel(Boost.Python.enum):
    AtomMapNumber: typing.ClassVar[MolzipLabel]  # value = rdkix.Chem.rdmolops.MolzipLabel.AtomMapNumber
    AtomType: typing.ClassVar[MolzipLabel]  # value = rdkix.Chem.rdmolops.MolzipLabel.AtomType
    FragmentOnBonds: typing.ClassVar[MolzipLabel]  # value = rdkix.Chem.rdmolops.MolzipLabel.FragmentOnBonds
    Isotope: typing.ClassVar[MolzipLabel]  # value = rdkix.Chem.rdmolops.MolzipLabel.Isotope
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'AtomMapNumber': rdkix.Chem.rdmolops.MolzipLabel.AtomMapNumber, 'Isotope': rdkix.Chem.rdmolops.MolzipLabel.Isotope, 'FragmentOnBonds': rdkix.Chem.rdmolops.MolzipLabel.FragmentOnBonds, 'AtomType': rdkix.Chem.rdmolops.MolzipLabel.AtomType}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdmolops.MolzipLabel.AtomMapNumber, 1: rdkix.Chem.rdmolops.MolzipLabel.Isotope, 2: rdkix.Chem.rdmolops.MolzipLabel.FragmentOnBonds, 3: rdkix.Chem.rdmolops.MolzipLabel.AtomType}
class MolzipParams(Boost.Python.instance):
    ...
    def setAtomSymbols(self, symbols: typing.Any) -> None:
        """
            ...
            C++ signature :
                void setAtomSymbols(struct RDKix::MolzipParams {lvalue},class boost::python::api::object)
        """
    @property
...
class SanitizeFlags(Boost.Python.enum):
    SANITIZE_ADJUSTHS: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ADJUSTHS
    SANITIZE_ALL: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ALL
    SANITIZE_CLEANUP: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUP
    SANITIZE_CLEANUPATROPISOMERS: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUPATROPISOMERS
    SANITIZE_CLEANUPCHIRALITY: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUPCHIRALITY
    SANITIZE_CLEANUP_ORGANOMETALLICS: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUP_ORGANOMETALLICS
    SANITIZE_FINDRADICALS: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_FINDRADICALS
    SANITIZE_KEKULIZE: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_KEKULIZE
    SANITIZE_NONE: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_NONE
    SANITIZE_PROPERTIES: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_PROPERTIES
    SANITIZE_SETAROMATICITY: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETAROMATICITY
    SANITIZE_SETCONJUGATION: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETCONJUGATION
    SANITIZE_SETHYBRIDIZATION: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETHYBRIDIZATION
    SANITIZE_SYMMRINGS: typing.ClassVar[SanitizeFlags]  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SYMMRINGS
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'SANITIZE_NONE': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_NONE, 'SANITIZE_CLEANUP': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUP, 'SANITIZE_PROPERTIES': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_PROPERTIES, 'SANITIZE_SYMMRINGS': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SYMMRINGS, 'SANITIZE_KEKULIZE': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_KEKULIZE, 'SANITIZE_FINDRADICALS': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_FINDRADICALS, 'SANITIZE_SETAROMATICITY': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETAROMATICITY, 'SANITIZE_SETCONJUGATION': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETCONJUGATION, 'SANITIZE_SETHYBRIDIZATION': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETHYBRIDIZATION, 'SANITIZE_CLEANUPCHIRALITY': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUPCHIRALITY, 'SANITIZE_CLEANUPATROPISOMERS': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUPATROPISOMERS, 'SANITIZE_ADJUSTHS': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ADJUSTHS, 'SANITIZE_CLEANUP_ORGANOMETALLICS': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUP_ORGANOMETALLICS, 'SANITIZE_ALL': rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ALL}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_NONE, 1: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUP, 2: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_PROPERTIES, 4: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SYMMRINGS, 8: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_KEKULIZE, 16: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_FINDRADICALS, 32: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETAROMATICITY, 64: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETCONJUGATION, 128: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETHYBRIDIZATION, 256: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUPCHIRALITY, 2048: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUPATROPISOMERS, 512: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ADJUSTHS, 1024: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUP_ORGANOMETALLICS, 268435455: rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ALL}
...
class StereoGroupAbsOptions(Boost.Python.enum):
    AlwaysInclude: typing.ClassVar[StereoGroupAbsOptions]  # value = rdkix.Chem.rdmolops.StereoGroupAbsOptions.AlwaysInclude
    NeverInclude: typing.ClassVar[StereoGroupAbsOptions]  # value = rdkix.Chem.rdmolops.StereoGroupAbsOptions.NeverInclude
    OnlyIncludeWhenOtherGroupsExist: typing.ClassVar[StereoGroupAbsOptions]  # value = rdkix.Chem.rdmolops.StereoGroupAbsOptions.OnlyIncludeWhenOtherGroupsExist
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'OnlyIncludeWhenOtherGroupsExist': rdkix.Chem.rdmolops.StereoGroupAbsOptions.OnlyIncludeWhenOtherGroupsExist, 'NeverInclude': rdkix.Chem.rdmolops.StereoGroupAbsOptions.NeverInclude, 'AlwaysInclude': rdkix.Chem.rdmolops.StereoGroupAbsOptions.AlwaysInclude}
    values: typing.ClassVar[dict]  # value = {0: rdkix.Chem.rdmolops.StereoGroupAbsOptions.OnlyIncludeWhenOtherGroupsExist, 1: rdkix.Chem.rdmolops.StereoGroupAbsOptions.NeverInclude, 2: rdkix.Chem.rdmolops.StereoGroupAbsOptions.AlwaysInclude}
def AddHs(mol: Mol, explicitOnly: bool = False, addCoords: bool = False, onlyOnAtoms: typing.Any = None, addResidueInfo: bool = False) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 AddHs(class RDKix::ROMol [,bool=False [,bool=False [,class boost::python::api::object=None [,bool=False]]]])
    """
def AddRecursiveQuery(mol: Mol, query: Mol, atomIdx: int, preserveExistingQuery: bool = True) -> None:
    """
        ...
        C++ signature :
            void AddRecursiveQuery(class RDKix::ROMol {lvalue},class RDKix::ROMol,unsigned int [,bool=True])
    """
def AddStereoAnnotations(*args, **kwargs) -> None:
    """
        ...
        C++ signature :
            void AddStereoAnnotations(class RDKix::ROMol {lvalue} [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='abs ({cip})' [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='or{id}' [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='and{id}' [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='({cip})' [,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >='({cip})']]]]])
    """
def AddWavyBondsForStereoAny(mol: Mol, clearDoubleBondFlags: bool = True, addWhenImpossible: int = 1000) -> None:
    """
        ...
        C++ signature :
            void AddWavyBondsForStereoAny(class RDKix::ROMol {lvalue} [,bool=True [,unsigned int=1000]])
    """
def AdjustQueryProperties(mol: Mol, params: typing.Any = None) -> rdkix.Chem.Mol:
    """
        Returns a new molecule where the query properties of atoms have been modified.
    
        C++ signature :
            class RDKix::ROMol * __ptr64 AdjustQueryProperties(class RDKix::ROMol [,class boost::python::api::object=None])
    """
def AdjustQueryPropertiesWithGenericGroups(mol: Mol, params: typing.Any = None) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 AdjustQueryPropertiesWithGenericGroups(class RDKix::ROMol [,class boost::python::api::object=None])
    """
def AssignAtomChiralTagsFromMolParity(mol: Mol, replaceExistingTags: bool = True) -> None:
    """
        ...
        C++ signature :
            void AssignAtomChiralTagsFromMolParity(class RDKix::ROMol {lvalue} [,bool=True])
    """
def AssignAtomChiralTagsFromStructure(mol: Mol, confId: int = -1, replaceExistingTags: bool = True) -> None:
    """
        ...
        C++ signature :
            void AssignAtomChiralTagsFromStructure(class RDKix::ROMol {lvalue} [,int=-1 [,bool=True]])
    """
def AssignChiralTypesFromBondDirs(mol: Mol, confId: int = -1, replaceExistingTags: bool = True) -> None:
    """
        ...
        C++ signature :
            void AssignChiralTypesFromBondDirs(class RDKix::ROMol {lvalue} [,int=-1 [,bool=True]])
    """
def AssignRadicals(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void AssignRadicals(class RDKix::ROMol {lvalue})
    """
def AssignStereochemistry(mol: Mol, cleanIt: bool = False, force: bool = False, flagPossibleStereoCenters: bool = False) -> None:
    """
        ...
        C++ signature :
            void AssignStereochemistry(class RDKix::ROMol {lvalue} [,bool=False [,bool=False [,bool=False]]])
    """
def AssignStereochemistryFrom3D(mol: Mol, confId: int = -1, replaceExistingTags: bool = True) -> None:
    """
        ...
        C++ signature :
            void AssignStereochemistryFrom3D(class RDKix::ROMol {lvalue} [,int=-1 [,bool=True]])
    """
def AtomHasConjugatedBond(atom: Atom) -> bool:
    """
        ...
        C++ signature :
            bool AtomHasConjugatedBond(class RDKix::Atom const * __ptr64)
    """
def CanonicalizeStereoGroups(mol: Mol, outputAbsoluteGroups: StereoGroupAbsOptions = ...) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 CanonicalizeStereoGroups(class RDKix::ROMol {lvalue} [,enum RDKix::StereoGroupAbsOptions=rdkix.Chem.rdmolops.StereoGroupAbsOptions.OnlyIncludeWhenOtherGroupsExist])
    """
def Cleanup(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void Cleanup(class RDKix::ROMol {lvalue})
    """
def CleanupAtropisomers(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void CleanupAtropisomers(class RDKix::ROMol {lvalue})
    """
def CleanupChirality(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void CleanupChirality(class RDKix::ROMol {lvalue})
    """
def CleanupOrganometallics(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void CleanupOrganometallics(class RDKix::ROMol {lvalue})
    """
def CollapseAttachmentPoints(mol: Mol, markedOnly: bool = True) -> None:
    """
        ...
        C++ signature :
            void CollapseAttachmentPoints(class RDKix::ROMol {lvalue} [,bool=True])
    """
def CombineMols(mol1: Mol, mol2: Mol, offset: Point3D = ...) -> rdkix.Chem.Mol:
    """
        Combine the atoms from two molecules to produce a third
    
        C++ signature :
            class RDKix::ROMol * __ptr64 CombineMols(class RDKix::ROMol,class RDKix::ROMol [,class RDGeom::Point3D=<rdkix.Geometry.rdGeometry.Point3D object at 0x000001B0A4E3C9C0>])
    """
def ConvertGenericQueriesToSubstanceGroups(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void ConvertGenericQueriesToSubstanceGroups(class RDKix::ROMol {lvalue})
    """
def CountAtomElec(atom: Atom) -> int:
    """
        ...
        C++ signature :
            int CountAtomElec(class RDKix::Atom const * __ptr64)
    """
def DativeBondsToHaptic(mol: Mol) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 DativeBondsToHaptic(class RDKix::ROMol)
    """
def DeleteSubstructs(mol: Mol, query: Mol, onlyFrags: bool = False, useChirality: bool = False) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 DeleteSubstructs(class RDKix::ROMol,class RDKix::ROMol [,bool=False [,bool=False]])
    """
def DetectBondStereoChemistry(mol: Mol, conformer: Conformer) -> None:
    """
        ...
        C++ signature :
            void DetectBondStereoChemistry(class RDKix::ROMol {lvalue},class RDKix::Conformer const * __ptr64)
    """
def DetectBondStereochemistry(mol: Mol, confId: int = -1) -> None:
    """
        ...
        C++ signature :
            void DetectBondStereochemistry(class RDKix::ROMol {lvalue} [,int=-1])
    """
def DetectChemistryProblems(mol: Mol, sanitizeOps: int = ...) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple DetectChemistryProblems(class RDKix::ROMol [,unsigned int=rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ALL])
    """
def ExpandAttachmentPoints(mol: Mol, addAsQueries: bool = True, addCoords: bool = True) -> None:
    """
        ...
        C++ signature :
            void ExpandAttachmentPoints(class RDKix::ROMol {lvalue} [,bool=True [,bool=True]])
    """
def FastFindRings(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void FastFindRings(class RDKix::ROMol)
    """
def FindAllPathsOfLengthN(*args, **kwargs) -> ...:
    """
        ...
        C++ signature :
            class std::list<class std::vector<int,class std::allocator<int> >,class std::allocator<class std::vector<int,class std::allocator<int> > > > FindAllPathsOfLengthN(class RDKix::ROMol,unsigned int [,bool=True [,bool=False [,int=-1 [,bool=False]]]])
    """
def FindAllSubgraphsOfLengthMToN(mol: Mol, min: int, max: int, useHs: bool = False, rootedAtAtom: int = -1) -> typing.Any:
    """
        ...
        C++ signature :
            class boost::python::api::object FindAllSubgraphsOfLengthMToN(class RDKix::ROMol,unsigned int,unsigned int [,bool=False [,int=-1]])
    """
def FindAllSubgraphsOfLengthN(*args, **kwargs) -> ...:
    """
        ...
        C++ signature :
            class std::list<class std::vector<int,class std::allocator<int> >,class std::allocator<class std::vector<int,class std::allocator<int> > > > FindAllSubgraphsOfLengthN(class RDKix::ROMol,unsigned int [,bool=False [,int=-1]])
    """
def FindAtomEnvironmentOfRadiusN(mol: Mol, radius: int, rootedAtAtom: int, useHs: bool = False, enforceSize: bool = True, atomMap: typing.Any = None) -> _vectint:
    """
        ...
        C++ signature :
            class std::vector<int,class std::allocator<int> > FindAtomEnvironmentOfRadiusN(class RDKix::ROMol,unsigned int,unsigned int [,bool=False [,bool=True [,class boost::python::api::object=None]]])
    """
def FindMesoCenters(mol: Mol, includeIsotopes: bool = True, includeAtomMaps: bool = False) -> typing.Any:
    """
        ...
        C++ signature :
            class boost::python::api::object FindMesoCenters(class RDKix::ROMol [,bool=True [,bool=False]])
    """
def FindPotentialStereo(*args, **kwargs) -> ...:
    """
        ...
        C++ signature :
            class std::vector<struct RDKix::Chirality::StereoInfo,class std::allocator<struct RDKix::Chirality::StereoInfo> > FindPotentialStereo(class RDKix::ROMol {lvalue} [,bool=False [,bool=True]])
    """
def FindPotentialStereoBonds(mol: Mol, cleanIt: bool = False) -> None:
    """
        ...
        C++ signature :
            void FindPotentialStereoBonds(class RDKix::ROMol {lvalue} [,bool=False])
    """
def FindRingFamilies(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void FindRingFamilies(class RDKix::ROMol)
    """
def FindUniqueSubgraphsOfLengthN(*args, **kwargs) -> ...:
    """
        ...
        C++ signature :
            class std::list<class std::vector<int,class std::allocator<int> >,class std::allocator<class std::vector<int,class std::allocator<int> > > > FindUniqueSubgraphsOfLengthN(class RDKix::ROMol,unsigned int [,bool=False [,bool=True [,int=-1]]])
    """
def FragmentOnBRICSBonds(mol: Mol) -> rdkix.Chem.Mol:
    """
        Return a new molecule with all BRICS bonds broken
    
        C++ signature :
            class RDKix::ROMol * __ptr64 FragmentOnBRICSBonds(class RDKix::ROMol)
    """
def FragmentOnBonds(mol: Mol, bondIndices: typing.Any, addDummies: bool = True, dummyLabels: typing.Any = None, bondTypes: typing.Any = None, cutsPerAtom: list = []) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 FragmentOnBonds(class RDKix::ROMol,class boost::python::api::object [,bool=True [,class boost::python::api::object=None [,class boost::python::api::object=None [,class boost::python::list=[]]]]])
    """
def FragmentOnSomeBonds(mol: Mol, bondIndices: typing.Any, numToBreak: int = 1, addDummies: bool = True, dummyLabels: typing.Any = None, bondTypes: typing.Any = None, returnCutsPerAtom: bool = False) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple FragmentOnSomeBonds(class RDKix::ROMol,class boost::python::api::object [,unsigned int=1 [,bool=True [,class boost::python::api::object=None [,class boost::python::api::object=None [,bool=False]]]]])
    """
def Get3DDistanceMatrix(mol: Mol, confId: int = -1, useAtomWts: bool = False, force: bool = False, prefix: str = '') -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 Get3DDistanceMatrix(class RDKix::ROMol {lvalue} [,int=-1 [,bool=False [,bool=False [,char const * __ptr64='']]]])
    """
def GetAdjacencyMatrix(mol: Mol, useBO: bool = False, emptyVal: int = 0, force: bool = False, prefix: str = '') -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetAdjacencyMatrix(class RDKix::ROMol {lvalue} [,bool=False [,int=0 [,bool=False [,char const * __ptr64='']]]])
    """
...
def GetDistanceMatrix(mol: Mol, useBO: bool = False, useAtomWts: bool = False, force: bool = False, prefix: str = '') -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetDistanceMatrix(class RDKix::ROMol {lvalue} [,bool=False [,bool=False [,bool=False [,char const * __ptr64='']]]])
    """
def GetFormalCharge(mol: Mol) -> int:
    """
        ...
        C++ signature :
            int GetFormalCharge(class RDKix::ROMol)
    """
def GetMolFrags(mol: Mol, asMols: bool = False, sanitizeFrags: bool = True, frags: typing.Any = None, fragsMolAtomMapping: typing.Any = None) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GetMolFrags(class RDKix::ROMol [,bool=False [,bool=True [,class boost::python::api::object=None [,class boost::python::api::object=None]]]])
    """
def GetMostSubstitutedCoreMatch(mol: Mol, core: Mol, matches: typing.Any) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetMostSubstitutedCoreMatch(class RDKix::ROMol,class RDKix::ROMol,class boost::python::api::object)
    """
def GetSSSR(*args, **kwargs) -> ...:
    """
        ...
        C++ signature :
            class std::vector<class std::vector<int,class std::allocator<int> >,class std::allocator<class std::vector<int,class std::allocator<int> > > > GetSSSR(class RDKix::ROMol {lvalue} [,bool=False])
    """
def GetShortestPath(mol: Mol, aid1: int, aid2: int) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GetShortestPath(class RDKix::ROMol,int,int)
    """
def GetSymmSSSR(*args, **kwargs) -> ...:
    """
        ...
        C++ signature :
            class std::vector<class std::vector<int,class std::allocator<int> >,class std::allocator<class std::vector<int,class std::allocator<int> > > > GetSymmSSSR(class RDKix::ROMol {lvalue} [,bool=False])
    """
def GetUseLegacyStereoPerception() -> bool:
    ...
    """
def HapticBondsToDative(mol: Mol) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 HapticBondsToDative(class RDKix::ROMol)
    """
def HasQueryHs(mol: Mol) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple HasQueryHs(class RDKix::ROMol)
    """
def Kekulize(mol: Mol, clearAromaticFlags: bool = False) -> None:
    """
        ...
        C++ signature :
            void Kekulize(class RDKix::ROMol {lvalue} [,bool=False])
    """
def KekulizeIfPossible(mol: Mol, clearAromaticFlags: bool = False) -> None:
    """
        ...
        C++ signature :
            void KekulizeIfPossible(class RDKix::ROMol {lvalue} [,bool=False])
    """
def LayeredFingerprint(mol: Mol, layerFlags: int = 4294967295, minPath: int = 1, maxPath: int = 7, fpSize: int = 2048, atomCounts: list = [], setOnlyBits: ExplicitBitVect = None, branchedPaths: bool = True, fromAtoms: typing.Any = 0) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 LayeredFingerprint(class RDKix::ROMol [,unsigned int=4294967295 [,unsigned int=1 [,unsigned int=7 [,unsigned int=2048 [,class boost::python::list=[] [,class ExplicitBitVect * __ptr64=None [,bool=True [,class boost::python::api::object=0]]]]]]]])
    """
def MergeQueryHs(mol: Mol, mergeUnmappedOnly: bool = False, mergeIsotopes: bool = False) -> rdkix.Chem.Mol:
    """
        merges hydrogens into their neighboring atoms as queries
    
        C++ signature :
            class RDKix::ROMol * __ptr64 MergeQueryHs(class RDKix::ROMol [,bool=False [,bool=False]])
    """
def MolAddRecursiveQueries(mol: Mol, queries: dict, propName: str) -> None:
    """
        ...
        C++ signature :
            void MolAddRecursiveQueries(class RDKix::ROMol {lvalue},class boost::python::dict,class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
    """
def MurckoDecompose(mol: Mol) -> rdkix.Chem.Mol:
    """
        Do a Murcko decomposition and return the scaffold
    
        C++ signature :
            class RDKix::ROMol * __ptr64 MurckoDecompose(class RDKix::ROMol)
    """
def NeedsHs(mol: Mol) -> bool:
    """
        ...
        C++ signature :
            bool NeedsHs(class RDKix::ROMol)
    """
def ParseMolQueryDefFile(fileobj: typing.Any, standardize: bool = True, delimiter: str = '\t', comment: str = '//', nameColumn: int = 0, smartsColumn: int = 1) -> dict:
    ...
    """
def PathToSubmol(mol: Mol, path: typing.Any, useQuery: bool = False, atomMap: typing.Any = None) -> rdkix.Chem.Mol:
    """
        C++ signature :
            class RDKix::ROMol * __ptr64 PathToSubmol(class RDKix::ROMol,class boost::python::api::object {lvalue} [,bool=False [,class boost::python::api::object=None]])
    """
@typing.overload
def PatternFingerprint(mol: Mol, fpSize: int = 2048, atomCounts: list = [], setOnlyBits: ExplicitBitVect = None, tautomerFingerprints: bool = False) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 PatternFingerprint(class RDKix::ROMol [,unsigned int=2048 [,class boost::python::list=[] [,class ExplicitBitVect * __ptr64=None [,bool=False]]]])
    """
@typing.overload
def PatternFingerprint(mol: MolBundle, fpSize: int = 2048, setOnlyBits: ExplicitBitVect = None, tautomerFingerprints: bool = False) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 PatternFingerprint(class RDKix::MolBundle [,unsigned int=2048 [,class ExplicitBitVect * __ptr64=None [,bool=False]]])
    """
def RDKFingerprint(mol: Mol, minPath: int = 1, maxPath: int = 7, fpSize: int = 2048, nBitsPerHash: int = 2, useHs: bool = True, tgtDensity: float = 0.0, minSize: int = 128, branchedPaths: bool = True, useBondOrder: bool = True, atomInvariants: typing.Any = 0, fromAtoms: typing.Any = 0, atomBits: typing.Any = None, bitInfo: typing.Any = None) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 RDKFingerprint(class RDKix::ROMol [,unsigned int=1 [,unsigned int=7 [,unsigned int=2048 [,unsigned int=2 [,bool=True [,double=0.0 [,unsigned int=128 [,bool=True [,bool=True [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,class boost::python::api::object=None [,class boost::python::api::object=None]]]]]]]]]]]]])
    """
def ReapplyMolBlockWedging(mol: Mol, allBondTypes: bool = True) -> None:
    """
        ...
        C++ signature :
            void ReapplyMolBlockWedging(class RDKix::ROMol {lvalue} [,bool=True])
    """
def RemoveAllHs(mol: Mol, sanitize: bool = True) -> rdkix.Chem.Mol:
    """
        Returns a copy of the molecule with all Hs removed.
    
        C++ signature :
            class RDKix::ROMol * __ptr64 RemoveAllHs(class RDKix::ROMol [,bool=True])
    """
@typing.overload
def RemoveHs(mol: Mol, implicitOnly: bool = False, updateExplicitCount: bool = False, sanitize: bool = True) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 RemoveHs(class RDKix::ROMol [,bool=False [,bool=False [,bool=True]]])
    """
@typing.overload
def RemoveHs(mol: Mol, params: RemoveHsParameters, sanitize: bool = True) -> rdkix.Chem.Mol:
    """
        Returns a copy of the molecule with Hs removed. Which Hs are removed is controlled by the params argument
    
        C++ signature :
            class RDKix::ROMol * __ptr64 RemoveHs(class RDKix::ROMol,struct RDKix::MolOps::RemoveHsParameters [,bool=True])
    """
def RemoveNonExplicit3DChirality(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void RemoveNonExplicit3DChirality(class RDKix::ROMol {lvalue})
    """
def RemoveStereochemistry(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void RemoveStereochemistry(class RDKix::ROMol {lvalue})
    """
def RenumberAtoms(mol: Mol, newOrder: typing.Any) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 RenumberAtoms(class RDKix::ROMol,class boost::python::api::object {lvalue})
    """
@typing.overload
def ReplaceCore(mol: Mol, core: Mol, matches: typing.Any, replaceDummies: bool = True, labelByIndex: bool = False, requireDummyMatch: bool = False) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 ReplaceCore(class RDKix::ROMol,class RDKix::ROMol,class boost::python::api::object [,bool=True [,bool=False [,bool=False]]])
    """
@typing.overload
def ReplaceCore(mol: Mol, coreQuery: Mol, replaceDummies: bool = True, labelByIndex: bool = False, requireDummyMatch: bool = False, useChirality: bool = False) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 ReplaceCore(class RDKix::ROMol,class RDKix::ROMol [,bool=True [,bool=False [,bool=False [,bool=False]]]])
    """
def ReplaceSidechains(mol: Mol, coreQuery: Mol, useChirality: bool = False) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 ReplaceSidechains(class RDKix::ROMol,class RDKix::ROMol [,bool=False])
    """
def ReplaceSubstructs(mol: Mol, query: Mol, replacement: Mol, replaceAll: bool = False, replacementConnectionPoint: int = 0, useChirality: bool = False) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 ReplaceSubstructs(class RDKix::ROMol,class RDKix::ROMol,class RDKix::ROMol [,bool=False [,unsigned int=0 [,bool=False]]])
    """
def SanitizeMol(mol: Mol, sanitizeOps: int = ..., catchErrors: bool = False) -> SanitizeFlags:
    """
        ...
        C++ signature :
            enum RDKix::MolOps::SanitizeFlags SanitizeMol(class RDKix::ROMol {lvalue} [,unsigned __int64=rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ALL [,bool=False]])
    """
...
def SetAromaticity(mol: Mol, model: AromaticityModel = ...) -> None:
    """
        ...
        C++ signature :
            void SetAromaticity(class RDKix::ROMol {lvalue} [,enum RDKix::MolOps::AromaticityModel=rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_DEFAULT])
    """
def SetBondStereoFromDirections(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void SetBondStereoFromDirections(class RDKix::ROMol {lvalue})
    """
def SetConjugation(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void SetConjugation(class RDKix::ROMol {lvalue})
    """
def SetDoubleBondNeighborDirections(mol: Mol, conf: typing.Any = None) -> None:
    """
        ...
        C++ signature :
            void SetDoubleBondNeighborDirections(class RDKix::ROMol {lvalue} [,class boost::python::api::object=None])
    """
def SetGenericQueriesFromProperties(mol: Mol, useAtomLabels: bool = True, useSGroups: bool = True) -> None:
    """
        ...
        C++ signature :
            void SetGenericQueriesFromProperties(class RDKix::ROMol {lvalue} [,bool=True [,bool=True]])
    """
def SetHybridization(mol: Mol) -> None:
    """
        ...
        C++ signature :
            void SetHybridization(class RDKix::ROMol {lvalue})
    """
def SetTerminalAtomCoords(mol: Mol, idx: int, otherIdx: int) -> None:
    """
        ...
        C++ signature :
            void SetTerminalAtomCoords(class RDKix::ROMol {lvalue},unsigned int,unsigned int)
    """
...
def SimplifyEnhancedStereo(mol: Mol, removeAffectedStereoGroups: bool = True) -> None:
    """
        ...
        C++ signature :
            void SimplifyEnhancedStereo(class RDKix::ROMol {lvalue} [,bool=True])
    """
def SortMatchesByDegreeOfCoreSubstitution(mol: Mol, core: Mol, matches: typing.Any) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 SortMatchesByDegreeOfCoreSubstitution(class RDKix::ROMol,class RDKix::ROMol,class boost::python::api::object)
    """
def SplitMolByPDBChainId(mol: Mol, whiteList: typing.Any = None, negateList: bool = False) -> dict:
    """
        ...
        C++ signature :
            class boost::python::dict SplitMolByPDBChainId(class RDKix::ROMol [,class boost::python::api::object=None [,bool=False]])
    """
def SplitMolByPDBResidues(mol: Mol, whiteList: typing.Any = None, negateList: bool = False) -> dict:
    """
        ...
        C++ signature :
            class boost::python::dict SplitMolByPDBResidues(class RDKix::ROMol [,class boost::python::api::object=None [,bool=False]])
    """
def TranslateChiralFlagToStereoGroups(mol: Mol, zeroFlagGroupType: StereoGroupType = ...) -> None:
    """
        ...
        C++ signature :
            void TranslateChiralFlagToStereoGroups(class RDKix::ROMol {lvalue} [,enum RDKix::StereoGroupType=rdkix.Chem.rdchem.StereoGroupType.STEREO_AND])
    """
def UnfoldedRDKFingerprintCountBased(mol: Mol, minPath: int = 1, maxPath: int = 7, useHs: bool = True, branchedPaths: bool = True, useBondOrder: bool = True, atomInvariants: typing.Any = 0, fromAtoms: typing.Any = 0, atomBits: typing.Any = None, bitInfo: typing.Any = None) -> ULongSparseIntVect:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<unsigned __int64> * __ptr64 UnfoldedRDKFingerprintCountBased(class RDKix::ROMol [,unsigned int=1 [,unsigned int=7 [,bool=True [,bool=True [,bool=True [,class boost::python::api::object=0 [,class boost::python::api::object=0 [,class boost::python::api::object=None [,class boost::python::api::object=None]]]]]]]]])
    """
def WedgeBond(bond: Bond, fromAtomIdx: int, conf: Conformer) -> None:
    """
        ...
        C++ signature :
            void WedgeBond(class RDKix::Bond * __ptr64,unsigned int,class RDKix::Conformer const * __ptr64)
    """
def WedgeMolBonds(mol: Mol, conformer: Conformer, params: BondWedgingParameters = None) -> None:
    """
        ...
        C++ signature :
            void WedgeMolBonds(class RDKix::ROMol {lvalue},class RDKix::Conformer const * __ptr64 [,struct RDKix::Chirality::BondWedgingParameters const * __ptr64=None])
    """
def _TestSetProps(mol: Mol) -> None:
    """
        C++ signature :
            void _TestSetProps(class RDKix::ROMol {lvalue})
    """
@typing.overload
def molzip(a: Mol, b: Mol, params: MolzipParams = ...) -> rdkix.Chem.Mol:
    """
        zip together two molecules using the given matching parameters
    
        C++ signature :
            class RDKix::ROMol * __ptr64 molzip(class RDKix::ROMol,class RDKix::ROMol [,struct RDKix::MolzipParams=<rdkix.Chem.rdmolops.MolzipParams object at 0x000001B0A4E256F0>])
    """
@typing.overload
def molzip(a: Mol, params: MolzipParams = ...) -> rdkix.Chem.Mol:
    """
        zip together two molecules using the given matching parameters
    
        C++ signature :
            class RDKix::ROMol * __ptr64 molzip(class RDKix::ROMol [,struct RDKix::MolzipParams=<rdkix.Chem.rdmolops.MolzipParams object at 0x000001B0A4E257A0>])
    """
@typing.overload
def molzip(row: dict, params: MolzipParams = ...) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 molzip(class boost::python::dict [,struct RDKix::MolzipParams=<rdkix.Chem.rdmolops.MolzipParams object at 0x000001B0A4E25900>])
    """
def molzipFragments(mols: typing.Any, params: MolzipParams = ...) -> rdkix.Chem.Mol:
    """
        ...
        C++ signature :
            class RDKix::ROMol * __ptr64 molzipFragments(class boost::python::api::object {lvalue} [,struct RDKix::MolzipParams=<rdkix.Chem.rdmolops.MolzipParams object at 0x000001B0A4E25850>])
    """
ADJUST_IGNOREALL: AdjustQueryWhichFlags  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREALL
ADJUST_IGNORECHAINS: AdjustQueryWhichFlags  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORECHAINS
ADJUST_IGNOREDUMMIES: AdjustQueryWhichFlags  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREDUMMIES
ADJUST_IGNOREMAPPED: AdjustQueryWhichFlags  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNOREMAPPED
ADJUST_IGNORENONDUMMIES: AdjustQueryWhichFlags  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORENONDUMMIES
ADJUST_IGNORENONE: AdjustQueryWhichFlags  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORENONE
ADJUST_IGNORERINGS: AdjustQueryWhichFlags  # value = rdkix.Chem.rdmolops.AdjustQueryWhichFlags.ADJUST_IGNORERINGS
AROMATICITY_CUSTOM: AromaticityModel  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_CUSTOM
AROMATICITY_DEFAULT: AromaticityModel  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_DEFAULT
AROMATICITY_MDL: AromaticityModel  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MDL
AROMATICITY_MMFF94: AromaticityModel  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_MMFF94
AROMATICITY_RDKIX: AromaticityModel  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_RDKIX
AROMATICITY_SIMPLE: AromaticityModel  # value = rdkix.Chem.rdmolops.AromaticityModel.AROMATICITY_SIMPLE
LayeredFingerprint_substructLayers: int = 7
SANITIZE_ADJUSTHS: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ADJUSTHS
SANITIZE_ALL: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_ALL
SANITIZE_CLEANUP: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUP
SANITIZE_CLEANUPATROPISOMERS: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUPATROPISOMERS
SANITIZE_CLEANUPCHIRALITY: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUPCHIRALITY
SANITIZE_CLEANUP_ORGANOMETALLICS: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_CLEANUP_ORGANOMETALLICS
SANITIZE_FINDRADICALS: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_FINDRADICALS
SANITIZE_KEKULIZE: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_KEKULIZE
SANITIZE_NONE: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_NONE
SANITIZE_PROPERTIES: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_PROPERTIES
SANITIZE_SETAROMATICITY: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETAROMATICITY
SANITIZE_SETCONJUGATION: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETCONJUGATION
SANITIZE_SETHYBRIDIZATION: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SETHYBRIDIZATION
SANITIZE_SYMMRINGS: SanitizeFlags  # value = rdkix.Chem.rdmolops.SanitizeFlags.SANITIZE_SYMMRINGS
