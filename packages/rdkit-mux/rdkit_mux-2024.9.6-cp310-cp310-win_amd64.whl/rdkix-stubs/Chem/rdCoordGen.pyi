...
class CoordGenParams(Boost.Python.instance):
    ...
    def SetCoordMap(self, coordMap: dict) -> None:
        """
            ...
            C++ signature :
                void SetCoordMap(struct RDKix::CoordGen::CoordGenParams * __ptr64,class boost::python::dict {lvalue})
        """
    def SetTemplateMol(self, templ: Mol) -> None:
        """
            ...
            C++ signature :
                void SetTemplateMol(struct RDKix::CoordGen::CoordGenParams * __ptr64,class RDKix::ROMol const * __ptr64)
        """
    ...
    def sketcherCoarsePrecision(*args, **kwargs):
        """
        "coarse" (fastest) precision setting, produces good-quality coordinates most of the time, this is the default setting for the RDKix
        """
    @property
...
def AddCoords(mol: Mol, params: typing.Any = None) -> None:
    """
        ...
        C++ signature :
            void AddCoords(class RDKix::ROMol {lvalue} [,class boost::python::api::object {lvalue}=None])
    """
