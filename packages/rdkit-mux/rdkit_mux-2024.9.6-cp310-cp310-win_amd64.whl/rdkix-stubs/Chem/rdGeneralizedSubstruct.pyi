...
class ExtendedQueryMol(Boost.Python.instance):
    ...
    def InitFromBinary(self, pkl: str) -> None:
        """
            C++ signature :
                void InitFromBinary(struct RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue},class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
        """
    def InitFromJSON(self, text: str) -> None:
        """
            C++ signature :
                void InitFromJSON(struct RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue},class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >)
        """
    def PatternFingerprintQuery(self, fingerprintSize: int = 2048) -> typing.Any:
        """
            C++ signature :
                class std::unique_ptr<class ExplicitBitVect,struct std::default_delete<class ExplicitBitVect> > PatternFingerprintQuery(struct RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue} [,unsigned int=2048])
        """
    def ToBinary(self) -> typing.Any:
        """
            C++ signature :
                class boost::python::api::object ToBinary(struct RDKix::GeneralizedSubstruct::ExtendedQueryMol)
        """
    def ToJSON(self) -> str:
        """
            C++ signature :
                class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > ToJSON(struct RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue})
        """
...
def CreateExtendedQueryMol(mol: Mol, doEnumeration: bool = True, doTautomers: bool = True, adjustQueryProperties: bool = False, adjustQueryParameters: AdjustQueryParameters = None) -> ExtendedQueryMol:
    """
        ...
        C++ signature :
            struct RDKix::GeneralizedSubstruct::ExtendedQueryMol * __ptr64 CreateExtendedQueryMol(class RDKix::ROMol [,bool=True [,bool=True [,bool=False [,struct RDKix::MolOps::AdjustQueryParameters * __ptr64=None]]]])
    """
def MolGetSubstructMatch(mol: Mol, query: ExtendedQueryMol, params: SubstructMatchParameters = None) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 MolGetSubstructMatch(class RDKix::ROMol,struct RDKix::GeneralizedSubstruct::ExtendedQueryMol [,struct RDKix::SubstructMatchParameters * __ptr64=None])
    """
def MolGetSubstructMatches(mol: Mol, query: ExtendedQueryMol, params: SubstructMatchParameters = None) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 MolGetSubstructMatches(class RDKix::ROMol,struct RDKix::GeneralizedSubstruct::ExtendedQueryMol [,struct RDKix::SubstructMatchParameters * __ptr64=None])
    """
def MolHasSubstructMatch(mol: Mol, query: ExtendedQueryMol, params: SubstructMatchParameters = None) -> bool:
    """
        ...
        C++ signature :
            bool MolHasSubstructMatch(class RDKix::ROMol,struct RDKix::GeneralizedSubstruct::ExtendedQueryMol [,struct RDKix::SubstructMatchParameters * __ptr64=None])
    """
def PatternFingerprintTarget(target: Mol, fingerprintSize: int = 2048) -> typing.Any:
    """
        ...
        C++ signature :
            class std::unique_ptr<class ExplicitBitVect,struct std::default_delete<class ExplicitBitVect> > PatternFingerprintTarget(class RDKix::ROMol [,unsigned int=2048])
    """
