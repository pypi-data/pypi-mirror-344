...
class O3A(Boost.Python.instance):
    ...
    def Align(self) -> float:
        """
            ...
            C++ signature :
                double Align(class RDKix::MolAlign::PyO3A {lvalue})
        """
    def Matches(self) -> list:
        """
            ...
            C++ signature :
                class boost::python::list Matches(class RDKix::MolAlign::PyO3A {lvalue})
        """
    def Score(self) -> float:
        """
            ...
            C++ signature :
                double Score(class RDKix::MolAlign::PyO3A {lvalue})
        """
    def Trans(self) -> typing.Any:
        """
            ...
            C++ signature :
                struct _object * __ptr64 Trans(class RDKix::MolAlign::PyO3A {lvalue})
        """
    def Weights(self) -> list:
        """
            ...
            C++ signature :
                class boost::python::list Weights(class RDKix::MolAlign::PyO3A {lvalue})
        """
def AlignMol(prbMol: Mol, refMol: Mol, prbCid: int = -1, refCid: int = -1, atomMap: typing.Any = [], weights: typing.Any = [], reflect: bool = False, maxIters: int = 50) -> float:
    """
        ...
        C++ signature :
            double AlignMol(class RDKix::ROMol {lvalue},class RDKix::ROMol [,int=-1 [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,bool=False [,unsigned int=50]]]]]])
    """
def AlignMolConformers(mol: Mol, atomIds: typing.Any = [], confIds: typing.Any = [], weights: typing.Any = [], reflect: bool = False, maxIters: int = 50, RMSlist: typing.Any = None) -> None:
    """
        ...
        C++ signature :
            void AlignMolConformers(class RDKix::ROMol {lvalue} [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,bool=False [,unsigned int=50 [,class boost::python::api::object=None]]]]]])
    """
def CalcRMS(prbMol: Mol, refMol: Mol, prbId: int = -1, refId: int = -1, map: typing.Any = None, maxMatches: int = 1000000, symmetrizeConjugatedTerminalGroups: bool = True, weights: typing.Any = []) -> float:
    """
        ...
        C++ signature :
            double CalcRMS(class RDKix::ROMol {lvalue},class RDKix::ROMol {lvalue} [,int=-1 [,int=-1 [,class boost::python::api::object=None [,int=1000000 [,bool=True [,class boost::python::api::object=[]]]]]]])
    """
def GetAlignmentTransform(prbMol: Mol, refMol: Mol, prbCid: int = -1, refCid: int = -1, atomMap: typing.Any = [], weights: typing.Any = [], reflect: bool = False, maxIters: int = 50) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetAlignmentTransform(class RDKix::ROMol,class RDKix::ROMol [,int=-1 [,int=-1 [,class boost::python::api::object=[] [,class boost::python::api::object=[] [,bool=False [,unsigned int=50]]]]]])
    """
def GetAllConformerBestRMS(mol: Mol, numThreads: int = 1, map: typing.Any = None, maxMatches: int = 1000000, symmetrizeConjugatedTerminalGroups: bool = True, weights: typing.Any = []) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GetAllConformerBestRMS(class RDKix::ROMol {lvalue} [,int=1 [,class boost::python::api::object=None [,int=1000000 [,bool=True [,class boost::python::api::object=[]]]]]])
    """
def GetBestAlignmentTransform(prbMol: Mol, refMol: Mol, prbCid: int = -1, refCid: int = -1, map: typing.Any = [], maxMatches: int = 1000000, symmetrizeConjugatedTerminalGroups: bool = True, weights: typing.Any = [], reflect: bool = False, maxIters: int = 50, numThreads: int = 1) -> typing.Any:
    """
        ...
        C++ signature :
            struct _object * __ptr64 GetBestAlignmentTransform(class RDKix::ROMol,class RDKix::ROMol [,int=-1 [,int=-1 [,class boost::python::api::object=[] [,int=1000000 [,bool=True [,class boost::python::api::object=[] [,bool=False [,unsigned int=50 [,int=1]]]]]]]]])
    """
def GetBestRMS(prbMol: Mol, refMol: Mol, prbId: int = -1, refId: int = -1, map: typing.Any = None, maxMatches: int = 1000000, symmetrizeConjugatedTerminalGroups: bool = True, weights: typing.Any = [], numThreads: int = 1) -> float:
    """
        ...
        C++ signature :
            double GetBestRMS(class RDKix::ROMol {lvalue},class RDKix::ROMol {lvalue} [,int=-1 [,int=-1 [,class boost::python::api::object=None [,int=1000000 [,bool=True [,class boost::python::api::object=[] [,int=1]]]]]]])
    """
def GetCrippenO3A(prbMol: Mol, refMol: Mol, prbCrippenContribs: list = [], refCrippenContribs: list = [], prbCid: int = -1, refCid: int = -1, reflect: bool = False, maxIters: int = 50, options: int = 0, constraintMap: list = [], constraintWeights: list = []) -> O3A:
    """
        ...
        C++ signature :
            class RDKix::MolAlign::PyO3A * __ptr64 GetCrippenO3A(class RDKix::ROMol {lvalue},class RDKix::ROMol {lvalue} [,class boost::python::list=[] [,class boost::python::list=[] [,int=-1 [,int=-1 [,bool=False [,unsigned int=50 [,unsigned int=0 [,class boost::python::list=[] [,class boost::python::list=[]]]]]]]]]])
    """
def GetCrippenO3AForProbeConfs(prbMol: Mol, refMol: Mol, numThreads: int = 1, prbCrippenContribs: list = [], refCrippenContribs: list = [], refCid: int = -1, reflect: bool = False, maxIters: int = 50, options: int = 0, constraintMap: list = [], constraintWeights: list = []) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GetCrippenO3AForProbeConfs(class RDKix::ROMol {lvalue},class RDKix::ROMol {lvalue} [,int=1 [,class boost::python::list=[] [,class boost::python::list=[] [,int=-1 [,bool=False [,unsigned int=50 [,unsigned int=0 [,class boost::python::list=[] [,class boost::python::list=[]]]]]]]]]])
    """
def GetO3A(prbMol: Mol, refMol: Mol, prbPyMMFFMolProperties: typing.Any = None, refPyMMFFMolProperties: typing.Any = None, prbCid: int = -1, refCid: int = -1, reflect: bool = False, maxIters: int = 50, options: int = 0, constraintMap: list = [], constraintWeights: list = []) -> O3A:
    """
        ...
        C++ signature :
            class RDKix::MolAlign::PyO3A * __ptr64 GetO3A(class RDKix::ROMol {lvalue},class RDKix::ROMol {lvalue} [,class boost::python::api::object=None [,class boost::python::api::object=None [,int=-1 [,int=-1 [,bool=False [,unsigned int=50 [,unsigned int=0 [,class boost::python::list=[] [,class boost::python::list=[]]]]]]]]]])
    """
def GetO3AForProbeConfs(prbMol: Mol, refMol: Mol, numThreads: int = 1, prbPyMMFFMolProperties: typing.Any = None, refPyMMFFMolProperties: typing.Any = None, refCid: int = -1, reflect: bool = False, maxIters: int = 50, options: int = 0, constraintMap: list = [], constraintWeights: list = []) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple GetO3AForProbeConfs(class RDKix::ROMol {lvalue},class RDKix::ROMol {lvalue} [,int=1 [,class boost::python::api::object=None [,class boost::python::api::object=None [,int=-1 [,bool=False [,unsigned int=50 [,unsigned int=0 [,class boost::python::list=[] [,class boost::python::list=[]]]]]]]]]])
    """
def RandomTransform(mol: Mol, cid: int = -1, seed: int = -1) -> None:
    """
        ...
        C++ signature :
            void RandomTransform(class RDKix::ROMol {lvalue} [,int=-1 [,int=-1]])
    """
