...
class EdgeType(Boost.Python.enum):
    Fragment: typing.ClassVar[EdgeType]  # value = rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.Fragment
    Generic: typing.ClassVar[EdgeType]  # value = rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.Generic
    GenericBond: typing.ClassVar[EdgeType]  # value = rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.GenericBond
    Initialize: typing.ClassVar[EdgeType]  # value = rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.Initialize
    RemoveAttachment: typing.ClassVar[EdgeType]  # value = rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.RemoveAttachment
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'Fragment': rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.Fragment, 'Generic': rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.Generic, 'GenericBond': rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.GenericBond, 'RemoveAttachment': rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.RemoveAttachment, 'Initialize': rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.Initialize}
    values: typing.ClassVar[dict]  # value = {1: rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.Fragment, 2: rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.Generic, 3: rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.GenericBond, 4: rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.RemoveAttachment, 5: rdkix.Chem.Scaffolds.rdScaffoldNetwork.EdgeType.Initialize}
class NetworkEdge(Boost.Python.instance):
    ...
    def __str__(self) -> typing.Any:
        """
            C++ signature :
                struct _object * __ptr64 __str__(struct RDKix::ScaffoldNetwork::NetworkEdge {lvalue})
        """
    @property
...
class NetworkEdge_VECT(Boost.Python.instance):
    ...
    def __contains__(self, item: typing.Any) -> bool:
        """
            C++ signature :
                bool __contains__(class std::vector<struct RDKix::ScaffoldNetwork::NetworkEdge,class std::allocator<struct RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},struct _object * __ptr64)
        """
    def __delitem__(self, item: typing.Any) -> None:
        """
            C++ signature :
                void __delitem__(class std::vector<struct RDKix::ScaffoldNetwork::NetworkEdge,class std::allocator<struct RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},struct _object * __ptr64)
        """
    def __getitem__(self, item: typing.Any) -> typing.Any:
        """
            C++ signature :
                class boost::python::api::object __getitem__(struct boost::python::back_reference<class std::vector<struct RDKix::ScaffoldNetwork::NetworkEdge,class std::allocator<struct RDKix::ScaffoldNetwork::NetworkEdge> > & __ptr64>,struct _object * __ptr64)
        """
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                struct boost::python::objects::iterator_range<struct boost::python::return_internal_reference<1,struct boost::python::default_call_policies>,class std::_Vector_iterator<class std::_Vector_val<struct std::_Simple_types<struct RDKix::ScaffoldNetwork::NetworkEdge> > > > __iter__(struct boost::python::back_reference<class std::vector<struct RDKix::ScaffoldNetwork::NetworkEdge,class std::allocator<struct RDKix::ScaffoldNetwork::NetworkEdge> > & __ptr64>)
        """
    def __len__(self) -> int:
        """
            C++ signature :
                unsigned __int64 __len__(class std::vector<struct RDKix::ScaffoldNetwork::NetworkEdge,class std::allocator<struct RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue})
        """
    def __setitem__(self, item: typing.Any, value: typing.Any) -> None:
        """
            C++ signature :
                void __setitem__(class std::vector<struct RDKix::ScaffoldNetwork::NetworkEdge,class std::allocator<struct RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},struct _object * __ptr64,struct _object * __ptr64)
        """
    def append(self, item: typing.Any) -> None:
        """
            C++ signature :
                void append(class std::vector<struct RDKix::ScaffoldNetwork::NetworkEdge,class std::allocator<struct RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},class boost::python::api::object)
        """
    def extend(self, other: typing.Any) -> None:
        """
            C++ signature :
                void extend(class std::vector<struct RDKix::ScaffoldNetwork::NetworkEdge,class std::allocator<struct RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},class boost::python::api::object)
        """
class ScaffoldNetwork(Boost.Python.instance):
    ...
    def __getinitargs__(self) -> tuple:
        """
            C++ signature :
                class boost::python::tuple __getinitargs__(struct RDKix::ScaffoldNetwork::ScaffoldNetwork)
        """
...
def BRICSScaffoldParams() -> ScaffoldNetworkParams:
    """
        ...
        C++ signature :
            struct RDKix::ScaffoldNetwork::ScaffoldNetworkParams * __ptr64 BRICSScaffoldParams()
    """
def CreateScaffoldNetwork(mols: typing.Any, params: ScaffoldNetworkParams) -> ScaffoldNetwork:
    """
        ...
        C++ signature :
            struct RDKix::ScaffoldNetwork::ScaffoldNetwork * __ptr64 CreateScaffoldNetwork(class boost::python::api::object,struct RDKix::ScaffoldNetwork::ScaffoldNetworkParams)
    """
def UpdateScaffoldNetwork(mols: typing.Any, network: ScaffoldNetwork, params: ScaffoldNetworkParams) -> None:
    """
        ...
        C++ signature :
            void UpdateScaffoldNetwork(class boost::python::api::object,struct RDKix::ScaffoldNetwork::ScaffoldNetwork {lvalue},struct RDKix::ScaffoldNetwork::ScaffoldNetworkParams)
    """
