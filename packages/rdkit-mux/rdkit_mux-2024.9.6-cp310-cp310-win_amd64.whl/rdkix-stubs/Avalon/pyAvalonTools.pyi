...
def CheckMolecule(mol: typing.Any) -> tuple:
    """
        ...
        C++ signature :
            class boost::python::tuple CheckMolecule(class RDKix::ROMol {lvalue})
    """
...
def Generate2DCoords(mol: typing.Any, clearConfs: bool = True) -> int:
    """
        ...
        C++ signature :
            unsigned int Generate2DCoords(class RDKix::ROMol {lvalue} [,bool=True])
    """
@typing.overload
...
def GetAvalonCountFP(mol: typing.Any, nBits: int = 512, isQuery: bool = False, bitFlags: int = 15761407) -> typing.Any:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<unsigned int> * __ptr64 GetAvalonCountFP(class RDKix::ROMol [,unsigned int=512 [,bool=False [,unsigned int=15761407]]])
    """
@typing.overload
def GetAvalonCountFP(molData: str, isSmiles: bool, nBits: int = 512, isQuery: bool = False, bitFlags: int = 15761407) -> typing.Any:
    """
        ...
        C++ signature :
            class RDKix::SparseIntVect<unsigned int> * __ptr64 GetAvalonCountFP(class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> >,bool [,unsigned int=512 [,bool=False [,unsigned int=15761407]]])
    """
@typing.overload
def GetAvalonFP(mol: typing.Any, nBits: int = 512, isQuery: bool = False, resetVect: bool = False, bitFlags: int = 15761407) -> typing.Any:
    """
        ...
        C++ signature :
            class ExplicitBitVect * __ptr64 GetAvalonFP(class RDKix::ROMol [,unsigned int=512 [,bool=False [,bool=False [,unsigned int=15761407]]]])
    """
@typing.overload
...
def GetAvalonFPAsWords(mol: typing.Any, nBits: int = 512, isQuery: bool = False, resetVect: bool = False, bitFlags: int = 15761407) -> list:
    """
        ...
        C++ signature :
            class boost::python::list GetAvalonFPAsWords(class RDKix::ROMol [,unsigned int=512 [,bool=False [,bool=False [,unsigned int=15761407]]]])
    """
@typing.overload
...
def GetCanonSmiles(mol: typing.Any, flags: int = -1) -> str:
    """
        ...
        C++ signature :
            class std::basic_string<char,struct std::char_traits<char>,class std::allocator<char> > GetCanonSmiles(class RDKix::ROMol {lvalue} [,int=-1])
    """
@typing.overload
