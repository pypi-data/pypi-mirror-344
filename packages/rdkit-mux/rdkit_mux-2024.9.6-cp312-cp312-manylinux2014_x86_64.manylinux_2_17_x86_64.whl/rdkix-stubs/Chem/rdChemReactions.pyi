...
class ChemicalReaction(Boost.Python.instance):
    ...
    def AddRecursiveQueriesToReaction(reaction: ChemicalReaction, queries: dict = {}, propName: str = 'molFileValue', getLabels: bool = False) -> typing.Any:
        """
            ...
            C++ signature :
                boost::python::api::object AddRecursiveQueriesToReaction(RDKix::ChemicalReaction {lvalue} [,boost::python::dict={} [,std::string='molFileValue' [,bool=False]]])
        """
    @staticmethod
    def __reduce__(*args, **kwargs):
        ...
    ...
    def ClearProp(self, key: str) -> None:
        """
            ...
            C++ signature :
                void ClearProp(RDKix::ChemicalReaction,std::string)
        """
    ...
    def GetAgents(self) -> MOL_SPTR_VECT:
        """
            ...
            C++ signature :
                std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > GetAgents(RDKix::ChemicalReaction {lvalue})
        """
    def GetBoolProp(self, key: str) -> bool:
        """
            ...
            C++ signature :
                bool GetBoolProp(RDKix::ChemicalReaction const*,std::string)
        """
    def GetDoubleProp(self, key: str) -> float:
        """
            ...
            C++ signature :
                double GetDoubleProp(RDKix::ChemicalReaction const*,std::string)
        """
    def GetIntProp(self, key: str) -> int:
        """
            ...
            C++ signature :
                int GetIntProp(RDKix::ChemicalReaction const*,std::string)
        """
    ...
    def GetProducts(self) -> MOL_SPTR_VECT:
        """
            ...
            C++ signature :
                std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > GetProducts(RDKix::ChemicalReaction {lvalue})
        """
    def GetProp(self, key: str) -> str:
        """
            ...
            C++ signature :
                std::string GetProp(RDKix::ChemicalReaction const*,std::string)
        """
    def GetPropNames(self, includePrivate: bool = False, includeComputed: bool = False) -> _vectSs:
        """
            ...
            C++ signature :
                std::vector<std::string, std::allocator<std::string> > GetPropNames(RDKix::ChemicalReaction {lvalue} [,bool=False [,bool=False]])
        """
    ...
    def GetReactants(self) -> MOL_SPTR_VECT:
        """
            ...
            C++ signature :
                std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > GetReactants(RDKix::ChemicalReaction {lvalue})
        """
    ...
    def GetUnsignedProp(self, key: str) -> int:
        """
            ...
            C++ signature :
                unsigned int GetUnsignedProp(RDKix::ChemicalReaction const*,std::string)
        """
    def HasProp(self, key: str) -> int:
        """
            ...
            C++ signature :
                int HasProp(RDKix::ChemicalReaction,std::string)
        """
    ...
    def SetBoolProp(self, key: str, val: bool, computed: bool = False) -> None:
        """
            ...
            C++ signature :
                void SetBoolProp(RDKix::ChemicalReaction,std::string,bool [,bool=False])
        """
    def SetDoubleProp(self, key: str, val: float, computed: bool = False) -> None:
        """
            ...
            C++ signature :
                void SetDoubleProp(RDKix::ChemicalReaction,std::string,double [,bool=False])
        """
    def SetIntProp(self, key: str, val: int, computed: bool = False) -> None:
        """
            ...
            C++ signature :
                void SetIntProp(RDKix::ChemicalReaction,std::string,int [,bool=False])
        """
    def SetProp(self, key: str, val: str, computed: bool = False) -> None:
        """
            ...
            C++ signature :
                void SetProp(RDKix::ChemicalReaction,std::string,std::string [,bool=False])
        """
    def SetUnsignedProp(self, key: str, val: int, computed: bool = False) -> None:
        """
            ...
            C++ signature :
                void SetUnsignedProp(RDKix::ChemicalReaction,std::string,unsigned int [,bool=False])
        """
    @typing.overload
...
class EnumerateLibrary(EnumerateLibraryBase):
    ...
    def GetReagents(self) -> VectMolVect:
        """
            ...
            C++ signature :
                std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > > GetReagents(RDKix::EnumerateLibraryWrap {lvalue})
        """
    @typing.overload
    def __init__(self) -> None:
        """
...
class EnumerateLibraryBase(Boost.Python.instance):
    ...
    def GetPosition(self) -> UnsignedLong_Vect:
        """
            ...
            C++ signature :
                std::vector<unsigned long, std::allocator<unsigned long> > GetPosition(RDKix::EnumerateLibraryBase {lvalue})
        """
    ...
    def GetState(self) -> str:
        """
            ...
            C++ signature :
                std::string GetState(RDKix::EnumerateLibraryBase {lvalue})
        """
    def InitFromString(self, data: str) -> None:
        """
            ...
            C++ signature :
                void InitFromString(RDKix::EnumerateLibraryBase {lvalue},std::string)
        """
    ...
    def SetState(self, state: str) -> None:
        """
            ...
            C++ signature :
                void SetState(RDKix::EnumerateLibraryBase {lvalue},std::string)
        """
    ...
    def nextSmiles(self) -> VectorOfStringVectors:
        """
            ...
            C++ signature :
                std::vector<std::vector<std::string, std::allocator<std::string> >, std::allocator<std::vector<std::string, std::allocator<std::string> > > > nextSmiles(RDKix::EnumerateLibraryBase {lvalue})
        """
...
class EnumerationStrategyBase(Boost.Python.instance):
    ...
    def GetNumPermutations(self) -> int:
        """
            ...
            C++ signature :
                unsigned long GetNumPermutations(RDKix::EnumerationStrategyBase {lvalue})
        """
    def GetPosition(self) -> UnsignedLong_Vect:
        """
            ...
            C++ signature :
                std::vector<unsigned long, std::allocator<unsigned long> > GetPosition(RDKix::EnumerationStrategyBase {lvalue})
        """
    ...
    def Skip(self, skipCount: int) -> bool:
        """
            ...
            C++ signature :
                bool Skip(RDKix::EnumerationStrategyBase {lvalue},unsigned long)
        """
    def Type(self) -> str:
        """
    ...
    def __next__(self) -> UnsignedLong_Vect:
        """
            ...
            C++ signature :
                std::vector<unsigned long, std::allocator<unsigned long> > __next__(RDKix::EnumerationStrategyBase {lvalue})
        """
    @typing.overload
    ...
    def next(self) -> UnsignedLong_Vect:
        """
            ...
            C++ signature :
                std::vector<unsigned long, std::allocator<unsigned long> > next(RDKix::EnumerationStrategyBase {lvalue})
        """
    @typing.overload
    def next(self) -> None:
        """
...
class EvenSamplePairsStrategy(EnumerationStrategyBase):
    ...
    def Stats(self) -> str:
        """
            ...
            C++ signature :
                std::string Stats(RDKix::EvenSamplePairsStrategy {lvalue})
        """
    def __copy__(self) -> EnumerationStrategyBase:
        """
            C++ signature :
...
class MOL_SPTR_VECT(Boost.Python.instance):
    ...
    def __contains__(self, item: typing.Any) -> bool:
        """
            C++ signature :
                bool __contains__(std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > {lvalue},_object*)
        """
    def __delitem__(self, item: typing.Any) -> None:
        """
            C++ signature :
                void __delitem__(std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > {lvalue},_object*)
        """
    def __getitem__(self, item: typing.Any) -> typing.Any:
        """
            C++ signature :
                boost::python::api::object __getitem__(boost::python::back_reference<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >&>,_object*)
        """
    def __init__(self) -> None:
        """
            C++ signature :
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                boost::python::objects::iterator_range<boost::python::return_value_policy<boost::python::return_by_value, boost::python::default_call_policies>, __gnu_cxx::__normal_iterator<boost::shared_ptr<RDKix::ROMol>*, std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > > __iter__(boost::python::back_reference<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >&>)
        """
    def __len__(self) -> int:
        """
            C++ signature :
                unsigned long __len__(std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > {lvalue})
        """
    def __setitem__(self, item: typing.Any, value: typing.Any) -> None:
        """
            C++ signature :
                void __setitem__(std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > {lvalue},_object*,_object*)
        """
    def append(self, item: typing.Any) -> None:
        """
            C++ signature :
                void append(std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > {lvalue},boost::python::api::object)
        """
    def extend(self, other: typing.Any) -> None:
        """
            C++ signature :
                void extend(std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > {lvalue},boost::python::api::object)
        """
...
class VectMolVect(Boost.Python.instance):
    ...
    def __contains__(self, item: typing.Any) -> bool:
        """
            C++ signature :
                bool __contains__(std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > > {lvalue},_object*)
        """
    def __delitem__(self, item: typing.Any) -> None:
        """
            C++ signature :
                void __delitem__(std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > > {lvalue},_object*)
        """
    def __getitem__(self, item: typing.Any) -> typing.Any:
        """
            C++ signature :
                boost::python::api::object __getitem__(boost::python::back_reference<std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > >&>,_object*)
        """
    def __init__(self) -> None:
        """
            C++ signature :
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                boost::python::objects::iterator_range<boost::python::return_internal_reference<1ul, boost::python::default_call_policies>, __gnu_cxx::__normal_iterator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >*, std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > > > > __iter__(boost::python::back_reference<std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > >&>)
        """
    def __len__(self) -> int:
        """
            C++ signature :
                unsigned long __len__(std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > > {lvalue})
        """
    def __setitem__(self, item: typing.Any, value: typing.Any) -> None:
        """
            C++ signature :
                void __setitem__(std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > > {lvalue},_object*,_object*)
        """
    def append(self, item: typing.Any) -> None:
        """
            C++ signature :
                void append(std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > > {lvalue},boost::python::api::object)
        """
    def extend(self, other: typing.Any) -> None:
        """
            C++ signature :
                void extend(std::vector<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > >, std::allocator<std::vector<boost::shared_ptr<RDKix::ROMol>, std::allocator<boost::shared_ptr<RDKix::ROMol> > > > > {lvalue},boost::python::api::object)
        """
...
def CreateDifferenceFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> UIntSparseIntVect:
    """
        ...
        C++ signature :
            RDKix::SparseIntVect<unsigned int>* CreateDifferenceFingerprintForReaction(RDKix::ChemicalReaction [,RDKix::ReactionFingerprintParams=<rdkix.Chem.rdChemReactions.ReactionFingerprintParams object at 0x7fa55afb7540>])
    """
def CreateStructuralFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            ExplicitBitVect* CreateStructuralFingerprintForReaction(RDKix::ChemicalReaction [,RDKix::ReactionFingerprintParams=<rdkix.Chem.rdChemReactions.ReactionFingerprintParams object at 0x7fa55afb75c0>])
    """
...
def PreprocessReaction(reaction: ChemicalReaction, queries: dict = {}, propName: str = 'molFileValue') -> typing.Any:
    """
        ...
        C++ signature :
            boost::python::api::object PreprocessReaction(RDKix::ChemicalReaction {lvalue} [,boost::python::dict={} [,std::string='molFileValue']])
    """
...
def ReactionFromPNGFile(fname: str) -> ChemicalReaction:
    """
        ...
        C++ signature :
            RDKix::ChemicalReaction* ReactionFromPNGFile(std::string)
    """
def ReactionFromPNGString(data: str) -> ChemicalReaction:
    """
        ...
        C++ signature :
            RDKix::ChemicalReaction* ReactionFromPNGString(std::string)
    """
def ReactionFromRxnBlock(rxnblock: str, sanitize: bool = False, removeHs: bool = False, strictParsing: bool = True) -> ChemicalReaction:
    """
        ...
        C++ signature :
            RDKix::ChemicalReaction* ReactionFromRxnBlock(std::string [,bool=False [,bool=False [,bool=True]]])
    """
def ReactionFromRxnFile(filename: str, sanitize: bool = False, removeHs: bool = False, strictParsing: bool = True) -> ChemicalReaction:
    """
        ...
        C++ signature :
            RDKix::ChemicalReaction* ReactionFromRxnFile(std::string [,bool=False [,bool=False [,bool=True]]])
    """
...
def ReactionToCXSmarts(reaction: ChemicalReaction) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToCXSmarts(RDKix::ChemicalReaction)
    """
@typing.overload
def ReactionToCXSmarts(reaction: ChemicalReaction, params: SmilesWriteParams, flags: int = ...) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToCXSmarts(RDKix::ChemicalReaction,RDKix::SmilesWriteParams [,unsigned int=rdkix.Chem.rdmolfiles.CXSmilesFields.CX_ALL])
    """
@typing.overload
def ReactionToCXSmiles(reaction: ChemicalReaction, canonical: bool = True) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToCXSmiles(RDKix::ChemicalReaction [,bool=True])
    """
@typing.overload
def ReactionToCXSmiles(reaction: ChemicalReaction, params: SmilesWriteParams, flags: int = ...) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToCXSmiles(RDKix::ChemicalReaction,RDKix::SmilesWriteParams [,unsigned int=rdkix.Chem.rdmolfiles.CXSmilesFields.CX_ALL])
    """
...
def ReactionToMrvBlock(reaction: ChemicalReaction, prettyPrint: bool = False) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToMrvBlock(RDKix::ChemicalReaction [,bool=False])
    """
def ReactionToMrvFile(reaction: ChemicalReaction, filename: str, prettyPrint: bool = False) -> None:
    """
        ...
        C++ signature :
            void ReactionToMrvFile(RDKix::ChemicalReaction,std::string [,bool=False])
    """
def ReactionToRxnBlock(reaction: ChemicalReaction, separateAgents: bool = False, forceV3000: bool = False) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToRxnBlock(RDKix::ChemicalReaction [,bool=False [,bool=False]])
    """
@typing.overload
def ReactionToSmarts(reaction: ChemicalReaction) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToSmarts(RDKix::ChemicalReaction)
    """
@typing.overload
def ReactionToSmarts(reaction: ChemicalReaction, params: SmilesWriteParams) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToSmarts(RDKix::ChemicalReaction,RDKix::SmilesWriteParams)
    """
@typing.overload
def ReactionToSmiles(reaction: ChemicalReaction, canonical: bool = True) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToSmiles(RDKix::ChemicalReaction [,bool=True])
    """
@typing.overload
def ReactionToSmiles(reaction: ChemicalReaction, params: SmilesWriteParams) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToSmiles(RDKix::ChemicalReaction,RDKix::SmilesWriteParams)
    """
def ReactionToV3KRxnBlock(reaction: ChemicalReaction, separateAgents: bool = False) -> str:
    """
        ...
        C++ signature :
            std::string ReactionToV3KRxnBlock(RDKix::ChemicalReaction [,bool=False])
    """
...
def SanitizeRxn(rxn: ChemicalReaction, sanitizeOps: int = 4294967295, params: AdjustQueryParameters = ..., catchErrors: bool = False) -> SanitizeFlags:
    """
        ...
        C++ signature :
            RDKix::RxnOps::SanitizeRxnFlags SanitizeRxn(RDKix::ChemicalReaction {lvalue} [,unsigned long=4294967295 [,RDKix::MolOps::AdjustQueryParameters=<rdkix.Chem.rdmolops.AdjustQueryParameters object at 0x7fa55afbb920> [,bool=False]]])
    """
