...
def GetRDKFingerprint(mol, atomId = -1, fpType = 'bv', nBits = 2048, minPath = 1, maxPath = 5, nBitsPerHash = 2, **kwargs):
    """
        ...
        Calculates the RDKix fingerprint with the paths of atomId removed.
    
        Parameters:
          mol -- the molecule of interest
          atomId -- the atom to remove the paths for (if -1, no path is removed)
          fpType -- the type of RDKix fingerprint: 'bv'
...
def GetSimilarityMapFromWeights(mol, weights, draw2d, colorMap = None, scale = -1, size = (250, 250), sigma = None, coordScale = 1.5, step = 0.01, colors = 'k', contourLines = 10, alpha = 0.5, **kwargs):
    """
        ...
        Parameters:
          ...
          draw2d -- the RDKix drawing object
...
def _DeleteFpInfoAttr(mol):
    ...
apDict: dict  # value = {'normal': <function <lambda> at 0x7f7f5849b100>, 'hashed': <function <lambda> at 0x7f7f5849b1a0>, 'bv': <function <lambda> at 0x7f7f5849b240>}
cm = None
ttDict: dict  # value = {'normal': <function <lambda> at 0x7f7f5849b380>, 'hashed': <function <lambda> at 0x7f7f5849b420>, 'bv': <function <lambda> at 0x7f7f5849b4c0>}
