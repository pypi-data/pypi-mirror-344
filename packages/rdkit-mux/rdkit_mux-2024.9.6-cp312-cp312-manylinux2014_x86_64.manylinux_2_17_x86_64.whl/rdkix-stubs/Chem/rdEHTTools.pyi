...
class EHTResults(Boost.Python.instance):
    ...
    def GetAtomicCharges(self) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetAtomicCharges(RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetHamiltonian(self) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetHamiltonian(RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetOrbitalEnergies(self) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetOrbitalEnergies(RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetOverlapMatrix(self) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetOverlapMatrix(RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetReducedChargeMatrix(self) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetReducedChargeMatrix(RDKix::EHTTools::EHTResults {lvalue})
        """
    def GetReducedOverlapPopulationMatrix(self) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetReducedOverlapPopulationMatrix(RDKix::EHTTools::EHTResults {lvalue})
        """
    @property
...
def RunMol(mol: Mol, confId: int = -1, keepOverlapAndHamiltonianMatrices: bool = False) -> tuple:
    """
        ...
        C++ signature :
            boost::python::tuple RunMol(RDKix::ROMol [,int=-1 [,bool=False]])
    """
