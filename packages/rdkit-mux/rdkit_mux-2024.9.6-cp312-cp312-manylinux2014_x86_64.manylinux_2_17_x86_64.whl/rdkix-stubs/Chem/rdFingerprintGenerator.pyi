...
class FingerprintGenerator32(Boost.Python.instance):
    ...
    def GetInfoString(self) -> str:
        """
            ...
            C++ signature :
                std::string GetInfoString(RDKix::FingerprintGenerator<unsigned int> const*)
        """
...
class FingerprintGenerator64(Boost.Python.instance):
    ...
    def GetCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> UIntSparseIntVect:
        """
            ...
            C++ signature :
                RDKix::SparseIntVect<unsigned int>* GetCountFingerprint(RDKix::FingerprintGenerator<unsigned long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            Generates a count fingerprint
            ...
            C++ signature :
                boost::python::api::object GetCountFingerprintAsNumPy(RDKix::FingerprintGenerator<unsigned long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates count fingerprints for a sequence of molecules
            ...
            C++ signature :
                boost::python::tuple GetCountFingerprints(RDKix::FingerprintGenerator<unsigned long> const*,boost::python::api::object [,int=1])
        """
    def GetFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> ExplicitBitVect:
        """
            Generates a fingerprint
            ...
            C++ signature :
                ExplicitBitVect* GetFingerprint(RDKix::FingerprintGenerator<unsigned long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetFingerprintAsNumPy(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> typing.Any:
        """
            Generates a fingerprint
            ...
            C++ signature :
                boost::python::api::object GetFingerprintAsNumPy(RDKix::FingerprintGenerator<unsigned long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates fingerprints for a sequence of molecules
            ...
            C++ signature :
                boost::python::tuple GetFingerprints(RDKix::FingerprintGenerator<unsigned long> const*,boost::python::api::object [,int=1])
        """
    def GetInfoString(self) -> str:
        """
            Returns a string containing information about the fingerprint generator
            ...
            C++ signature :
                std::string GetInfoString(RDKix::FingerprintGenerator<unsigned long> const*)
        """
    def GetOptions(self) -> FingerprintOptions:
        """
            return the fingerprint options object
            ...
            C++ signature :
                RDKix::FingerprintArguments* GetOptions(RDKix::FingerprintGenerator<unsigned long>*)
        """
    def GetSparseCountFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> ULongSparseIntVect:
        """
            ...
            C++ signature :
                RDKix::SparseIntVect<unsigned long>* GetSparseCountFingerprint(RDKix::FingerprintGenerator<unsigned long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetSparseCountFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates sparse count fingerprints for a sequence of molecules
            ...
            C++ signature :
                boost::python::tuple GetSparseCountFingerprints(RDKix::FingerprintGenerator<unsigned long> const*,boost::python::api::object [,int=1])
        """
    def GetSparseFingerprint(self, mol: Mol, fromAtoms: typing.Any = [], ignoreAtoms: typing.Any = [], confId: int = -1, customAtomInvariants: typing.Any = [], customBondInvariants: typing.Any = [], additionalOutput: typing.Any = None) -> SparseBitVect:
        """
            Generates a sparse fingerprint
            ...
            C++ signature :
                SparseBitVect* GetSparseFingerprint(RDKix::FingerprintGenerator<unsigned long> const*,RDKix::ROMol [,boost::python::api::object=[] [,boost::python::api::object=[] [,int=-1 [,boost::python::api::object=[] [,boost::python::api::object=[] [,boost::python::api::object=None]]]]]])
        """
    def GetSparseFingerprints(self, mols: typing.Any, numThreads: int = 1) -> tuple:
        """
            Generates sparse fingerprints for a sequence of molecules
            ...
            C++ signature :
                boost::python::tuple GetSparseFingerprints(RDKix::FingerprintGenerator<unsigned long> const*,boost::python::api::object [,int=1])
        """
...
def GetAtomPairGenerator(minDistance: int = 1, maxDistance: int = 30, includeChirality: bool = False, use2D: bool = True, countSimulation: bool = True, countBounds: typing.Any = None, fpSize: int = 2048, atomInvariantsGenerator: typing.Any = None) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            RDKix::FingerprintGenerator<unsigned long>* GetAtomPairGenerator([ unsigned int=1 [,unsigned int=30 [,bool=False [,bool=True [,bool=True [,boost::python::api::object {lvalue}=None [,unsigned int=2048 [,boost::python::api::object {lvalue}=None]]]]]]]])
    """
...
def GetMorganGenerator(radius: int = 3, countSimulation: bool = False, includeChirality: bool = False, useBondTypes: bool = True, onlyNonzeroInvariants: bool = False, includeRingMembership: bool = True, countBounds: typing.Any = None, fpSize: int = 2048, atomInvariantsGenerator: typing.Any = None, bondInvariantsGenerator: typing.Any = None, includeRedundantEnvironments: bool = False) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            RDKix::FingerprintGenerator<unsigned long>* GetMorganGenerator([ unsigned int=3 [,bool=False [,bool=False [,bool=True [,bool=False [,bool=True [,boost::python::api::object {lvalue}=None [,unsigned int=2048 [,boost::python::api::object {lvalue}=None [,boost::python::api::object {lvalue}=None [,bool=False]]]]]]]]]]])
    """
...
def GetRDKixFPGenerator(minPath: int = 1, maxPath: int = 7, useHs: bool = True, branchedPaths: bool = True, useBondOrder: bool = True, countSimulation: bool = False, countBounds: typing.Any = None, fpSize: int = 2048, numBitsPerFeature: int = 2, atomInvariantsGenerator: typing.Any = None) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            RDKix::FingerprintGenerator<unsigned long>* GetRDKixFPGenerator([ unsigned int=1 [,unsigned int=7 [,bool=True [,bool=True [,bool=True [,bool=False [,boost::python::api::object {lvalue}=None [,unsigned int=2048 [,unsigned int=2 [,boost::python::api::object {lvalue}=None]]]]]]]]]])
    """
...
def GetTopologicalTorsionGenerator(includeChirality: bool = False, torsionAtomCount: int = 4, countSimulation: bool = True, countBounds: typing.Any = None, fpSize: int = 2048, atomInvariantsGenerator: typing.Any = None) -> FingerprintGenerator64:
    """
        ...
        C++ signature :
            RDKix::FingerprintGenerator<unsigned long>* GetTopologicalTorsionGenerator([ bool=False [,unsigned int=4 [,bool=True [,boost::python::api::object {lvalue}=None [,unsigned int=2048 [,boost::python::api::object {lvalue}=None]]]]]])
    """
