...
def LogInfoMsg(msg: str) -> None:
    """
        Log a message to the RDKix info logs
...
def SeedRandomNumberGenerator(seed: int) -> None:
    """
        ...
        This does not affect pure Python code, but is relevant to some of the RDKix C++ components.
...
rdkixBuild: str = 'Linux|6.11.0-1012-azure|UNIX|GNU|64-bit'
rdkixVersion: str = '2024.09.6'
