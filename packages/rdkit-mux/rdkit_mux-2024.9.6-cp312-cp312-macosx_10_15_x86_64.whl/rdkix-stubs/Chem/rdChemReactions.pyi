...
def CreateDifferenceFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> UIntSparseIntVect:
    """
        ...
        C++ signature :
            RDKix::SparseIntVect<unsigned int>* CreateDifferenceFingerprintForReaction(RDKix::ChemicalReaction [,RDKix::ReactionFingerprintParams=<rdkix.Chem.rdChemReactions.ReactionFingerprintParams object at 0x10cd98240>])
    """
def CreateStructuralFingerprintForReaction(reaction: ChemicalReaction, ReactionFingerPrintParams: ReactionFingerprintParams = ...) -> ExplicitBitVect:
    """
        ...
        C++ signature :
            ExplicitBitVect* CreateStructuralFingerprintForReaction(RDKix::ChemicalReaction [,RDKix::ReactionFingerprintParams=<rdkix.Chem.rdChemReactions.ReactionFingerprintParams object at 0x10cd982c0>])
    """
...
def SanitizeRxn(rxn: ChemicalReaction, sanitizeOps: int = 4294967295, params: AdjustQueryParameters = ..., catchErrors: bool = False) -> SanitizeFlags:
    """
        ...
        C++ signature :
            RDKix::RxnOps::SanitizeRxnFlags SanitizeRxn(RDKix::ChemicalReaction {lvalue} [,unsigned long long=4294967295 [,RDKix::MolOps::AdjustQueryParameters=<rdkix.Chem.rdmolops.AdjustQueryParameters object at 0x10cd56ac0> [,bool=False]]])
    """
