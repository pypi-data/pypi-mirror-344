...
RDCodeDir=os.path.join(r'/Users/runner/work/rdkix-pypi/rdkix-pypi/build/temp.macosx-11.0-arm64-cpython-311/rdkix_install/lib/python3.11/site-packages','rdkix')
