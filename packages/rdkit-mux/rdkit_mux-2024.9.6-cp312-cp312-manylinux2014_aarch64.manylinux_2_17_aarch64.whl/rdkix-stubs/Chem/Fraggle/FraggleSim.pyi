...
import sys as sys
__all__ = ['ACYC_SMARTS', 'CYC_SMARTS', 'Chem', 'DataStructs', 'FTYPE_ACYCLIC', 'FTYPE_CYCLIC', 'FTYPE_CYCLIC_ACYCLIC', 'GetFraggleSimilarity', 'atomContrib', 'cSma1', 'cSma2', 'combinations', 'compute_fraggle_similarity_for_subs', 'delete_bonds', 'dummyAtomQuery', 'generate_fraggle_fragmentation', 'isValidRingCut', 'modified_query_fps', 'rdkixFpParams', 'rdqueries', 'select_fragments', 'sys']
...
def select_fragments(fragments, ftype, hac):
    ...
ACYC_SMARTS: rdkix.Chem.rdchem.Mol  # value = <rdkix.Chem.rdchem.Mol object>
CYC_SMARTS: rdkix.Chem.rdchem.Mol  # value = <rdkix.Chem.rdchem.Mol object>
FTYPE_ACYCLIC: str = 'acyclic'
FTYPE_CYCLIC: str = 'cyclic'
FTYPE_CYCLIC_ACYCLIC: str = 'cyclic_and_acyclic'
cSma1: rdkix.Chem.rdchem.Mol  # value = <rdkix.Chem.rdchem.Mol object>
cSma2: rdkix.Chem.rdchem.Mol  # value = <rdkix.Chem.rdchem.Mol object>
dummyAtomQuery: rdkix.Chem.rdchem.QueryAtom  # value = <rdkix.Chem.rdchem.QueryAtom object>
modified_query_fps: dict = {}
rdkixFpParams: dict = {'maxPath': 5, 'fpSize': 1024, 'nBitsPerHash': 2}
