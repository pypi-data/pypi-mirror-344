...
class FragCatParams(Boost.Python.instance):
    ...
    def GetTypeString(self) -> str:
        """
            C++ signature :
                std::string GetTypeString(RDKix::FragCatParams {lvalue})
        """
    ...
    def Serialize(self) -> str:
        """
            C++ signature :
                std::string Serialize(RDKix::FragCatParams {lvalue})
        """
...
class FragCatalog(Boost.Python.instance):
    ...
    def GetBitDescription(self, idx: int) -> str:
        """
            C++ signature :
                std::string GetBitDescription(RDCatalog::HierarchCatalog<RDKix::FragCatalogEntry, RDKix::FragCatParams, int> const*,unsigned int)
        """
    def GetBitDiscrims(self, idx: int) -> typing.Sequence[double]:
        """
            C++ signature :
                std::vector<double, std::allocator<double> > GetBitDiscrims(RDCatalog::HierarchCatalog<RDKix::FragCatalogEntry, RDKix::FragCatParams, int> const*,unsigned int)
        """
    ...
    def GetBitFuncGroupIds(self, idx: int) -> typing.Sequence[int]:
        """
            C++ signature :
                std::vector<int, std::allocator<int> > GetBitFuncGroupIds(RDCatalog::HierarchCatalog<RDKix::FragCatalogEntry, RDKix::FragCatParams, int> const*,unsigned int)
        """
    ...
    def GetEntryDescription(self, idx: int) -> str:
        """
            C++ signature :
                std::string GetEntryDescription(RDCatalog::HierarchCatalog<RDKix::FragCatalogEntry, RDKix::FragCatParams, int> const*,unsigned int)
        """
    def GetEntryDownIds(self, idx: int) -> typing.Sequence[int]:
        """
            C++ signature :
                std::vector<int, std::allocator<int> > GetEntryDownIds(RDCatalog::HierarchCatalog<RDKix::FragCatalogEntry, RDKix::FragCatParams, int> const*,unsigned int)
        """
    def GetEntryFuncGroupIds(self, idx: int) -> typing.Sequence[int]:
        """
            C++ signature :
                std::vector<int, std::allocator<int> > GetEntryFuncGroupIds(RDCatalog::HierarchCatalog<RDKix::FragCatalogEntry, RDKix::FragCatParams, int> const*,unsigned int)
        """
    ...
    def Serialize(self) -> str:
        """
            C++ signature :
                std::string Serialize(RDCatalog::HierarchCatalog<RDKix::FragCatalogEntry, RDKix::FragCatParams, int> {lvalue})
        """
