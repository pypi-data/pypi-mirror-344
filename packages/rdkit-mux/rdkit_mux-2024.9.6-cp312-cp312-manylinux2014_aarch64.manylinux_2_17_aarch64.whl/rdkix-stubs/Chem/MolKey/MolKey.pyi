...
def GetInchiForCTAB(ctab):
    """
        ...
        >>> from rdkix.Chem.MolKey import MolKey
        >>> from rdkix.Avalon import pyAvalonTools
...
BAD_SET: int = 986019
CHIRAL_POS: int = 12
ERROR_DICT: dict = {'BAD_MOLECULE': 1, 'ALIAS_CONVERSION_FAILED': 2, 'TRANSFORMED': 4, 'FRAGMENTS_FOUND': 8, 'EITHER_WARNING': 16, 'STEREO_ERROR': 32, 'DUBIOUS_STEREO_REMOVED': 64, 'ATOM_CLASH': 128, 'ATOM_CHECK_FAILED': 256, 'SIZE_CHECK_FAILED': 512, 'RECHARGED': 1024, 'STEREO_FORCED_BAD': 2048, 'STEREO_TRANSFORMED': 4096, 'TEMPLATE_TRANSFORMED': 8192, 'INCHI_COMPUTATION_ERROR': 65536, 'RDKIX_CONVERSION_ERROR': 131072, 'INCHI_READWRITE_ERROR': 262144, 'NULL_MOL': 524288}
...
RDKIX_CONVERSION_ERROR: int = 131072
