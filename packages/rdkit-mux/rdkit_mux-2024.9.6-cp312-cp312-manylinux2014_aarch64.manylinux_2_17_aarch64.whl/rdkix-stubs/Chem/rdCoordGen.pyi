...
class CoordGenParams(Boost.Python.instance):
    ...
    def SetCoordMap(self, coordMap: dict) -> None:
        """
            ...
            C++ signature :
                void SetCoordMap(RDKix::CoordGen::CoordGenParams*,boost::python::dict {lvalue})
        """
    def SetTemplateMol(self, templ: Mol) -> None:
        """
            ...
            C++ signature :
                void SetTemplateMol(RDKix::CoordGen::CoordGenParams*,RDKix::ROMol const*)
        """
...
def AddCoords(mol: Mol, params: typing.Any = None) -> None:
    """
        ...
        C++ signature :
            void AddCoords(RDKix::ROMol {lvalue} [,boost::python::api::object {lvalue}=None])
    """
