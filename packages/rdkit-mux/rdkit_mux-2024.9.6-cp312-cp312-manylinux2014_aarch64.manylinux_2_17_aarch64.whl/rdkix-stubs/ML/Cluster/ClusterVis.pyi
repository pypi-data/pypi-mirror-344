...
from rdkix.ML.Cluster import ClusterUtils
import rdkix.sping.colors
from rdkix.sping import pid
from rdkix.sping import pid as piddle
import typing
...
class VisOpts:
    ...
    """
    hideColor: typing.ClassVar[rdkix.sping.colors.Color]  # value = Color(0.80,0.80,0.80)
    hideWidth: typing.ClassVar[float] = 1.1
    highlightColor: typing.ClassVar[rdkix.sping.colors.Color]  # value = Color(1.00,1.00,0.40)
    highlightRad: typing.ClassVar[int] = 10
    lineColor: typing.ClassVar[rdkix.sping.colors.Color]  # value = Color(0.00,0.00,0.00)
    lineWidth: typing.ClassVar[int] = 2
    nodeColor: typing.ClassVar[rdkix.sping.colors.Color]  # value = Color(1.00,0.40,0.40)
