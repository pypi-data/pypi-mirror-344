...
class MMFFMolProperties(Boost.Python.instance):
    ...
    def GetMMFFAngleBendParams(self, mol: typing.Any, idx1: int, idx2: int, idx3: int) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetMMFFAngleBendParams(ForceFields::PyMMFFMolProperties {lvalue},RDKix::ROMol,unsigned int,unsigned int,unsigned int)
        """
    ...
    def GetMMFFBondStretchParams(self, mol: typing.Any, idx1: int, idx2: int) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetMMFFBondStretchParams(ForceFields::PyMMFFMolProperties {lvalue},RDKix::ROMol,unsigned int,unsigned int)
        """
    ...
    def GetMMFFOopBendParams(self, mol: typing.Any, idx1: int, idx2: int, idx3: int, idx4: int) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetMMFFOopBendParams(ForceFields::PyMMFFMolProperties {lvalue},RDKix::ROMol,unsigned int,unsigned int,unsigned int,unsigned int)
        """
    ...
    def GetMMFFStretchBendParams(self, mol: typing.Any, idx1: int, idx2: int, idx3: int) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetMMFFStretchBendParams(ForceFields::PyMMFFMolProperties {lvalue},RDKix::ROMol,unsigned int,unsigned int,unsigned int)
        """
    def GetMMFFTorsionParams(self, mol: typing.Any, idx1: int, idx2: int, idx3: int, idx4: int) -> typing.Any:
        """
            ...
            C++ signature :
                _object* GetMMFFTorsionParams(ForceFields::PyMMFFMolProperties {lvalue},RDKix::ROMol,unsigned int,unsigned int,unsigned int,unsigned int)
        """
