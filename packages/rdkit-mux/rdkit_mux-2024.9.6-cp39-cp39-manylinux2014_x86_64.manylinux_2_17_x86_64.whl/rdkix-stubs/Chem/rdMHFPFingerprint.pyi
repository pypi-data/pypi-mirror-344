...
class MHFPEncoder(Boost.Python.instance):
    ...
    def CreateShinglingFromMol(self, mol: Mol, radius: int = 3, rings: bool = True, isomeric: bool = False, kekulize: bool = False, min_radius: int = 1) -> _vectSs:
        """
            ...
            C++ signature :
                std::vector<std::string, std::allocator<std::string> > CreateShinglingFromMol(RDKix::MHFPFingerprints::MHFPEncoder*,RDKix::ROMol [,unsigned char=3 [,bool=True [,bool=False [,bool=False [,unsigned char=1]]]]])
        """
    def CreateShinglingFromSmiles(self, smiles: str, radius: int = 3, rings: bool = True, isomeric: bool = False, kekulize: bool = False, min_radius: int = 1) -> _vectSs:
        """
            ...
            C++ signature :
                std::vector<std::string, std::allocator<std::string> > CreateShinglingFromSmiles(RDKix::MHFPFingerprints::MHFPEncoder*,std::string [,unsigned char=3 [,bool=True [,bool=False [,bool=False [,unsigned char=1]]]]])
        """
    def EncodeMol(self, mol: Mol, radius: int = 3, rings: bool = True, isomeric: bool = False, kekulize: bool = False, min_radius: int = 1) -> typing.Sequence[int]:
        """
            ...
            C++ signature :
                std::vector<unsigned int, std::allocator<unsigned int> > EncodeMol(RDKix::MHFPFingerprints::MHFPEncoder*,RDKix::ROMol [,unsigned char=3 [,bool=True [,bool=False [,bool=False [,unsigned char=1]]]]])
        """
    def EncodeMolsBulk(self, mols: list, radius: int = 3, rings: bool = True, isomeric: bool = False, kekulize: bool = False, min_radius: int = 1) -> typing.Sequence[typing.Sequence[int]]:
        """
            ...
            C++ signature :
                std::vector<std::vector<unsigned int, std::allocator<unsigned int> >, std::allocator<std::vector<unsigned int, std::allocator<unsigned int> > > > EncodeMolsBulk(RDKix::MHFPFingerprints::MHFPEncoder*,boost::python::list {lvalue} [,unsigned char=3 [,bool=True [,bool=False [,bool=False [,unsigned char=1]]]]])
        """
    ...
    def EncodeSECFPMolsBulk(self, smiles: list, radius: int = 3, rings: bool = True, isomeric: bool = False, kekulize: bool = False, min_radius: int = 1, length: int = 2048) -> typing.Any:
        """
            ...
            C++ signature :
                std::vector<ExplicitBitVect, std::allocator<ExplicitBitVect> > EncodeSECFPMolsBulk(RDKix::MHFPFingerprints::MHFPEncoder*,boost::python::list {lvalue} [,unsigned char=3 [,bool=True [,bool=False [,bool=False [,unsigned char=1 [,unsigned long=2048]]]]]])
        """
    def EncodeSECFPSmiles(self, smiles: str, radius: int = 3, rings: bool = True, isomeric: bool = False, kekulize: bool = False, min_radius: int = 1, length: int = 2048) -> ExplicitBitVect:
        """
            ...
            C++ signature :
                ExplicitBitVect EncodeSECFPSmiles(RDKix::MHFPFingerprints::MHFPEncoder*,std::string [,unsigned char=3 [,bool=True [,bool=False [,bool=False [,unsigned char=1 [,unsigned long=2048]]]]]])
        """
    def EncodeSECFPSmilesBulk(self, smiles: list, radius: int = 3, rings: bool = True, isomeric: bool = False, kekulize: bool = False, min_radius: int = 1, length: int = 2048) -> typing.Any:
        """
            ...
            C++ signature :
                std::vector<ExplicitBitVect, std::allocator<ExplicitBitVect> > EncodeSECFPSmilesBulk(RDKix::MHFPFingerprints::MHFPEncoder*,boost::python::list {lvalue} [,unsigned char=3 [,bool=True [,bool=False [,bool=False [,unsigned char=1 [,unsigned long=2048]]]]]])
        """
    def EncodeSmiles(self, smiles: str, radius: int = 3, rings: bool = True, isomeric: bool = False, kekulize: bool = False, min_radius: int = 1) -> typing.Sequence[int]:
        """
            ...
            C++ signature :
                std::vector<unsigned int, std::allocator<unsigned int> > EncodeSmiles(RDKix::MHFPFingerprints::MHFPEncoder*,std::string [,unsigned char=3 [,bool=True [,bool=False [,bool=False [,unsigned char=1]]]]])
        """
    def EncodeSmilesBulk(self, smiles: list, radius: int = 3, rings: bool = True, isomeric: bool = False, kekulize: bool = False, min_radius: int = 1) -> typing.Sequence[typing.Sequence[int]]:
        """
            ...
            C++ signature :
                std::vector<std::vector<unsigned int, std::allocator<unsigned int> >, std::allocator<std::vector<unsigned int, std::allocator<unsigned int> > > > EncodeSmilesBulk(RDKix::MHFPFingerprints::MHFPEncoder*,boost::python::list {lvalue} [,unsigned char=3 [,bool=True [,bool=False [,bool=False [,unsigned char=1]]]]])
        """
    def FromArray(self, vec: list) -> typing.Sequence[int]:
        """
            ...
            C++ signature :
                std::vector<unsigned int, std::allocator<unsigned int> > FromArray(RDKix::MHFPFingerprints::MHFPEncoder*,boost::python::list {lvalue})
        """
    def FromStringArray(self, vec: list) -> typing.Sequence[int]:
        """
            ...
            C++ signature :
                std::vector<unsigned int, std::allocator<unsigned int> > FromStringArray(RDKix::MHFPFingerprints::MHFPEncoder*,boost::python::list {lvalue})
        """
