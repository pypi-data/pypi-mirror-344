...
class InfoType(Boost.Python.enum):
    BIASCHISQUARE: typing.ClassVar[InfoType]  # value = rdkix.ML.InfoTheory.rdInfoTheory.InfoType.BIASCHISQUARE
    BIASENTROPY: typing.ClassVar[InfoType]  # value = rdkix.ML.InfoTheory.rdInfoTheory.InfoType.BIASENTROPY
    CHISQUARE: typing.ClassVar[InfoType]  # value = rdkix.ML.InfoTheory.rdInfoTheory.InfoType.CHISQUARE
    ENTROPY: typing.ClassVar[InfoType]  # value = rdkix.ML.InfoTheory.rdInfoTheory.InfoType.ENTROPY
    __slots__: typing.ClassVar[tuple] = tuple()
    names: typing.ClassVar[dict]  # value = {'ENTROPY': rdkix.ML.InfoTheory.rdInfoTheory.InfoType.ENTROPY, 'BIASENTROPY': rdkix.ML.InfoTheory.rdInfoTheory.InfoType.BIASENTROPY, 'CHISQUARE': rdkix.ML.InfoTheory.rdInfoTheory.InfoType.CHISQUARE, 'BIASCHISQUARE': rdkix.ML.InfoTheory.rdInfoTheory.InfoType.BIASCHISQUARE}
    values: typing.ClassVar[dict]  # value = {1: rdkix.ML.InfoTheory.rdInfoTheory.InfoType.ENTROPY, 2: rdkix.ML.InfoTheory.rdInfoTheory.InfoType.BIASENTROPY, 3: rdkix.ML.InfoTheory.rdInfoTheory.InfoType.CHISQUARE, 4: rdkix.ML.InfoTheory.rdInfoTheory.InfoType.BIASCHISQUARE}
...
def InfoGain(resArr: typing.Any) -> float:
    ...
    """
BIASCHISQUARE: InfoType  # value = rdkix.ML.InfoTheory.rdInfoTheory.InfoType.BIASCHISQUARE
BIASENTROPY: InfoType  # value = rdkix.ML.InfoTheory.rdInfoTheory.InfoType.BIASENTROPY
CHISQUARE: InfoType  # value = rdkix.ML.InfoTheory.rdInfoTheory.InfoType.CHISQUARE
ENTROPY: InfoType  # value = rdkix.ML.InfoTheory.rdInfoTheory.InfoType.ENTROPY
