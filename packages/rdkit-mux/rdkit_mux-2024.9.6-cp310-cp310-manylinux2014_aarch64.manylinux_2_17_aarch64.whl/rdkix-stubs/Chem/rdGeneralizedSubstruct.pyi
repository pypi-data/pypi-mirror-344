...
class ExtendedQueryMol(Boost.Python.instance):
    ...
    def InitFromBinary(self, pkl: str) -> None:
        """
            C++ signature :
                void InitFromBinary(RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue},std::string)
        """
    def InitFromJSON(self, text: str) -> None:
        """
            C++ signature :
                void InitFromJSON(RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue},std::string)
        """
    def PatternFingerprintQuery(self, fingerprintSize: int = 2048) -> typing.Any:
        """
            C++ signature :
                std::unique_ptr<ExplicitBitVect, std::default_delete<ExplicitBitVect> > PatternFingerprintQuery(RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue} [,unsigned int=2048])
        """
    ...
    def ToJSON(self) -> str:
        """
            C++ signature :
                std::string ToJSON(RDKix::GeneralizedSubstruct::ExtendedQueryMol {lvalue})
        """
...
def PatternFingerprintTarget(target: Mol, fingerprintSize: int = 2048) -> typing.Any:
    """
        ...
        C++ signature :
            std::unique_ptr<ExplicitBitVect, std::default_delete<ExplicitBitVect> > PatternFingerprintTarget(RDKix::ROMol [,unsigned int=2048])
    """
