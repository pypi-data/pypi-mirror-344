...
class Properties(Boost.Python.instance):
    ...
    def GetProperty(propName: str) -> PropertyFunctor:
        """
            ...
            C++ signature :
                boost::shared_ptr<RDKix::Descriptors::PropertyFunctor> GetProperty(std::string)
        """
    @staticmethod
    ...
    def ComputeProperties(self, mol: Mol, annotateMol: bool = False) -> typing.Sequence[double]:
        """
            ...
            C++ signature :
                std::vector<double, std::allocator<double> > ComputeProperties(RDKix::Descriptors::Properties {lvalue},RDKix::ROMol [,bool=False])
        """
    def GetPropertyNames(self) -> _vectSs:
        """
            ...
            C++ signature :
                std::vector<std::string, std::allocator<std::string> > GetPropertyNames(RDKix::Descriptors::Properties {lvalue})
        """
    @typing.overload
    def __init__(self) -> None:
        """
...
class PropertyFunctor(Boost.Python.instance):
    ...
    def GetName(self) -> str:
        """
            ...
            C++ signature :
                std::string GetName(RDKix::Descriptors::PropertyFunctor {lvalue})
        """
    def GetVersion(self) -> str:
        """
            ...
            C++ signature :
                std::string GetVersion(RDKix::Descriptors::PropertyFunctor {lvalue})
        """
...
def BCUT2D(mol: Mol, atom_props: list) -> tuple:
    """
        ...
        C++ signature :
            std::pair<double, double> BCUT2D(RDKix::ROMol,boost::python::list)
    """
@typing.overload
def BCUT2D(mol: Mol, atom_props: tuple) -> tuple:
    """
        ...
        C++ signature :
            std::pair<double, double> BCUT2D(RDKix::ROMol,boost::python::tuple)
    """
@typing.overload
def BCUT2D(mol: Mol, atom_propname: str) -> tuple:
    """
        ...
        C++ signature :
            std::pair<double, double> BCUT2D(RDKix::ROMol,std::string)
    """
def CalcAUTOCORR2D(mol: Mol, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            boost::python::list CalcAUTOCORR2D(RDKix::ROMol [,std::string=''])
    """
def CalcAUTOCORR3D(mol: Mol, confId: int = -1, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            boost::python::list CalcAUTOCORR3D(RDKix::ROMol [,int=-1 [,std::string='']])
    """
...
def CalcGETAWAY(mol: Mol, confId: int = -1, precision: float = 2, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            boost::python::list CalcGETAWAY(RDKix::ROMol [,int=-1 [,double=2 [,std::string='']]])
    """
...
def CalcMORSE(mol: Mol, confId: int = -1, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            boost::python::list CalcMORSE(RDKix::ROMol [,int=-1 [,std::string='']])
    """
def CalcMolFormula(mol: Mol, separateIsotopes: bool = False, abbreviateHIsotopes: bool = True) -> str:
    """
        ...
        C++ signature :
            std::string CalcMolFormula(RDKix::ROMol [,bool=False [,bool=True]])
    """
...
def CalcRDF(mol: Mol, confId: int = -1, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            boost::python::list CalcRDF(RDKix::ROMol [,int=-1 [,std::string='']])
    """
...
def CalcWHIM(mol: Mol, confId: int = -1, thresh: float = 0.001, CustomAtomProperty: str = '') -> list:
    """
        ...
        C++ signature :
            boost::python::list CalcWHIM(RDKix::ROMol [,int=-1 [,double=0.001 [,std::string='']]])
    """
def CustomProp_VSA_(mol: Mol, customPropName: str, bins: AtomPairsParameters, force: bool = False) -> list:
    """
        C++ signature :
            boost::python::list CustomProp_VSA_(RDKix::ROMol,std::string,boost::python::api::object [,bool=False])
    """
...
def GetHashedTopologicalTorsionFingerprint(mol: Mol, nBits: int = 2048, targetSize: int = 4, fromAtoms: AtomPairsParameters = 0, ignoreAtoms: AtomPairsParameters = 0, atomInvariants: AtomPairsParameters = 0, includeChirality: bool = False) -> LongSparseIntVect:
    """
        ...
        C++ signature :
            RDKix::SparseIntVect<long>* GetHashedTopologicalTorsionFingerprint(RDKix::ROMol [,unsigned int=2048 [,unsigned int=4 [,boost::python::api::object=0 [,boost::python::api::object=0 [,boost::python::api::object=0 [,bool=False]]]]]])
    """
...
def GetTopologicalTorsionFingerprint(mol: Mol, targetSize: int = 4, fromAtoms: AtomPairsParameters = 0, ignoreAtoms: AtomPairsParameters = 0, atomInvariants: AtomPairsParameters = 0, includeChirality: bool = False) -> LongSparseIntVect:
    """
        ...
        C++ signature :
            RDKix::SparseIntVect<long>* GetTopologicalTorsionFingerprint(RDKix::ROMol [,unsigned int=4 [,boost::python::api::object=0 [,boost::python::api::object=0 [,boost::python::api::object=0 [,bool=False]]]]])
    """
...
def MakePropertyRangeQuery(name: str, min: float, max: float) -> PropertyRangeQuery:
    """
        ...
        C++ signature :
            Queries::RangeQuery<double, RDKix::ROMol const&, true>* MakePropertyRangeQuery(std::string,double,double)
    """
