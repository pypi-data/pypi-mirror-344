...
f: _io.BufferedReader  # value = <_io.BufferedReader name='/project/build/temp.linux-aarch64-cpython-310/rdkix_install/lib/python3.10/site-packages/rdkix/sping/PIL/pilfonts/metrics.dat'>
figureArc: int = 2
figureCurve: int = 3
figureLine: int = 1
