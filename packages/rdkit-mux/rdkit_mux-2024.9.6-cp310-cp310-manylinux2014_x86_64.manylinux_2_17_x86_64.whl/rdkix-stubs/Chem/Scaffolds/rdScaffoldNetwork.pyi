...
class NetworkEdge_VECT(Boost.Python.instance):
    ...
    def __contains__(self, item: typing.Any) -> bool:
        """
            C++ signature :
                bool __contains__(std::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::allocator<RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},_object*)
        """
    def __delitem__(self, item: typing.Any) -> None:
        """
            C++ signature :
                void __delitem__(std::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::allocator<RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},_object*)
        """
    def __getitem__(self, item: typing.Any) -> typing.Any:
        """
            C++ signature :
                boost::python::api::object __getitem__(boost::python::back_reference<std::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::allocator<RDKix::ScaffoldNetwork::NetworkEdge> >&>,_object*)
        """
    ...
    def __iter__(self) -> typing.Any:
        """
            C++ signature :
                boost::python::objects::iterator_range<boost::python::return_internal_reference<1ul, boost::python::default_call_policies>, __gnu_cxx::__normal_iterator<RDKix::ScaffoldNetwork::NetworkEdge*, std::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::allocator<RDKix::ScaffoldNetwork::NetworkEdge> > > > __iter__(boost::python::back_reference<std::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::allocator<RDKix::ScaffoldNetwork::NetworkEdge> >&>)
        """
    def __len__(self) -> int:
        """
            C++ signature :
                unsigned long __len__(std::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::allocator<RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue})
        """
    def __setitem__(self, item: typing.Any, value: typing.Any) -> None:
        """
            C++ signature :
                void __setitem__(std::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::allocator<RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},_object*,_object*)
        """
    def append(self, item: typing.Any) -> None:
        """
            C++ signature :
                void append(std::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::allocator<RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},boost::python::api::object)
        """
    def extend(self, other: typing.Any) -> None:
        """
            C++ signature :
                void extend(std::vector<RDKix::ScaffoldNetwork::NetworkEdge, std::allocator<RDKix::ScaffoldNetwork::NetworkEdge> > {lvalue},boost::python::api::object)
        """
