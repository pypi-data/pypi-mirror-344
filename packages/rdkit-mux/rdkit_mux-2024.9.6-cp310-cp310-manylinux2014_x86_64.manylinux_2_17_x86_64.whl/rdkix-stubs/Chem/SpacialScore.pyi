...
class _SpacialScore:
    ...
    """
    _hybridisations: typing.ClassVar[collections.defaultdict]  # value = defaultdict(<function _SpacialScore.<lambda> at 0x7f4967f2b640>, {rdkix.Chem.rdchem.HybridizationType.SP: 1, rdkix.Chem.rdchem.HybridizationType.SP2: 2, rdkix.Chem.rdchem.HybridizationType.SP3: 3})
