...
class MCSAcceptance(Boost.Python.instance):
    ...
    def __call__(self) -> bool:
        """
            ...
            C++ signature :
                bool __call__(RDKix::PyMCSAcceptance {lvalue})
        """
...
class MCSAtomCompare(Boost.Python.instance):
    ...
    def CheckAtomCharge(self, parameters: MCSAtomCompareParameters, mol1: Mol, atom1: int, mol2: Mol, atom2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckAtomCharge(RDKix::PyMCSAtomCompare {lvalue},RDKix::MCSAtomCompareParameters,RDKix::ROMol,unsigned int,RDKix::ROMol,unsigned int)
        """
    def CheckAtomChirality(self, parameters: MCSAtomCompareParameters, mol1: Mol, atom1: int, mol2: Mol, atom2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckAtomChirality(RDKix::PyMCSAtomCompare {lvalue},RDKix::MCSAtomCompareParameters,RDKix::ROMol,unsigned int,RDKix::ROMol,unsigned int)
        """
    def CheckAtomRingMatch(self, parameters: MCSAtomCompareParameters, mol1: Mol, atom1: int, mol2: Mol, atom2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckAtomRingMatch(RDKix::PyMCSAtomCompare {lvalue},RDKix::MCSAtomCompareParameters,RDKix::ROMol,unsigned int,RDKix::ROMol,unsigned int)
        """
    def __call__(self, parameters: MCSAtomCompareParameters, mol1: Mol, atom1: int, mol2: Mol, atom2: int) -> bool:
        """
            ...
            C++ signature :
                bool __call__(RDKix::PyMCSAtomCompare {lvalue},RDKix::MCSAtomCompareParameters,RDKix::ROMol,unsigned int,RDKix::ROMol,unsigned int)
        """
    def __init__(self) -> None:
        """
            C++ signature :
...
class MCSBondCompare(Boost.Python.instance):
    ...
    def CheckBondRingMatch(self, parameters: MCSBondCompareParameters, mol1: Mol, bond1: int, mol2: Mol, bond2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckBondRingMatch(RDKix::PyMCSBondCompare {lvalue},RDKix::MCSBondCompareParameters,RDKix::ROMol,unsigned int,RDKix::ROMol,unsigned int)
        """
    def CheckBondStereo(self, parameters: MCSBondCompareParameters, mol1: Mol, bond1: int, mol2: Mol, bond2: int) -> bool:
        """
            ...
            C++ signature :
                bool CheckBondStereo(RDKix::PyMCSBondCompare {lvalue},RDKix::MCSBondCompareParameters,RDKix::ROMol,unsigned int,RDKix::ROMol,unsigned int)
        """
    def __call__(self, parameters: MCSBondCompareParameters, mol1: Mol, bond1: int, mol2: Mol, bond2: int) -> bool:
        """
            ...
            C++ signature :
                bool __call__(RDKix::PyMCSBondCompare {lvalue},RDKix::MCSBondCompareParameters,RDKix::ROMol,unsigned int,RDKix::ROMol,unsigned int)
        """
    def __init__(self) -> None:
        """
            C++ signature :
...
class MCSFinalMatchCheck(Boost.Python.instance):
    ...
    def __call__(self) -> bool:
        """
            ...
            C++ signature :
                bool __call__(RDKix::PyMCSFinalMatchCheck {lvalue})
        """
    def __init__(self) -> None:
        """
            C++ signature :
...
class MCSProgress(Boost.Python.instance):
    ...
    def __call__(self, stat: typing.Any, parameters: typing.Any) -> bool:
        """
            ...
            C++ signature :
                bool __call__(RDKix::PyMCSProgress {lvalue},RDKix::MCSProgressData,RDKix::MCSParameters)
        """
    def __init__(self) -> None:
        """
            C++ signature :
...
def FindMCS(mols: typing.Any, maximizeBonds: bool = True, threshold: float = 1.0, timeout: int = 3600, verbose: bool = False, matchValences: bool = False, ringMatchesRingOnly: bool = False, completeRingsOnly: bool = False, matchChiralTag: bool = False, atomCompare: AtomCompare = ..., bondCompare: BondCompare = ..., ringCompare: RingCompare = ..., seedSmarts: str = '') -> MCSResult:
    """
        ...
        C++ signature :
            RDKix::MCSResult* FindMCS(boost::python::api::object [,bool=True [,double=1.0 [,unsigned int=3600 [,bool=False [,bool=False [,bool=False [,bool=False [,bool=False [,RDKix::AtomComparator=rdkix.Chem.rdFMCS.AtomCompare.CompareElements [,RDKix::BondComparator=rdkix.Chem.rdFMCS.BondCompare.CompareOrder [,RDKix::RingComparator=rdkix.Chem.rdFMCS.RingCompare.IgnoreRingFusion [,std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>='']]]]]]]]]]]])
    """
@typing.overload
def FindMCS(mols: typing.Any, parameters: MCSParameters) -> MCSResult:
    """
        ...
        C++ signature :
            RDKix::MCSResult* FindMCS(boost::python::api::object,RDKix::PyMCSParameters {lvalue})
    """
