...
class SubstructureResult(Boost.Python.instance):
    ...
    def GetCancelled(arg1: SubstructureResult) -> bool:
        """
            ...
            C++ signature :
                bool GetCancelled(RDKix::SynthonSpaceSearch::SearchResults {lvalue})
        """
    @staticmethod
    def GetMaxNumResults(arg1: SubstructureResult) -> int:
        """
            ...
            C++ signature :
                unsigned long GetMaxNumResults(RDKix::SynthonSpaceSearch::SearchResults {lvalue})
        """
    @staticmethod
    def GetTimedOut(arg1: SubstructureResult) -> bool:
        """
            ...
            C++ signature :
                bool GetTimedOut(RDKix::SynthonSpaceSearch::SearchResults {lvalue})
        """
    @staticmethod
    ...
    def GetHitMolecules(self) -> list:
        """
            ...
            C++ signature :
                boost::python::list GetHitMolecules(RDKix::SynthonSpaceSearch::SearchResults)
        """
class SynthonSpace(Boost.Python.instance):
    ...
    def BuildSynthonFingerprints(self, fingerprintGenerator: typing.Any) -> None:
        """
            ...
            C++ signature :
                void BuildSynthonFingerprints(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},RDKix::FingerprintGenerator<unsigned long long>)
        """
    def FingerprintSearch(self, query: Mol, fingerprintGenerator: typing.Any, params: typing.Any = None) -> SubstructureResult:
        """
            ...
            C++ signature :
                RDKix::SynthonSpaceSearch::SearchResults FingerprintSearch(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},RDKix::ROMol,boost::python::api::object [,boost::python::api::object=None])
        """
    def GetNumProducts(self) -> int:
        """
            ...
            C++ signature :
                long long GetNumProducts(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue})
        """
    def GetNumReactions(self) -> int:
        """
            ...
            C++ signature :
                unsigned long GetNumReactions(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue})
        """
    def ReadDBFile(self, inFile: str) -> None:
        """
            ...
            C++ signature :
                void ReadDBFile(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
        """
    def ReadTextFile(self, inFile: str) -> None:
        """
            ...
            C++ signature :
                void ReadTextFile(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
        """
    def SubstructureSearch(self, query: Mol, params: typing.Any = None) -> SubstructureResult:
        """
            ...
            C++ signature :
                RDKix::SynthonSpaceSearch::SearchResults SubstructureSearch(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},RDKix::ROMol [,boost::python::api::object=None])
        """
    def Summarise(self) -> None:
        """
            ...
            C++ signature :
                void Summarise(RDKix::SynthonSpaceSearch::SynthonSpace)
        """
    def WriteDBFile(self, outFile: str) -> None:
        """
            ...
            C++ signature :
                void WriteDBFile(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
        """
    def WriteEnumeratedFile(self, outFile: str) -> None:
        """
            ...
            C++ signature :
                void WriteEnumeratedFile(RDKix::SynthonSpaceSearch::SynthonSpace {lvalue},std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>)
        """
