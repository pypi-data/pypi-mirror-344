...
class HashLayer(enum.Enum):
    """
        ...
        :cvar CANONICAL_SMILES: RDKix canonical SMILES (excluding enhanced stereo)
        :cvar ESCAPE: arbitrary other information to be incorporated
        :cvar FORMULA: a simple molecular formula for the molecule
        :cvar NO_STEREO_SMILES: RDKix canonical SMILES with all stereo removed
...
def GetMolHash(all_layers, hash_scheme: HashScheme = ...) -> str:
    ...
    """
def GetMolLayers(original_molecule: rdkix.Chem.rdchem.Mol, data_field_names: typing.Union[typing.Iterable, NoneType] = None, escape: typing.Union[str, NoneType] = None, cxflag = 1089, enable_tautomer_hash_v2 = False) -> typing.Dict[rdkix.Chem.RegistrationHash.HashLayer, str]:
    """
...
ENHANCED_STEREO_GROUP_WEIGHTS: dict  # value = {rdkix.Chem.rdchem.StereoGroupType.STEREO_AND: 1000, rdkix.Chem.rdchem.StereoGroupType.STEREO_OR: 2000, rdkix.Chem.rdchem.StereoGroupType.STEREO_ABSOLUTE: 3000}
logger: logging.Logger  # value = <Logger rdkix.Chem.RegistrationHash (WARNING)>
