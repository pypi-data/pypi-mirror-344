...
__all__ = ['AllChem', 'Chem', 'EnumerateHeterocycles', 'GetHeterocycleReactionSmarts', 'GetHeterocycleReactions', 'REACTION_CACHE', 'collections']
def EnumerateHeterocycles(inputmol, depth = None):
    """
        ...
        >>> from rdkix.Chem.EnumerateHeterocycles import EnumerateHeterocycles
        >>> from rdkix import Chem
...
def GetHeterocycleReactions():
    """
        ...
        Return RDKix ChemicalReaction objects of the reaction SMARTS
