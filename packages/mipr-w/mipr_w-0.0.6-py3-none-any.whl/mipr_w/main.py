...
def read_crash_year(start_year, end_year):
    all_crashes = []
    start_year = 2014
...
def read_driver_year(start_year, end_year):
    all_driver = []
    start_year = 2014
    end_year_plus_one = end_year + 1
    for year in range(start_year, end_year_plus_one):
...
def read_vehicle_year(start_year, end_year):
    all_driver = []
    start_year = 2014
    end_year_plus_one = end_year + 1
    for year in range(start_year, end_year_plus_one):
...
def read_passenger_year(start_year, end_year):
    all_driver = []
    start_year = 2014
    end_year_plus_one = end_year + 1
    for year in range(start_year, end_year_plus_one):
...
def read_non_motorist_year(start_year, end_year):
    all_driver = []
    start_year = 2014
    end_year_plus_one = end_year + 1
    for year in range(start_year, end_year_plus_one):
