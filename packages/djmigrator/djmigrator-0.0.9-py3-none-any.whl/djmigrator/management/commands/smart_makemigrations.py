...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            '--repair',
            action='store_true',
            help="Attempt to auto-fix missing columns and tables via SQL and migration re-sync."
        )
    ...
    def handle(self, *args, **options):
        ...
        if missing_changes_detected:
            ...
            try:
                ...
                # Handle non-nullable fields without defaults
                if 'It is impossible to add a non-nullable field' in str(e):
                    ...
                    self.stdout.write("Please provide default values for the following fields:")
                    ...
                    for model in apps.get_models():
                        for field in model._meta.fields:
                            if not field.null and not field.has_default():
                                ...
                                # Update the field's default
                                field.default = default_value

                    # Retry makemigrations with updated defaults
                    call_command('makemigrations', interactive=False)
                else:
