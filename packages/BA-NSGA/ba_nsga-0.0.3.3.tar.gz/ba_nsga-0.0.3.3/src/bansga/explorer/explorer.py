...
class EvolutionaryStructureExplorer:
    ...
    def _execute_physical_model(self, structures, temperature, generation:int=None):
        ...
        unique_structures = self._filter_hash_collisions(generation_partition.containers)
        no_collision_unique_structures = self._filter_self_collisions(unique_structures)

        generation_partition.containers = no_collision_unique_structures
