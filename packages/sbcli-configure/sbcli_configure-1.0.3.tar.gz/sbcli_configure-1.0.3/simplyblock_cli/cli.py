...
class CLIWrapper(CLIWrapperBase):
    ...
    def init_storage_node__configure(self, subparser):
        ...
        argument = subcommand.add_argument('--sockets-to-use', help='The system socket to use when adding the storage nodes', type=str, default='0', dest='socket_to_use', required=False)
