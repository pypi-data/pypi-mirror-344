...
class QuickViper3:
    ...
    def list( self ):
        ...
        # self.toolkit.executor_sync( cmd = [ str( self.bin_path.joinpath( "python" ) ), "-m", "pip", "list"], shell = False )
    ...
    def update(
        ...
        cmd = [manager, 'env', 'update', '-f', env_file]
        if prune:
            cmd.append('--prune')
...
class MainLoop():
    ...
    def create_from_yml( self ):
        self.quickviper.create_from_environment_yml( yml_path = os.path.join( self.arc_path, "env_0427_00.yml" ) )
        self.quickviper.activate()
