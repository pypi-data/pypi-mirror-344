...
class BomClient:
    ...
    def update_bom_instance(self, instance_id: str, **kwargs: Unpack[BomInstanceUpdate]) -> None:
        ...
        instance_update_payload = BomInstanceUpdate(
            name=kwargs.get("name") or instance.name,
            description=kwargs.get("description") or instance.description,
            reference=kwargs.get("reference") or instance.reference,
            ...
            parent_id=kwargs.get("parent_id") or instance.parent_id,
            object_type_id=kwargs.get("object_type_id") or instance.object_type_id,
            quantity=kwargs.get("quantity") or instance.quantity,
        )
            ...
            self.update_callback(
                UpdatePayload(
                    ...
                    payload=InstanceUpdatePayload(
                        instance_id=instance.id, properties=instance_update_payload
                    ),
                )
            )
