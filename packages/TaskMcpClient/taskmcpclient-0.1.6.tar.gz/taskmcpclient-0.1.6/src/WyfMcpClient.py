...
from TaskFileQueryResult import TaskFileQueryResult
...
class WyfMcpClient:
    ...
    def __init__(self):
        ...
        PrintTimeMsg(f'WyfMcpClient.sWorkDir={self.sWorkDir}=')
        ...
        self.oTask = TaskFileQueryResult(self.sWorkDir)
...
def main():
    asyncio_loop_run(mainWyfMcpClient)
