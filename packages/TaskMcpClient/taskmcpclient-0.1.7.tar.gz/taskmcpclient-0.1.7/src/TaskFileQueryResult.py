...
class TaskFileQueryResult:
    def __init__(self, sWorkDir=''):
        ...
        PrintTimeMsg(f'TaskFileQueryResult.sTaskDir={self.sTaskDir}=')
...
def mainTaskFileQueryResult():
    o = TaskFileQueryResult()
