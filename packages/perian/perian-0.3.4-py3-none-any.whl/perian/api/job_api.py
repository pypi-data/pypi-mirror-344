...
class JobApi:
    ...
    def cancel_job(
        ...
        Endpoint for Cancelling a Job by its id.  Args:     organization: Authenticated organization     job_id(int): Job id to be cancelled.  Returns:     DefaultSuccess  Raises:     NoJobFoundError: if the requested Job is not found,     JobAlreadyDoneError: if the requested Job is already done.
