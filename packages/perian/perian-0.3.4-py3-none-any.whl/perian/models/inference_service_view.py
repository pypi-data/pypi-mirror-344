...
class InferenceServiceView(BaseModel):
    ...
    cloudflare_record_id: Optional[StrictStr] = None
    model_template_id: Optional[StrictStr] = None
    api_token: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "status", "started_at", "done_at", "logs", "errors", "price", "docker_metadata", "requirement_metadata", "runtime_metadata", "created_at", "updated_at", "container_port", "server_ip", "api_url", "cloudflare_record_id", "model_template_id", "api_token"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if cloudflare_record_id (nullable) is None
        # and model_fields_set contains the field
        if self.cloudflare_record_id is None and "cloudflare_record_id" in self.model_fields_set:
            _dict['cloudflare_record_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cloudflare_record_id": obj.get("cloudflare_record_id"),
