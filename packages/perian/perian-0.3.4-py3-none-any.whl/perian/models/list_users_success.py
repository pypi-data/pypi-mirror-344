...
class ListUsersSuccess(BaseModel):
    """
    ...
    users: Optional[List[UserView]] = None
    __properties: ClassVar[List[str]] = ["status", "message", "detail", "status_code", "users"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListUsersSuccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListUsersSuccess from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "users": [UserView.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
