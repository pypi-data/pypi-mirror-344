...
class UsageLimitRequest(BaseModel):
    """
    JSON schema for organization usage limit request.
    """ # noqa: E501
    limit: Limit
    currency: Currency
    is_enabled: StrictBool
    __properties: ClassVar[List[str]] = ["limit", "currency", "is_enabled"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UsageLimitRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UsageLimitRequest from a dict"""
        if obj is None:
            return None
