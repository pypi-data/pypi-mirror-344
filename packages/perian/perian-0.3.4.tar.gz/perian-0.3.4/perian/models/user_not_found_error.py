...
class UserNotFoundError(BaseModel):
    ...
    detail: Optional[StrictStr] = 'The given User could not be found. Authentication failed.'
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserNotFoundError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserNotFoundError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "detail": obj.get("detail") if obj.get("detail") is not None else 'The given User could not be found. Authentication failed.',
