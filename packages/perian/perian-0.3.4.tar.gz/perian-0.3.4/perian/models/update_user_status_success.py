...
class UpdateUserStatusSuccess(BaseModel):
    """
    Response model for updating user status.
    """ # noqa: E501
    ...
    user: UserView
    __properties: ClassVar[List[str]] = ["status", "message", "detail", "status_code", "user"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateUserStatusSuccess from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateUserStatusSuccess from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "user": UserView.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
