...
class GetOrganizationUsageLimitResponse(BaseModel):
    """
    JSON schema for getting organization usage limit.
    """ # noqa: E501
    ...
    usage: StrictStr
    __properties: ClassVar[List[str]] = ["status", "message", "detail", "status_code", "start_time", "end_time", "amount", "currency", "duration_type", "is_enabled", "usage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetOrganizationUsageLimitResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetOrganizationUsageLimitResponse from a dict"""
        if obj is None:
            return None
