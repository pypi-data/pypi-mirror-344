...
class SrcApiRouterInferenceNoParameterError(BaseModel):
    """
    Error response for missing Inference Service id.
    """ # noqa: E501
    status: Optional[StrictStr] = 'Error'
    message: Optional[StrictStr] = 'Operation failed due to a client error'
    detail: Optional[StrictStr] = 'Please provide a specific Inference Service ID.'
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SrcApiRouterInferenceNoParameterError from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SrcApiRouterInferenceNoParameterError from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "detail": obj.get("detail") if obj.get("detail") is not None else 'Please provide a specific Inference Service ID.',
