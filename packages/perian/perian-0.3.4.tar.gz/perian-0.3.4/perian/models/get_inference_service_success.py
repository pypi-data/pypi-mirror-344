...
class GetInferenceServiceSuccess(BaseModel):
    """
    Success response for Inference Service creation.
    """ # noqa: E501
    ...
    inference_services: Optional[List[InferenceServiceView]] = None
    pagination: Optional[PaginationMetadata] = None
    __properties: ClassVar[List[str]] = ["status", "message", "detail", "status_code", "limit", "no", "inference_services", "pagination"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetInferenceServiceSuccess from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in inference_services (list)
        _items = []
        if self.inference_services:
            for _item in self.inference_services:
                if _item:
                    _items.append(_item.to_dict())
            _dict['inference_services'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetInferenceServiceSuccess from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "inference_services": [InferenceServiceView.from_dict(_item) for _item in obj["inference_services"]] if obj.get("inference_services") is not None else None,
