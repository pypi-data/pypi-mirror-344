...
def get_report_input():
    ...
    # Додаємо параметр для вибору сортування
    parser.add_argument(
        "-o",
        "--order",
        choices=["asc", "desc"],
    ...
    # Додаємо параметр для виведення інформації про конкретного пілота
    parser.add_argument(
    ...
    # Якщо не передано жодного параметра, виводимо повідомлення і допомогу
