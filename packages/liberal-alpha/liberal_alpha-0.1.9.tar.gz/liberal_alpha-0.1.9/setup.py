...
setup(
    ...
    install_requires=[
        "grpcio>=1.30.0",      # Lower version requirements
        "protobuf>=3.13.0",    # Lower version requirements
        "requests>=2.20.0",
        "coincurve>=13.0.0",   # Lower version requirements
        "pycryptodome>=3.9.0", # Lower version requirements
        "eth-account>=0.5.0",
        "eth-keys>=0.3.0",
        "websockets>=8.0.0",
    ],
