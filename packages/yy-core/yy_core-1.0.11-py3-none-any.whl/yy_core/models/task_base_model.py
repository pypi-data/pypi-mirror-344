...
@LastEditTime: 2025-04-28 17:40:33
@LastEditors: yy
@Description: 
"""
...
class TaskBaseModel(FrameBaseModel):
    ...
    def get_only_id(self,user_id,complete_type,task_type,task_sub_type="",complete_count=1):
        ...
        if complete_type == 1:
            only_id += f"_{TimeHelper.get_now_day_int()}"
    ...
    def add_task_log(self, task_type, task_sub_type, app_id, act_id, module_id, user_id, open_id, user_nick, task_name, log_title, reward_type, reward_object_id, reward_name, reward_num, handler_name, request_code, info_json={}):
        ...
        if task_config.get("is_task_log",False) == True:
            try:
                ...
                task_log_model = TaskLogModel(context=self.context)
    ...
    def add_gear_task_count(self, app_id, act_id, module_id, user_id, open_id, task_type, value, remark=''):
        ...
        redis_init = RedisHelper.init(config_dict=self.redis_config_dict)
    ...
    def get_client_task_list(self, app_id, act_id, module_id, user_id, task_types="", order_by="sort_index desc,id asc"):
        """
        :description: 获取任务列表
        :param app_id:应用标识
        :param act_id:活动标识
        ...
        for task_info_dict in task_info_list:
            ...
            if task_info_dict["task_type"] == TaskType.weekly_sign.value:
