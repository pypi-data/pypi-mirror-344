...
@LastEditTime: 2025-04-28 15:59:27
@LastEditors: yy
:Description: 数据库基础操作类
"""

from yy_core.mysql import MySQLHelper
import datetime
import os
from yy_core import *
...
class BaseModel:
    ...
    def set_sub_table(self, object_id=''):
        ...
        if table_config and object_id:
            ...
            sub_table = CoreHelper.get_sub_table(object_id, table_config.get("sub_count", 10))
            if sub_table:
                # 数据库表名
    ...
    def relation_and_merge_dict_list(self, primary_dict_list, relation_db_model, relation_key_field, field="*", primary_key_field="id", is_cache=True, dependency_key="", cache_expire=1800):
        ...
        where = CoreHelper.get_condition_by_int_list(relation_key_field, ext_table_ids)
        if is_cache == True:
        ...
        dict_list = CoreHelper.merge_dict_list(primary_dict_list, primary_key_field, relation_dict_list, relation_key_field, exclude_merge_columns_names="id")
        return dict_list
