...
@LastEditTime: 2025-04-28 17:39:04
@LastEditors: yy
@Description: 
"""
from time import *
...
class WeChatHelper:
    ...
    def get_jsapi_ticket(self, app_id=""):
        ...
        try:
            ...
            redis_init = RedisHelper.init(config_dict=share_config.get_value("platform_redis"))
    ...
    def create_qr_code_unlimit(self, page, scene="a=1", width=430, env_version="release", check_path=False, app_id="", app_secret=""):
        ...
        invoke_result_data = InvokeResultData()
        redis_init = RedisHelper.init(decode_responses=False)
    ...
    def decrypt_data_by_code(self, open_id, code, encrypted_Data, iv, app_id="", app_secret=""):
        ...
        try:
            session_key = RedisHelper.init().get(f"{app_id}_wechat_sessionkey:{open_id}")
