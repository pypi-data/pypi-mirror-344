...
@LastEditTime: 2025-04-28 17:27:07
@LastEditors: yy
:description: 常用帮助类
"""
from yy_core import *
...
class CoreHelper:
    ...
    def is_continue_request(self, cache_key, expire=500, config_dict=None):
        ...
        redis_init = RedisHelper.init(config_dict=config_dict)
    ...
    def get_now_int(self, hours=0, minutes=0, fmt='%Y%m%d%H%M%S'):
        ...
        :last_editors: yy
        """
        return TimeHelper.get_now_int(hours, minutes, fmt)
    ...
    def get_now_hour_int(self, hours=0):
        ...
        :last_editors: yy
        """
        return TimeHelper.get_now_int(hours=hours, fmt='%Y%m%d%H')
    ...
    def get_now_day_int(self, hours=0):
        ...
        :last_editors: yy
        """
        return TimeHelper.get_now_int(hours=hours, fmt='%Y%m%d')
    ...
    def get_now_month_int(self, hours=0):
        ...
        :last_editors: yy
        """
        return TimeHelper.get_now_int(hours=hours, fmt='%Y%m')
    ...
    def get_date_list(self, start_date, end_date):
        ...
        :last_editors: yy
        """
        return TimeHelper.get_date_list(start_date, end_date)
