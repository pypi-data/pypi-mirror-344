...
@LastEditTime: 2025-04-28 16:18:56
...
from yy_core.libs.common.frame_db import *
...
class CacheModel(BaseModel):
    ...
    def get_dependency_cache(self, dependency_key, cache_key, redis_config_dict=None):
        ...
        redis_init = RedisHelper.init(config_dict=self.get_redis_config(redis_config_dict), decode_responses=True)
