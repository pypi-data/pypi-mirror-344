...
@LastEditTime: 2025-04-23 16:48:38
@LastEditors: yy
@Description: 
"""
#此文件由rigger自动生成
...
from yy_core.models.cache_model import *


class AssetLogModel(CacheModel):
    def __init__(self, db_connect_key='db_yy', sub_table=None, db_transaction=None, context=None, is_auto=False):
        super(AssetLogModel, self).__init__(AssetLog, sub_table)
        db_connect_key, self.redis_config_dict = CoreHelper.get_connect_config("db_asset","redis_asset", db_connect_key)
