...
class Job:
    ...
    def __init__(self, job_descriptor):
        self.job_descriptor: JobDescription = job_descriptor
...
class Workload:
    ...
    def __init__(self, workload_dir, workload_description):
        ...
        self.workload_description: WorkloadDescription = workload_description  
...
class WorkloadManager:
    ...
    def _update_descriptor_id(self, descriptor: WorkloadDescription):
        """
    ...
    def new_workload(self, workload_descriptor: WorkloadDescription):
        """
