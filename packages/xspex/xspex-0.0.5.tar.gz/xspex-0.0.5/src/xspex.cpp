...
py::dict xla_registrations() {
    ...
    reg["gaussian_f32"] = xspex::EncapsulateFunction(xspex::wrapper_C_XLA_f32<C_gaussianLine, 2>);
    ...
    reg["vgaussian_f32"] = xspex::EncapsulateFunction(xspex::wrapper_C_XLA_f32<C_vgaussianLine, 2>);
    ...
    reg["SSS_ice_f32"] = xspex::EncapsulateFunction(xspex::wrapper_f_XLA_f32<xssssi_, 1>);
    ...
    reg["zvgaussian_f32"] = xspex::EncapsulateFunction(xspex::wrapper_C_XLA_f32<C_zvgaussianLine, 3>);
    ...
    reg["gaussian_f64"] = xspex::EncapsulateFunction(xspex::wrapper_C_XLA_f64<C_gaussianLine, 2>);
    ...
    reg["vgaussian_f64"] = xspex::EncapsulateFunction(xspex::wrapper_C_XLA_f64<C_vgaussianLine, 2>);
    ...
    reg["SSS_ice_f64"] = xspex::EncapsulateFunction(xspex::wrapper_f_XLA_f64<xssssi_, 1>);
    ...
    reg["zvgaussian_f64"] = xspex::EncapsulateFunction(xspex::wrapper_C_XLA_f64<C_zvgaussianLine, 3>);
...
zmshift - 1 parameter.
    ...
    m.def("gaussian", xspex::wrapper_C<double, C_gaussianLine, 2>, "The Xspec additive gaussian model with 2 parameters.","pars"_a, "energies"_a, "spectrum"_a=1, "initStr"_a="");
    ...
    m.def("vgaussian", xspex::wrapper_C<double, C_vgaussianLine, 2>, "The Xspec additive vgaussian model with 2 parameters.","pars"_a, "energies"_a, "spectrum"_a=1, "initStr"_a="");
    ...
    m.def("SSS_ice", xspex::wrapper_f<float, xssssi_, 1>, "The Xspec multiplicative SSS_ice model with 1 parameter.","pars"_a, "energies"_a, "spectrum"_a=1);
    ...
    m.def("zvgaussian", xspex::wrapper_C<double, C_zvgaussianLine, 3>, "The Xspec additive zvgaussian model with 3 parameters.","pars"_a, "energies"_a, "spectrum"_a=1, "initStr"_a="");
