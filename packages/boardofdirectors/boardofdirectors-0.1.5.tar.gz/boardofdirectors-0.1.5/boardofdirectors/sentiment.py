...
logistic_bow_predict=logistic.predict(cv_test_reviews)
print(logistic_bow_predict)
##Predicting the model for tfidf features
logistic_tfidf_predict=logistic.predict(tv_test_reviews)
...
print("logistic_bow_score :",logistic_bow_score)
#Accuracy score for tfidf features
logistic_tfidf_score=accuracy_score(test_sentiments,logistic_tfidf_predict)
print("logistic_tfidf_score :",logistic_tfidf_score)
...
cm_bow=confusion_matrix(test_sentiments,logistic_bow_predict,labels=[1,0])
print(cm_bow)
#confusion matrix for tfidf features
cm_tfidf=confusion_matrix(test_sentiments,logistic_tfidf_predict,labels=[1,0])
print(cm_tfidf)
