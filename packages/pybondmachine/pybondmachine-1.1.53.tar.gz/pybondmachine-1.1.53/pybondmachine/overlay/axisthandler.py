...
class AxiStreamHandler():
    ...
    def predict(self, debug=False):
        ...
        print("Number of input features: ", self.n_input)
        print("Number of output features: ", self.n_output)
        print("Number of samples: ", self.samples_len)
        print("Number of input features: ", self.n_input)
        print("Number of output features: ", self.n_output)
        print("Board: ", self.model_specs['board'])
        print("Benchcore: ", self.benchcore)
