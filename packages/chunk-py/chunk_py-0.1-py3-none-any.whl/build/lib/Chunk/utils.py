...
def getCCcomm(adata, gene1, gene2, L_threshold=20, R_threshold=20, marked_col=None, 
...
def Cellphone(
    ...
    """
    Simplified version of CellPhoneDB.
    ...
    logger.info(f"Running Optimized CellPhoneDB: iterations={iterations}, threshold={threshold}, "
