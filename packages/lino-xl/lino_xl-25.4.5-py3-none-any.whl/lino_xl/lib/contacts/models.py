...
class Partner(Duplicable, ContactDetailsOwner, Polymorphic, AddressOwner,
              ...
              VatSubjectable, Commentable, PeppolPartner):
...
class PartnerDetail(dd.DetailLayout):
    ...
    if dd.is_installed('invoicing'):
        trading = dd.Panel("""
        salesrule__invoice_recipient salesrule__paper_type send_peppol
    ...
    if dd.is_installed('vatless'):
        ...
        accounting = dd.Panel("""
        partner_ref purchase_account payment_term
    ...
    if dd.is_installed('sepa'):
        sepa = dd.Panel("""
        payment_term #peppol_id send_peppol
