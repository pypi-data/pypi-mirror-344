...
async def set_publish_params():
    set_publish_params = SetPublishParams(['表彰管理系统工具'], set_original=True,
                                          author='XiaoqiangClub',
                                          quick_reprint=True, set_collect=['工具箱'], open_comment=False,
                                          set_praise=False, original_link=None, hide_browser=False)
