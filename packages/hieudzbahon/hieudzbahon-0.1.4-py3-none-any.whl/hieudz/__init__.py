from .core import (
    ...
    sohoanhao, phantich, daonguoc, tamgiac, dinhgiang
)
import inspect
...
def help() -> None:
    ...
    print("Danh sách các hàm trong thư viện hieudz:")
...
def code(func_name: str) -> None:
    ...
    if func_name not in FUNCTIONS:
        print(f"Hàm '{func_name}' không tồn tại. Dùng 'hieudz.help()' để xem danh sách hàm.")
        return
...
__all__ = [
    "songuyento", "tachds", "uocchung", "boichung", "uoclonnhat", "nguyento",
    "sohoanhao", "phantich", "daonguoc", "tamgiac", "dinhgiang", "help", "code"
]