...
**5. Add the first scene to the current act.** This also makes it the current scene.
...
**12. List recent events** to see both manual and oracle-derived ones.
...
**20. Select the first interpretation from the *new* set.**
