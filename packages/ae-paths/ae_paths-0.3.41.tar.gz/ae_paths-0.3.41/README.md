...
[![LatestPyPIrelease](
    https://img.shields.io/gitlab/pipeline/ae-group/ae_paths/release0.3.40?logo=python)](
    https://gitlab.com/ae-group/ae_paths/-/tree/release0.3.40)
[![PyPIVersions](https://img.shields.io/pypi/v/ae_paths)](
    https://pypi.org/project/ae-paths/#history)

>ae_paths module 0.3.41.
