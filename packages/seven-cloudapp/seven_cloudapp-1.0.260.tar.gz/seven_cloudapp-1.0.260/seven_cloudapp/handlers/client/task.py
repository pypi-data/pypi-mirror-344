...
@LastEditTime: 2025-04-29 11:09:27
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 1:
                ...
                invoke_result_data = self.change_crm_point(open_id, 1, 0, send_num, access_token, activity_id=task_type, activity_id="新人有礼任务", is_log=True)
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 1:
                ...
                if not result:
                    return self.reponse_json_error("No_Member", "不是会员，不能领取")
                invoke_result_data = self.change_crm_point(open_id, 1, 0, send_num, access_token, activity_id=task_type, activity_name="每日签到任务", is_log=True)
                if invoke_result_data.success == False:
                    return self.reponse_json_error("Error", "无法操作会员积分")
    ...
    def get_async(self):
        ...
        if reward_count > 0:
            ...
            if currency_type == 1:
                ...
                if not result:
                    return self.reponse_json_error("No_Member", "不是会员，不能领取")
                invoke_result_data = self.change_crm_point(open_id, 1, 0, reward_count, access_token, activity_id=task_type, activity_name="每日签到任务", is_log=True)
                if invoke_result_data.success == False:
                    return self.reponse_json_error("Error", "无法操作会员积分")
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 1:
                ...
                if not result:
                    return self.reponse_json_error("No_Member", "不是会员，不能领取")
                invoke_result_data = self.change_crm_point(open_id, 1, 0, send_num, access_token, activity_id=task_type, activity_name="关注任务", is_log=True)
                if invoke_result_data.success == False:
                    return self.reponse_json_error("Error", "无法操作会员积分")
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 1:
                ...
                if not result:
                    return self.reponse_json_error("No_Member", "不是会员，不能领取")
                invoke_result_data = self.change_crm_point(open_id, 1, 0, send_num, access_token, activity_id=task_type, activity_name="加入会员任务", is_log=True)
                if invoke_result_data.success == False:
                    return self.reponse_json_error("Error", "无法操作会员积分")
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 1:
                ...
                if not result:
                    return self.reponse_json_error("No_Member", "不是会员，不能领取")
                invoke_result_data = self.change_crm_point(open_id, 1, 0, send_num, access_token, activity_id=task_type, activity_name="收藏商品任务", is_log=True)
                if invoke_result_data.success == False:
                    return self.reponse_json_error("Error", "无法操作会员积分")
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 1:
                ...
                if not result:
                    return self.reponse_json_error("No_Member", "不是会员，不能领取")
                invoke_result_data = self.change_crm_point(open_id, 1, 0, send_num, access_token, activity_id=task_type, activity_name="浏览商品任务", is_log=True)
                if invoke_result_data.success == False:
                    return self.reponse_json_error("Error", "无法操作会员积分")
                ...
                if order["oid"] not in pay_order_id_list:
                    ...
                    if task_count.count_value > num_limit:
                        ...
                        if currency_type == 4:
                            ...
                            if not result:
                                return self.reponse_json_error("No_Member", "不是会员，不能领取")
                            invoke_result_data = self.change_crm_point(open_id, 1, 0, send_num, access_token, activity_id=task_type, activity_name="指定商品下单任务", is_log=True)
                            if invoke_result_data.success == False:
                                return self.reponse_json_error("Error", "无法操作会员积分")
    ...
    def get_async(self):
        ...
        if send_num > 0:
            ...
            if currency_type == 4:
                ...
                if not result:
                    return self.reponse_json_error("No_Member", "不是会员，不能领取")
                invoke_result_data = self.change_crm_point(open_id, 1, 0, send_num, access_token, activity_id=task_type, activity_name="每周签到任务", is_log=True)
                if invoke_result_data.success == False:
                    return self.reponse_json_error("Error", "无法操作会员积分")
