...
if APP_CONFIG_DIR and os.path.isdir(APP_CONFIG_DIR):
    print(f"TalkyTrend Config: Found TT_CONFIG_DIR: {APP_CONFIG_DIR}")
    ...
    print(
        f"TalkyTrend Config: TT_CONFIG_DIR not set or invalid "
...
if os.path.exists(DEFAULT_SETTINGS_PATH):
    ...
    print(
        f"TalkyTrend Config: Warning - Library default not found "
...
print(f"TalkyTrend Config: Loading settings from: {settings_files}")
# --- End Modification ---
