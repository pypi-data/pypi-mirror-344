...
class SimpleApp:
    ...
    def upload_document(self, file_path: str, tenant_id: str = "demo", session_id: str = None) -> None:
        """
    ...
    def ask_question(self, question: str, tenant_id: str = "demo", session_id: str = None) -> None:
        """
    ...
    def _handle_vector_stored(self, event_data: Dict[str, Any]) -> None:
        ...
        logger.info(f"Documento processado e armazenado com sucesso! Total: {self.documents_processed}")
