...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in zepben/protobuf/ns/network_state_pb2_grpc.py depends on'
...
def add_UpdateNetworkStateServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('zepben.protobuf.ns.UpdateNetworkStateService', rpc_method_handlers)
...
def add_QueryNetworkStateServiceServicer_to_server(servicer, server):
    ...
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('zepben.protobuf.ns.QueryNetworkStateService', rpc_method_handlers)
