...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in zepben/protobuf/cc/cc_pb2_grpc.py depends on'
...
def add_CustomerConsumerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('zepben.protobuf.cc.CustomerConsumer', rpc_method_handlers)
