...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in zepben/protobuf/nc/nc_pb2_grpc.py depends on'
...
def add_NetworkConsumerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('zepben.protobuf.nc.NetworkConsumer', rpc_method_handlers)
