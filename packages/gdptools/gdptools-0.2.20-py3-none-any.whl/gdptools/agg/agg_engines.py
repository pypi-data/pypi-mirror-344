...
class SerialAgg(AggEngine):
    ...
    def calc_agg(
        ...
        This method extracts the time period, sorts and dissolves geometries, retrieves and loads data,
        prepares weights, performs parallel aggregation, and returns the aggregated results.
        ...
        Returns:
            Tuple[gpd.GeoDataFrame, npt.NDArray[Union[np.int_, np.double]]]:
                ...
                - Aggregated values as a NumPy array (time_steps, geometries).

        Raises:
            ValueError: If the data is too large to load into memory.
        """
        cp = data.cat_cr
        gdf = data.feature
