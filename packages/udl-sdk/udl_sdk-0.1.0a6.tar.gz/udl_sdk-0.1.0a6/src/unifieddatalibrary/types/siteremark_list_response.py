...
__all__ = ["SiteremarkListResponse", "SiteremarkListResponseItem"]


class SiteremarkListResponseItem(BaseModel):
...
SiteremarkListResponse: TypeAlias = List[SiteremarkListResponseItem]
