...
__all__ = ["SubstatusListResponse", "SubstatusListResponseItem"]


class SubstatusListResponseItem(BaseModel):
...
SubstatusListResponse: TypeAlias = List[SubstatusListResponseItem]
