...
if __name__ == "__main__":
    # Test the function
    print(is_city_capitol_of_state("Denver", "Colorado"))  # Should return True
    print(is_city_capitol_of_state("Denver", "California"))  # Should return False
    print(is_city_capitol_of_state("Los Angeles", "California"))  # Should return False
    print(is_city_capitol_of_state("Sacramento", "California"))  # Should return True
    # pthon -m my_packaging.states_info
