...
class ALFObjectNotFound(ALFError):
    ...
    explanation = (
        "The ALF object was not found.  This may occur if the object or namespace or "
...
class ALFMultipleObjectsFound(ALFError):
    ...
    explanation = (
        "Dataset files belonging to more than one object found.  "
...
class ALFMultipleCollectionsFound(ALFError):
    ...
    explanation = (
        "The matching object/file(s) belong to more than one collection.  "
        "ALF names have the pattern "
...
class ALFMultipleRevisionsFound(ALFError):
    ...
    explanation = (
        "The matching object/file(s) belong to more than one revision.  "
