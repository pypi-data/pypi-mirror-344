...
class TestConverters(unittest.TestCase):
    ...
    def test_path2eid(self):
        ...
        session_path = Path.home().joinpath("mainenlab", "Subjects", "ZFM-01935", "2021-02-05", "001", "alf")
    ...
    def test_eid2path(self):
        ...
        expected = Path(self.tempdir.name).joinpath("mainenlab", "Subjects", "ZFM-01935", "2021-02-05", "001")
    ...
    def test_path2record(self):
        ...
        file = Path(self.tempdir.name).joinpath(
            "cortexlab", "Subjects", "KS005", "2019-04-02", "001", "alf", "_ibl_wheel.position.npy"
        )
        ...
        session_path = Path(self.tempdir.name).joinpath("cortexlab", "Subjects", "KS005", "2019-04-02", "001")
    ...
    def test_ref2path(self):
        ...
        expected = ["zadorlab/Subjects/flowers/2018-07-13/001", "cortexlab/Subjects/KS005/2019-04-11/001"]
...
class TestOnlineConverters(unittest.TestCase):
    ...
    def test_record2url(self):
        ...
        expected = (
            "https://ibl.flatironinstitute.org/public/hoferlab/Subjects/"
        ...
        expected = "https://ibl.flatironinstitute.org/public/hoferlab/Subjects/SWC_043/2020-09-21/001"
        self.assertEqual(expected, url)
    ...
    def test_record2path(self):
        ...
        rec = self.one.get_details(self.eid, full=True, query_type="local")
        # As pd.Series
        alf_path = "hoferlab/Subjects/SWC_043/2020-09-21/001/alf/probe00/_phy_spikes_subset.channels.npy"
    ...
    def test_eid2path(self):
        ...
        expected = Path(self.one.cache_dir).joinpath(
            "hoferlab",
            "Subjects",
            "SWC_043",
            "2020-09-21",
...
class TestAlyx2Path(unittest.TestCase):
    ...
    def test_dsets_2_path(self):
        ...
        testable = converters.path_from_dataset(self.dset, root_path=root, repository="ibl_floferlab_SR")
    ...
    def test_session_record2path(self):
        ...
        rec = {
            "date": datetime.datetime.fromisoformat("2020-01-01").date(),
            "number": "001",
            "lab": "foo",
            "subject": "ALK01",
        }
