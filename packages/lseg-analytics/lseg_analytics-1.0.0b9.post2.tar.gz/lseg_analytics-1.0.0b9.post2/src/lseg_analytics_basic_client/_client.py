...
class AnalyticsAPIClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype cross_currencies_resource: analyticsapi.operations.crossCurrenciesResourceOperations
    :ivar cross_currency_resource: crossCurrencyResourceOperations operations
    :vartype cross_currency_resource: analyticsapi.operations.crossCurrencyResourceOperations
    :ivar currencies_resource: currenciesResourceOperations operations
    :vartype currencies_resource: analyticsapi.operations.currenciesResourceOperations
    :ivar currency_resource: currencyResourceOperations operations
    :vartype currency_resource: analyticsapi.operations.currencyResourceOperations
