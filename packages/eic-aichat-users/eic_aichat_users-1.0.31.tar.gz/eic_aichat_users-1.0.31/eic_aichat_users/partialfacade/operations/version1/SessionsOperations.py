...
class SessionsOperations(RestOperations):
    ...
    def register_routes(self, auth: AuthorizerV1, controller: RestController):
        controller.register_route('post', '/users/signup', None, auth.anybody,  lambda: self.signup())
        
        controller.register_route('get', '/users/signup/validate', None, auth.anybody, lambda: self.signup_validate())
        
        controller.register_route('post', '/users/signin', None, auth.anybody, lambda: self.signin())
        
        controller.register_route('post', '/users/signout', None, auth.anybody,lambda: self.signout())
        
        controller.register_route('get', '/users/sessions', None, auth.admin, lambda: self.get_sessions())
        
        controller.register_route('post', '/users/sessions/restore', None, auth.signed, lambda: self.restore_session())
        
        controller.register_route('get', '/users/sessions/current', None, auth.signed, lambda: self.get_current_session())
        
        controller.register_route('get', '/users/:user_id/sessions', None, auth.signed, lambda user_id: self.get_user_sessions(user_id))
        
        controller.register_route('del', '/users/:user_id/sessions/:session_id', None, auth.signed, 
