...
def create_dataset(option_list: list):
    ...
    sys.stdout.write(f"New dataset detail: \n{result}\n")
...
def get_dataset(option_list: list):
    ...
    sys.stdout.write(f"Dataset detail: \n{result}\n")
...
def update_dataset(option_list: list):
    ...
    sys.stdout.write(f"Updated dataset detail: \n{result}\n")
...
def delete_dataset(option_list: list):
    ...
    sys.stdout.write(f"Deleted dataset detail: \n{result}\n")
...
def list_dataset_rows(option_list: list):
    ...
    sys.stdout.write(f"Dataset rows: \n{result}\n")
...
def delete_dataset_row(option_list: list):
    ...
    sys.stdout.write(f"Deleted row detail: \n{result}\n")
...
def create_dataset_row_expected_source(option_list: list):
    ...
    sys.stdout.write(f"Extended source detail: \n{result}\n")
...
def list_dataset_row_expected_sources(option_list: list):
    ...
    sys.stdout.write(f"Expected sources: \n{result}\n")
...
def get_dataset_row_expected_source(option_list: list):
    ...
    sys.stdout.write(f"Expected source detail: \n{result}\n")
...
def update_dataset_row_expected_source(option_list: list):
    ...
    sys.stdout.write(f"Updated expected source detail: \n{result}\n")
...
def delete_dataset_row_expected_source(option_list: list):
    ...
    sys.stdout.write(f"Deleted expected source detail: \n{result}\n")
...
def create_dataset_row_filter_variable(option_list: list):
    ...
    sys.stdout.write(f"Filter variable detail: \n{result}\n")
...
def list_dataset_row_filter_variables(option_list: list):
    ...
    sys.stdout.write(f"Filter variables: \n{result}\n")
...
def update_dataset_row_filter_variable(option_list: list):
    ...
    sys.stdout.write(f"Updated filter variable detail: \n{result}\n")
...
def delete_dataset_row_filter_variable(option_list: list):
    ...
    sys.stdout.write(f"Deleted filter variable detail: \n{result}\n")
...
def update_dataset_rows_file(option_list: list):
    ...
    sys.stdout.write(f"Dataset rows file detail: \n{result}\n")
...
def list_evaluation_plans():
    ...
    sys.stdout.write(f"Evaluation plans: \n{result}\n")
...
def create_evaluation_plan(option_list: list):
    ...
    sys.stdout.write(f"New evaluation plan detail: \n{result}\n")
...
def get_evaluation_plan(option_list: list):
    ...
    sys.stdout.write(f"Evaluation plan detail: \n{result}\n")
...
def update_evaluation_plan(option_list: list):
    ...
    sys.stdout.write(f"Updated evaluation plan: \n{result}\n")
...
def delete_evaluation_plan(option_list: list):
    ...
    sys.stdout.write(f"Deleted evaluation plan: \n{result}\n")
...
def list_evaluation_plan_system_metrics(option_list: list):
    ...
    sys.stdout.write(f"Evaluation plan's system metrics: \n{result}\n")
...
def get_evaluation_plan_system_metric(option_list: list):
    ...
    sys.stdout.write(f"Evaluation plan's system metric: \n{result}\n")
...
def list_system_metrics():
    ...
    sys.stdout.write(f"Available system metrics: \n{result}\n")
...
def get_system_metric(option_list: list):
    ...
    sys.stdout.write(f"System metric: \n{result}\n")
...
def execute_evaluation_plan(option_list: list):
    ...
    sys.stdout.write(f"Evaluation plan execution: \n{result}\n")
...
def list_evaluation_results(option_list: list):
    ...
    sys.stdout.write(f"Evaluation results: \n{result}\n")
...
def get_evaluation_result(option_list: list):
    ...
    sys.stdout.write(f"Evaluation result: \n{result}\n")
