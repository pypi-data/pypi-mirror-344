...
from x4util.conversion import x4_x4toj4, x4_j4tox4, x4_poipoi

def main():
  args=get_args(ver)
  extract(*get_input(args))

def extract(file_inp,file_dict,data_id,file_out,force0):
...
# Conversion to J4 format by X4TOJ4
  ...
  x4_x4toj4.convert(file_inp,file_dict,file_js0,key_keep,force,chkrid,add19,keepflg,outstr)
...
# Conversion to J4 format without pointer structure by POIPOI
  if data_id=="all":
    ...
    os.mkdir(dir_js1)
    x4_poipoi.remove_pointer(file_js0,file_dict,data_id,dir_js1,key_keep,force,delpoin,keep001)
  else:
    file_js1 = "exfor1.json"
    x4_poipoi.remove_pointer(file_js0,file_dict,data_id,file_js1,key_keep,force,delpoin,keep001)
...
# Conversion to X4 format by J4TOX4
  if data_id=="all":
    ...
    for file_js1 in file_js1s:
      ...
      x4_j4tox4.convert(file_js1,file_dict,file_exf,force)
  else:
    x4_j4tox4.convert(file_js1,file_dict,file_out,force)
