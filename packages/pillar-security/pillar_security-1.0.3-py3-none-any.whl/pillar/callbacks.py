...
def raise_on_flagged(request: API_REQUEST, response: API_RESPONSE) -> OnFlaggedResultType:
...
def mask_on_flagged(request: API_REQUEST, response: API_RESPONSE) -> OnFlaggedResultType:
...
def id_on_flagged(request: API_REQUEST, response: API_RESPONSE) -> OnFlaggedResultType:
