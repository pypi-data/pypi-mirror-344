...
class Logger:
    ...
    def _log(self, level: int, message: str, trace: str | None = None) -> None:
        ...
        try:
            self.pillar._log(level, message, trace)
        except Exception:
    ...
    def error(self, message: str) -> None:
        ...
        self._log(logging.ERROR, message, trace_to_log)
    ...
    def critical(self, message: str) -> None:
        ...
        trace = traceback.format_exc()
        trace_to_log = None if trace == "NoneType: None\n" else trace  # No active exception
        self._log(logging.CRITICAL, message, trace_to_log)
