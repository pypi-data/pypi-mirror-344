...
extra_compile_args = [
    '-O2',  # Set default optimization level
    '-fstack-protector-strong',  # Stack protection
    '-Wp,-D_FORTIFY_SOURCE=2',   # Fortify source protection
    '-Wp,-D_GLIBCXX_ASSERTIONS',  # Assert for C++ standard library
    '-Wall',  # Enable all warnings
    '-fPIC',  # Position independent code
    '-m64',  # 64-bit architecture
#    '-march=x86-64-v2',  # Target specific architecture
    '-mtune=generic',  # Tune for generic processor
    '-fasynchronous-unwind-tables',  # For exception handling
    '-fstack-clash-protection',  # Protection against stack clashes
    #'-fcf-protection',  # Control flow protection
    '-D_GNU_SOURCE',  # Define _GNU_SOURCE for compatibility
]
...
setup(name='mapr-streams-python',
      ...
      version='2.6.0',
      description='Python client for Data Fabric Streams',
      author='Hewlett Packard Enterprise, Confluent Inc.',
      url='https://github.com/mapr/private-confluent-kafka-python',
      ext_modules=[module],
