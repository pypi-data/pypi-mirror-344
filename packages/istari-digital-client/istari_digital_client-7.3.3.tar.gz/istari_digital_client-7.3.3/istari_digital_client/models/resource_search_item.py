...
class ResourceSearchItem(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "file_id", "file_revision_id", "type_name", "created_by_id", "archive_status", "name", "extension", "size", "created", "updated", "mime", "description", "version_name", "external_identifier", "display_name"]
