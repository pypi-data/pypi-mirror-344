...
from ...models.report_create_request_schema import ReportCreateRequestSchema
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = ResponseWithMetadataSchemaReportSchema.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Args:
    - **request[ReportCreateRequestSchema]**: Schema containing the details of the report to be created.
