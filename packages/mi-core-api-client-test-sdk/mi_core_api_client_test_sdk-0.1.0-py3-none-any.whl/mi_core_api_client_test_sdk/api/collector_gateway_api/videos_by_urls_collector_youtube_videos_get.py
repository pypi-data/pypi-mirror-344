...
def sync_detailed(
    *,
    ...
    """Videos By Urls
     ...
     Retrieve YouTube videos by URLs.

    Args:
    - **extract_method**: The method used to extract data (e.g., API).
    - **urls**: A list of YouTube video URLs to fetch.
    ...
    GatewayErrorDTO]**: A list of YouTube videos or error objects.
