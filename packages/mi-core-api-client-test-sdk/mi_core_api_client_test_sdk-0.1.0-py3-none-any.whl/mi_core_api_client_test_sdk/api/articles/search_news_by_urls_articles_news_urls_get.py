...
def sync_detailed(
    *,
    ...
    """Search News By Urls
     ...
     Searches for news articles based on a list of URLs.

    The service will fetch and process the articles corresponding to the given URLs.

    Args:
    - **urls**: A list of URLs to search for news articles.

    Returns:
    - **list[Union[ArticleSchema, ErrorDTO]]**: A list of aggregated articles or error details.
