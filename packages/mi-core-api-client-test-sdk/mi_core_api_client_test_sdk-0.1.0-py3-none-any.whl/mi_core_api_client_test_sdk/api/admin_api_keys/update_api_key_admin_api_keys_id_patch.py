...
def sync_detailed(
    ...
    *,
    ...
    This endpoint allows superusers to update the details (e.g., name or expiration date) of a specific
    API key.

    Args:
    - **id**: The ID of the API key to update.
    - **data[APIKeyUpgradeSchema]**: Schema containing the updated API key details.
