...
def _get_kwargs(
    *,
    ...
    end_date: Union[Unset, datetime.datetime] = isoparse("2025-05-01T09:12:13.990046"),
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/bigquery/viral-content-uniform",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get Viral Content Uniform

     Retrieve the fastest growing viral content based on specified criteria,
    with uniform time resolution and smoothed metric values.
    ...
    Args:
        ...
        time_res (str): Time resolution (e.g., '1sec', '3days', '1month', '2weeks')
        ...
        end_date (Union[Unset, datetime.datetime]):  Default:
            isoparse('2025-05-01T09:12:13.990046').
