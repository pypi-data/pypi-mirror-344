...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/storyboards/{storyboard_id}/status",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get Storyboard Generation Status
     ...
     Retrieve the generation status of a specific storyboard.

    Args:
    - **storyboard_id**: The ID of the storyboard.

    Returns:
    - **StoryboardGenerationStatusDTO**: The generation status of the storyboard.
