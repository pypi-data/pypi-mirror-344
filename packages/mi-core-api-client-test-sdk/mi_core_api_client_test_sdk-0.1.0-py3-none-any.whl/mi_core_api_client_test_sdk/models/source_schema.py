...
if TYPE_CHECKING:
    ...
    from ..models.source_schema_source_metadata_type_0 import SourceSchemaSourceMetadataType0
    from ..models.source_schema_source_metadata_type_1_item import SourceSchemaSourceMetadataType1Item
...
T = TypeVar("T", bound="SourceSchema")
...
class SourceSchema:
    ...
    Attributes:
        ...
        metadata_status (JobStatus): Enumeration class representing job statuses.
            ...
            Attributes:
                ...
                FAILED: Represents failed job status.
        id (Union[Unset, UUID]):
        source_metadata (Union['SourceSchemaSourceMetadataType0', None, Unset,
            list['SourceSchemaSourceMetadataType1Item']]):
    ...
    source_metadata: Union[
        "SourceSchemaSourceMetadataType0", None, Unset, list["SourceSchemaSourceMetadataType1Item"]
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.source_metadata, SourceSchemaSourceMetadataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_source_metadata(
            data: object,
        ) -> Union["SourceSchemaSourceMetadataType0", None, Unset, list["SourceSchemaSourceMetadataType1Item"]]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                source_metadata_type_0 = SourceSchemaSourceMetadataType0.from_dict(data)
            ...
            try:
                ...
                for source_metadata_type_1_item_data in _source_metadata_type_1:
                    source_metadata_type_1_item = SourceSchemaSourceMetadataType1Item.from_dict(
                ...
                pass
            return cast(
                Union["SourceSchemaSourceMetadataType0", None, Unset, list["SourceSchemaSourceMetadataType1Item"]], data
            )
        ...
        source_schema.additional_properties = d
