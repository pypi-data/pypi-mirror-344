...
class ActionDTO:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if custom_fields_ids is not UNSET:
            field_dict["customFieldsIds"] = custom_fields_ids
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_fields_ids = _parse_custom_fields_ids(d.pop("customFieldsIds", UNSET))
        ...
        report_ids = _parse_report_ids(d.pop("reportIds", UNSET))
