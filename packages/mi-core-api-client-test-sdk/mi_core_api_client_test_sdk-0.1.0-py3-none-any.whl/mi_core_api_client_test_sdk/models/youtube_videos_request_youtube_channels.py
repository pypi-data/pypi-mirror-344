...
T = TypeVar("T", bound="YoutubeVideosRequestYoutubeChannels")


@_attrs_define
class YoutubeVideosRequestYoutubeChannels:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        youtube_videos_request_youtube_channels = cls()
        ...
        youtube_videos_request_youtube_channels.additional_properties = additional_properties
        return youtube_videos_request_youtube_channels
