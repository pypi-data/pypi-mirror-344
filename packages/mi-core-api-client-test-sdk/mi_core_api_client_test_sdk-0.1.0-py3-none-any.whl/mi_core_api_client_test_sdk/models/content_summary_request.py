...
if TYPE_CHECKING:
    from ..models.youtube_channels_with_videos_ids_from_db import YoutubeChannelsWithVideosIdsFromDB


T = TypeVar("T", bound="ContentSummaryRequest")


@_attrs_define
class ContentSummaryRequest:
    """
    Attributes:
        youtube_channels (list['YoutubeChannelsWithVideosIdsFromDB']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for youtube_channels_item_data in _youtube_channels:
            youtube_channels_item = YoutubeChannelsWithVideosIdsFromDB.from_dict(youtube_channels_item_data)
        ...
        content_summary_request = cls(
            youtube_channels=youtube_channels,
            prompt_id=prompt_id,
        )

        content_summary_request.additional_properties = d
        return content_summary_request
