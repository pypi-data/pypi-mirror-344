...
T = TypeVar("T", bound="ArticlesSearchParamsDTO")


@_attrs_define
class ArticlesSearchParamsDTO:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        articles_search_params_dto = cls(
            engine=engine,
            tbm=tbm,
            q=q,
            timeframe=timeframe,
        ...
        articles_search_params_dto.additional_properties = d
        return articles_search_params_dto
