...
T = TypeVar("T", bound="UpdateTemplateSchema")


@_attrs_define
class UpdateTemplateSchema:
    """
    Attributes:
        name (str):
        project_id (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_template_schema.additional_properties = d
        return update_template_schema
