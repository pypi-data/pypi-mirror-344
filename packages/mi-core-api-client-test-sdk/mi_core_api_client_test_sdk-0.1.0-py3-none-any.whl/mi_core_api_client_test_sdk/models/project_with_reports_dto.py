...
T = TypeVar("T", bound="ProjectWithReportsDTO")


@_attrs_define
class ProjectWithReportsDTO:
    """
    Attributes:
        name (str):
        description (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_with_reports_dto.additional_properties = d
        return project_with_reports_dto
