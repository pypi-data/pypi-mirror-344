...
T = TypeVar("T", bound="PaginatedResponseYoutubeChannelInfoSchema")


@_attrs_define
class PaginatedResponseYoutubeChannelInfoSchema:
    """
    Attributes:
        count (int): Number of total items
        total_pages (int): Number of total pages
        input_items (Union[Unset, list['YoutubeChannelInfoSchema']]): List of items before pagination
    """

    count: int
    total_pages: int
    input_items: Union[Unset, list["YoutubeChannelInfoSchema"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for input_items_item_data in _input_items or []:
            input_items_item = YoutubeChannelInfoSchema.from_dict(input_items_item_data)

            input_items.append(input_items_item)

        paginated_response_youtube_channel_info_schema = cls(
            count=count,
            total_pages=total_pages,
            input_items=input_items,
        )

        paginated_response_youtube_channel_info_schema.additional_properties = d
        return paginated_response_youtube_channel_info_schema
