...
T = TypeVar("T", bound="ProjectWithSourcesDTO")


@_attrs_define
class ProjectWithSourcesDTO:
    """
    Attributes:
        name (str):
        description (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_with_sources_dto.additional_properties = d
        return project_with_sources_dto
