...
T = TypeVar("T", bound="YoutubeChannelParams")


@_attrs_define
class YoutubeChannelParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        with_transcript = d.pop("with_transcript", UNSET)
        ...
        youtube_channel_params.additional_properties = d
        return youtube_channel_params
