...
T = TypeVar("T", bound="CustomColumnBaseSchema")


@_attrs_define
class CustomColumnBaseSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_column_base_schema.additional_properties = d
        return custom_column_base_schema
