...
T = TypeVar("T", bound="ProjectWithAllRelationsDTO")


@_attrs_define
class ProjectWithAllRelationsDTO:
    """
    Attributes:
        name (str):
        description (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_with_all_relations_dto = cls(
            name=name,
            description=description,
            reports=reports,
            sources=sources,
        ...
        project_with_all_relations_dto.additional_properties = d
        return project_with_all_relations_dto
