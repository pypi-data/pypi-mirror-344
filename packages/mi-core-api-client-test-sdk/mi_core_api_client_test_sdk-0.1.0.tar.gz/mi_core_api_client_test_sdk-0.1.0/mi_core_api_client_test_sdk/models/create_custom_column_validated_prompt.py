...
T = TypeVar("T", bound="CreateCustomColumnValidatedPrompt")


@_attrs_define
class CreateCustomColumnValidatedPrompt:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_custom_column_validated_prompt = cls(
            content_type=content_type,
            model=model,
            prompt=prompt,
            name=name,
        ...
        create_custom_column_validated_prompt.additional_properties = d
        return create_custom_column_validated_prompt
