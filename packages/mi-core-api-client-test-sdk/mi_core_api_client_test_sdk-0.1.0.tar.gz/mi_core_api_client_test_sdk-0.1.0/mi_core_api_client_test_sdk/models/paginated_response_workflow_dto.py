...
T = TypeVar("T", bound="PaginatedResponseWorkflowDTO")


@_attrs_define
class PaginatedResponseWorkflowDTO:
    """
    Attributes:
        count (int): Number of total items
        total_pages (int): Number of total pages
        input_items (Union[Unset, list['WorkflowDTO']]): List of items before pagination
    """

    count: int
    total_pages: int
    input_items: Union[Unset, list["WorkflowDTO"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for input_items_item_data in _input_items or []:
            input_items_item = WorkflowDTO.from_dict(input_items_item_data)

            input_items.append(input_items_item)

        paginated_response_workflow_dto = cls(
            count=count,
            total_pages=total_pages,
            input_items=input_items,
        )

        paginated_response_workflow_dto.additional_properties = d
        return paginated_response_workflow_dto
