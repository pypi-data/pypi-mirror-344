...
T = TypeVar("T", bound="CustomColumnSchema")


@_attrs_define
class CustomColumnSchema:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        custom_column_schema.additional_properties = d
        return custom_column_schema
