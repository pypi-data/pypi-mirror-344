...
def sync_detailed(
    ...
    *,
    ...
    """Reactivate Workflow
     ...
     Reactivate a workflow by its ID for the authenticated user.

    Args:
    - **id**: The ID of the workflow to reactivate.

    Returns:
    - **WorkflowDTO**: The reactivated workflow details.
