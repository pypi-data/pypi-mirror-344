...
def sync_detailed(
    ...
    *,
    ...
    """Regenerate Graph Entities

     Regenerates all graph tree from scratch

    Args:
    - **id**: The UUID of the running collection to regenerate.

    Returns:
    - **200 OK**: A successful response that regeneration started
