...
from ...models.response_with_metadata_schema_top_content_dto import ResponseWithMetadataSchemaTopContentDTO
...
def _get_kwargs(
    *,
    ...
    end_date: Union[Unset, datetime.datetime] = isoparse("2025-05-01T09:12:13.986037"),
) -> dict[str, Any]:
    params: dict[str, Any] = {}
...
) -> Optional[Union[HTTPValidationError, ResponseWithMetadataSchemaTopContentDTO]]:
    if response.status_code == 200:
        response_200 = ResponseWithMetadataSchemaTopContentDTO.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, ResponseWithMetadataSchemaTopContentDTO]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Top Content
     ...
     Retrieve top performing/engaged content from Reddit, YouTube, or articles.
    ...
    Args:
        ...
        end_date (Union[Unset, datetime.datetime]):  Default:
            isoparse('2025-05-01T09:12:13.986037').
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, ResponseWithMetadataSchemaTopContentDTO]
    """
