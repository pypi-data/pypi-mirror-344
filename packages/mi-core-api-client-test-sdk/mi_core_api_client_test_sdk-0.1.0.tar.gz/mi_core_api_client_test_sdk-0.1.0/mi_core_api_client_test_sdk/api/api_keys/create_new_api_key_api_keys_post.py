...
from ...models.api_key_create_request_schema import APIKeyCreateRequestSchema
...
def sync_detailed(
    *,
    ...
    This endpoint allows authenticated users to generate a new API key with a specified name and
    expiration date.

    Args:
    - **data[APIKeyCreateRequestSchema]**: Schema containing the API key name and expiration date.

    Returns:
    - **APIKeyDTO**: The details of the newly created API key.
