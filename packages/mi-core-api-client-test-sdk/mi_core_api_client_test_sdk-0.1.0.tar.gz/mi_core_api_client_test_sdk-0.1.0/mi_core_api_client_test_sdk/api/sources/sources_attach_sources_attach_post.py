...
def sync_detailed(
    *,
    ...
    """Sources Attach
     ...
     Attach sources to collections.

    This endpoint attaches all sources to all provided collections if they are not already attached,
    and if collection is owned by the user.

    Args:
    - **source_ids**: List of source ids to attach to collections.
    - **collection_ids**: List of collection ids to attach sources to.

    Returns:
    - **201 Created**: A successful response with no content.
    ...
    Args:
        source_ids (Union[Unset, list[UUID]]): List of source Ids to attach to collections
