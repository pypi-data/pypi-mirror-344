...
class TradeBrokerCapacity(str, Enum, metaclass=utils.OpenEnumMeta):
...
class TradePrevailingMarketPriceTypedDict(TypedDict):
...
class TradePrevailingMarketPrice(BaseModel):
    r"""The price for the instrument that is prevailing in the market."""
...
class TradePriceAdjustmentType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class PriceAdjustmentRecordTypedDict(TypedDict):
    ...
    r"""The percent at which the price was adjusted. Expressed as a number from 0.00-100 (rounded to 2 decimals)"""
    price_adjustment_type: NotRequired[TradePriceAdjustmentType]
    r"""The type of price adjustment being applied by the broker to the net price of the security"""
...
class PriceAdjustmentRecord(BaseModel):
    ...
    price_adjustment_type: Annotated[
        Optional[TradePriceAdjustmentType], PlainValidator(validate_open_enum(False))
    ] = None
    r"""The type of price adjustment being applied by the broker to the net price of the security"""
...
class TradeTypedDict(TypedDict):
    ...
    broker_capacity: NotRequired[TradeBrokerCapacity]
    r"""Used to calculate broadridge blotter code"""
    ...
    prevailing_market_price: NotRequired[Nullable[TradePrevailingMarketPriceTypedDict]]
    r"""The price for the instrument that is prevailing in the market."""
...
class Trade(BaseModel):
    ...
    broker_capacity: Annotated[
        Optional[TradeBrokerCapacity], PlainValidator(validate_open_enum(False))
    ] = None
    r"""Used to calculate broadridge blotter code"""
    ...
    prevailing_market_price: OptionalNullable[TradePrevailingMarketPrice] = UNSET
    r"""The price for the instrument that is prevailing in the market."""
