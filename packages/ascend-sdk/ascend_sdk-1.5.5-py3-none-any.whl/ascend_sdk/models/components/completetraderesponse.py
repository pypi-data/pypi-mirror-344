...
class CompleteTradeResponsePrevailingMarketPriceTypedDict(TypedDict):
...
class CompleteTradeResponsePrevailingMarketPrice(BaseModel):
    r"""The price for the instrument that is prevailing in the market."""
...
class CompleteTradeResponsePriceAdjustmentAmountTypedDict(TypedDict):
...
class CompleteTradeResponsePriceAdjustmentAmount(BaseModel):
    r"""Total monetary value of the price_adjustment"""
...
class CompleteTradeResponsePriceAdjustmentPercentTypedDict(TypedDict):
...
class CompleteTradeResponsePriceAdjustmentPercent(BaseModel):
    r"""The percent at which the price was adjusted. Expressed as a number from 0.00-100 (rounded to 2 decimals)"""
...
class CompleteTradeResponsePriceAdjustmentType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CompleteTradeResponsePriceAdjustmentRecordTypedDict(TypedDict):
    r"""Information about any price adjustments applied to the security"""

    price_adjustment_amount: NotRequired[
        Nullable[CompleteTradeResponsePriceAdjustmentAmountTypedDict]
    ]
    r"""Total monetary value of the price_adjustment"""
    price_adjustment_percent: NotRequired[
        Nullable[CompleteTradeResponsePriceAdjustmentPercentTypedDict]
    ]
    r"""The percent at which the price was adjusted. Expressed as a number from 0.00-100 (rounded to 2 decimals)"""
    price_adjustment_type: NotRequired[CompleteTradeResponsePriceAdjustmentType]
    r"""The type of price adjustment being applied by the broker to the net price of the security"""


class CompleteTradeResponsePriceAdjustmentRecord(BaseModel):
    r"""Information about any price adjustments applied to the security"""
    ...
    price_adjustment_type: Annotated[
        Optional[CompleteTradeResponsePriceAdjustmentType],
...
class CompleteTradeResponseTradeTypedDict(TypedDict):
    ...
    prevailing_market_price: NotRequired[
        Nullable[CompleteTradeResponsePrevailingMarketPriceTypedDict]
    ]
    r"""The price for the instrument that is prevailing in the market."""
    price_adjustment_record: NotRequired[
        Nullable[CompleteTradeResponsePriceAdjustmentRecordTypedDict]
    ]
    r"""Information about any price adjustments applied to the security"""
...
class CompleteTradeResponseTrade(BaseModel):
    r"""The completed trade."""
...
class CompleteTradeResponseTypedDict(TypedDict):
    ...
    trade: NotRequired[Nullable[CompleteTradeResponseTradeTypedDict]]
    r"""The completed trade."""
...
class CompleteTradeResponse(BaseModel):
    ...
    trade: OptionalNullable[CompleteTradeResponseTrade] = UNSET
    r"""The completed trade."""
