...
class CancelTradeResponsePrevailingMarketPriceTypedDict(TypedDict):
...
class CancelTradeResponsePrevailingMarketPrice(BaseModel):
    r"""The price for the instrument that is prevailing in the market."""
...
class CancelTradeResponsePriceAdjustmentAmountTypedDict(TypedDict):
...
class CancelTradeResponsePriceAdjustmentAmount(BaseModel):
    r"""Total monetary value of the price_adjustment"""
...
class CancelTradeResponsePriceAdjustmentPercentTypedDict(TypedDict):
...
class CancelTradeResponsePriceAdjustmentPercent(BaseModel):
    r"""The percent at which the price was adjusted. Expressed as a number from 0.00-100 (rounded to 2 decimals)"""
...
class CancelTradeResponsePriceAdjustmentType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class CancelTradeResponsePriceAdjustmentRecordTypedDict(TypedDict):
    r"""Information about any price adjustments applied to the security"""

    price_adjustment_amount: NotRequired[
        Nullable[CancelTradeResponsePriceAdjustmentAmountTypedDict]
    ]
    r"""Total monetary value of the price_adjustment"""
    price_adjustment_percent: NotRequired[
        Nullable[CancelTradeResponsePriceAdjustmentPercentTypedDict]
    ]
    r"""The percent at which the price was adjusted. Expressed as a number from 0.00-100 (rounded to 2 decimals)"""
    price_adjustment_type: NotRequired[CancelTradeResponsePriceAdjustmentType]
    r"""The type of price adjustment being applied by the broker to the net price of the security"""


class CancelTradeResponsePriceAdjustmentRecord(BaseModel):
    r"""Information about any price adjustments applied to the security"""
    ...
    price_adjustment_type: Annotated[
        Optional[CancelTradeResponsePriceAdjustmentType],
...
class CancelTradeResponseTradeTypedDict(TypedDict):
    ...
    prevailing_market_price: NotRequired[
        Nullable[CancelTradeResponsePrevailingMarketPriceTypedDict]
    ]
    r"""The price for the instrument that is prevailing in the market."""
    price_adjustment_record: NotRequired[
        Nullable[CancelTradeResponsePriceAdjustmentRecordTypedDict]
    ]
    r"""Information about any price adjustments applied to the security"""
