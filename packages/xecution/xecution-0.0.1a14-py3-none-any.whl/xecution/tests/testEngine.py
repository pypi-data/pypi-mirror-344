...
class Engine(BaseEngine):
    ...
    async def on_candle_closed(self, kline_topic: KlineTopic):
        ...
        # await self.fetch_data_source(data_topic=DataTopic(provider=DataProvider.CRYPTOQUANT, url='/btc/market-data/coinbase-premium-index?window=hour&exchange=bybit'))
