...
class ProviderArgs:
    def __init__(__self__, *,
                 ...
                 management_key: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def management_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "management_key")

    @management_key.setter
    def management_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Provider(pulumi.ProviderResource):
    ...
    @property
    @pulumi.getter(name="managementKey")
    def management_key(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "management_key")
