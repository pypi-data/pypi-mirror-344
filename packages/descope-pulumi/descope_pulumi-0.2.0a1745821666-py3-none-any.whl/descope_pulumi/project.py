...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] environment: This can be set to `production` to mark production projects, otherwise this should be left unset for development or staging projects.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Descope project.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tags: Descriptive tags for your Descope project. Each tag must be no more than 50 characters long.
        """
