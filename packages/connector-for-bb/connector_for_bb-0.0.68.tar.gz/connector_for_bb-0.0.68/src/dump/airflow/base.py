...
class AirflowBaseSensor(BaseSensorOperator):
    ...
    def __init_context(self, context: Context):
        ...
        self.execution_date_moscow_tz = self.execution_date.astimezone(pendulum.timezone("Europe/Moscow"))
        self.execution_date_moscow = self.execution_date + self.execution_date_moscow_tz.utcoffset()
