...
from typing import Any, Literal, Optional, Union, cast, Type
...
class Notification(BaseModel):
    ...
    If none, sends notification to requestor.
    """
...
class APISpec(BaseModel):
    ...
    def validate_custom_attributes(cls, value: dict | None) -> dict | None:
        if value:
