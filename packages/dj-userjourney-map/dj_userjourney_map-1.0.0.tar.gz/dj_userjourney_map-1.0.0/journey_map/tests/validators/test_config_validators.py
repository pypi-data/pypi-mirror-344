...
class TestValidateBooleanSetting:
    ...
    def test_invalid_boolean(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "journey_map.E001_SOME_BOOLEAN_SETTING"
...
class TestValidateListFields:
    ...
    def test_invalid_list_type(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "journey_map.E002_SOME_LIST_SETTING"
    ...
    def test_empty_list(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "journey_map.E003_SOME_LIST_SETTING"
    ...
    def test_invalid_element_in_list(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "journey_map.E004_SOME_LIST_SETTING"
...
class TestValidateThrottleRate:
    ...
    def test_invalid_format(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "journey_map.E005_THROTTLE_RATE_SETTING"

        errors = validate_throttle_rate("invalid/type/given", "THROTTLE_RATE_SETTING")
        assert len(errors) == 1
        assert errors[0].id == "journey_map.E006_THROTTLE_RATE_SETTING"
    ...
    def test_invalid_time_unit(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "journey_map.E008_THROTTLE_RATE_SETTING"
    ...
    def test_non_numeric_rate(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "journey_map.E007_THROTTLE_RATE_SETTING"
...
class TestValidateOptionalClassSetting:
    def test_valid_class_import(self) -> None:
        ...
        with patch("django.utils.module_loading.import_string"):
            errors = validate_optional_path_setting(
                "journey_map.api.throttlings.role_base_throttle.RoleBasedUserRateThrottle",
                "SOME_CLASS_SETTING",
            )
            assert not errors
    ...
    def test_invalid_class_import(self) -> None:
        ...
        with patch(
            ...
            assert len(errors) == 1
            assert errors[0].id == "journey_map.E010_SOME_CLASS_SETTING"
    ...
    def test_invalid_class_path_type(self) -> None:
        ...
        assert len(errors) == 1
        assert errors[0].id == "journey_map.E009_SOME_CLASS_SETTING"
    ...
    def test_invalid_list_args_classes_import(self) -> None:
        ...
        assert len(errors) == 2
        assert errors[0].id == "journey_map.E012_SOME_CLASS_SETTING"
    ...
    def test_invalid_path_classes_import(self) -> None:
        ...
        with patch(
            ...
            assert len(errors) == 1
            assert errors[0].id == "journey_map.E013_SOME_CLASS_SETTING"
