    ...
    def make_instance(self, include_optional) -> V0040OpenapiAccountsAddCondResp:
        ...
        if include_optional:
            return V0040OpenapiAccountsAddCondResp(
                association_condition = aind_slurm_rest_v2.models.v0/0/40_accounts_add_cond.v0.0.40_accounts_add_cond(
                    accounts = [
                        ''
                        ], 
                    association = aind_slurm_rest_v2.models.v0/0/40_assoc_rec_set.v0.0.40_assoc_rec_set(
                        comment = '', 
                        defaultqos = '', 
                ...
                account = aind_slurm_rest_v2.models.v0/0/40_account_short.v0.0.40_account_short(
                    description = '', 
                    organization = '', ),
