    ...
    def make_instance(self, include_optional) -> V0040OpenapiUsersAddCondResp:
        ...
        if include_optional:
            return V0040OpenapiUsersAddCondResp(
                association_condition = aind_slurm_rest_v2.models.v0/0/40_users_add_cond.v0.0.40_users_add_cond(
                    accounts = [
                        ''
                        ], 
                    ...
                    users = , 
                    wckeys = , ),
                user = aind_slurm_rest_v2.models.v0/0/40_user_short.v0.0.40_user_short(
                    adminlevel = [
                        'Not Set'
                        ], 
                    defaultaccount = '', 
