    ...
    def make_instance(self, include_optional) -> Dbv0039Diag:
        ...
        if include_optional:
            return Dbv0039Diag(
                ...
                statistics = aind_slurm_rest_v2.models.v0/0/39_stats_rec.v0.0.39_stats_rec(
                    time_start = 56, 
                    rollups = [
                    ...
                    rpcs = [
                        aind_slurm_rest_v2.models.v0/0/39_stats_rpc.v0.0.39_stats_rpc(
                            rpc = '', 
                            count = 56, 
                            time = aind_slurm_rest_v2.models.v0_0_39_stats_rpc_time.v0_0_39_stats_rpc_time(
                                average = 56, 
                                total = 56, ), )
                        ], 
                    users = [
                        aind_slurm_rest_v2.models.v0/0/39_stats_user.v0.0.39_stats_user(
                            user = '', 
                            count = 56, )
                        ], )
            )
