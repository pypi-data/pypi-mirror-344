    ...
    def make_instance(self, include_optional) -> V0040UpdateNodeMsg:
        ...
        if include_optional:
            return V0040UpdateNodeMsg(
                ...
                reason = '',
                reason_uid = '',
                resume_after = aind_slurm_rest_v2.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
                weight = aind_slurm_rest_v2.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, )
            )
