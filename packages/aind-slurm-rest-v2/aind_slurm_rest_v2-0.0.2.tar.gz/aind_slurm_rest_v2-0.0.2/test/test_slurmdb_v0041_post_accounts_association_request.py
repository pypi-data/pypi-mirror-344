    ...
    def make_instance(self, include_optional) -> SlurmdbV0041PostAccountsAssociationRequest:
        ...
        if include_optional:
            return SlurmdbV0041PostAccountsAssociationRequest(
                association_condition = aind_slurm_rest_v2.models.slurmdb_v0041_post_accounts_association_request_association_condition.slurmdb_v0041_post_accounts_association_request_association_condition(
                    accounts = [
                        ''
                        ], 
                ...
                account = aind_slurm_rest_v2.models.slurmdb_v0041_post_accounts_association_request_account.slurmdb_v0041_post_accounts_association_request_account(
                    description = '', 
                    organization = '', ),
