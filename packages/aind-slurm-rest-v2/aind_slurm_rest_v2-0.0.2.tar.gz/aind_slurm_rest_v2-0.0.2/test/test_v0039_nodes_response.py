    ...
    def make_instance(self, include_optional) -> V0039NodesResponse:
        ...
        if include_optional:
            return V0039NodesResponse(
                ...
                nodes = [
                    aind_slurm_rest_v2.models.v0/0/39_node.v0.0.39_node(
                        architecture = '', 
                        ...
                        cpu_binding = 56, 
                        cpu_load = aind_slurm_rest_v2.models.v0/0/39_uint32_no_val.v0.0.39_uint32_no_val(
                            set = True, 
                            infinite = True, 
                            number = 56, ), 
                        free_mem = aind_slurm_rest_v2.models.v0/0/39_uint64_no_val.v0.0.39_uint64_no_val(
                            set = True, 
                            infinite = True, 
                            number = 56, ), 
                        cpus = 56, 
                        effective_cpus = 56, 
                        specialized_cpus = '', 
                        energy = aind_slurm_rest_v2.models.v0/0/39_acct_gather_energy.v0.0.39_acct_gather_energy(
                            average_watts = 56, 
                            base_consumed_energy = 56, 
                            consumed_energy = 56, 
                            current_watts = aind_slurm_rest_v2.models.v0/0/39_uint32_no_val.v0.0.39_uint32_no_val(
                                set = True, 
                                infinite = True, 
                                number = 56, ), 
                            previous_consumed_energy = 56, 
                            last_collected = 56, ), 
                        external_sensors = aind_slurm_rest_v2.models.v0/0/39_ext_sensors_data.v0.0.39_ext_sensors_data(), 
                        extra = '', 
                        power = aind_slurm_rest_v2.models.v0/0/39_power_mgmt_data.v0.0.39_power_mgmt_data(), 
                        features = [
                            ''
                            ], 
                        active_features = [
                        ...
                        reason_set_by_user = '', 
                        resume_after = aind_slurm_rest_v2.models.v0/0/39_uint64_no_val.v0.0.39_uint64_no_val(
                            set = True, 
                            infinite = True, 
                            number = 56, ), 
                        reservation = '', 
