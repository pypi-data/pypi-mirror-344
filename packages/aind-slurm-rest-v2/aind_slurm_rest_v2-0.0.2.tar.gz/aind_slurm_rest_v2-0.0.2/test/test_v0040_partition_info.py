            ...
            return V0040PartitionInfo(
                ...
                maximums = aind_slurm_rest_v2.models.v0_0_40_partition_info_maximums.v0_0_40_partition_info_maximums(
                    cpus_per_node = aind_slurm_rest_v2.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                        ...
                        infinite = True, 
                        number = 56, ), 
                    cpus_per_socket = aind_slurm_rest_v2.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                        set = True, 
                        infinite = True, 
                        number = 56, ), 
                    memory_per_cpu = 56, 
                ...
                timeouts = aind_slurm_rest_v2.models.v0_0_40_partition_info_timeouts.v0_0_40_partition_info_timeouts(
                    resume = aind_slurm_rest_v2.models.v0/0/40_uint16_no_val.v0.0.40_uint16_no_val(
                        ...
                        infinite = True, 
                        number = 56, ), 
                    suspend = aind_slurm_rest_v2.models.v0/0/40_uint16_no_val.v0.0.40_uint16_no_val(
                        set = True, 
                        infinite = True, 
                        number = 56, ), ),
                ...
                suspend_time = aind_slurm_rest_v2.models.v0/0/40_uint32_no_val.v0.0.40_uint32_no_val(
                    set = True, 
                    infinite = True, 
                    number = 56, )
            )
