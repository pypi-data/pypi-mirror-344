    ...
    def make_instance(self, include_optional) -> V0041OpenapiReservationResp:
        ...
        if include_optional:
            return V0041OpenapiReservationResp(
                reservations = [
                    aind_slurm_rest_v2.models.v0_0_41_openapi_reservation_resp_reservations_inner.v0_0_41_openapi_reservation_resp_reservations_inner(
                        accounts = '', 
                        burst_buffer = '', 
                        core_count = 56, 
                ...
                last_update = aind_slurm_rest_v2.models.v0_0_41_openapi_reservation_resp_last_update.v0_0_41_openapi_reservation_resp_last_update(
                    set = True, 
                    infinite = True, 
                    number = 56, ),
