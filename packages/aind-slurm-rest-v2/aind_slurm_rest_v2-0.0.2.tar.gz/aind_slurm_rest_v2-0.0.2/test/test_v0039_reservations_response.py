    ...
    def make_instance(self, include_optional) -> V0039ReservationsResponse:
        ...
        if include_optional:
            return V0039ReservationsResponse(
                ...
                reservations = [
                    aind_slurm_rest_v2.models.v0/0/39_reservation_info.v0.0.39_reservation_info(
                        accounts = '', 
                        burst_buffer = '', 
                        core_count = 56, 
                        core_specializations = [
                            aind_slurm_rest_v2.models.v0/0/39_reservation_core_spec.v0.0.39_reservation_core_spec(
                                node = '', 
                                core = '', )
                            ], 
                        end_time = 56, 
                        ...
                        node_list = '', 
                        partition = '', 
                        purge_completed = aind_slurm_rest_v2.models.v0_0_39_reservation_info_purge_completed.v0_0_39_reservation_info_purge_completed(
                            time = aind_slurm_rest_v2.models.v0/0/39_uint32_no_val.v0.0.39_uint32_no_val(
                                set = True, 
                                infinite = True, 
                                number = 56, ), ), 
                        start_time = 56, 
                        watts = aind_slurm_rest_v2.models.v0/0/39_uint32_no_val.v0.0.39_uint32_no_val(
                            set = True, 
                            infinite = True, 
                            number = 56, ), 
                        tres = '', 
