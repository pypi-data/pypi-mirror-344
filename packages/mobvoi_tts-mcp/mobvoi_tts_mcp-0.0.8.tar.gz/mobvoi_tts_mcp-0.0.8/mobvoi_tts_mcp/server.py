...
print(f"mobvoi_tts-mcp version1: {mobvoi_tts_mcp.__version__}")
print(f"mobvoi_tts-mcp version2: {mobvoi_tts_mcp.__version__}")
print(f"mobvoi_tts-mcp version3: {mobvoi_tts_mcp.__version__}")
...
def main():
    ...
    print("Starting MCP server: 0.0.7")
    """Run the MCP server"""
    mcp.run()
