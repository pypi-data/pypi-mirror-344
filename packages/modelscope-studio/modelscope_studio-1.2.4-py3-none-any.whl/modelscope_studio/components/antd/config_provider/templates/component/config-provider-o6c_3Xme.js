import { i as vt, a as de, r as xt, w as L, g as St, b as jt, c as Be, d as Ct } from "./Index-DLHiPW3-.js";
...
const tn = /* @__PURE__ */ Be(Pt), rn = /* @__PURE__ */ He({
  ...
  ar_EG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ar_EG-BDYlGXj2.js").then((e) => e.a), import("./ar-C529YRrv.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "ar"
    };
  ...
  az_AZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./az_AZ-C0yRna2R.js").then((e) => e.a), import("./az-C6DWVc5S.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "az"
    };
  ...
  bg_BG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bg_BG-CXr4M5Up.js").then((e) => e.b), import("./bg-C24qvShO.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bg"
    };
  ...
  bn_BD: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bn_BD-Bfdezy53.js").then((e) => e.b), import("./bn-gwvOx2Ek.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bn"
    };
  ...
  by_BY: async () => {
    const [{
      ...
      import("./by_BY-BphepITW.js").then((e) => e.b),
      import("./be-xRthvgwj.js").then((e) => e.b)
      // Belarusian (Belarus)
    ]);
    return {
      antd: t,
  ...
  ca_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ca_ES-N0VHCBkk.js").then((e) => e.c), import("./ca-DZmKiUtg.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "ca"
    };
  ...
  cs_CZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./cs_CZ-0YBQ8fsk.js").then((e) => e.c), import("./cs-D2XcbNI-.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "cs"
    };
  ...
  da_DK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./da_DK-DImKVYe8.js").then((e) => e.d), import("./da-DhJZBh_Q.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "da"
    };
  ...
  de_DE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./de_DE-CBtIRT-P.js").then((e) => e.d), import("./de-Bv-xACZA.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "de"
    };
  ...
  el_GR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./el_GR-8YMHSSky.js").then((e) => e.e), import("./el-CJQhg_AI.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "el"
    };
  ...
  en_GB: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./en_GB-B2tDilGM.js").then((e) => e.e), import("./en-gb-pPJceM0P.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "en-gb"
    };
  ...
  es_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./es_ES-D2seFSUh.js").then((e) => e.e), import("./es-W_Fj8X9m.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "es"
    };
  ...
  et_EE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./et_EE-D7uWhtC0.js").then((e) => e.e), import("./et-e-uNkwfr.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "et"
    };
  ...
  eu_ES: async () => {
    const [{
      ...
      import("./eu_ES-CVM1NZ2e.js").then((e) => e.e),
      import("./eu-CVDZsSWU.js").then((e) => e.e)
      // Basque
    ]);
    return {
      antd: t,
  ...
  fa_IR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fa_IR-CyQP9Wsw.js").then((e) => e.f), import("./fa-6kkbxJEr.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fa"
    };
  ...
  fi_FI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fi_FI-ugE9HN6g.js").then((e) => e.f), import("./fi-xaKR0b7B.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fi"
    };
  ...
  fr_BE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_BE-DfStj8AB.js").then((e) => e.f), import("./fr-B8feA5zB.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  fr_CA: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_CA-BnlIIWPq.js").then((e) => e.f), import("./fr-ca-Dv4FVOQl.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr-ca"
    };
  ...
  fr_FR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_FR-CVC9VCKT.js").then((e) => e.f), import("./fr-B8feA5zB.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  ga_IE: async () => {
    const [{
      ...
      import("./ga_IE-U2XgiBO5.js").then((e) => e.g),
      import("./ga-C526Fte1.js").then((e) => e.g)
      // Irish
    ]);
    return {
      antd: t,
  ...
  gl_ES: async () => {
    const [{
      ...
      import("./gl_ES-Byc3bAmr.js").then((e) => e.g),
      import("./gl-Dqu2dF6z.js").then((e) => e.g)
      // Galician
    ]);
    return {
      antd: t,
  ...
  he_IL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./he_IL-DXz6I84R.js").then((e) => e.h), import("./he-BDVz-BX1.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "he"
    };
  ...
  hi_IN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hi_IN-BJ1sBsnh.js").then((e) => e.h), import("./hi-C6C_bZ3n.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hi"
    };
  ...
  hr_HR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hr_HR-C0pkTVQ1.js").then((e) => e.h), import("./hr-oRXzB1fM.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hr"
    };
  ...
  hu_HU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hu_HU-DANz72Wt.js").then((e) => e.h), import("./hu-DF5OEXSm.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hu"
    };
  ...
  hy_AM: async () => {
    const [{
      ...
      import("./hy_AM-Bnjhnnpg.js").then((e) => e.h),
      import("./am-BUAdThKX.js").then((e) => e.a)
      // Armenian
    ]);
    return {
      antd: t,
  ...
  id_ID: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./id_ID-pSZt6pTX.js").then((e) => e.i), import("./id-M_uhWJLC.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "id"
    };
  ...
  is_IS: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./is_IS-DjpDxoff.js").then((e) => e.i), import("./is-DJKY4yhL.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "is"
    };
  ...
  it_IT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./it_IT-sUGHbRAP.js").then((e) => e.i), import("./it-BC3zlPAA.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "it"
    };
  ...
  ja_JP: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ja_JP-Bn6Sz3ry.js").then((e) => e.j), import("./ja-B0PsAyx6.js").then((e) => e.j)]);
    return {
      antd: t,
      dayjs: "ja"
    };
  ...
  ka_GE: async () => {
    const [{
      ...
      import("./ka_GE-Cvij5MAr.js").then((e) => e.k),
      import("./ka-B9NfUn_G.js").then((e) => e.k)
      // Georgian
    ]);
    return {
      antd: t,
  ...
  kk_KZ: async () => {
    const [{
      ...
      import("./kk_KZ-CD2IV6oc.js").then((e) => e.k),
      import("./kk-DLaagEna.js").then((e) => e.k)
      // Kazakh
    ]);
    return {
      antd: t,
  ...
  km_KH: async () => {
    const [{
      ...
      import("./km_KH-Cu5AmcOh.js").then((e) => e.k),
      import("./km-jgeqUSPl.js").then((e) => e.k)
      // Khmer
    ]);
    return {
      antd: t,
  ...
  kmr_IQ: async () => {
    const [t] = await Promise.all([
      import("./kmr_IQ-Bk56GUA3.js").then((e) => e.k)
  ...
  kn_IN: async () => {
    const [{
      ...
      import("./kn_IN-CQtlxmcj.js").then((e) => e.k),
      import("./kn-DrpXXZfS.js").then((e) => e.k)
      // Kannada
    ]);
    return {
      antd: t,
  ...
  ko_KR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ko_KR-C0_9dn3q.js").then((e) => e.k), import("./ko-CAF7ndEo.js").then((e) => e.k)]);
    return {
      antd: t,
      dayjs: "ko"
    };
  ...
  ku_IQ: async () => {
    const [{
      ...
      import("./ku_IQ-BVj6ltt1.js").then((e) => e.k),
      import("./ku-C8INMLRW.js").then((e) => e.k)
      // Kurdish (Central)
    ]);
    return {
      antd: t,
  ...
  lt_LT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lt_LT-CEZl0bVM.js").then((e) => e.l), import("./lt-qMtDCwFf.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lt"
    };
  ...
  lv_LV: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lv_LV-dFEbe00F.js").then((e) => e.l), import("./lv-CvowMrfG.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lv"
    };
  ...
  mk_MK: async () => {
    const [{
      ...
      import("./mk_MK-CsiHqa_A.js").then((e) => e.m),
      import("./mk-DKEaxjsv.js").then((e) => e.m)
      // Macedonian
    ]);
    return {
      antd: t,
  ...
  ml_IN: async () => {
    const [{
      ...
      import("./ml_IN-BQVvQSnD.js").then((e) => e.m),
      import("./ml-Ppgn76Yh.js").then((e) => e.m)
      // Malayalam
    ]);
    return {
      antd: t,
  ...
  mn_MN: async () => {
    const [{
      ...
      import("./mn_MN-OpzhMP0f.js").then((e) => e.m),
      import("./mn-BPAAVsal.js").then((e) => e.m)
      // Mongolian
    ]);
    return {
      antd: t,
  ...
  ms_MY: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ms_MY-CNC3wPHY.js").then((e) => e.m), import("./ms-DurwxF6t.js").then((e) => e.m)]);
    return {
      antd: t,
      dayjs: "ms"
    };
  ...
  my_MM: async () => {
    const [{
      ...
      import("./my_MM-Dt9tHDp8.js").then((e) => e.m),
      import("./my-CqPapAfn.js").then((e) => e.m)
      // Burmese
    ]);
    return {
      antd: t,
  ...
  nb_NO: async () => {
    const [{
      ...
      import("./nb_NO-D09yTmKr.js").then((e) => e.n),
      import("./nb-B8jJJmPk.js").then((e) => e.n)
      // Norwegian Bokmål
    ]);
    return {
      antd: t,
  ...
  ne_NP: async () => {
    const [{
      ...
      import("./ne_NP-DIlJyQYm.js").then((e) => e.n),
      import("./ne-CjkHJuXp.js").then((e) => e.n)
      // Nepali
    ]);
    return {
      antd: t,
  ...
  nl_BE: async () => {
    const [{
      ...
      import("./nl_BE-Yr4I_b2x.js").then((e) => e.n),
      import("./nl-be-B-oFdJak.js").then((e) => e.n)
      // Dutch (Belgium)
    ]);
    return {
      antd: t,
  ...
  nl_NL: async () => {
    const [{
      ...
      import("./nl_NL-ZbkukxQ9.js").then((e) => e.n),
      import("./nl-CCDpJiyb.js").then((e) => e.n)
      // Dutch (Netherlands)
    ]);
    return {
      antd: t,
  ...
  pl_PL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./pl_PL-wol8S8rU.js").then((e) => e.p), import("./pl-NW1TZzNm.js").then((e) => e.p)]);
    return {
      antd: t,
      dayjs: "pl"
    };
  ...
  pt_BR: async () => {
    const [{
      ...
      import("./pt_BR-DA5UID_O.js").then((e) => e.p),
      import("./pt-br-DHy13ANP.js").then((e) => e.p)
      // Portuguese (Brazil)
    ]);
    return {
      antd: t,
  ...
  pt_PT: async () => {
    const [{
      ...
      import("./pt_PT-Cdw-cv5u.js").then((e) => e.p),
      import("./pt-CGh5N1FA.js").then((e) => e.p)
      // Portuguese (Portugal)
    ]);
    return {
      antd: t,
  ...
  ro_RO: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ro_RO-BCj0eaAK.js").then((e) => e.r), import("./ro-B85gmLxb.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ro"
    };
  ...
  ru_RU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ru_RU-7KLRBJGE.js").then((e) => e.r), import("./ru-DrrZ1How.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ru"
    };
  ...
  si_LK: async () => {
    const [{
      ...
      import("./si_LK-xzRuRRtY.js").then((e) => e.s),
      import("./si-D0Cjaz1v.js").then((e) => e.s)
      // Sinhala
    ]);
    return {
      antd: t,
  ...
  sk_SK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sk_SK-BJi4vnK2.js").then((e) => e.s), import("./sk-2n6kYYaf.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sk"
    };
  ...
  sl_SI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sl_SI-CNnLsTS3.js").then((e) => e.s), import("./sl-b9v2LvN2.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sl"
    };
  ...
  sr_RS: async () => {
    const [{
      ...
      import("./sr_RS-Dq4qxyjD.js").then((e) => e.s),
      import("./sr-Cb9EAuq-.js").then((e) => e.s)
      // Serbian
    ]);
    return {
      antd: t,
  ...
  sv_SE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sv_SE-BUEqlCvI.js").then((e) => e.s), import("./sv-D2zLobM7.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sv"
    };
  ...
  ta_IN: async () => {
    const [{
      ...
      import("./ta_IN-a4c4H06u.js").then((e) => e.t),
      import("./ta-BtESwnv0.js").then((e) => e.t)
      // Tamil
    ]);
    return {
      antd: t,
  ...
  th_TH: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./th_TH-DYS-xEps.js").then((e) => e.t), import("./th-16gz5zb1.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "th"
    };
  ...
  tk_TK: async () => {
    const [{
      ...
      import("./tk_TK-BIUEbEqI.js").then((e) => e.t),
      import("./tk-6zYxM5SA.js").then((e) => e.t)
      // Turkmen
    ]);
    return {
      antd: t,
  ...
  tr_TR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./tr_TR-Vtf3h0pr.js").then((e) => e.t), import("./tr-Bcn3us-E.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "tr"
    };
  ...
  uk_UA: async () => {
    const [{
      ...
      import("./uk_UA-ILANrEEy.js").then((e) => e.u),
      import("./uk-oyGWKlE-.js").then((e) => e.u)
      // Ukrainian
    ]);
    return {
      antd: t,
  ...
  ur_PK: async () => {
    const [{
      ...
      import("./ur_PK-CInFeSBh.js").then((e) => e.u),
      import("./ur-CtWsnnKT.js").then((e) => e.u)
      // Urdu
    ]);
    return {
      antd: t,
  ...
  uz_UZ: async () => {
    const [{
      ...
      import("./uz_UZ-_i0_byPR.js").then((e) => e.u),
      import("./uz-BMG0rfAu.js").then((e) => e.u)
      // Uzbek
    ]);
    return {
      antd: t,
  ...
  vi_VN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./vi_VN-BESfBFK4.js").then((e) => e.v), import("./vi-ckp0fj0R.js").then((e) => e.v)]);
    return {
      antd: t,
      dayjs: "vi"
    };
  ...
  zh_CN: async () => {
    const [{
      ...
      import("./zh_CN-E06yk8KQ.js").then((e) => e.z),
      import("./zh-cn-Qfplxm-O.js").then((e) => e.z)
      // Chinese (Simplified)
    ]);
    return {
      antd: t,
  ...
  zh_HK: async () => {
    const [{
      ...
      import("./zh_HK-BAYwLQte.js").then((e) => e.z),
      import("./zh-hk-C6GE8bFX.js").then((e) => e.z)
      // Chinese (Hong Kong)
    ]);
    return {
      antd: t,
  ...
  zh_TW: async () => {
    const [{
      ...
      import("./zh_TW-BqZVJ6pC.js").then((e) => e.z),
      import("./zh-tw-BdTEAVfn.js").then((e) => e.z)
      // Chinese (Taiwan)
    ]);
    return {
      antd: t,
