import { w as L, g as vt, a as Be, c as xt } from "./XProvider-DNBNaIwG.js";
import { a as Ct, b as de, r as kt, c as Et } from "./Index-vNmTKWbV.js";
...
const tn = /* @__PURE__ */ Be(Pt), rn = /* @__PURE__ */ He({
  ...
  ar_EG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ar_EG-CmPlt9yx.js").then((e) => e.a), import("./ar-BDitlfXr.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "ar"
    };
  ...
  az_AZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./az_AZ-Bpo-y0Zk.js").then((e) => e.a), import("./az-DWvITetz.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "az"
    };
  ...
  bg_BG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bg_BG-ChEW8Obo.js").then((e) => e.b), import("./bg-ncfXJeBh.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bg"
    };
  ...
  bn_BD: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bn_BD-BO5SaQTN.js").then((e) => e.b), import("./bn-Bi0nPUTr.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bn"
    };
  ...
  by_BY: async () => {
    const [{
      ...
      import("./by_BY-CS9rGd2x.js").then((e) => e.b),
      import("./be-Cd5cvjd2.js").then((e) => e.b)
      // Belarusian (Belarus)
    ]);
    return {
      antd: t,
  ...
  ca_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ca_ES-DcD5YebO.js").then((e) => e.c), import("./ca-DsoRieOd.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "ca"
    };
  ...
  cs_CZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./cs_CZ-BjuDqsWd.js").then((e) => e.c), import("./cs-D4VisOJn.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "cs"
    };
  ...
  da_DK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./da_DK-BDiPRdNi.js").then((e) => e.d), import("./da-ngI5vcHd.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "da"
    };
  ...
  de_DE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./de_DE-DppxroDz.js").then((e) => e.d), import("./de-3B9uOouk.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "de"
    };
  ...
  el_GR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./el_GR-CeJodjNn.js").then((e) => e.e), import("./el-9WpK2dTM.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "el"
    };
  ...
  en_GB: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./en_GB-DGNbh6-a.js").then((e) => e.e), import("./en-gb-CERWGmsT.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "en-gb"
    };
  ...
  es_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./es_ES-s3p_1Aov.js").then((e) => e.e), import("./es-CeynDX2X.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "es"
    };
  ...
  et_EE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./et_EE-23pDQsos.js").then((e) => e.e), import("./et-DXNMvjwp.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "et"
    };
  ...
  eu_ES: async () => {
    const [{
      ...
      import("./eu_ES-CVD8ioFp.js").then((e) => e.e),
      import("./eu-BPqjRpsG.js").then((e) => e.e)
      // Basque
    ]);
    return {
      antd: t,
  ...
  fa_IR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fa_IR-1_4IRflz.js").then((e) => e.f), import("./fa-COlJJhSA.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fa"
    };
  ...
  fi_FI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fi_FI-DP25m_Ad.js").then((e) => e.f), import("./fi-BxMET5qp.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fi"
    };
  ...
  fr_BE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_BE-Dlf7d4Qh.js").then((e) => e.f), import("./fr-BolOLqtc.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  fr_CA: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_CA-DPUjEPVr.js").then((e) => e.f), import("./fr-ca-BxLttk7M.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr-ca"
    };
  ...
  fr_FR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_FR-CYF2zn27.js").then((e) => e.f), import("./fr-BolOLqtc.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  ga_IE: async () => {
    const [{
      ...
      import("./ga_IE-C_taYIfN.js").then((e) => e.g),
      import("./ga-DxVfbwto.js").then((e) => e.g)
      // Irish
    ]);
    return {
      antd: t,
  ...
  gl_ES: async () => {
    const [{
      ...
      import("./gl_ES-BQNNhwCW.js").then((e) => e.g),
      import("./gl-VvH74grE.js").then((e) => e.g)
      // Galician
    ]);
    return {
      antd: t,
  ...
  he_IL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./he_IL-BonHJeoy.js").then((e) => e.h), import("./he-CtaQ_KSL.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "he"
    };
  ...
  hi_IN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hi_IN-B5BnwT0t.js").then((e) => e.h), import("./hi-BEa0c-fg.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hi"
    };
  ...
  hr_HR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hr_HR-DpnQLOJ6.js").then((e) => e.h), import("./hr-k6On7hAo.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hr"
    };
  ...
  hu_HU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hu_HU-Mw8gZDo_.js").then((e) => e.h), import("./hu-BVnveiw2.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hu"
    };
  ...
  hy_AM: async () => {
    const [{
      ...
      import("./hy_AM-DCXmU6Vp.js").then((e) => e.h),
      import("./am-h7_IKWwC.js").then((e) => e.a)
      // Armenian
    ]);
    return {
      antd: t,
  ...
  id_ID: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./id_ID-DL3Artp4.js").then((e) => e.i), import("./id-srQvp7Ye.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "id"
    };
  ...
  is_IS: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./is_IS-BylsuYsp.js").then((e) => e.i), import("./is-D3YYCm_u.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "is"
    };
  ...
  it_IT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./it_IT-P-x2tf9Z.js").then((e) => e.i), import("./it-DLSxS60z.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "it"
    };
  ...
  ja_JP: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ja_JP-BBwkEpzJ.js").then((e) => e.j), import("./ja-FEL0bnjt.js").then((e) => e.j)]);
    return {
      antd: t,
      dayjs: "ja"
    };
  ...
  ka_GE: async () => {
    const [{
      ...
      import("./ka_GE-CmnWILSh.js").then((e) => e.k),
      import("./ka-Bl4WztYo.js").then((e) => e.k)
      // Georgian
    ]);
    return {
      antd: t,
  ...
  kk_KZ: async () => {
    const [{
      ...
      import("./kk_KZ-0kY5SUXJ.js").then((e) => e.k),
      import("./kk-D1nAEb0j.js").then((e) => e.k)
      // Kazakh
    ]);
    return {
      antd: t,
  ...
  km_KH: async () => {
    const [{
      ...
      import("./km_KH-BR1tdpC1.js").then((e) => e.k),
      import("./km-BmuxehG8.js").then((e) => e.k)
      // Khmer
    ]);
    return {
      antd: t,
  ...
  kmr_IQ: async () => {
    const [t] = await Promise.all([
      import("./kmr_IQ-BU84M-Ki.js").then((e) => e.k)
  ...
  kn_IN: async () => {
    const [{
      ...
      import("./kn_IN-BtMd9wss.js").then((e) => e.k),
      import("./kn-DwX6eR7l.js").then((e) => e.k)
      // Kannada
    ]);
    return {
      antd: t,
  ...
  ko_KR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ko_KR-C-fWIIQ7.js").then((e) => e.k), import("./ko-DZt2OMbn.js").then((e) => e.k)]);
    return {
      antd: t,
      dayjs: "ko"
    };
  ...
  ku_IQ: async () => {
    const [{
      ...
      import("./ku_IQ-BqYzw9rK.js").then((e) => e.k),
      import("./ku-ByX5XHSZ.js").then((e) => e.k)
      // Kurdish (Central)
    ]);
    return {
      antd: t,
  ...
  lt_LT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lt_LT-D5TWj5N6.js").then((e) => e.l), import("./lt-rmhjI9uD.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lt"
    };
  ...
  lv_LV: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lv_LV-CQlxQc90.js").then((e) => e.l), import("./lv-D2ycabWz.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lv"
    };
  ...
  mk_MK: async () => {
    const [{
      ...
      import("./mk_MK-Di0I7M1N.js").then((e) => e.m),
      import("./mk-4FyIzf2Y.js").then((e) => e.m)
      // Macedonian
    ]);
    return {
      antd: t,
  ...
  ml_IN: async () => {
    const [{
      ...
      import("./ml_IN-C_5mPO-4.js").then((e) => e.m),
      import("./ml-2R3RrkCN.js").then((e) => e.m)
      // Malayalam
    ]);
    return {
      antd: t,
  ...
  mn_MN: async () => {
    const [{
      ...
      import("./mn_MN-CQ42BVrn.js").then((e) => e.m),
      import("./mn-Bi6n_mdz.js").then((e) => e.m)
      // Mongolian
    ]);
    return {
      antd: t,
  ...
  ms_MY: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ms_MY-BbBVUflv.js").then((e) => e.m), import("./ms-zGqzkrf4.js").then((e) => e.m)]);
    return {
      antd: t,
      dayjs: "ms"
    };
  ...
  my_MM: async () => {
    const [{
      ...
      import("./my_MM-CRzh2Rgs.js").then((e) => e.m),
      import("./my-p2f1LsY9.js").then((e) => e.m)
      // Burmese
    ]);
    return {
      antd: t,
  ...
  nb_NO: async () => {
    const [{
      ...
      import("./nb_NO-BgahbbjI.js").then((e) => e.n),
      import("./nb-9p-pJ7L-.js").then((e) => e.n)
      // Norwegian Bokmål
    ]);
    return {
      antd: t,
  ...
  ne_NP: async () => {
    const [{
      ...
      import("./ne_NP-C2-L21dR.js").then((e) => e.n),
      import("./ne-DgxJTD49.js").then((e) => e.n)
      // Nepali
    ]);
    return {
      antd: t,
  ...
  nl_BE: async () => {
    const [{
      ...
      import("./nl_BE-BEIMdhy1.js").then((e) => e.n),
      import("./nl-be-DAtlLubp.js").then((e) => e.n)
      // Dutch (Belgium)
    ]);
    return {
      antd: t,
  ...
  nl_NL: async () => {
    const [{
      ...
      import("./nl_NL-cSzu5Q50.js").then((e) => e.n),
      import("./nl-C8EJw682.js").then((e) => e.n)
      // Dutch (Netherlands)
    ]);
    return {
      antd: t,
  ...
  pl_PL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./pl_PL-BcmqB0rO.js").then((e) => e.p), import("./pl-D0JO8qmM.js").then((e) => e.p)]);
    return {
      antd: t,
      dayjs: "pl"
    };
  ...
  pt_BR: async () => {
    const [{
      ...
      import("./pt_BR-DugWPeur.js").then((e) => e.p),
      import("./pt-br-A00bSMiO.js").then((e) => e.p)
      // Portuguese (Brazil)
    ]);
    return {
      antd: t,
  ...
  pt_PT: async () => {
    const [{
      ...
      import("./pt_PT-Zww3GF--.js").then((e) => e.p),
      import("./pt-D25eKg5s.js").then((e) => e.p)
      // Portuguese (Portugal)
    ]);
    return {
      antd: t,
  ...
  ro_RO: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ro_RO-DjbZFABf.js").then((e) => e.r), import("./ro-CHLYdOPM.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ro"
    };
  ...
  ru_RU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ru_RU-DC-xdsjQ.js").then((e) => e.r), import("./ru-CI8bgawX.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ru"
    };
  ...
  si_LK: async () => {
    const [{
      ...
      import("./si_LK-CKHGNHrS.js").then((e) => e.s),
      import("./si-Bqir9mFm.js").then((e) => e.s)
      // Sinhala
    ]);
    return {
      antd: t,
  ...
  sk_SK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sk_SK-Cs9SdESI.js").then((e) => e.s), import("./sk-B6l5VkAh.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sk"
    };
  ...
  sl_SI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sl_SI-A6ZCUiWS.js").then((e) => e.s), import("./sl-CMgfvIUT.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sl"
    };
  ...
  sr_RS: async () => {
    const [{
      ...
      import("./sr_RS-Dq9FglDX.js").then((e) => e.s),
      import("./sr-D2soHOhh.js").then((e) => e.s)
      // Serbian
    ]);
    return {
      antd: t,
  ...
  sv_SE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sv_SE-0MAEF5sa.js").then((e) => e.s), import("./sv-m0Q_U12_.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sv"
    };
  ...
  ta_IN: async () => {
    const [{
      ...
      import("./ta_IN-CTocPEmx.js").then((e) => e.t),
      import("./ta-CN5MOULL.js").then((e) => e.t)
      // Tamil
    ]);
    return {
      antd: t,
  ...
  th_TH: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./th_TH-CTMwCT6e.js").then((e) => e.t), import("./th-DyDqqZdT.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "th"
    };
  ...
  tk_TK: async () => {
    const [{
      ...
      import("./tk_TK-bc_gasfQ.js").then((e) => e.t),
      import("./tk-DvG3ibSn.js").then((e) => e.t)
      // Turkmen
    ]);
    return {
      antd: t,
  ...
  tr_TR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./tr_TR-D05QRXWK.js").then((e) => e.t), import("./tr-Dcm1Zryk.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "tr"
    };
  ...
  uk_UA: async () => {
    const [{
      ...
      import("./uk_UA-Cneti49z.js").then((e) => e.u),
      import("./uk-BopEpe8Z.js").then((e) => e.u)
      // Ukrainian
    ]);
    return {
      antd: t,
  ...
  ur_PK: async () => {
    const [{
      ...
      import("./ur_PK-DsZ14rWi.js").then((e) => e.u),
      import("./ur-CgNoWfkG.js").then((e) => e.u)
      // Urdu
    ]);
    return {
      antd: t,
  ...
  uz_UZ: async () => {
    const [{
      ...
      import("./uz_UZ-fQWtu-3w.js").then((e) => e.u),
      import("./uz-BbNTBdoL.js").then((e) => e.u)
      // Uzbek
    ]);
    return {
      antd: t,
  ...
  vi_VN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./vi_VN-Bp3BFKIx.js").then((e) => e.v), import("./vi-DnGL-K9d.js").then((e) => e.v)]);
    return {
      antd: t,
      dayjs: "vi"
    };
  ...
  zh_CN: async () => {
    const [{
      ...
      import("./zh_CN-CS9z4G1O.js").then((e) => e.z),
      import("./zh-cn-DcnX9dgG.js").then((e) => e.z)
      // Chinese (Simplified)
    ]);
    return {
      antd: t,
  ...
  zh_HK: async () => {
    const [{
      ...
      import("./zh_HK-4Zj1mwxv.js").then((e) => e.z),
      import("./zh-hk-Db0SvWAT.js").then((e) => e.z)
      // Chinese (Hong Kong)
    ]);
    return {
      antd: t,
  ...
  zh_TW: async () => {
    const [{
      ...
      import("./zh_TW-DEex07wp.js").then((e) => e.z),
      import("./zh-tw-CXRbDlhd.js").then((e) => e.z)
      // Chinese (Taiwan)
    ]);
    return {
      antd: t,
