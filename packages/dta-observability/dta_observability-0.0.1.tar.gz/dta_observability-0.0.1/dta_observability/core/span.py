        ...
        if is_coroutine:
            ...
            async def async_wrapper(*args: Any, **kwargs: Any) -> Any:
                ...
                span_attributes.update(
                    {SpanAttribute.FUNCTION_NAME: func.__name__, SpanAttribute.FUNCTION_MODULE: func.__module__}
                )
...
class Tracer:
    ...
    def start_span(
        ...
        actual_kind = kind if kind is not None else trace.SpanKind.INTERNAL
        return self._tracer.start_span(name, attributes=attributes, kind=actual_kind)
    ...
    def start_as_current_span(
        ...
        actual_kind = kind if kind is not None else trace.SpanKind.INTERNAL
        return self._tracer.start_as_current_span(name, attributes=attributes, kind=actual_kind)
...
def create_span(name: str, kind: Optional[trace.SpanKind] = None, attributes: Optional[Dict[str, str]] = None) -> Any:
    """
    ...
    actual_kind = kind if kind is not None else trace.SpanKind.INTERNAL
    return tracer.start_as_current_span(name, kind=actual_kind, attributes=attributes)
