...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="vidot is a fork of xdot.py an interactive viewer for graphs written in Graphviz's dot language, with enhanced url handling and other such features.",
