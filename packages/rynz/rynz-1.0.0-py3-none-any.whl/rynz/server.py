...
def server(port=5555):
    try:
        ...
        console.print(f"\n[bold green]✅ Rynz server is live![/bold green]")
        ...
        console.print(f"  1. [yellow]Not a valid Rynz directory[/yellow] - Ensure you are in the correct directory where your site was generated.")
        console.print(f"  2. [yellow]Project not built yet[/yellow] - Make sure to run the build process before starting the server. You can use [bold]rynz build[/bold] to generate the site.")
        console.print(f"\n[dim]Debug Info: {e}[/dim]")
        sys.exit(1)

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Start a local server to serve your Rynz site.")
