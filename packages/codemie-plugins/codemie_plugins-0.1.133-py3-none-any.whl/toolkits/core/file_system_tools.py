...
from codemie.langchain.services import format_tool_output, format_tool_content
from toolkits.core.tools_vars import READ_FILE_TOOL, LIST_DIRECTORY_TOOL, WRITE_FILE_TOOL, \
    COMMAND_LINE_TOOL
    ...
    def _run(self, command: str, *args, **kwargs) -> Any:
        ...
        if error:
            ...
            if result.returncode != 0:
                ...
                logger.info(format_tool_output(self.name, result.stdout))
