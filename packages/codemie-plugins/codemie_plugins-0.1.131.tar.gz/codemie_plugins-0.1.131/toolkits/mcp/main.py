...
CONFIG_FILE_WINDOWS = "servers-win.json"
CONFIG_FILE_UNIX = "servers.json"
...
class ConfigurationManager:
    ...
    def _get_server_config_path() -> str:
        """Determine the server configuration file path based on the operating system."""

        return CONFIG_FILE_WINDOWS if os.name == "nt" else CONFIG_FILE_UNIX
