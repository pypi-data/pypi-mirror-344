...
def get_help_text(lang='zh'):
    ...
    if lang == 'zh':
        return {
            'prog': 'Tabular Tool Kit',
            'description': '''
            Tabular Tool Kit - 高性能表格数据处理工具
            功能说明:
        ...
        return {
            'prog': 'Tabular Tool Kit',
            'description': '''
            Tabular Tool Kit - High-performance Table Data Processing Tool
            Features:
            ...
            'input_format': 'Input file format (csv/xlsx)',
            'output_dir': 'Output directory path',
            'output_format': 'Output file format (csv/xlsx)',
