...
class Model:
    ...
    Attributes:
        ...
        model_instance (Union[ChatOpenAI, ChatAnthropic, ChatMistralAI, ChatFireworks, ChatGoogleGenerativeAI, ChatXAI]):
    ...
    def initialize_model(self: Self) -> Union[
        ...
        Returns:
            Union[ChatOpenAI, ChatAnthropic, ChatMistralAI, ChatFireworks, ChatGoogleGenerativeAI, ChatXAI]:
