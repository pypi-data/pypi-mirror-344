...
def run_server(
    ...
    upload_title2 = "Checkpoint(zip)",
    upload_filename2 = "checkpoint.zip",
    extract_to = "raw_data",
    extract_to2 = "raw_data2",
    ...
    # ファイルアップローダ
    c.enable_file_uploader(upload_dir, {upload_title: upload_filename, upload_title2: upload_filename2  })
    c.register_functions(
        [
            ...
            JsonApiFunc(
                ...
                display_name="unzip2",
                method="GET",
                path="/functions_unzip2",
                func=functools.partial(unzip, port=port, zip_path=f"{upload_dir}/{upload_filename2}", extract_to=extract_to2),
            ),
            JsonApiFunc(
                id="json_save",
                type="progress",
...
def wrapped_run_server(
    ...
    """
    run_server(port=port, allow_origins=allow_origins, colab=colab, upload_dir=upload_dir, upload_title=upload_title, upload_filename=upload_filename, upload_title2=upload_title2, upload_filename2=upload_filename2, extract_to=extract_to, extract_to2=extract_to2, config_path=config_path)
