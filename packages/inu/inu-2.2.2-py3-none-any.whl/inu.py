...
class waypoints:
    def __init__(self, points, seg_len=1.0, radius_min=10.0,
...
def path_grid(seg_len, spacing=300.0, length=1600.0, rows=6):
    ...
    seg_len : float
        ...
        concatenation of the Bezier curves. This length should be equal to the
        product of velocity and the sampling period.
