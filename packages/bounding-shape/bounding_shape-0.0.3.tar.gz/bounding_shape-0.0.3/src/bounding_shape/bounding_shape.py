...
def get_grid_spacing_for_points(points: MultiPoint, magnitude: int | None = None) -> int:
    ...
    area_of_point_in_grid = total_area / magnitude
    grid_spacing = math.sqrt(area_of_point_in_grid)
    return grid_spacing
