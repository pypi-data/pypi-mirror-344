...
def get_trace_context()->TraceContext:
	try:return getattr(thread_local_tracing,'trace_context',_A)or TraceContext()
...
def get_request_context()->RequestContext|_A:A=_get_request_context_stack();return A[-1]if A else _A