...
class ProjectDB:
    def __init__(self, base_dir="./local-db"):
        ...
        print(f"Database directory set to: {self.base_dir}")  # Debug statement
    ...
    def _init_experiments_table(self):
        ...
        if not experiments_path.exists():
            ...
            print("experiments.parquet already exists.")  # Debug statement
    ...
    def _init_prompts_table(self):
        ...
        if not prompts_path.exists():
            ...
            print("prompts.parquet already exists.")  # Debug statement
    ...
    def _init_datasets_table(self):
        ...
        if not datasets_path.exists():
            ...
            print("datasets.parquet already exists.")  # Debug statement
    ...
    def _init_projects_table(self):
        ...
        if not projects_path.exists():
            ...
            print("projects.parquet already exists.")  # Debug statement
    ...
    def _init_glossary_table(self):
        ...
        if not glossary_path.exists():
            ...
            print("glossary.parquet already exists.")  # Debug statement

    def _init_refset_table(self):
        """Initialize the refset table if it doesn't exist"""
        refset_path = self.base_dir / "refset.parquet"
        
        if not refset_path.exists():
            print("Creating refset.parquet...")  # Debug statement
            # Create empty refset table with schema
            df = pd.DataFrame({
                'project_id': [],  # Ties to specific project
                'input': [],  # Question
                'output': []  # SQL pairs
            })
            df.to_parquet(refset_path, index=False)
        else:
            print("refset.parquet already exists.")  # Debug statement
    ...
    def _init_evalset_table(self):
        ...
        if not evalset_path.exists():
            ...
            print("evalset.parquet already exists.")  # Debug statement
