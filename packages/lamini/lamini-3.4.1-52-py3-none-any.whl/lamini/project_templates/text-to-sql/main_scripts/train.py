...
def main():
    ...
    parser.add_argument('--lr', help="learning rate", default=3.0e-4, type=float)
    parser.add_argument('-ms','--max_steps', help="max steps for fine tuning", default=300, type=int)
