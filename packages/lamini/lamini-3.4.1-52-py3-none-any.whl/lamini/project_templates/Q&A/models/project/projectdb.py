...
class ProjectDB:
    ...
    def delete_experiment(self, experiment_id: str):
        ...
        experiment_name = experiments_df[experiments_df['experiment_id'] == experiment_id]['experiment_name'].iloc[0]
        
        # Remove experiment from experiments table
        experiments_df = experiments_df[experiments_df['experiment_id'] != experiment_id]
    ...
    def register_experiment(self, project_id: str, experiment_id: str, experiment_name: str, description: str, 
                          ...
                          validators: list = None, chunk_ids: list = None, 
    ...
    def update_experiment_eval_dataset_id(self, experiment_name: str, eval_dataset_id: str):
        ...
        # Update the record
        experiments_df.loc[experiments_df['experiment_name'] == experiment_name, 'eval_dataset_id'] = eval_dataset_id
        experiments_df.loc[experiments_df['experiment_name'] == experiment_name, 'last_updated'] = datetime.now().isoformat()
