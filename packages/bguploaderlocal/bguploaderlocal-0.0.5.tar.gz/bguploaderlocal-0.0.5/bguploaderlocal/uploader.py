...
def upload_file(filepath: str, api_key: str, team_id: str, project_id: str, testrun_id: str) -> List[dict]:
	...
	# Call the curl_request method to get the Sprint Testpert details
	getTestPertKBStatusResponse =  curl_request(http_method, api_endpoint, api_key, params_dict, files)

	# Error Check
	if getTestPertKBStatusResponse['status'] != 'OK' or getTestPertKBStatusResponse['apiResponse']['status'] != 'OK':
		return getTestPertKBStatusResponse

	return getTestPertKBStatusResponse

def upload_xml_files_from_folder(folder: str, api_key: str, team_id: str, project_id: str, testrun_id: str) -> List[dict]:
	...
	response = curl_request(http_method, api_endpoint, api_key, params_dict, files)
...
def curl_request(http_method='POST', api_endpoint='', api_key='', params_dict=None, files=None):
