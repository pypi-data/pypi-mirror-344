...
class LoadArray:
    ...
    def load_ranked_array(self, arr: Any, fill_value: Optional[float] = None) -> Input1D:
        """Load a 1D array-like structure as a ranked list.
    ...
    def load_pairs_array(
        ...
        """Load a paired edge list from a 2D array-like structure.
    ...
    def load_matrix_array(
        ...
        """Load a 2D array-like structure as an adjacency matrix.
