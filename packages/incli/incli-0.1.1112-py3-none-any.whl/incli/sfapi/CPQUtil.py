    ...
    if len(sorted_records)>0:
        ...
        for record in sorted_records:
            if 'productHierarchyPath' in record:
                if record['productHierarchyPath'] == "01t7a00000AhqMXAAZ<01t7a00000AhqLCAAZ":
                    a=1
            for item_type in item_types:
                if item_type in record:
                    sort_cartItems(record[item_type])
            if 'productHierarchyPath' in record:
                if record['productHierarchyPath'] == "01t7a00000AhqMXAAZ<01t7a00000AhqLCAAZ":
                    a=1
            ...
            newRecord = {**remaining_keys, **ordered_keys}
