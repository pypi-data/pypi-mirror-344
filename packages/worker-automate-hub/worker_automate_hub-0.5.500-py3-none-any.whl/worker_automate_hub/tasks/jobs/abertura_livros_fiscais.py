...
async def wait_aguarde_window_closed(timeout=300):
    console.print("Esperando janela 'Aguarde...' ou travada fechar")
...
async def abertura_livros_fiscais(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    try:
        ...
        if return_login.sucesso:
            ...
            texto_aguardando = get_text_from_window(app, (570, 320, 830, 350))
            console.print(f"Texto por OCR: ${texto_aguardando}")
