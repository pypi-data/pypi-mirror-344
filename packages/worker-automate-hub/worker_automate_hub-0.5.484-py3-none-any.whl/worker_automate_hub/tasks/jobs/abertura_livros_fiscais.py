...
@repeat(times=4, delay=5)
async def wait_aguarde_window_closed2(timeout=300):
    ...
    raise TimeoutError("Timeout esperando a janela 'Aguarde...' fechar.")
...
async def abertura_livros_fiscais(task: RpaProcessoEntradaDTO) -> RpaRetornoProcessoDTO:
    try:
        ...
        if return_login.sucesso:
            ...
            await wait_aguarde_window_closed2()
