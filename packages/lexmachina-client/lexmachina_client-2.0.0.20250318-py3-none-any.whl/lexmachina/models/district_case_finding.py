...
class DistrictCaseFinding(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "type", "judgmentSource", "inFavorOfPartyIds", "patentInvalidityReasons", "againstPartyIds", "docketEntryFiled", "specificReasons", "negated", "reinstated"]
