...
class MappingInfo:
    def __init__(self, slope, intercept, xr_peaks, uv_peaks, xr_moment, uv_moment):
        self.slope = slope
    ...
    def get_mapped_index(self, i, x, y):
        yi = x[i] * self.slope + self.intercept
        return int(round(yi - y[0]))
