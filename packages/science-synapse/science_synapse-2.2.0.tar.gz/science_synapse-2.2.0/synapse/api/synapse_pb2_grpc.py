...
def add_SynapseDeviceServicer_to_server(servicer, server):
    rpc_method_handlers = {'Info': grpc.unary_unary_rpc_method_handler(servicer.Info, request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString, response_serializer=api_dot_synapse__pb2.DeviceInfo.SerializeToString), 'Configure': grpc.unary_unary_rpc_method_handler(servicer.Configure, request_deserializer=api_dot_synapse__pb2.DeviceConfiguration.FromString, response_serializer=api_dot_status__pb2.Status.SerializeToString), 'Start': grpc.unary_unary_rpc_method_handler(servicer.Start, request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString, response_serializer=api_dot_status__pb2.Status.SerializeToString), 'Stop': grpc.unary_unary_rpc_method_handler(servicer.Stop, request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString, response_serializer=api_dot_status__pb2.Status.SerializeToString), 'Query': grpc.unary_unary_rpc_method_handler(servicer.Query, request_deserializer=api_dot_query__pb2.QueryRequest.FromString, response_serializer=api_dot_query__pb2.QueryResponse.SerializeToString), 'StreamQuery': grpc.unary_stream_rpc_method_handler(servicer.StreamQuery, request_deserializer=api_dot_query__pb2.StreamQueryRequest.FromString, response_serializer=api_dot_query__pb2.StreamQueryResponse.SerializeToString), 'ListFiles': grpc.unary_unary_rpc_method_handler(servicer.ListFiles, request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString, response_serializer=api_dot_files__pb2.ListFilesResponse.SerializeToString), 'WriteFile': grpc.unary_unary_rpc_method_handler(servicer.WriteFile, request_deserializer=api_dot_files__pb2.WriteFileRequest.FromString, response_serializer=api_dot_files__pb2.WriteFileResponse.SerializeToString), 'ReadFile': grpc.unary_stream_rpc_method_handler(servicer.ReadFile, request_deserializer=api_dot_files__pb2.ReadFileRequest.FromString, response_serializer=api_dot_files__pb2.ReadFileResponse.SerializeToString), 'DeleteFile': grpc.unary_unary_rpc_method_handler(servicer.DeleteFile, request_deserializer=api_dot_files__pb2.DeleteFileRequest.FromString, response_serializer=api_dot_files__pb2.DeleteFileResponse.SerializeToString), 'GetLogs': grpc.unary_unary_rpc_method_handler(servicer.GetLogs, request_deserializer=api_dot_logging__pb2.LogQueryRequest.FromString, response_serializer=api_dot_logging__pb2.LogQueryResponse.SerializeToString), 'TailLogs': grpc.unary_stream_rpc_method_handler(servicer.TailLogs, request_deserializer=api_dot_logging__pb2.TailLogsRequest.FromString, response_serializer=api_dot_logging__pb2.LogEntry.SerializeToString)}
