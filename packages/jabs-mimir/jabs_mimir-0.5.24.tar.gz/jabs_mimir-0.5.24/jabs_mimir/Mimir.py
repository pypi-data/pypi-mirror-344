...
class Mimir:
    ...
    from ttkbootstrap.widgets import Notebook  # Make sure this is imported

    def addTabbedView(self, parent, tabs, row=0, column=0, columnspan=1, rowspan=1, sticky="nsew", fit=True):
        """
        ...
        Parameters:
            ...
            fit (bool): If True, the notebook expands to fill space (default: True)
