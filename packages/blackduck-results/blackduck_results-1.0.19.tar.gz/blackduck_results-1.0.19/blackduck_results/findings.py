...
def summary(df, cutoff, headers, style="SHORT", urls=True,hub=HubInstance()):
    if df is None:
        return
...
def cves(project_name,version_name,hub=HubInstance()):
    """
    Return a json object with the stats of the project.
