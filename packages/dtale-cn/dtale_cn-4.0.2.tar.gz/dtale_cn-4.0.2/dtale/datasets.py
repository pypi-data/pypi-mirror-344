...
def simpsons():
    ...
    episodes = load_csv(
        path="https://github.com/WangLaoShi/dtale-media/raw/master/datasets/simpsons_episodes.csv"
    )
    ...
    _, scripts = next(
        load_zip(
            "https://github.com/WangLaoShi/dtale-media/raw/master/datasets/simpsons_script_lines.csv.zip"
        )
    )
...
def video_games():
    _, games = next(
        load_zip(
            "https://github.com/WangLaoShi/dtale-media/raw/master/datasets/vgsales.csv.zip"
        )
    )
...
def movies():
    _, movies = next(
        load_zip(
            "https://github.com/WangLaoShi/dtale-media/raw/master/datasets/IMDb_movies.csv.zip"
        )
    )
