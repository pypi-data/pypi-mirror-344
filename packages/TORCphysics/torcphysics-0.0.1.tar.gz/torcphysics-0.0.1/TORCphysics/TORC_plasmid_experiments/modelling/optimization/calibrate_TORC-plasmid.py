...
# Description
# ----------------------------------------------------------------------------------------------------------------------
# I want to build the optimization that finds the parametrisation that best reproduces experiments.
# For this optimization model, I will mantain the concentration of topos
