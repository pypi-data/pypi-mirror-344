...
n_simulations = 128#96  #60#84  # 60 #48 #120
...
width_max_topoI = 0.05
threshold_min_topoI = 0.0 # 0.001  #-0.05
threshold_max_topoI = 0.1 #0.05  #-0.001

# Gyrase ranges
k_cat_min_gyrase = 1.0  # Ranges to vary k_cat
k_cat_max_gyrase = 20.0
#sigma0_min_gyrase = -.13 #-0.3
#sigma0_max_gyrase = -0.09 #0.0
width_min_gyrase = 0.001
width_max_gyrase = 0.05  #0.01 #.05  # 1.0
threshold_min_gyrase = 0.0  #0.001
threshold_max_gyrase = 0.1 #0.05  # 0.1  # 1.0
...
def objective_function(params):
    ...
    binding_oparams = {'k_on':k_on_topoI, 'width': params['width_topoI'],
                       'threshold': params['threshold_topoI']}
    ...
    binding_oparams = {'k_on': k_on_gyrase, 'width': params['width_gyrase'],
                       'threshold': params['threshold_gyrase']}
...
space = {
    ...
    'threshold_topoI': hp.uniform('threshold_topoI', threshold_min_topoI, threshold_max_topoI),
    ...
    'threshold_gyrase': hp.uniform('threshold_gyrase', threshold_min_gyrase, threshold_max_gyrase)
}
...
both_df = pd.DataFrame(columns=['k_on_topoI', 'k_off_topoI', 'k_cat_topoI', 'width_topoI', 'threshold_topoI',
                                'k_on_gyrase', 'k_off_gyrase', 'k_cat_gyrase', 'width_gyrase', 'threshold_gyrase',
                                'sigma0_gyrase'])
...
both_df['threshold_topoI'] = best_df['threshold_topoI']
...
both_df['threshold_gyrase'] = best_df['threshold_gyrase']
