...
dt=1.0
initial_time = 0
final_time = 5400#5000#5000  #30000 ~8.3hrs
n_simulations =  24#63#12 #50 #12 # Per system

k_weak = 0.002#3#25 #25 # This is the one inferred from the experiment
...
info_file = 'dist_reproduce-'+model_code + promoter_cases[0] + '_dt' + str(dt)
file_out = info_file + '_RNAPTracking_off'
