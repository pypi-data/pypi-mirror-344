...
# 1.- [P] = [R] Product. Relaxed DNA (concentration) for topo I, and [SC] supercoiled DNA for Gyrase.
# 2.- [S] Substrate. Supercoiled DNA for topo I and Relaxed DNA.
# 3.- sigma - superhelical density

# Here, we assume that there is a total plasmid concentration [T] = [R] + [SC], so that, when [R] decreases,
# then [SC] increases.

# For the studied cases, we begin with either a fully supercoiled DNA state with sigma=-0.11 (because that's the maximum
# superhelicity gyrase can induct) or in a fully relaxed DNA state with sigma=0.0

# We will produce four cases:
# 1.- Topo I interacts with supercoiled DNA (fully supercoiled state).
# 2.- Gyrase interacts with relaxed DNA (fully relaxed).
# 3.- Topo I and Gyrase interact with supercoiled DNA (fully supercoiled).
# 4.- Topo I and Gyrase interact with relaxed DNA (fully relaxed).
...
# ==================================================================================================================
# Build experimental curve for Gyrase and topo I acting on the DNA (fully supercoiled state)
# ==================================================================================================================
...
# ==================================================================================================================
# Build experimental curve for Gyrase and topo I acting on the DNA (fully relaxed state)
# ==================================================================================================================
# Kinetics Gyrase: Relaxed_DNA + Gyrase -> Relaxed-Gyrase -> Supercoiled_DNA + Gyrase
# Kinetics Topoisomerase: Supercoiled_DNA + TopoI -> Supercoiled_DNA-TopoI -> Relaxed_DNA + TopoI

mycolor = 'purple'#both_color
mylabel = 'Both SC'
