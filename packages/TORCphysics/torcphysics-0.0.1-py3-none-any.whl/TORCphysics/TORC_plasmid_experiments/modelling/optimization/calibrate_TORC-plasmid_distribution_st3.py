...
# Description
# ----------------------------------------------------------------------------------------------------------------------
# Optimization process based on the third strategy!
...
file_out = 'dist_op_TORC_plasmid_st3_test'
...
# --------------------------------
topoI_C_min = Ecoli_topoI_C/3  # This variation will be applied to Salmonella
topoI_C_max = Ecoli_topoI_C*3
gyrase_C_min = Ecoli_gyrase_C/3
gyrase_C_max = Ecoli_gyrase_C*3
...
def objective_function(params, calibrating=True):
    ...
    # ΔtopA - environment
    Ecoli_dtopA_variation = {'name': 'topoI', 'object_type': 'environmental', 'concentration':
        Ecoli_topoI_C*params['a_dtopA']}
    Sal_dtopA_variation = {'name': 'topoI', 'object_type': 'environmental',
                           'concentration': params['topoI_concentration']*params['a_dtopA']}
    ...
    my_global_dict = {'circuit_filename': min_circuit_file, 'sites_filename': min_sites_file,
                       ...
                       'frames': frames, 'dt': dt, 'n_simulations': n_simulations, 'initial_sigma': sigma0,
                       'DNA_concentration': 0.0}
    my_variation = [PleuWT_variation, tetA_variation, antitet_variation, bla_variation, Ecoli_dtopA_variation, dlacI_variation]
    ...
    my_global_dict = {'circuit_filename': min_circuit_file, 'sites_filename': min_sites_file,
                       ...
                       'DNA_concentration': 0.0}
    my_variation = [PleuWT_variation, tetA_variation, antitet_variation, bla_variation,
                    gyrase_variation, dlacI_variation, Sal_dtopA_variation]
    ...
    my_global_dict = {'circuit_filename': min_circuit_file, 'sites_filename': min_sites_file,
                       ...
                       'DNA_concentration': 0.0}
    my_variation = [PleuWT_variation, tetA_variation, antitet_variation, bla_variation,
                    gyrase_variation,  Sal_dtopA_variation]
