...
# Description
# ----------------------------------------------------------------------------------------------------------------------
# Same calibration protocol but using simpler models for the promoters! Basically, using the MaxminPromoter Binding
# model
...
file_out = 'op-simple_TORC_plasmid'
...
binding_oparams = { 'k_max': 0.05, 'k_min': 0.001, 'a': presponse['a'].iloc[0], 'b': presponse['b'].iloc[0],
...
def objective_function(params, calibrating=True):
    ...
    PleuWT_variation['binding_oparams']['k_max'] = params['PleuWT_k_on']

    # tetA - site
    tetA_variation = variation_dict['tetA']
    tetA_variation['binding_oparams']['k_max'] = params['tetA_k_on']

    # antitet - site
    antitet_variation = variation_dict['antitet']
    antitet_variation['binding_oparams']['k_max'] = params['antitet_k_on']

    # bla - site
    bla_variation = variation_dict['bla']
    bla_variation['binding_oparams']['k_max'] = params['bla_k_on']
