...
class Annotation(pydantic_v1.BaseModel):
    ...
    # annotation id auto generated by django
    id: typing.Optional[int] = None

    # image id - reference the image
    image: typing.Optional[int] = None

    # one of bbox, segmentation, polygon
    type: typing.Optional[str] = pydantic_v1.Field(default=None)

    # one of nao, ball, penaltymark
    class_name: typing.Optional[str] = pydantic_v1.Field(default=None)
