...
class Client(ABC):
    ...
    async def get_chat_response(
        ...
        Args:
            ...
            force_tool: Whether to force the model to use tools or allow it to respond with text.
    ...
    async def stream_chat_response(
        ...
        Args:
            ...
            system: Optional system message to set the behavior of the AI.
            tools: Optional list of tools available for the model to use.
            force_tool: Whether to force the model to use tools (True) or allow it to respond with text (False).
