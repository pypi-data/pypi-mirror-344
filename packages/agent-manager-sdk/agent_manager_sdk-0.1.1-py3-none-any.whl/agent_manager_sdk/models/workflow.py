...
from ..app_libs import helper

# from models import db.String
...
class Workflow(db.Model):
    ...
    id = db.Column(db.String, nullable=False) #, server_default=db.text('uuid_generate_v4()'))
    # tenant_id = db.Column(db.String, nullable=False)
    # app_id = db.Column(db.String, nullable=False)
    user_id = db.Column(db.String, db.ForeignKey('account.user_id'),nullable=False)
    
    # type = db.Column(db.String(255), nullable=False)
    version = db.Column(db.String(255), nullable=False)
    graph = db.Column(db.Text)
    output_keys = db.Column(db.Text)
    # user = db.relationship('Account', back_populates='Workflow')
...
class WorkflowRun(db.Model):
    ...
    id = db.Column(db.String) #, server_default=db.text('uuid_generate_v4()'))
    # tenant_id = db.Column(db.String, nullable=False)
    # app_id = db.Column(db.String, nullable=False)
...
class WorkflowNodeExecution(db.Model):
    ...
    workflow_id = db.Column(db.String, db.ForeignKey('workflows.id'), nullable=False)
    # triggered_from = db.Column(db.String(255), nullable=False)
    workflow_run_id = db.Column(db.String)
    ...
    # created_by = db.Column(db.String, nullable=False)
    finished_at = db.Column(db.DateTime)
    # user = db.relationship('Account', back_populates='workflow_node_executions')
    # workflow = db.relationship('Workflow', back_populates='workflow_node_executions')
...
#     tenant_id = db.Column(db.String, nullable=False)
#     app_id = db.Column(db.String, nullable=False)
#     workflow_id = db.Column(db.String, nullable=False)
#     workflow_run_id = db.Column(db.String, nullable=False)
