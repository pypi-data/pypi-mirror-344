            ...
            if cmd.endswith("#c2cbe"):
                ...
                with Session(db.ENGINE) as session:
                    ...
                    try:
                        ...
                        print(e)
            elif cmd.lower() in ['mksl','make shopping list','p-slq','prompt slq','set list qty','slqp']:
                TM.Tasks.TasksMode(parent=self,engine=db.ENGINE,init_only=True).setFieldInList(f"ListQty")
