...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', '_lin_solver_cls', '_lin_solver_args', 'gfu_old', 'c', 'bfmstar', 'time')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('dt', '_lin_solver_cls', '_lin_solver_args', 'gfu_old', 'c', 'bfmstar', 'gfv_old', 'gfa_old', 'time')
