...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('tol', 'mat', 'ax', '_final_residual', 'printrates', 'clear_output', 'plotrates', 'pre', 'callback', 'residuals', 'maxiter', 'ress', 'its', 'fig', 'sol', 'atol', 'callback_sol', 'display', 'iterations', 'plt')
