...
"""
Installation of the unitapi package.
"""
...
version = {}
with open("src/unitapi/_version.py") as f:
    exec(f.read(), version)
...
setup(
    ...
    project_urls={
        ...
        "Changelog": "https://github.com/unitapi/python/releases",
        "Wiki": "https://github.com/unitapi/python/wiki",
        "Issue Tracker": "https://github.com/unitapi/python/issues/new",
    },
