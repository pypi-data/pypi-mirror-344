...
def nticks_yrange(yrange: list[float], nticks: int, range_as_multiple_of: int = 10) -> tuple[float]:
    """
    ...
    # - The range 40 is divisible by both 5 and 5, so the result is (10.0, 50.0)
