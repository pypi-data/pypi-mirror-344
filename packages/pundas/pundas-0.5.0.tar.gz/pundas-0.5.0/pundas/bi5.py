...
Original file is located at
    https://colab.research.google.com/drive/1FUsMLlTuFUkNghvNHZCz5Zih3V1fcIwq
"""
...
df['Sex']=LabelEncoder().fit_transform(df['Sex']) #matera, female:2
...
plt.figure(figsize=(6, 4))
sns.violinplot(x='Survived', y='Fare', data=df, palette='Set2')
