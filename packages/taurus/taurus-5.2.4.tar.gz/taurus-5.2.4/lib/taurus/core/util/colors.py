...
DEVICE_STATE_DATA = {
    ...
    "DevState.ON": ("Lime", 0, 255, 0, 0),
    "DevState.OFF": ("White", 255, 255, 255, 0),
    "DevState.CLOSE": ("White", 255, 255, 255, 3),
    "DevState.OPEN": ("Lime", 0, 255, 0, 0),
    "DevState.INSERT": ("White", 255, 255, 255, 0),
    "DevState.EXTRACT": ("Lime", 0, 255, 0, 0),
    "DevState.MOVING": ("Taurus - Cornflower Blue", 128, 160, 255, 0),
    "DevState.STANDBY": ("Yellow", 255, 255, 0, 0),
    "DevState.FAULT": ("Red", 255, 0, 0, 0),
    "DevState.INIT": ("Taurus - Dark Khaki", 204, 204, 122, 0),
    "DevState.RUNNING": ("Taurus - Cornflower Blue", 128, 160, 255, 0),
    "DevState.ALARM": ("Dark Orange", 255, 140, 0, 1),
