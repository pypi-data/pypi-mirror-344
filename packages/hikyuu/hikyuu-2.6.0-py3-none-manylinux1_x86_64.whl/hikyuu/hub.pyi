...
class ConfigModel(sqlalchemy.orm.decl_api.Base):
    __mapper__: typing.ClassVar[sqlalchemy.orm.mapper.Mapper]  # value = <Mapper at 0x78fcc06c72e0; ConfigModel>
    ...
    _sa_class_manager: typing.ClassVar[sqlalchemy.orm.instrumentation.ClassManager]  # value = <ClassManager of <class 'hikyuu.hub.ConfigModel'> at 78fcc06db4a0>
...
class HubModel(sqlalchemy.orm.decl_api.Base):
    __mapper__: typing.ClassVar[sqlalchemy.orm.mapper.Mapper]  # value = <Mapper at 0x78fcc06c7ca0; HubModel>
    ...
    _sa_class_manager: typing.ClassVar[sqlalchemy.orm.instrumentation.ClassManager]  # value = <ClassManager of <class 'hikyuu.hub.HubModel'> at 78fd539d0180>
    def __init__(self, **kwargs):
        """
        A simple constructor that allows initialization from kwargs.
...
class PartModel(sqlalchemy.orm.decl_api.Base):
    __mapper__: typing.ClassVar[sqlalchemy.orm.mapper.Mapper]  # value = <Mapper at 0x78fd539d59d0; PartModel>
    ...
    _sa_class_manager: typing.ClassVar[sqlalchemy.orm.instrumentation.ClassManager]  # value = <ClassManager of <class 'hikyuu.hub.PartModel'> at 78fd539d0bd0>
    def __init__(self, **kwargs):
        """
        A simple constructor that allows initialization from kwargs.
