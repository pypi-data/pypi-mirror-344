...
impl QuantumGate {
    ...
    pub(crate) fn decomposition_list(&self, control_size: usize) -> Vec<Algorithm> {
        ...
        match self {
            QuantumGate::PauliX | QuantumGate::PauliY | QuantumGate::PauliZ => {
                if control_size <= 3 {
                    ...
                    vec![
                        ...
                        Algorithm::VChain(CXMode::C2X, AuxMode::Clean),
                        Algorithm::VChain(CXMode::C3X, AuxMode::Clean),
                        Algorithm::VChain(CXMode::C2X, AuxMode::Dirty),
                        Algorithm::VChain(CXMode::C3X, AuxMode::Dirty),
                        Algorithm::NoAuxCX,
                    ]
                } else {
                    vec![
                        ...
                        Algorithm::VChain(CXMode::C3X, AuxMode::Dirty),
                        Algorithm::AdjustableDepth,
                        Algorithm::SingleAux(DepthMode::Linear, AuxMode::Clean),
            ...
            QuantumGate::RotationX(_) | QuantumGate::RotationY(_) | QuantumGate::RotationZ(_) => {
                if control_size > 1 {
                    vec![
                        Algorithm::NetworkU2(CXMode::C2X),
    ...
    fn decompose_r(
        ...
        match &schema.algorithm {
            ...
            Algorithm::SU2(depth_mode) => {
                decompose::su2::decompose(*self, control, target, u4_gate, *depth_mode)
            }
    ...
    fn decompose_x(
        ...
        match &schema.algorithm {
            ...
            Algorithm::NoAuxCX => decompose::x::c2to4x::c1to4x(control, target, u4_gate, false),
    ...
    fn decompose_hadamard(
        ...
        match &schema.algorithm {
            ...
            Algorithm::SU2Rewrite => {
                su2_rewrite_hadamard(control, schema.aux_qubits.unwrap()[0], target, u4_gate)
            }
            Algorithm::CU2 => {
