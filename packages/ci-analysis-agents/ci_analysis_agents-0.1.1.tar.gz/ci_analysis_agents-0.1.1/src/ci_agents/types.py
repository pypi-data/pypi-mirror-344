...
def dispatch_ai_response(response: AIResponse, context: AnalysisContext) -> AIResponse:
    ...
    if context.infra_issue_response and context.infra_issue_response.failed_by_infra:
        response = context.infra_issue_response
    elif context.env_issue_response and context.env_issue_response.failed_by_env:
