...
{   
    // static_assert(is_8bit_integer<TData>, "Template argument must be an 8-bit unsigned integer type.");
    ...
    int status;
    status = inflateInit2(&stream, 16+MAX_WBITS); // gzip files
    if (status != Z_OK) {
