...
#define PACKAGE_VERSION "9.0.0a0.post1384"
...
#define VERSION "9.0.0a0.post1384"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/Users/runner/work/1/s/nrn_build_venv312_-6763134/bin/python)"};
