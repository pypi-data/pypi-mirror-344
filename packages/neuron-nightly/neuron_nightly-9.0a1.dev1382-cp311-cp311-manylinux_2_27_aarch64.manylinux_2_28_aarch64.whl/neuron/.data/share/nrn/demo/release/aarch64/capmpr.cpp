 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 6, "diam");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 capmpr /root/nrn/build/cmake_install/share/nrn/demo/release/capmpr.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/root/nrn/build/cmake_install/share/nrn/demo/release/capmpr.mod";
