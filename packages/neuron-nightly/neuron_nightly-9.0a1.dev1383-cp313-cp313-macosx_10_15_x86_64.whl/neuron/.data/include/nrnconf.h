...
#define PACKAGE_VERSION "9.0.0a0.post1383"
...
#define VERSION "9.0.0a0.post1383"
...
#ifdef USE_PYTHON
   constexpr std::string_view default_python_executable{R"(/Users/runner/work/1/s/nrn_build_venv313_-8614197/bin/python)"};
