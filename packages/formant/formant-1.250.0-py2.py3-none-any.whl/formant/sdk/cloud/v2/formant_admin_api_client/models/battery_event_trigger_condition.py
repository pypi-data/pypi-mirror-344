...
from ..models.battery_event_trigger_condition_operator import BatteryEventTriggerConditionOperator
from ..models.battery_event_trigger_condition_type import BatteryEventTriggerConditionType

if TYPE_CHECKING:
    from ..models.battery_event_trigger_condition_conditions import BatteryEventTriggerConditionConditions
