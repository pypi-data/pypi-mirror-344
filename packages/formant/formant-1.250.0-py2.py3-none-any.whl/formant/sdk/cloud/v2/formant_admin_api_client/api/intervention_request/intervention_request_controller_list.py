...
from ...models.intervention_request_controller_list_order import InterventionRequestControllerListOrder
from ...models.intervention_request_list_response import InterventionRequestListResponse
...
def _get_kwargs(
    *,
    ...
    url = "{}/intervention-requests/".format(client.base_url)
