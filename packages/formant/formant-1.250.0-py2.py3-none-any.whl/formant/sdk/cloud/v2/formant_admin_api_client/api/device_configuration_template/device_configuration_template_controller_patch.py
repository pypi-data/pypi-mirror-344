...
from ...models.partial_device_configuration_template import PartialDeviceConfigurationTemplate
...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/device-configuration-templates/{id}".format(client.base_url, id=id)
