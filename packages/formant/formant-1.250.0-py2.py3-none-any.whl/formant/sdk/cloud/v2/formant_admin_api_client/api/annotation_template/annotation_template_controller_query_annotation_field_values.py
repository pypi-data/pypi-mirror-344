...
from ...models.annotation_field_values_request import AnnotationFieldValuesRequest
from ...models.annotation_field_values_response import AnnotationFieldValuesResponse
...
def _get_kwargs(
    *,
    ...
    url = "{}/annotation-templates/query".format(client.base_url)
