...
if TYPE_CHECKING:
    ...
    from ..models.device_application_configuration import DeviceApplicationConfiguration
    from ..models.device_blob_data import DeviceBlobData
    from ..models.device_configuration_document_tags import DeviceConfigurationDocumentTags
    from ..models.device_diagnostics_configuration import DeviceDiagnosticsConfiguration
    from ..models.device_port_forwarding_configuration import DevicePortForwardingConfiguration
    from ..models.device_realtime_configuration import DeviceRealtimeConfiguration
    from ..models.device_resources_configuration import DeviceResourcesConfiguration
    from ..models.device_telemetry_configuration import DeviceTelemetryConfiguration
