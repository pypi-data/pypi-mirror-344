...
if TYPE_CHECKING:
    from ..models.device_teleop_custom_stream_configuration import DeviceTeleopCustomStreamConfiguration
    from ..models.device_teleop_hardware_stream_configuration import DeviceTeleopHardwareStreamConfiguration
    from ..models.device_teleop_ros_stream_configuration import DeviceTeleopRosStreamConfiguration
