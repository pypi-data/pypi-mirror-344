"""
Django application configuration for Django-MCP.

This module provides the AppConfig class for the Django-MCP package,
...
class DjangoMCPConfig(AppConfig):
    ...
    This class manages the Django-MCP application, including:
    ...
    def ready(self):
        """
        Initialize the Django-MCP application when Django starts.
        ...
        if not hasattr(self, 'mcp_server'):
            from django_mcp.mcp_server import create_mcp_server
            ...
            app_name = mcp_config.get('MCP_APP_NAME', 'django_mcp')
