...
from streaming_helper.transaction_management.deribit import cancelling_active_orders as cancel_order
                    ...
                    if my_trade_receiving_channel in message_channel:
                        ...
                        for trade in data:
                            ...
                            for currency in currencies:
                                ...
                                subaccounts_details_params = end_point_params_template.get_subaccounts_details_params(currency)
