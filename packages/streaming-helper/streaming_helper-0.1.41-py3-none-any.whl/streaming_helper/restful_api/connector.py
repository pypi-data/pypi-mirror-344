...
async def get_connected(
    ...
    async with aiohttp.ClientSession() as session:
        ...
        log.debug(f"client_id {client_id} client_secret {client_secret} params {params}")   
...
async def deribit_response(
    ...
    async with aiohttp.ClientSession() as session:
        ...
        log.warning(f"payload {payload} params {params} status_code {status_code} response {response}")
