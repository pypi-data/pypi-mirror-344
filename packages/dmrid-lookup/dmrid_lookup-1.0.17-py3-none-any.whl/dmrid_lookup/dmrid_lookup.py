...
def main():
    ...
    parser.add_argument("--callsign", type=str, help="Callsign to look up")
    ...
    if args.id:
        ...
        console.print("Please provide a DMR ID using --id or a callsign using --callsign", style="yellow")
        sys.exit(1)
