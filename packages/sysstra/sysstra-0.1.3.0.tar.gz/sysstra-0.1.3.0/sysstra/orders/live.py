...
def place_live_order(credential_id, order_details):
    ...
    try:
        ...
        response = requests.post(url=config.orders_url+"place_order", params=request_dict)
...
def modify_live_order(credential_id, order_details):
    ...
    try:
        ...
        response = requests.post(url=config.orders_url + "modify_order", params=request_dict)
        print("******** Order Placement Response *********")
        print(response.json())
        return response.json()
    except Exception as e:
