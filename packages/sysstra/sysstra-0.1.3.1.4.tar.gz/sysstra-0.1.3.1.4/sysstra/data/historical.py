...
def fetch_option_candles(underlying_symbol, start_date, end_date, option_type, strike_price, expiry="near", granularity=1, timestamp=None):
    """ Function to Fetch Options Trade Data """
    try:
        headers = {"x-api-key": api_key, "content-type": "application/json"}
        request_data = {"underlying_symbol": underlying_symbol, "from_date": start_date,
...
def fetch_option_candle_by_timestamp(underlying_symbol, strike_price, option_type, timestamp, granularity=1, expiry="near"):
    """ Function to Fetch Order Candle based on timestamp """
    try:
        headers = {"x-api-key": api_key, "content-type": "application/json"}
        request_data = {"underlying_symbol": underlying_symbol, "option_type": option_type,
