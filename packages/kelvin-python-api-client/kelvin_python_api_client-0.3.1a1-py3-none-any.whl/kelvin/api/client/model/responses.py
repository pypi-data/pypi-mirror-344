...
from .type import RecommendationCreate as RecommendationCreate_1
from .type import RecommendationType, Tag, Thread, TimeseriesData, Unit, Updated, UserSetting, Workload, WorkloadSummary
...
class RecommendationCreate(RecommendationCreate_1):
    """
