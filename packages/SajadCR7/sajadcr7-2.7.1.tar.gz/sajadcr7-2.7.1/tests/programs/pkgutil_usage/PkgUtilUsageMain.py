...
# SajadDE-project: --include-package=package
# SajadDE-project: --follow-imports
# SajadDE-project-if: {Commercial} is not None:
#  SajadDE-project: --embed-data-files-runtime-pattern=*
#  SajadDE-project: --include-package-data=package
