...
from SajadDE.build.DataComposerInterface import runDataComposer
from SajadDE.build.SconsUtils import (
    getSconsReportValue,
    readSconsErrorReport,
    readSconsReport,
)
from SajadDE.code_generation.ConstantCodes import (
    addDistributionMetadataValue,
    getDistributionMetadataValues,
)
from SajadDE.freezer.IncludedDataFiles import (
    addIncludedDataFilesFromFileOptions,
    addIncludedDataFilesFromPackageOptions,
    addIncludedDataFilesFromPlugins,
    copyDataFiles,
)
from SajadDE.freezer.IncludedEntryPoints import (
    addExtensionModuleEntryPoint,
    addIncludedEntryPoints,
    getStandaloneEntryPoints,
    setMainEntryPoint,
)
from SajadDE.importing.Importing import locateModule, setupImportingFromOptions
from SajadDE.importing.Recursion import (
    scanIncludedPackage,
...
from SajadDE.PostProcessing import executePostProcessing
from SajadDE.Progress import (
    closeProgressBar,
    reportProgressBar,
    setupProgressBar,
)
from SajadDE.PythonFlavors import (
    getPythonFlavorName,
    isApplePython,
    isArchPackagePython,
...
from SajadDE.Serialization import ConstantAccessor
from SajadDE.Tracing import general, inclusion_logger, pgo_logger
from SajadDE.tree import SyntaxErrors
from SajadDE.tree.ReformulationMultidist import createMultidistMainSourceCode
from SajadDE.utils import InstanceCounters
from SajadDE.utils.Distributions import getDistribution
...
from SajadDE.utils.Importing import (
    getPackageDirFilename,
    getSharedLibrarySuffix,
)
from SajadDE.utils.MemoryUsage import reportMemoryUsage, showMemoryTrace
from SajadDE.utils.ModuleNames import ModuleName
from SajadDE.utils.ReExecute import callExecProcess, reExecuteSajadQ
from SajadDE.utils.StaticLibraries import getSystemStaticLibPythonPath
from SajadDE.utils.Utils import getArchitecture, isMacOS, isWin32Windows
...
def runSconsBackend():
    ...
    scons_options["SajadDE_python"] = asBoolStr(isSajadQPython())
...
of the precise Python interpreter binary and '-m SajadDE', e.g. use this
'python%s -m SajadDE' option, if that's not the one the program expects.
""" % (
            python_version_str,
