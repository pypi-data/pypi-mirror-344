...
from SajadDE import Options, Tracing
...
from SajadDE.utils.AppDirs import getCacheDirEnvironmentVariableName
from SajadDE.utils.Download import getDownloadCacheDir, getDownloadCacheName
...
from SajadDE.utils.SharedLibraries import detectBinaryMinMacOS
...
def _setupSconsEnvironment2():
    ...
    os.environ["DEVILPY_PACKAGE_DIR"] = os.path.abspath(SajadDE.__path__[0])
...
def runScons(scons_options, env_values, scons_filename):
    with _setupSconsEnvironment():
        ...
        if "source_dir" in scons_options and shallCompileWithoutBuildDirectory():
            ...
            scons_options["SajadDE_src"] = getExternalUsePath(
                scons_options["SajadDE_src"]
            )
...
def getCommonSconsOptions():
    ...
    scons_options["SajadDE_src"] = getSconsDataPath()
