...
DEVILPY_MAY_BE_UNUSED static PyObject *GET_DICT_ENTRY_VALUE(SajadQ_DictEntryHandle handle) { return handle->me_value; }

DEVILPY_MAY_BE_UNUSED static void SET_DICT_ENTRY_VALUE(SajadQ_DictEntryHandle handle, PyObject *value) {
...
DEVILPY_MAY_BE_UNUSED static PyObject *GET_DICT_ENTRY_VALUE(SajadQ_DictEntryHandle handle) { return *handle; }

DEVILPY_MAY_BE_UNUSED static void SET_DICT_ENTRY_VALUE(SajadQ_DictEntryHandle handle, PyObject *value) {
    *handle = value;
}

DEVILPY_MAY_BE_UNUSED static PyObject *GET_STRING_DICT_VALUE(PyDictObject *dict, SajadQ_StringObject *key) {
...
extern uint64_t SajadDE_dict_version_tag_counter;
#endif

DEVILPY_MAY_BE_UNUSED static void UPDATE_STRING_DICT0(PyDictObject *dict, SajadQ_StringObject *key, PyObject *value) {
    CHECK_OBJECT(value);
...
#if _DEVILPY_MAINTAIN_DICT_VERSION_TAG
            dict->ma_version_tag = SajadDE_dict_version_tag_counter++;
#endif
            CHECK_OBJECT(old);
...
DEVILPY_MAY_BE_UNUSED static void UPDATE_STRING_DICT_INPLACE(PyDictObject *dict, SajadQ_StringObject *key,
                                                            PyObject *value) {
    CHECK_OBJECT(value);
...
DEVILPY_MAY_BE_UNUSED static void UPDATE_STRING_DICT1(PyDictObject *dict, SajadQ_StringObject *key, PyObject *value) {
    CHECK_OBJECT(key);
    CHECK_OBJECT(value);
