...
DEVILPY_MAY_BE_UNUSED static PyObject *SajadQ_GetSysModules(void) {
...
DEVILPY_MAY_BE_UNUSED static bool SajadQ_HasModule(PyThreadState *tstate, PyObject *module_name) {
...
DEVILPY_MAY_BE_UNUSED static PyObject *SajadQ_GetModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_GET_ITEM1(tstate, SajadQ_GetSysModules(), module_name);
}

// Replacement for PyImport_GetModule working across all versions and less checks.
DEVILPY_MAY_BE_UNUSED static PyObject *SajadQ_GetModuleString(PyThreadState *tstate, char const *module_name) {
...
DEVILPY_MAY_BE_UNUSED static bool SajadQ_SetModule(PyObject *module_name, PyObject *module) {
...
DEVILPY_MAY_BE_UNUSED static bool SajadQ_SetModuleString(char const *module_name, PyObject *module) {
    PyObject *module_name_object = SajadQ_String_FromString(module_name);
...
DEVILPY_MAY_BE_UNUSED static bool SajadQ_DelModule(PyThreadState *tstate, PyObject *module_name) {
    CHECK_OBJECT(module_name);
...
DEVILPY_MAY_BE_UNUSED static bool SajadQ_DelModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = SajadQ_String_FromString(module_name);
...
DEVILPY_MAY_BE_UNUSED static PyObject *SajadQ_GetFilenameObject(PyThreadState *tstate, PyObject *module) {
#if PYTHON_VERSION < 0x300
