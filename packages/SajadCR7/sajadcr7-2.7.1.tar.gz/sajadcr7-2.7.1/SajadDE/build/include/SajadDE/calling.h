...
DEVILPY_MAY_BE_UNUSED static inline PyObject *SajadQ_CheckFunctionResult(PyThreadState *tstate, PyObject *callable,
                                                                        PyObject *result) {
    if (result == NULL) {
...
#include "SajadDE/helper/calling_generated.h"
