...
DEVILPY_MAY_BE_UNUSED static void *SajadQObject_Malloc(size_t size) { return python_obj_malloc(python_obj_ctx, size); }

// Our version of "PyMem_Malloc".
DEVILPY_MAY_BE_UNUSED static void *SajadQMem_Malloc(size_t size) { return python_mem_malloc(python_mem_ctx, size); }

// Our version of "PyMem_Calloc".
DEVILPY_MAY_BE_UNUSED static void *SajadQMem_Calloc(size_t nelem, size_t elsize) {
    return python_mem_calloc(python_mem_ctx, nelem, elsize);
}

#ifndef Py_GIL_DISABLED
// Our version of "PyMem_Realloc".
DEVILPY_MAY_BE_UNUSED static void *SajadQMem_Realloc(void *ptr, size_t new_size) {
    return python_mem_realloc(python_mem_ctx, ptr, new_size);
}
#else
DEVILPY_MAY_BE_UNUSED static void SajadQMem_Free(void *ptr) { python_mem_free(python_mem_ctx, ptr); }
#endif
...
DEVILPY_MAY_BE_UNUSED static void *SajadQ_GC_NewVar(PyTypeObject *type, Py_ssize_t nitems) {
    assert(nitems >= 0);
...
DEVILPY_MAY_BE_UNUSED static void *SajadQ_GC_New(PyTypeObject *type) {
#if PYTHON_VERSION < 0x3b0
