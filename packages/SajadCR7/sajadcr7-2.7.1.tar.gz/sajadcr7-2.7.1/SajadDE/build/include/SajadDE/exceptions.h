...
#include "SajadDE/checkers.h"
#include "SajadDE/constants.h"
#include "SajadDE/printing.h"
...
DEVILPY_MAY_BE_UNUSED inline static struct SajadQ_ExceptionStackItem GET_CURRENT_EXCEPTION(PyThreadState *tstate) {
...
DEVILPY_MAY_BE_UNUSED static void INIT_ERROR_OCCURRED_STATE(struct SajadQ_ExceptionPreservationItem *exception_state) {
...
DEVILPY_MAY_BE_UNUSED static void SET_EXCEPTION_STATE_TRACEBACK(struct SajadQ_ExceptionPreservationItem *exception_state,
                                                               PyTracebackObject *exception_tb) {
    CHECK_OBJECT_X(exception_state->exception_tb);
    CHECK_OBJECT_X(exception_tb);
...
DEVILPY_MAY_BE_UNUSED static bool HAS_EXCEPTION_STATE(struct SajadQ_ExceptionPreservationItem const *exception_state) {
...
// reference.
DEVILPY_MAY_BE_UNUSED static inline PyObject *SajadQ_Exception_GetContext(PyObject *self) {
...
// consume a reference.
DEVILPY_MAY_BE_UNUSED static inline void SajadQ_Exception_SetContext(PyObject *self, PyObject *context) {
...
DEVILPY_MAY_BE_UNUSED static inline void SajadQ_Exception_DeleteContext(PyObject *self) {
...
DEVILPY_MAY_BE_UNUSED static inline void SajadQ_Exception_SetCause(PyObject *self, PyObject *cause) {
