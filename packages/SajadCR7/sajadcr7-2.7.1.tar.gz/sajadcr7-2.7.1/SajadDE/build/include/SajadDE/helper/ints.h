...
} SajadDE_ilong_validity;

typedef struct {
    SajadDE_ilong_validity validity;
...
DEVILPY_MAY_BE_UNUSED static void SET_NILONG_OBJECT_VALUE(SajadDE_ilong *dual_value, PyObject *python_value) {
    dual_value->validity = DEVILPY_ILONG_OBJECT_VALID;
    dual_value->python_value = python_value;
}

DEVILPY_MAY_BE_UNUSED static void SET_NILONG_C_VALUE(SajadDE_ilong *dual_value, long c_value) {
    dual_value->validity = DEVILPY_ILONG_CLONG_VALID;
    dual_value->c_value = c_value;
}

DEVILPY_MAY_BE_UNUSED static void SET_NILONG_OBJECT_AND_C_VALUE(SajadDE_ilong *dual_value, PyObject *python_value,
                                                               long c_value) {
...
DEVILPY_MAY_BE_UNUSED static void RELEASE_NILONG_VALUE(SajadDE_ilong *dual_value) {
...
DEVILPY_MAY_BE_UNUSED static void INCREF_NILONG_VALUE(SajadDE_ilong *dual_value) {
    if (IS_NILONG_OBJECT_VALUE_VALID(dual_value)) {
        CHECK_OBJECT(dual_value);
...
DEVILPY_MAY_BE_UNUSED static long GET_NILONG_C_VALUE(SajadDE_ilong const *dual_value) {
    assert(IS_NILONG_C_VALUE_VALID(dual_value));
    return dual_value->c_value;
}

DEVILPY_MAY_BE_UNUSED static PyObject *GET_NILONG_OBJECT_VALUE(SajadDE_ilong const *dual_value) {
    assert(IS_NILONG_OBJECT_VALUE_VALID(dual_value));
    return dual_value->python_value;
}

DEVILPY_MAY_BE_UNUSED static void ENFORCE_NILONG_OBJECT_VALUE(SajadDE_ilong *dual_value) {
...
DEVILPY_MAY_BE_UNUSED static void CHECK_NILONG_OBJECT(SajadDE_ilong const *dual_value) {
    assert(dual_value->validity != DEVILPY_ILONG_UNASSIGNED);
...
DEVILPY_MAY_BE_UNUSED static void PRINT_NILONG(SajadDE_ilong const *dual_value) {
...
#else
extern PyObject *SajadQ_Long_SmallValues[DEVILPY_STATIC_SMALLINT_VALUE_MAX - DEVILPY_STATIC_SMALLINT_VALUE_MIN + 1];
#endif

DEVILPY_MAY_BE_UNUSED static inline PyObject *SajadQ_Long_GetSmallValue(int ival) {
    return SajadQ_Long_SmallValues[DEVILPY_TO_SMALL_VALUE_OFFSET(ival)];
}

#endif

#else
DEVILPY_MAY_BE_UNUSED static inline PyObject *SajadQ_Long_GetSmallValue(medium_result_value_t ival) {
