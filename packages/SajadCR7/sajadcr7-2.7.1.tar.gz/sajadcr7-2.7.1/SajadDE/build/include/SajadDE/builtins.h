...
DEVILPY_MAY_BE_UNUSED static PyObject *SajadQ_SysGetObject(char const *name) { return PySys_GetObject((char *)name); }

DEVILPY_MAY_BE_UNUSED static void SajadQ_SysSetObject(char const *name, PyObject *value) {
