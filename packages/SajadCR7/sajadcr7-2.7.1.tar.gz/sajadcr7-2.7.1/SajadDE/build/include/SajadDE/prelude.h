...
#include "SajadDE/debug_settings.h"
...
DEVILPY_MAY_BE_UNUSED static inline managed_static_type_state *SajadQ_PyStaticType_GetState(PyInterpreterState *interp,
                                                                                           PyTypeObject *self) {
...
DEVILPY_MAY_BE_UNUSED static inline bool SajadQ_StringOrUnicode_CheckExact(PyObject *value) {
...
DEVILPY_MAY_BE_UNUSED static Py_UNICODE *SajadQ_UnicodeAsWideString(PyObject *str, Py_ssize_t *size) {
    PyObject *unicode;
...
#else
DEVILPY_MAY_BE_UNUSED static char const *SajadQ_String_AsString_Unchecked(PyObject *object) {
...
#else
DEVILPY_MAY_BE_UNUSED static PyObject *SajadQ_TypeLookup(PyTypeObject *type, PyObject *name) {
...
#include "SajadDE/allocator.h"
#include "SajadDE/exceptions.h"
...
typedef long SajadDE_digit;

#include "SajadDE/helpers.h"

#include "SajadDE/compiled_frame.h"

#include "SajadDE/compiled_cell.h"

#include "SajadDE/compiled_function.h"
...
#include "SajadDE/compiled_generator.h"

#include "SajadDE/compiled_method.h"

#if PYTHON_VERSION >= 0x350
#include "SajadDE/compiled_coroutine.h"
#endif

#if PYTHON_VERSION >= 0x360
#include "SajadDE/compiled_asyncgen.h"
#endif

#include "SajadDE/filesystem_paths.h"
#include "SajadDE/safe_string_ops.h"

#include "SajadDE/jit_sources.h"

#if _DEVILPY_EXPERIMENTAL_WRITEABLE_CONSTANTS
#include "SajadDE_data_decoder.h"
#else
...
#include "SajadDE_init_program.h"
#else
...
#include "SajadDE_exit_program.h"
#else
