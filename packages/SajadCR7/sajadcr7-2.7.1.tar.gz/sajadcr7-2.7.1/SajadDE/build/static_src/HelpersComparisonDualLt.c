 ...
 */
PyObject *RICH_COMPARE_LT_OBJECT_NILONG_NILONG(SajadDE_ilong *operand1, SajadDE_ilong *operand2) {
...
/* Code referring to "NILONG" corresponds to SajadQ int/long/C long value and "NILONG" to SajadQ int/long/C long value.
 */
bool RICH_COMPARE_LT_CBOOL_NILONG_NILONG(SajadDE_ilong *operand1, SajadDE_ilong *operand2) {
    CHECK_NILONG_OBJECT(operand1);
    CHECK_NILONG_OBJECT(operand2);
...
PyObject *RICH_COMPARE_LT_OBJECT_NILONG_CLONG(SajadDE_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
...
/* Code referring to "NILONG" corresponds to SajadQ int/long/C long value and "CLONG" to C platform long value. */
bool RICH_COMPARE_LT_CBOOL_NILONG_CLONG(SajadDE_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
 ...
 * Python objects. */
PyObject *RICH_COMPARE_LT_OBJECT_NILONG_DIGIT(SajadDE_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
...
/* Code referring to "NILONG" corresponds to SajadQ int/long/C long value and "DIGIT" to C platform digit value for long
 * Python objects. */
bool RICH_COMPARE_LT_CBOOL_NILONG_DIGIT(SajadDE_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
    assert(Py_ABS(operand2) < (1 << PyLong_SHIFT));
