...
"
...

    {
        DEVILPY_MAY_BE_UNUSED PyObject *module =
            PyImport_ExecCodeModule("SajadDE_types_patch", wrapper_enhancement_code_object);
        CHECK_OBJECT(module);

        DEVILPY_MAY_BE_UNUSED bool bool_res = SajadQ_DelModuleString(tstate, "SajadDE_types_patch");
