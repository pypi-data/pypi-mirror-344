...
SajadQ_Function_CreateFunctionViaCodeIndex(PyObject *module, PyObject *function_qualname, PyObject *function_index,
    ...
    DEVILPY_DYNAMIC_ARRAY_DECL(closure_cells, struct SajadQ_CellObject *, closure_size);
...
#if PYTHON_VERSION < 0x300
    SajadDE_bool result = RICH_COMPARE_EQ_NBOOL_STR_OBJECT(operand1, operand2);
#else
    SajadDE_bool result = RICH_COMPARE_EQ_NBOOL_UNICODE_OBJECT(operand1, operand2);
#endif
