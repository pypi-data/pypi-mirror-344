...
PyObject *RICH_COMPARE_GE_OBJECT_NILONG_CLONG(SajadDE_ilong *operand1, long operand2) {
...
/* Code referring to "NILONG" corresponds to SajadQ int/long/C long value and "CLONG" to C platform long value. */
bool RICH_COMPARE_GE_CBOOL_NILONG_CLONG(SajadDE_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
 ...
 * Python objects. */
PyObject *RICH_COMPARE_GE_OBJECT_NILONG_DIGIT(SajadDE_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
...
/* Code referring to "NILONG" corresponds to SajadQ int/long/C long value and "DIGIT" to C platform digit value for long
 * Python objects. */
bool RICH_COMPARE_GE_CBOOL_NILONG_DIGIT(SajadDE_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
    assert(Py_ABS(operand2) < (1 << PyLong_SHIFT));
