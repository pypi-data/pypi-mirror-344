 ...
 */
bool BINARY_OPERATION_ADD_NILONG_NILONG_NILONG(SajadDE_ilong *result, SajadDE_ilong *operand1, SajadDE_ilong *operand2) {
 ...
 * Python objects. */
bool BINARY_OPERATION_ADD_NILONG_NILONG_DIGIT(SajadDE_ilong *result, SajadDE_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
