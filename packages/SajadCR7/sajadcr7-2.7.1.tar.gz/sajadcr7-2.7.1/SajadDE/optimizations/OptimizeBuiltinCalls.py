...
from SajadDE.__past__ import unicode, xrange
from SajadDE.Errors import SajadQAssumptionError
from SajadDE.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from SajadDE.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from SajadDE.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from SajadDE.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from SajadDE.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from SajadDE.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from SajadDE.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from SajadDE.nodes.BuiltinFormatNodes import (
...
from SajadDE.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from SajadDE.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from SajadDE.nodes.BuiltinIntegerNodes import (
    ExpressionBuiltinInt1,
    ExpressionBuiltinInt2,
)
from SajadDE.nodes.BuiltinIteratorNodes import (
    ExpressionBuiltinIter1,
    ExpressionBuiltinIter2,
)
from SajadDE.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from SajadDE.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from SajadDE.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from SajadDE.nodes.BuiltinRangeNodes import (
...
from SajadDE.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from SajadDE.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from SajadDE.nodes.BuiltinTypeNodes import (
...
from SajadDE.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from SajadDE.nodes.CallNodes import makeExpressionCall
from SajadDE.nodes.ClassNodes import ExpressionBuiltinType3
from SajadDE.nodes.ComparisonNodes import ExpressionComparisonIs
from SajadDE.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from SajadDE.nodes.ConstantRefNodes import makeConstantRefNode
from SajadDE.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from SajadDE.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from SajadDE.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from SajadDE.nodes.ImportNodes import ExpressionBuiltinImport
from SajadDE.nodes.KeyValuePairNodes import (
...
from SajadDE.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from SajadDE.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from SajadDE.nodes.OutlineNodes import ExpressionOutlineBody
from SajadDE.nodes.ReturnNodes import makeStatementReturn
from SajadDE.nodes.SliceNodes import makeExpressionBuiltinSlice
from SajadDE.nodes.TypeNodes import (
...
from SajadDE.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from SajadDE.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from SajadDE.PythonVersions import python_version
from SajadDE.specs import BuiltinParameterSpecs
from SajadDE.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from SajadDE.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from SajadDE.tree.TreeHelpers import (
    makeCallNode,
...
if python_version < 0x300:
    from SajadDE.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from SajadDE.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def check():
    from SajadDE.Builtins import builtin_names
