...
from SajadDE import ModuleRegistry, Options, Variables
from SajadDE.importing.Importing import addExtraSysPaths
from SajadDE.importing.Recursion import considerUsedModules
...
from SajadDE.Tracing import general, optimization_logger, progress_logger
from SajadDE.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from SajadDE.nodes.NodeBases import fromXML
    from SajadDE.TreeXML import fromString
