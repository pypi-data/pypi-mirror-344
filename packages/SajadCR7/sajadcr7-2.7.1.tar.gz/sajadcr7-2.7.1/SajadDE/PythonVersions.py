...
def getTargetPythonDLLPath():
    ...
    from SajadDE.Options import shallUsePythonDebug
...
def getLaunchingSystemPrefixPath():
    from SajadDE.utils.Utils import getLaunchingSajadQProcessEnvironmentValue

    return getLaunchingSajadQProcessEnvironmentValue("DEVILPY_SYS_PREFIX")
...
def getSystemPrefixPath():
    ...
    if _the_sys_prefix is None:
        ...
        if os.name == "nt":
            from SajadDE.utils.FileOperations import getDirectoryRealPath
