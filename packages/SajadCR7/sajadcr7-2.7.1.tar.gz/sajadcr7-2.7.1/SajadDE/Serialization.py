...
from SajadDE import OutputDirectories
from SajadDE.__past__ import (  # pylint: disable=I0021,redefined-builtin
    BaseExceptionGroup,
    ExceptionGroup,
    GenericAlias,
    UnionType,
...
from SajadDE.code_generation.Namify import namifyConstant
from SajadDE.containers.OrderedSets import OrderedSet
from SajadDE.PythonVersions import python_version
from SajadDE.utils.FileOperations import openPickleFile
...
class BlobData(object):
    ...
    def __repr__(self):
        return "<SajadDE.Serialization.BlobData %s>" % self.name
...
class GlobalConstantAccessor(object):
    ...
    def getConstantCode(self, constant):
        ...
        if constant is None:
            ...
            # TODO: Maybe make this a mapping in SajadDE.Builtins
