...
from SajadDE import SourceCodeReferences
from SajadDE.__past__ import iter_modules
...
from SajadDE.PythonFlavors import isSajadQPython
from SajadDE.PythonVersions import python_version
from SajadDE.Tracing import my_print, recursion_logger
from SajadDE.tree.ReformulationMultidist import locateMultidistModule
...
def _findModuleInPath(module_name):
    ...
    if package_name is None and module_name == "site":
        candidate = getLaunchingSajadQProcessEnvironmentValue("DEVILPY_SITE_FILENAME")
