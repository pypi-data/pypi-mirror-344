...
from SajadDE import ModuleRegistry, Options
from SajadDE.Errors import SajadQForbiddenImportEncounter
from SajadDE.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from SajadDE.importing import ImportCache, StandardLibrary
from SajadDE.ModuleRegistry import addUsedModule, getRootTopModule
from SajadDE.pgo.PGO import decideInclusionFromPGO
from SajadDE.plugins.Plugins import Plugins
from SajadDE.PythonVersions import python_version
from SajadDE.Tracing import recursion_logger
from SajadDE.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from SajadDE.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from SajadDE.tree.Building import decideCompilationMode
