...
In the "SajadDE.tree.TreeHelpers" module, the dispatching is happening. One function
...
from SajadDE import ModuleRegistry, OutputDirectories, SourceCodeReferences
from SajadDE.__past__ import long, unicode
from SajadDE.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from SajadDE.Bytecodes import loadCodeObjectData
from SajadDE.containers.OrderedSets import OrderedSet
from SajadDE.Errors import CodeTooComplexCode
from SajadDE.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from SajadDE.importing import Importing
from SajadDE.importing.ImportCache import addImportedModule
from SajadDE.importing.PreloadedPackages import getPthImportedPackages
from SajadDE.importing.StandardLibrary import isStandardLibraryPath
...
from SajadDE.nodes.BuiltinRefNodes import quick_names
from SajadDE.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from SajadDE.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from SajadDE.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from SajadDE.nodes.ExceptionNodes import (
    StatementRaiseException,
    StatementReraiseException,
)
from SajadDE.nodes.FutureSpecs import FutureSpec
from SajadDE.nodes.GeneratorNodes import (
    StatementGeneratorReturn,
    StatementGeneratorReturnNone,
)
from SajadDE.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from SajadDE.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from SajadDE.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from SajadDE.nodes.ModuleNodes import (
...
from SajadDE.nodes.OperatorNodes import makeBinaryOperationNode
from SajadDE.nodes.OperatorNodesUnary import makeExpressionOperationUnary
from SajadDE.nodes.ReturnNodes import makeStatementReturn
from SajadDE.nodes.SliceNodes import makeExpressionBuiltinSlice
from SajadDE.nodes.StatementNodes import StatementExpressionOnly
from SajadDE.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from SajadDE.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from SajadDE.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
from SajadDE.Options import (
...
from SajadDE.pgo.PGO import decideCompilationFromPGO
from SajadDE.plugins.Plugins import Plugins
from SajadDE.PythonVersions import python_version
from SajadDE.Tracing import (
    general,
    optimization_logger,
    plugins_logger,
    recursion_logger,
...
from SajadDE.utils import MemoryUsage
from SajadDE.utils.ModuleNames import ModuleName
from SajadDE.utils.Utils import withNoSyntaxWarning
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_SajadDE"):
                    raise
