...
from SajadDE.utils.Execution import getExecutablePath
...
from SajadDE.utils.Images import checkIconUsage
from SajadDE.utils.Importing import getInlineCopyFolder
...
def printVersionInformation():
    ...
    from SajadDE.build.SconsInterface import (
        asBoolStr,
...
def parseArgs():
    ...
    global is_SajadDE_run, options, positional_args, extra_args, is_debug, is_non_debug
...
Error, the Python from Windows app store is not supported.""",
    ...
    is_SajadDE_run, options, positional_args, extra_args = parseOptions(
    ...
    if (
        getLaunchingSajadQProcessEnvironmentValue("DEVILPY_RE_EXECUTION")
    ...
    if options.clean_caches:
        from SajadDE.CacheCleanup import cleanCaches
    ...
    if isMacOS():
        ...
        if (options.macos_target_arch or "native") != "native":
            from SajadDE.utils.SharedLibraries import (
...
def _couldUseStaticLibPython():
    ...
    from SajadDE.utils.StaticLibraries import isDebianSuitableForStaticLinking
