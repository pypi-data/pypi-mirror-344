...
from SajadDE.Options import getOnefileTempDirSpec, isOnefileTempDirMode
from SajadDE.OutputDirectories import getResultFullpath
from SajadDE.plugins.Plugins import Plugins
from SajadDE.PostProcessing import executePostProcessingResources
from SajadDE.PythonVersions import (
    getZstandardSupportingVersions,
    python_version,
)
from SajadDE.Tracing import onefile_logger, postprocessing_logger
from SajadDE.utils.Execution import withEnvironmentVarsOverridden
...
from SajadDE.utils.SharedLibraries import cleanupHeaderForAndroid
from SajadDE.utils.Signing import addMacOSCodeSignature
...
from SajadDE.utils.WindowsResources import RT_RCDATA, addResourceToFile
...
def runOnefileCompressor(
    ...
    if compressor_python is None or areSamePaths(
        ...
        from SajadDE.tools.onefile_compressor.OnefileCompressor import (
        ...
        mapping = {
            "DEVILPY_PACKAGE_HOME": os.path.dirname(
                os.path.abspath(sys.modules["SajadDE"].__path__[0])
            )
        }
