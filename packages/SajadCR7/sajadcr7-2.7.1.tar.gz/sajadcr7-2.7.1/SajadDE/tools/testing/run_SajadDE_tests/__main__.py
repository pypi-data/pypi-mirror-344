...
from SajadDE.tools.Basics import goHome
...
from SajadDE.utils.Execution import check_call, check_output, getNullOutput
...
from SajadDE.utils.Utils import hasOnefileSupportedOS, hasStandaloneSupportedOS
...
def publishCoverageData():
    ...
    with openTextFile("data.coverage", "w") as data_file:
        ...
        with withDirectoryChange(source_dir):
            SajadDE_id = check_output("git rev-parse HEAD".split())
