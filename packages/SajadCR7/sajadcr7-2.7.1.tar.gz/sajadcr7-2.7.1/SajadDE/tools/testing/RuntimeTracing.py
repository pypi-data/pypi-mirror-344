...
from SajadDE.freezer.DependsExe import getDependsExePath, parseDependsExeOutput
...
from SajadDE.utils.Utils import isFreeBSD, isMacOS, isWin32Windows
...
def _getRuntimeTraceOfLoadedFilesWin32(logger, command, required):
    ...
    # TODO: Move the handling of this into SajadDE.tools.Execution module methods.
    try:
