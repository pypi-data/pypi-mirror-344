...
from SajadDE.__past__ import long
...
class NBoolDesc(ConcreteCTypeBase):
    ...
    def getToValueFromObjectExpression(cls, operand):
        # TODO: Seems wrong, int return values only happen to match SajadDE_bool here
