...
import SajadDE.specs.BuiltinUnicodeOperationSpecs
from SajadDE.code_generation.BinaryOperationHelperDefinitions import (
    getSpecializedBinaryOperations,
    isCommutativeOperation,
    parseTypesFromHelper,
)
from SajadDE.code_generation.c_types.CTypePyObjectPointers import (
    make_list_constant_direct_threshold,
    make_list_constant_hinted_threshold,
)
from SajadDE.code_generation.CallCodes import (
    getQuickCallCode,
...
from SajadDE.code_generation.ComparisonHelperDefinitions import (
    getSpecializedComparisonOperations,
)
from SajadDE.code_generation.ImportCodes import getImportModuleHardCodeName
from SajadDE.containers.OrderedSets import OrderedSet
from SajadDE.HardImportRegistry import (
    hard_modules,
...
from SajadDE.utils.Jinja2 import getTemplateC
...
def getDoExtensionUsingTemplateC(template_name):
    return getTemplateC(
        package_name="SajadDE.code_generation",
...
def makeHelpersComparisonOperation(operand, op_code):
    ...
    filename_c = "SajadDE/build/static_src/HelpersComparison%s.c" % op_code.capitalize()
    filename_h = "SajadDE/build/include/SajadDE/helper/comparisons_%s.h" % op_code.lower()
...
def makeHelpersComparisonDualOperation(operand, op_code):
    ...
    filename_c = (
        "SajadDE/build/static_src/HelpersComparisonDual%s.c" % op_code.capitalize()
    )
    filename_h = (
        "SajadDE/build/include/SajadDE/helper/comparisons_dual_%s.h" % op_code.lower()
    )
...
def makeHelpersBinaryOperation(operator, op_code):
    ...
    filename_c = (
        "SajadDE/build/static_src/HelpersOperationBinary%s.c" % op_code.capitalize()
    )
    filename_h = (
        "SajadDE/build/include/SajadDE/helper/operations_binary_%s.h" % op_code.lower()
    )
...
def makeHelpersInplaceOperation(operator, op_code):
    ...
    filename_c = (
        "SajadDE/build/static_src/HelpersOperationInplace%s.c" % op_code.capitalize()
    )
    filename_h = (
        "SajadDE/build/include/SajadDE/helper/operations_inplace_%s.h" % op_code.lower()
    )
...
def makeHelpersBinaryDualOperation(operand, op_code):
    ...
    filename_c = (
        "SajadDE/build/static_src/HelpersOperationBinaryDual%s.c" % op_code.capitalize()
    )
    filename_h = (
        "SajadDE/build/include/SajadDE/helper/operations_binary_dual_%s.h"
        % op_code.lower()
    )
...
def makeHelpersImportHard():
    filename_c = "SajadDE/build/static_src/HelpersImportHard.c"
    filename_h = "SajadDE/build/include/SajadDE/helper/import_hard.h"
...
def makeHelperCalls():
    filename_c = "SajadDE/build/static_src/HelpersCallingGenerated.c"
    filename_h = "SajadDE/build/include/SajadDE/helper/calling_generated.h"
    ...
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
            ...
            template = getTemplateC(
                "SajadDE.code_generation", "CodeTemplateCallsPositional.c.j2"
            )
            ...
            template = getTemplateC(
                "SajadDE.code_generation", "CodeTemplateCallsMixed.c.j2"
            )
...
def makeHelperLists():
    filename_c = "SajadDE/build/static_src/HelpersListsGenerated.c"
    filename_h = "SajadDE/build/include/SajadDE/helper/lists_generated.h"
    ...
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
            ...
            template = getTemplateC(
                "SajadDE.code_generation", "CodeTemplateMakeListSmall.c.j2"
            )
            ...
            template = getTemplateC(
                "SajadDE.code_generation", "CodeTemplateMakeListHinted.c.j2"
            )
...
generate_builtin_type_operations = [
    ...
    (
        "tshape_unicode",
        unicode_desc,
        SajadDE.specs.BuiltinUnicodeOperationSpecs,
        (
            "strip",
            "rstrip",
            "lstrip",
...
def makeDictCopyHelperCodes():
    filename_c = "SajadDE/build/static_src/HelpersDictionariesGenerated.c"
...
def makeHelperBuiltinTypeMethods():
    ...
    filename_c = "SajadDE/build/static_src/HelpersBuiltinTypeMethods.c"
    filename_h = "SajadDE/build/include/SajadDE/helper/operations_builtin_types.h"
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
