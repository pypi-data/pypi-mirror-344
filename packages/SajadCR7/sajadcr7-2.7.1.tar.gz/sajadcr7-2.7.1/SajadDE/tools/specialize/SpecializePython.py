...
import sys
import SajadDE.Options

SajadDE.Options.is_full_compat = False
...
import SajadDE.code_generation.BinaryOperationHelperDefinitions
import SajadDE.code_generation.CodeGeneration
import SajadDE.code_generation.ComparisonCodes
import SajadDE.code_generation.Namify
import SajadDE.nodes.NetworkxNodes
import SajadDE.nodes.PackageMetadataNodes
import SajadDE.nodes.PackageResourceNodes
import SajadDE.nodes.SideEffectNodes
import SajadDE.nodes.TensorflowNodes
import SajadDE.specs.BuiltinBytesOperationSpecs
import SajadDE.specs.BuiltinDictOperationSpecs
import SajadDE.specs.BuiltinListOperationSpecs
import SajadDE.specs.BuiltinStrOperationSpecs
import SajadDE.specs.BuiltinTypeOperationSpecs
import SajadDE.specs.HardImportSpecs
import SajadDE.tree.Building
from SajadDE.containers.OrderedDicts import OrderedDict
from SajadDE.containers.OrderedSets import OrderedSet
from SajadDE.nodes.ImportNodes import hard_modules_non_stdlib
from SajadDE.nodes.NodeMetaClasses import NodeCheckMetaClass
from SajadDE.nodes.shapes.BuiltinTypeShapes import (
    tshape_bool,
    tshape_bytes,
    tshape_dict,
    tshape_int,
...
from SajadDE.utils.Jinja2 import getTemplate
...
def _getMixinForShape(shape):
    ...
    if shape is tshape_str:
        return "SajadDE.nodes.ExpressionShapeMixins.ExpressionStrShapeExactMixin"
    elif shape is tshape_list:
        return "SajadDE.nodes.ExpressionShapeMixins.ExpressionListShapeExactMixin"
    elif shape is tshape_tuple:
        return "SajadDE.nodes.ExpressionShapeMixins.ExpressionTupleShapeExactMixin"
    elif shape is tshape_int:
        return "SajadDE.nodes.ExpressionShapeMixins.ExpressionIntShapeExactMixin"
    elif shape is tshape_bool:
        return "SajadDE.nodes.ExpressionShapeMixins.ExpressionBoolShapeExactMixin"
    elif shape is tshape_none:
        return "SajadDE.nodes.ExpressionShapeMixins.ExpressionNoneShapeExactMixin"
    elif shape is tshape_dict:
        return "SajadDE.nodes.ExpressionShapeMixins.ExpressionDictShapeExactMixin"
    elif shape is tshape_bytes:
        return "SajadDE.nodes.ExpressionShapeMixins.ExpressionBytesShapeExactMixin"
    else:
        assert False, shape
...
processTypeShapeAttribute(
    "tshape_dict",
    SajadDE.specs.BuiltinDictOperationSpecs,
    python2_dict_methods,
    python3_dict_methods,
    ("fromkeys",),
)
...
processTypeShapeAttribute(
    "tshape_str",
    SajadDE.specs.BuiltinStrOperationSpecs,
    python2_str_methods,
    python3_str_methods,
)
...
processTypeShapeAttribute(
    "tshape_bytes",
    SajadDE.specs.BuiltinBytesOperationSpecs,
    (),
    python3_bytes_methods,
)
...
processTypeShapeAttribute(
    "tshape_list",
    SajadDE.specs.BuiltinListOperationSpecs,
    python2_list_methods,
    python3_list_methods,
)
...
processTypeShapeAttribute(
    "tshape_type",
    SajadDE.specs.BuiltinTypeOperationSpecs,
    python2_type_methods,
    python3_type_methods,
)
...
def emitGenerationWarning(emit, doc_string, template_name):
    ...
    for spec_descriptions in getSpecVersions(SajadDE.specs.HardImportSpecs):
...
def makeAttributeNodes():
    filename_python = "SajadDE/nodes/AttributeNodesGenerated.py"
    ...
    with withFileOpenedAndAutoFormatted(
        ...
        emit("from SajadDE.specs.BuiltinParameterSpecs import extractBuiltinArgs")

        emit("from SajadDE.nodes.ConstantRefNodes import makeConstantRefNode")
        emit(
            """\
from SajadDE.nodes.NodeMakingHelpers import (
    ...
    makeRaiseExceptionReplacementExpression
        ...
        emit(
            "from SajadDE.nodes.KeyValuePairNodes import makeKeyValuePairExpressionsFromKwArgs"
        )

        emit("from SajadDE.nodes.AttributeNodes import makeExpressionAttributeLookup")

        emit("from SajadDE.PythonVersions import getDictFromkeysNoArgErrorMessage")
...
def makeBuiltinOperationNodes():
    filename_python = "SajadDE/nodes/BuiltinOperationNodeBasesGenerated.py"
...
def makeChildrenHavingMixinNodes():
    ...
    filename_python = "SajadDE/nodes/ChildrenHavingMixins.py"
    filename_python2 = "SajadDE/nodes/ExpressionBasesGenerated.py"
    filename_python3 = "SajadDE/nodes/StatementBasesGenerated.py"
    ...
    with withFileOpenedAndAutoFormatted(
        ...
        emit1(
            """
from SajadDE.nodes.Checkers import (
    checkStatementsSequenceOrNone,
...
def makeHardImportNodes():
    ...
    filename_python = "SajadDE/nodes/HardImportNodesGenerated.py"
