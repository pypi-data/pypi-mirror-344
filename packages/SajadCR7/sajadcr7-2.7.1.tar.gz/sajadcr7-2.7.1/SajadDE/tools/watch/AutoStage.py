...
from SajadDE.tools.quality.Git import (
    getCheckoutFileChangeDesc,
    getFileHashContent,
    putFileHashContent,
    updateGitFile,
)
from SajadDE.TreeXML import fromString, toString
from SajadDE.utils.FileOperations import getFileContents, withTemporaryFile
...
def onCompilationReportChange(filename, git_stage):
    ...
    new_SajadDE_version = new_report.attrib["SajadDE_version"]
    changed = False
    if old_report.attrib["SajadDE_version"] != new_SajadDE_version:
        old_report.attrib["SajadDE_version"] = new_SajadDE_version
