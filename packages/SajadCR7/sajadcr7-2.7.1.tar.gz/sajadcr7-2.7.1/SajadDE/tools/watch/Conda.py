...
""" Conda backend for maintaining locked package state with SajadDE-watch. """

from SajadDE.utils.Execution import check_call, executeToolChecked
from SajadDE.utils.FileOperations import changeTextFileContents
...
def _getCaseEnvironmentName(installed_python, case_data):
    return "SajadDE-watch-case-%(python_version)s-%(case)s" % {
