...
from SajadDE import Options
from SajadDE.__past__ import iter_modules, unicode
from SajadDE.containers.Namedtuples import makeNamedtupleClass
...
from SajadDE.Tracing import plugins_logger
from SajadDE.utils.AppDirs import getAppdirsModule
...
from SajadDE.utils.Importing import getSharedLibrarySuffix, isBuiltinModuleName
...
from SajadDE.utils.SharedLibraries import locateDLL, locateDLLsInDirectory
from SajadDE.utils.SlotMetaClasses import getMetaClassBase
...
def _getPackageData(package_name, resource, default=None):
    ...
    from SajadDE.utils.PackageResources import getPackageData
...
class SajadQPluginBase(getMetaClassBase("Plugin", require_slots=False)):
    ...
    What they are can be displayed using "SajadDE --plugin-list file.py" (filename
...
%(recommendation)s or uninstall it for best compatibility with pure Python execution."""
    ...
    def locateModules(module_name):
        ...
        from SajadDE.importing.Importing import locateModules
