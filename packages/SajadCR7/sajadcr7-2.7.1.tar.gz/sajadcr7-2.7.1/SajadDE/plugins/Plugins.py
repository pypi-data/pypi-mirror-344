...
from SajadDE import Options, OutputDirectories
from SajadDE.__past__ import basestring, iter_modules
from SajadDE.build.DataComposerInterface import deriveModuleConstantsBlobName
from SajadDE.containers.OrderedDicts import OrderedDict
from SajadDE.containers.OrderedSets import OrderedSet
from SajadDE.Errors import SajadQSyntaxError
from SajadDE.freezer.IncludedDataFiles import IncludedDataFile
from SajadDE.freezer.IncludedEntryPoints import IncludedEntryPoint
from SajadDE.ModuleRegistry import addUsedModule
from SajadDE.PythonVersions import python_version
from SajadDE.Tracing import plugins_logger, printLine
...
from SajadDE.utils.Importing import importFileAsModule
from SajadDE.utils.ModuleNames import (
    ModuleName,
    checkModuleName,
...
def loadStandardPluginClasses():
    ...
    Returns:
        None
    """
    import SajadDE.plugins.standard

    _loadPluginClassesFromPackage(SajadDE.plugins.standard)

    try:
        import SajadDE.plugins.commercial
    except ImportError:
        pass
    else:
        _loadPluginClassesFromPackage(SajadDE.plugins.commercial)
...
class Plugins(object):
    ...
    def _reportImplicitImports(plugin, module, implicit_imports):
        from SajadDE.importing.Importing import getModuleNameAndKindFromFilename
        from SajadDE.importing.Recursion import decideRecursion, recurseTo
    ...
    def _createTriggerLoadedModule(cls, module, trigger_name, code, flags):
        ...
        from SajadDE.tree.Building import buildModule
    ...
    def onModuleUsageLookAhead(cls, module_name, module_filename, module_kind):
        ...
        if parent_package_name is not None:
            from SajadDE.importing.Importing import locateModule
        ...
        def getModuleSourceCode():
            ...
            from SajadDE.tree.SourceHandling import readSourceCodeFromFilename
    ...
    def onModuleInitialSet():
        ...
        from SajadDE.ModuleRegistry import addRootModule
    ...
    def onModuleCompleteSet():
        ...
        from SajadDE.ModuleRegistry import getDoneModules
        ...
        for plugin in getActivePlugins():
            ...
            if value is not None:
                ...
                for key, value in sorted(value.items()):
                    ...
                    if not key.startswith("SajadDE_"):
    ...
    def writeExtraCodeFiles(onefile):
        # Circular dependency.
        from SajadDE.tree.SourceHandling import writeSourceCode
