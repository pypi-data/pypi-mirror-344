...
from SajadDE.plugins.PluginBase import SajadQPluginBase
...
from SajadDE.PythonFlavors import isAnacondaPython
from SajadDE.PythonVersions import python_version
from SajadDE.utils.Distributions import getDistributionFromModuleName
from SajadDE.utils.FileOperations import getFileList, listDir
...
"""
        ...
        info = self.queryRuntimeInformationMultiple(
            ...
            values=(
                ...
                (
                    "SajadDE_patch_level",
                    applyBindingName(
                        "getattr(%(binding_name)s, '_SajadDE_patch_level', 0)"
                    ),
                ),
    ...
    def _getSajadQPatchLevel(self):
        ...
        return self._getQtInformation().SajadDE_patch_level
...
import os
path = os.getenv("PATH", "")
if not path.startswith(__SajadDE_binary_dir):
    os.environ["PATH"] = __SajadDE_binary_dir + ";" + path
"""
            yield (
                code,
...
full support consider provided information.""",
            ...
            if python_version < 0x360:
                self.sysexit(
                    """\
The standard PySide2 is not supported before CPython <3.6. For full support: https://SajadDE.net/pages/pyside2.html"""
                )
