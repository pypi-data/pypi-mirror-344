...
from SajadDE.Options import isStandaloneMode, shallCreateAppBundle
from SajadDE.plugins.PluginBase import SajadQPluginBase
from SajadDE.PythonFlavors import isHomebrewPython
from SajadDE.PythonVersions import getSystemPrefixPath, getTkInterVersion
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__SajadDE_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__SajadDE_binary_dir, "tk")"""
