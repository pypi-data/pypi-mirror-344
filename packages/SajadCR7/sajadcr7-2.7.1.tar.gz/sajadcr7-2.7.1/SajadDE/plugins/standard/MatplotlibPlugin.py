...
from SajadDE.Options import isStandaloneMode
...
from SajadDE.utils.Execution import SajadQCalledProcessError
from SajadDE.utils.FileOperations import getFileContentByLine
from SajadDE.utils.Jinja2 import renderTemplateFromString
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__SajadDE_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__SajadDE_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
