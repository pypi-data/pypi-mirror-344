...
from SajadDE.plugins.YamlPluginBase import SajadQYamlPluginBase
from SajadDE.utils.ModuleNames import ModuleName
from SajadDE.utils.Utils import isMacOS, isWin32Windows
...
class SajadQPluginImplicitImports(SajadQYamlPluginBase):
    ...
    def onModuleSourceCode(self, module_name, source_filename, source_code):
        ...
        if module_name == "site":
            ...
            source_code = """\
__file__ = (__SajadDE_binary_dir + '%ssite.py') if '__SajadDE_binary_dir' in dict(__builtins__ ) else '<frozen>';%s""" % (
                os.path.sep,
                source_code,
            )
...
def makeExpressionImportModuleNameHardExistsAfterImportFactory(
    ...
    from SajadDE.HardImportRegistry import trust_node_factory
    from SajadDE.nodes.ImportHardNodes import (
