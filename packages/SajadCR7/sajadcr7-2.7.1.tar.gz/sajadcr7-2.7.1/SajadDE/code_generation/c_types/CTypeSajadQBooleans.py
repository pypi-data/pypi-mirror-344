...
""" CType classes for SajadDE_bool, an enum to represent True, False, unassigned.

"""

from SajadDE.code_generation.ErrorCodes import getReleaseCode
...
class CTypeSajadQBoolEnum(CTypeNotReferenceCountedMixin, CTypeBase):
    ...
    def emitVariableAssignCode(
        ...
        if tmp_name.c_type == "SajadDE_bool":
