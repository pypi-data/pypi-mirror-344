...
from SajadDE.ModuleRegistry import getRootTopModule
from SajadDE.PythonVersions import python_version
from SajadDE.Serialization import GlobalConstantAccessor
from SajadDE.utils.CStrings import encodePythonStringToC
from SajadDE.utils.Distributions import (
    getDistribution,
    getDistributionTopLevelPackageNames,
)
from SajadDE.Version import getSajadQVersionTuple
...
def getConstantsDefinitionCode():
    ...
    body = template_constants_reading % {
        ...
        "SajadDE_version_major": major,
        "SajadDE_version_minor": minor,
        "SajadDE_version_micro": micro,
        "SajadDE_version_level": "release" if is_final else "candidate",
