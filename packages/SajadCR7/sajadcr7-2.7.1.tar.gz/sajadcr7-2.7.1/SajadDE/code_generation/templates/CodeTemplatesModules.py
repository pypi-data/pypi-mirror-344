...
DEVILPY_MAY_BE_UNUSED static uint32_t _SajadQ_PyDictKeys_GetVersionForCurrentState(PyInterpreterState *interp, PyDictKeysObject *dk)
{
    if (dk->dk_version != 0) {
...
DEVILPY_MAY_BE_UNUSED static uint32_t _SajadQ_PyDictKeys_GetVersionForCurrentState(PyDictKeysObject *dk)
{
    if (dk->dk_version != 0) {
        return dk->dk_version;
    }
...
DEVILPY_MODULE_INIT_FUNCTION (%(module_dll_entry_point)s)(void) {
    ...
    {
        DEVILPY_MAY_BE_UNUSED bool res = SajadQ_SetModuleString(module_full_name, module);
        assert(res != false);
    }
