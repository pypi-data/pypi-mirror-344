...
static void _createGlobalConstants(PyThreadState *tstate) {
    ...
    PyStructSequence_SET_ITEM(SajadQ_dunder_compiled_value, 0, SajadQ_PyInt_FromLong(%(SajadDE_version_major)s));
    PyStructSequence_SET_ITEM(SajadQ_dunder_compiled_value, 1, SajadQ_PyInt_FromLong(%(SajadDE_version_minor)s));
    PyStructSequence_SET_ITEM(SajadQ_dunder_compiled_value, 2, SajadQ_PyInt_FromLong(%(SajadDE_version_micro)s));

    PyStructSequence_SET_ITEM(SajadQ_dunder_compiled_value, 3, SajadQ_String_FromString("%(SajadDE_version_level)s"));
