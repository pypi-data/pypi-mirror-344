...
def generateAssignmentVariableCode(statement, emit, context):
    ...
    if variable.isModuleVariable():
        ...
        if source_shape is tshape_bool and variable_declaration.c_type == "SajadDE_bool":
            tmp_name = context.allocateTempName("assign_source", "SajadDE_bool")
        elif (
            source_shape is tshape_int_or_long
            and variable_declaration.c_type == "SajadDE_ilong"
        ):
            tmp_name = context.allocateTempName("assign_source", "SajadDE_ilong")
        else:
            tmp_name = context.allocateTempName("assign_source")
