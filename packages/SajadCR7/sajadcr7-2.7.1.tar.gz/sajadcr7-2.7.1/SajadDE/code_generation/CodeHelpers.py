...
from SajadDE.nodes.NodeMetaClasses import SajadQNodeDesignError
from SajadDE.Options import shallTraceExecution
from SajadDE.PythonVersions import python_version
from SajadDE.Tracing import printError
...
def decideConversionCheckNeeded(to_name, expression):
    if to_name.c_type == "SajadDE_bool":
...
def assignConstantNoneResult(to_name, emit, context):
    ...
    if to_name.c_type == "SajadDE_void":
