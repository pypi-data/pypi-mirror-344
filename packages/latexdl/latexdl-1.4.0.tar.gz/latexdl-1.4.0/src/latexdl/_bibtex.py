...
def _entry_to_text(
    key: str, entry: dict[str, Any], markdown: bool = False
) -> str | None:
    ...
    if author_field := entry.get("author"):
        ...
        author_list = [a.strip() for a in author_field.split(" and ")]
        formatted_authors = []
