...
class Generator:
    ...
    def linearRegressionSlopeBackward(self, i, t, seconds = 5):
        subset_len = int(seconds/(3600 * t))  # Convert minutes to steps
        xy = 0
        x = 0
        y = 0
        x2 = 0
    ...
    def linearRegressionSlopeForward(self, i, t, seconds = 5):
        subset_len = int(seconds/(3600 * t))  # Convert minutes to steps
        xy = 0
        x = 0
        y = 0
