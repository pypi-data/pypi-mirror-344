from random_allocation.random_allocation_scheme.inverse import allocation_epsilon_inverse
...
def allocation_epsilon_combined(sigma: float,
    ...
    if direction != 'add':
        ...
        epsilon_remove_RDP = allocation_epsilon_direct(sigma=sigma, delta=delta, num_steps=num_steps, 
    ...
    if direction != 'remove':
        ...
        epsilon_add_RDP = allocation_epsilon_direct(sigma=sigma, delta=delta, num_steps=num_steps, 
