...
def normalize(img, maxval, reshape=False):
    ...
    Call utils.normalize moving forward.
    """
...
class MergeDataset(Dataset):
    ...
    .. code-block:: python
        ...
        dmerge = datasets.MergeDataset([dataset1, dataset2, ...])
        # Output:
...
class SubsetDataset(Dataset):
    ...
    .. code-block:: python
        ...
        dsubset = datasets.SubsetDataset(dataset, [0, 5, 60])
        # Output:
    ...
    .. code-block:: python
        ...
        dsubset = datasets.SubsetDataset(dataset, idxs)
        # Output:
...
class VinBrain_Dataset(Dataset):
    ...
    .. code-block:: python
        ...
        d_vin = datasets.VinBrain_Dataset(
            imgpath=".../train",
            csvpath=".../train.csv"
        )
...
class CovariateDataset(Dataset):
    ...
    The class datasets.CovariateDataset takes two datasets and two arrays
