...
class RunnerJobsApi:
    ...
    def complete_api_v1_runner_jobs_complete_post(
        self,
        ack: StrictStr,
        complete_runner_job_request_dto: CompleteRunnerJobRequestDto,
        ...
        :param ack: (required)
        :type ack: str
        :param complete_runner_job_request_dto: (required)
        :type complete_runner_job_request_dto: CompleteRunnerJobRequestDto
        ...
        _param = self._complete_api_v1_runner_jobs_complete_post_serialize(
            ack=ack,
            complete_runner_job_request_dto=complete_runner_job_request_dto,
    ...
    def _complete_api_v1_runner_jobs_complete_post_serialize(
        self,
        ack,
        complete_runner_job_request_dto,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
    ...
    def lease_api_v1_runner_jobs_lease_post(
        ...
        :param runner_host: (required)
        :type runner_host: RunnerHost
    ...
    def lease_api_v1_runner_jobs_lease_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LeaseRunnerJobResponseDto]:
        """Lease
    ...
    def ping_api_v1_runner_jobs_ping_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PingRunnerJobResponseDto]:
        """Ping
