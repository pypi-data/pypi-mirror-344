...
class AgentsApi:
    ...
    def create_agent_api_v1_agents_post(
        self,
        agent_create_command: AgentCreateCommand,
        ...
        :param agent_create_command: (required)
        :type agent_create_command: AgentCreateCommand
    ...
    def list_agents_api_v1_agents_get(
        ...
        :param limit:
        :type limit: int
        :param expand: total_count: Include the total number of agents that match the query, only accurate up to 100.
    ...
    def update_agent_api_v1_agents_agent_id_patch(
        self,
        agent_id: StrictStr,
        agent_update_command: AgentUpdateCommand,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type agent_id: str
        :param agent_update_command: (required)
        :type agent_update_command: AgentUpdateCommand
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
