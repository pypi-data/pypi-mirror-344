...
class SchedulesApi:
    ...
    def create_schedule_api_v1_workspaces_workspace_id_schedules_post(
        ...
        create_schedule_request_dto: CreateScheduleRequestDto,
        ...
        :param create_schedule_request_dto: (required)
        :type create_schedule_request_dto: CreateScheduleRequestDto
        ...
        _param = self._create_schedule_api_v1_workspaces_workspace_id_schedules_post_serialize(
            ...
            create_schedule_request_dto=create_schedule_request_dto,
    ...
    def create_schedule_api_v1_workspaces_workspace_id_schedules_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateScheduleResponseDto]:
        """Create Schedule
