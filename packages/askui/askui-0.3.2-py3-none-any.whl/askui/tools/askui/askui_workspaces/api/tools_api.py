...
class ToolsApi:
    ...
    def extract_data_api_v1_tools_extract_data_post(
        self,
        extract_data_command: ExtractDataCommand,
        ...
        Extract data from files using a provided schema. Depending on the number of files, their size and type, and the complexity of the schema, it may take a while (up to multiple minutes) to complete so don't time out too early.

        :param extract_data_command: (required)
        :type extract_data_command: ExtractDataCommand
