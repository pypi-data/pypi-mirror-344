...
class CNN1D(nn.Module):
    def __init__(self, n_features: int, window_size: int, **kwargs):
        ...
        self.conv0_features = kwargs.get('conv1_features', 256)
        self.conv0_kernel_size = kwargs.get('conv1_kernel_size', 5)

        self.conv1_features = kwargs.get('conv1_features', 256)
