...
""")
    ...
    dist_parser.add_argument('--element1', '-e1', type=str, default="Mn", help='First element type')
    dist_parser.add_argument('--element2', '-e2', type=str, default="N", help='Second element type')
